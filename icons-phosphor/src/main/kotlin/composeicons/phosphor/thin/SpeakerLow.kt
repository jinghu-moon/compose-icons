...
val PhosphorIcons.Thin.SpeakerLow: ImageVector
    get() {
        ...
        _speakerLow = phosphorThinIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M153.76 28.41c-1.373-.676-3.011-.509-4.22 .43L78.63 84h-46.63C25.373 84 20 89.373 20 96v64c0 6.627 5.373 12 12 12h46.63l70.91 55.16c.706 .541 1.57 .836 2.46 .84 .611 .002 1.213-.138 1.76-.41 1.37-.671 2.239-2.064 2.24-3.59v-192c-.001-1.526-.87-2.919-2.24-3.59ZM28 160v-64c0-2.209 1.791-4 4-4h44v72h-44c-2.209 0-4-1.791-4-4ZM148 215.82 84 166v-76L148 40.22ZM204 128c.002 8.771-3.198 17.242-9 23.82-1.464 1.657-3.993 1.814-5.65 .35-1.657-1.464-1.814-3.993-.35-5.65 9.31-10.577 9.31-26.423 0-37-1.343-1.668-1.135-4.097 .473-5.512 1.608-1.415 4.044-1.312 5.527 .232 5.788 6.563 8.987 15.009 9 23.76Z"),
