        ...
        _brandCpp = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(3.567004f, 6.0f, 2.0f, 7.567004f, 2.0f, 9.5f),
                    PathNode.LineTo(2.0f, 14.5f),
                    PathNode.CurveTo(2.0f, 16.432997f, 3.567004f, 18.0f, 5.5f, 18.0f),
                    PathNode.LineTo(6.0f, 18.0f),
                    PathNode.CurveTo(7.656854f, 18.0f, 9.0f, 16.656855f, 9.0f, 15.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
