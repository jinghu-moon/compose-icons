...
val PhosphorIcons.Duotone.ChatCircleText: ImageVector
    get() {
        if (_chatCircleText != null) return _chatCircleText!!
        _chatCircleText = phosphorDuotoneIcon(
            name = "ChatCircleText",
