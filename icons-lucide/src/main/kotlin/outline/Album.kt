...
val LucideIcons.Outline.Album: ImageVector
    get() {
        if (_album != null) return _album!!
        _album = lucideOutlineIcon(
            name = "Album",
            ...
            addPath(
                pathData = parseSvgPathData("M 11.000 3.000 L 11.000 11.000 L 14.000 8.000 L 17.000 11.000 L 17.000 3.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
