        ...
        _slackLogo = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(224.0f, 165.25484f, 213.25484f, 176.0f, 200.0f, 176.0f),
                    PathNode.LineTo(152.0f, 176.0f),
                    PathNode.CurveTo(165.25484f, 176.0f, 176.0f, 186.74516f, 176.0f, 200.0f),
                    PathNode.LineTo(176.0f, 200.0f),
                    PathNode.CurveTo(176.0f, 213.25484f, 165.25484f, 224.0f, 152.0f, 224.0f),
                    PathNode.LineTo(152.0f, 224.0f),
                    PathNode.CurveTo(138.74516f, 224.0f, 128.0f, 213.25484f, 128.0f, 200.0f),
                    PathNode.LineTo(128.0f, 176.0f),
                    PathNode.LineTo(152.0f, 176.0f),
                    PathNode.CurveTo(138.74516f, 176.0f, 128.0f, 165.25484f, 128.0f, 152.0f),
                    PathNode.LineTo(128.0f, 128.0f),
                    PathNode.LineTo(200.0f, 128.0f),
                    PathNode.CurveTo(213.25484f, 128.0f, 224.0f, 138.74516f, 224.0f, 152.0f),
                    PathNode.Close,
                    PathNode.MoveTo(104.0f, 80.0f),
                    PathNode.LineTo(128.0f, 80.0f),
                    PathNode.LineTo(128.0f, 56.0f),
                    PathNode.CurveTo(128.0f, 42.745167f, 117.25484f, 32.0f, 104.0f, 32.0f),
                    PathNode.LineTo(104.0f, 32.0f),
                    PathNode.CurveTo(90.74516f, 32.0f, 80.0f, 42.745167f, 80.0f, 56.0f),
                    PathNode.LineTo(80.0f, 56.0f),
                    PathNode.CurveTo(80.0f, 69.25484f, 90.74516f, 80.0f, 104.0f, 80.0f),
                    PathNode.LineTo(56.0f, 80.0f),
                    PathNode.CurveTo(42.745167f, 80.0f, 32.0f, 90.74516f, 32.0f, 104.0f),
                    PathNode.LineTo(32.0f, 104.0f),
                    PathNode.CurveTo(32.0f, 117.25484f, 42.745167f, 128.0f, 56.0f, 128.0f),
                    PathNode.LineTo(128.0f, 128.0f),
                    PathNode.LineTo(128.0f, 104.0f),
                    PathNode.CurveTo(128.0f, 90.74516f, 117.25484f, 80.0f, 104.0f, 80.0f),
                    PathNode.Close
                ),
