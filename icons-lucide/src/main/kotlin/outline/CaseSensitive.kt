...
val LucideIcons.Outline.CaseSensitive: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 22.000 9.000 L 22.000 16.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 22.000 12.500 C 22.000 14.433 20.433 16.000 18.500 16.000 C 16.567 16.000 15.000 14.433 15.000 12.500 C 15.000 10.567 16.567 9.000 18.500 9.000 C 20.433 9.000 22.000 10.567 22.000 12.500 Z"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
