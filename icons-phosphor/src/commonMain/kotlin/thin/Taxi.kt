        ...
        _taxi = phosphorThinIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(226.32f, 108.0f),
                    PathNode.LineTo(197.78f, 58.05f),
                    PathNode.CurveTo(195.63147f, 54.328606f, 191.65707f, 52.04009f, 187.36f, 52.05f),
                    PathNode.LineTo(162.71f, 52.05f),
                    PathNode.LineTo(149.71f, 19.59f),
                    PathNode.CurveTo(147.90407f, 15.019724f, 143.49413f, 12.012407f, 138.58f, 12.0f),
                    PathNode.LineTo(117.42f, 12.0f),
                    PathNode.CurveTo(112.51094f, 11.996071f, 108.09453f, 14.982595f, 106.27f, 19.54f),
                    PathNode.LineTo(93.29f, 52.0f),
                    PathNode.LineTo(68.64f, 52.0f),
                    PathNode.CurveTo(64.34292f, 51.99009f, 60.368538f, 54.278606f, 58.22f, 58.0f),
                    PathNode.LineTo(29.68f, 108.0f),
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(113.7f, 22.51f),
                    PathNode.CurveTo(114.309685f, 20.991043f, 115.78326f, 19.99678f, 117.42f, 20.0f),
                    PathNode.LineTo(138.58f, 20.0f),
                    PathNode.CurveTo(140.21675f, 19.99678f, 141.6903f, 20.991043f, 142.3f, 22.51f),
                    PathNode.LineTo(154.09f, 52.0f),
                    PathNode.LineTo(101.91f, 52.0f),
                    PathNode.Close,
                    PathNode.MoveTo(65.17f, 62.0f),
                    PathNode.CurveTo(65.88558f, 60.76057f, 67.20883f, 59.99789f, 68.64f, 60.0f),
                    PathNode.LineTo(187.36f, 60.0f),
                    PathNode.CurveTo(188.79117f, 59.99789f, 190.11441f, 60.76057f, 190.83f, 62.0f),
                    PathNode.LineTo(217.11f, 108.0f),
                    PathNode.LineTo(38.89f, 108.0f),
                    PathNode.Close,
