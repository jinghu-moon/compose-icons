...
val PhosphorIcons.Duotone.CaretLineLeft: ImageVector
    get() {
        ...
        _caretLineLeft = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M192 48v160L112 128Z"),
            ...
            addPath(
                pathData = parseSvgPathData("M195.06 40.61c-2.989-1.24-6.431-.557-8.72 1.73l-80 80c-1.502 1.501-2.346 3.537-2.346 5.66 0 2.123 .844 4.159 2.346 5.66l80 80c2.288 2.291 5.731 2.976 8.722 1.737 2.991-1.239 4.94-4.159 4.938-7.397v-160c-.001-3.236-1.95-6.152-4.94-7.39ZM184 188.69 123.31 128 184 67.31ZM80 48v160c0 4.418-3.582 8-8 8-4.418 0-8-3.582-8-8v-160c0-4.418 3.582-8 8-8 4.418 0 8 3.582 8 8Z"),
                pathFillType = PathFillType.NonZero,
                fill = SolidColor(Color(0xFF000000)),
                fillAlpha = 1f,
                stroke = null,
