...
val LucideIcons.Outline.BadgeInfo: ImageVector
    get() {
        if (_badgeInfo != null) return _badgeInfo!!
        _badgeInfo = lucideOutlineIcon(
            name = "BadgeInfo",
    ...
    addPath(
        pathData = parseSvgPathData("M 12.000 16.000 L 12.000 12.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 12.000 8.000 L 12.010 8.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
