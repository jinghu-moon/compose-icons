...
val TablerIcons.Outline.BracketsContainStart: ImageVector
    get() {
        ...
        _bracketsContainStart = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 9.000 4.000 L 5.000 4.000 L 5.000 20.000 L 9.000 20.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 18.000 16.000 L 17.990 16.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 14.000 16.000 L 13.990 16.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 10.000 16.000 L 9.990 16.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
