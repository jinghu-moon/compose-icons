        ...
        _microsoftWordLogo = phosphorLightIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(70.18f, 153.46f),
                    PathNode.LineTo(58.18f, 105.46f),
                    PathNode.CurveTo(57.373665f, 102.245705f, 59.325703f, 98.986336f, 62.54f, 98.18f),
                    PathNode.CurveTo(65.754295f, 97.373665f, 69.013664f, 99.32571f, 69.82f, 102.54f),
                    PathNode.LineTo(77.89f, 134.81f),
                    PathNode.LineTo(86.63f, 117.32f),
                    PathNode.CurveTo(87.64498f, 115.28351f, 89.724594f, 113.9964f, 92.0f, 113.9964f),
                    PathNode.CurveTo(94.275406f, 113.9964f, 96.35502f, 115.28351f, 97.37f, 117.32f),
                    PathNode.LineTo(106.11f, 134.81f),
                    PathNode.LineTo(114.18f, 102.54f),
                    PathNode.CurveTo(114.986336f, 99.32571f, 118.245705f, 97.373665f, 121.46f, 98.18f),
                    PathNode.CurveTo(124.67429f, 98.986336f, 126.626335f, 102.245705f, 125.82f, 105.46f),
                    PathNode.LineTo(113.82f, 153.46f),
                    PathNode.CurveTo(113.20731f, 155.89359f, 111.14483f, 157.68878f, 108.65f, 157.96f),
                    PathNode.CurveTo(108.4336f, 157.97523f, 108.2164f, 157.97523f, 108.0f, 157.96f),
                    PathNode.CurveTo(105.725395f, 157.96068f, 103.64599f, 156.6751f, 102.63f, 154.64f),
                    PathNode.LineTo(92.0f, 133.42f),
                    PathNode.LineTo(81.37f, 154.68f),
                    PathNode.CurveTo(80.24928f, 156.92786f, 77.84702f, 158.23975f, 75.35007f, 157.96751f),
                    PathNode.CurveTo(72.85312f, 157.69528f, 70.78999f, 155.89655f, 70.18f, 153.46f),
                    PathNode.Close
                ),
