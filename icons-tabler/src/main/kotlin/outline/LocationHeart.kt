...
val TablerIcons.Outline.LocationHeart: ImageVector
    get() {
        if (_locationHeart != null) return _locationHeart!!
        _locationHeart = tablerOutlineIcon(
            name = "LocationHeart",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24.0f, height = 24.0f),
        ) {
    addPath(
        pathData = parseSvgPathData("M 10.365 14.730 L 10.000 14.000 L 3.000 10.500 C 2.804 10.410 2.679 10.215 2.679 10.000 C 2.679 9.785 2.804 9.590 3.000 9.500 L 21.000 3.000 L 17.976 11.373"),
