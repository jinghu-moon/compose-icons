...
val TablerIcons.Outline.Diabolo: ImageVector
    get() {
        ...
        _diabolo = tablerOutlineIcon(
            ...
            addPathData("M4 6v.143c-0 .104 .016 .208 .048 .307L6 12 4.036 17.67c-.024 .086-.036 .175-.036 .265v.065c0 1.657 3.582 3 8 3 4.418 0 8-1.343 8-3v-.065c-0-.09-.012-.179-.036-.265L18 12 19.952 6.45c.032-.099 .048-.203 .048-.307v-.143")
