...
val PhosphorIcons.Duotone.Scroll: ImageVector
    get() {
        ...
        _scroll = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M200 176h-96c0 0 8 6 8 16 0 13.255-10.745 24-24 24C74.745 216 64 205.255 64 192v-128C64 50.745 53.255 40 40 40h136c13.255 0 24 10.745 24 24Z"),
