...
val TablerIcons.Outline.MapHeart: ImageVector
    get() {
        if (_mapHeart != null) return _mapHeart!!
        _mapHeart = tablerOutlineIcon(
            name = "MapHeart",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24f, height = 24f),
        ) {
            addPath(
                pathData = parseSvgPathData("M 10.000 17.500 L 9.000 17.000 L 3.000 20.000 L 3.000 7.000 L 9.000 4.000 L 15.000 7.000 L 21.000 4.000 L 21.000 11.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 15.000 7.000 L 15.000 11.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
