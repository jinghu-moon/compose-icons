        ...
        _ironing3 = tablerFilledIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.MoveTo(9.01f, 14.0f),
                    PathNode.LineTo(9.0f, 14.0f),
                    PathNode.CurveTo(8.470906f, 14.000587f, 8.033836f, 14.413211f, 8.002828f, 14.941395f),
                    PathNode.CurveTo(7.971821f, 15.469579f, 8.35761f, 15.93051f, 8.883f, 15.993f),
                    PathNode.LineTo(9.01f, 16.0f),
                    PathNode.CurveTo(9.562284f, 16.0f, 10.01f, 15.552285f, 10.01f, 15.0f),
                    PathNode.CurveTo(10.01f, 14.447715f, 9.562284f, 14.0f, 9.01f, 14.0f),
                    PathNode.MoveTo(15.01f, 14.0f),
                    PathNode.LineTo(15.0f, 14.0f),
                    PathNode.CurveTo(14.470906f, 14.000587f, 14.033835f, 14.413211f, 14.002828f, 14.941395f),
                    PathNode.CurveTo(13.971821f, 15.469579f, 14.35761f, 15.93051f, 14.883f, 15.993f),
                    PathNode.LineTo(15.01f, 16.0f),
                    PathNode.CurveTo(15.562284f, 16.0f, 16.01f, 15.552285f, 16.01f, 15.0f),
                    PathNode.CurveTo(16.01f, 14.447715f, 15.562284f, 14.0f, 15.01f, 14.0f)
                ),
