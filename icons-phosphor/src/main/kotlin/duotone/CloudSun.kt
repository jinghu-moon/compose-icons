...
val PhosphorIcons.Duotone.CloudSun: ImageVector
    get() {
        ...
        _cloudSun = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(139.84f, 84.41f),
                    PathNode.LineTo(139.84f, 84.41f),
                    PathNode.CurveTo(119.38279f, 92.176285f, 103.89256f, 109.28433f, 98.19f, 130.41f),
                    PathNode.LineTo(98.19f, 130.3f),
                    PathNode.CurveTo(85.262276f, 125.908f, 71.02902f, 127.75455f, 59.65f, 135.3f),
                    PathNode.LineTo(59.65f, 135.3f),
                    PathNode.CurveTo(47.385162f, 121.038574f, 44.580643f, 100.9276f, 52.475845f, 83.854805f),
                    PathNode.CurveTo(60.37105f, 66.78201f, 77.510796f, 55.894135f, 96.32044f, 56.002907f),
                    PathNode.CurveTo(115.13009f, 56.111675f, 132.14276f, 67.19704f, 139.84f, 84.36f),
                    PathNode.Close
                ),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(95.42f, 48.0f, 94.84f, 48.0f, 94.26f, 48.0f),
                    ...
                    PathNode.CurveTo(56.009815f, 86.61858f, 67.243324f, 71.232834f, 83.796005f, 65.92977f),
                    PathNode.CurveTo(100.34869f, 60.626705f, 118.43158f, 66.62022f, 128.54f, 80.76f),
                    ...
                    PathNode.CurveTo(58.051254f, 118.634094f, 56.002155f, 111.389565f, 56.0f, 104.0f),
                    PathNode.Close,
                    PathNode.MoveTo(164.0f, 208.0f),
                    PathNode.LineTo(84.0f, 208.0f),
                    PathNode.CurveTo(70.58175f, 207.97531f, 58.290806f, 200.49f, 52.111187f, 188.5794f),
                    PathNode.CurveTo(45.93157f, 176.6688f, 46.88897f, 162.30981f, 54.595158f, 151.32507f),
                    PathNode.CurveTo(62.301346f, 140.34032f, 75.47725f, 134.55304f, 88.78f, 136.31f),
                    PathNode.CurveTo(88.41f, 138.68f, 88.15f, 141.1f, 88.01f, 143.54f),
                    PathNode.CurveTo(87.75595f, 147.95828f, 91.13172f, 151.74596f, 95.55f, 152.0f),
                    PathNode.CurveTo(99.96828f, 152.25404f, 103.75595f, 148.87828f, 104.01f, 144.46f),
                    PathNode.CurveTo(104.23444f, 140.46976f, 104.86435f, 136.51271f, 105.89f, 132.65f),
                    PathNode.CurveTo(105.89f, 132.49f, 105.98f, 132.33f, 106.01f, 132.17f),
                    PathNode.CurveTo(114.177734f, 102.15467f, 143.91168f, 83.34284f, 174.53291f, 88.81748f),
                    PathNode.CurveTo(205.15416f, 94.29212f, 226.52791f, 122.24128f, 223.78947f, 153.2273f),
                    PathNode.CurveTo(221.05104f, 184.2133f, 195.10678f, 207.98065f, 164.0f, 208.0f),
                    PathNode.Close
                ),
                pathFillType = PathFillType.NonZero,
                fill = SolidColor(Color.Black),
