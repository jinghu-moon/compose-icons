        ...
        _currencyDollar = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(192.0f, 190.09138f, 174.09138f, 208.0f, 152.0f, 208.0f),
                    PathNode.LineTo(128.0f, 208.0f),
                    PathNode.LineTo(128.0f, 128.0f),
                    PathNode.LineTo(152.0f, 128.0f),
                    PathNode.CurveTo(174.09138f, 128.0f, 192.0f, 145.90862f, 192.0f, 168.0f),
                    PathNode.Close,
                    PathNode.MoveTo(112.0f, 48.0f),
                    PathNode.CurveTo(89.90861f, 48.0f, 72.0f, 65.90861f, 72.0f, 88.0f),
                    PathNode.CurveTo(72.0f, 110.09139f, 89.90861f, 128.0f, 112.0f, 128.0f),
                    PathNode.LineTo(128.0f, 128.0f),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(161.67311f, 56.0f, 176.0f, 70.32689f, 176.0f, 88.0f),
                    PathNode.CurveTo(176.0f, 92.41828f, 179.58173f, 96.0f, 184.0f, 96.0f),
                    PathNode.CurveTo(188.41827f, 96.0f, 192.0f, 92.41828f, 192.0f, 88.0f),
                    PathNode.CurveTo(191.97244f, 61.501755f, 170.49825f, 40.02756f, 144.0f, 40.0f),
                    ...
                    PathNode.CurveTo(64.0f, 114.50967f, 85.49033f, 136.0f, 112.0f, 136.0f),
                    PathNode.LineTo(120.0f, 136.0f),
                    PathNode.LineTo(120.0f, 200.0f),
                    PathNode.LineTo(104.0f, 200.0f),
                    PathNode.CurveTo(86.32689f, 200.0f, 72.0f, 185.67311f, 72.0f, 168.0f),
                    PathNode.CurveTo(72.0f, 163.58173f, 68.41828f, 160.0f, 64.0f, 160.0f),
                    PathNode.CurveTo(59.581722f, 160.0f, 56.0f, 163.58173f, 56.0f, 168.0f),
                    PathNode.CurveTo(56.02756f, 194.49825f, 77.501755f, 215.97244f, 104.0f, 216.0f),
                    ...
                    PathNode.CurveTo(178.50967f, 216.0f, 200.0f, 194.50967f, 200.0f, 168.0f),
                    PathNode.CurveTo(200.0f, 141.49033f, 178.50967f, 120.0f, 152.0f, 120.0f),
                    PathNode.Close,
                    PathNode.MoveTo(112.0f, 120.0f),
                    PathNode.CurveTo(94.32689f, 120.0f, 80.0f, 105.67311f, 80.0f, 88.0f),
                    PathNode.CurveTo(80.0f, 70.32689f, 94.32689f, 56.0f, 112.0f, 56.0f),
                    ...
                    PathNode.CurveTo(169.67311f, 136.0f, 184.0f, 150.32689f, 184.0f, 168.0f),
                    PathNode.CurveTo(184.0f, 185.67311f, 169.67311f, 200.0f, 152.0f, 200.0f),
                    PathNode.Close
                ),
                pathFillType = PathFillType.NonZero,
                fill = SolidColor(Color.Black),
