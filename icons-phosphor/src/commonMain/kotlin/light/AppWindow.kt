        ...
        _appWindow = phosphorLightIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(78.0f, 84.0f),
                    PathNode.CurveTo(78.0f, 89.52285f, 73.52285f, 94.0f, 68.0f, 94.0f),
                    PathNode.CurveTo(62.477154f, 94.0f, 58.0f, 89.52285f, 58.0f, 84.0f),
                    PathNode.CurveTo(58.0f, 78.47715f, 62.477154f, 74.0f, 68.0f, 74.0f),
                    PathNode.CurveTo(73.52285f, 74.0f, 78.0f, 78.47715f, 78.0f, 84.0f),
                    PathNode.Close,
                    PathNode.MoveTo(118.0f, 84.0f),
                    PathNode.CurveTo(118.0f, 89.52285f, 113.52285f, 94.0f, 108.0f, 94.0f),
                    PathNode.CurveTo(102.47715f, 94.0f, 98.0f, 89.52285f, 98.0f, 84.0f),
                    PathNode.CurveTo(98.0f, 78.47715f, 102.47715f, 74.0f, 108.0f, 74.0f),
                    PathNode.CurveTo(113.52285f, 74.0f, 118.0f, 78.47715f, 118.0f, 84.0f),
                    PathNode.Close
                ),
