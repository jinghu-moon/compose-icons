...
val PhosphorIcons.Duotone.ImageBroken: ImageVector
    get() {
        ...
        _imageBroken = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M224 56v32l-48 16-16 40-23.35 9.34-39-39c-1.501-1.502-3.537-2.346-5.66-2.346-2.123 0-4.159 .844-5.66 2.346L32 168.69v-112.69c0-4.418 3.582-8 8-8h176c4.418 0 8 3.582 8 8Z"),
