...
val TablerIcons.Outline.ArrowMergeAltRight: ImageVector
    get() {
        ...
        _arrowMergeAltRight = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(6.0f, 18.01f),
                    PathNode.LineTo(6.0f, 18.02f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(7.0f, 15.02f),
                    PathNode.LineTo(7.0f, 15.03f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(10.0f, 13.03f),
                    PathNode.LineTo(10.0f, 13.04f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
