...
val PhosphorIcons.Duotone.Football: ImageVector
    get() {
        ...
        _football = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(222.5f, 110.56f),
                    PathNode.CurveTo(219.18f, 135.79f, 209.5f, 163.56f, 186.5f, 186.51f),
                    PathNode.CurveTo(163.5f, 209.46f, 135.78f, 219.18f, 110.55f, 222.51f),
                    PathNode.LineTo(110.55f, 222.51f),
                    PathNode.LineTo(33.5f, 145.44f),
                    PathNode.LineTo(33.5f, 145.44f),
                    PathNode.CurveTo(36.82f, 120.21f, 46.5f, 92.44f, 69.5f, 69.49f),
                    PathNode.CurveTo(92.5f, 46.54f, 120.22f, 36.82f, 145.5f, 33.49f),
                    PathNode.LineTo(222.56f, 110.55f),
                    PathNode.Close
                ),
