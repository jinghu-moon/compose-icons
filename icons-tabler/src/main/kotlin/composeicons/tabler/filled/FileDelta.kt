...
val TablerIcons.Filled.FileDelta: ImageVector
    get() {
        ...
        _fileDelta = tablerFilledIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M12 2l.117 .007c.459 .054 .822 .417 .876 .876L13 3v4l.005 .15c.074 .984 .854 1.767 1.838 1.844L15 9h4l.117 .007c.459 .054 .822 .417 .876 .876L20 10v9c0 1.589-1.238 2.902-2.824 2.995L17 22h-10C5.411 22 4.098 20.762 4.005 19.176L4 19v-14C4 3.411 5.238 2.098 6.824 2.005L7 2ZM12.894 10.553c-.17-.338-.516-.552-.894-.552-.378 0-.724 .214-.894 .552l-3 6c-.155 .31-.138 .678 .044 .973 .182 .295 .504 .474 .85 .474h6c.346-0 .668-.18 .85-.474 .182-.295 .199-.663 .044-.973ZM12 13.236 13.381 16h-2.763ZM14.999 2.999 19 7h-4Z"),
