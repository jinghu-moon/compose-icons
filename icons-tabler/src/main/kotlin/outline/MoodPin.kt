...
val TablerIcons.Outline.MoodPin: ImageVector
    get() {
        ...
        _moodPin = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 21.000 12.000 C 21.000 8.301 18.736 4.978 15.294 3.625 C 11.851 2.271 7.931 3.162 5.411 5.870 C 2.891 8.578 2.285 12.553 3.883 15.889 C 5.482 19.225 8.958 21.243 12.648 20.977"),
            ...
            addPath(
                pathData = parseSvgPathData("M 9.500 15.000 C 10.158 15.672 11.060 16.000 12.000 16.000 C 12.102 16.000 12.203 15.996 12.304 15.988"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
