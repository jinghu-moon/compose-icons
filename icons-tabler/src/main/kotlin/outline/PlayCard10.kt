...
val TablerIcons.Outline.PlayCard10: ImageVector
    get() {
        ...
        _playCard10 = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 13.000 C 12.000 14.105 12.672 15.000 13.500 15.000 C 14.328 15.000 15.000 14.105 15.000 13.000 L 15.000 11.000 C 15.000 9.895 14.328 9.000 13.500 9.000 C 12.672 9.000 12.000 9.895 12.000 11.000 L 12.000 13.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
