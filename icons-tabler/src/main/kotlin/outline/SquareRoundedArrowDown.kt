...
val TablerIcons.Outline.SquareRoundedArrowDown: ImageVector
    get() {
        if (_squareRoundedArrowDown != null) return _squareRoundedArrowDown!!
        _squareRoundedArrowDown = tablerOutlineIcon(
            name = "SquareRoundedArrowDown",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24f, height = 24f),
        ) {
            addPath(
                pathData = parseSvgPathData("M 8.000 12.000 L 12.000 16.000 L 16.000 12.000"),
