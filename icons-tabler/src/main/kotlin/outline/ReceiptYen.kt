...
val TablerIcons.Outline.ReceiptYen: ImageVector
    get() {
        if (_receiptYen != null) return _receiptYen!!
        _receiptYen = tablerOutlineIcon(
            name = "ReceiptYen",
    ...
    addPath(
        pathData = parseSvgPathData("M 9.000 7.000 L 12.000 11.500"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 15.000 7.000 L 12.000 11.500 L 12.000 16.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
