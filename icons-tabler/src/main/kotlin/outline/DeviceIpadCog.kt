...
val TablerIcons.Outline.DeviceIpadCog: ImageVector
    get() {
        if (_deviceIpadCog != null) return _deviceIpadCog!!
        _deviceIpadCog = tablerOutlineIcon(
            name = "DeviceIpadCog",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24.0f, height = 24.0f),
        ) {
    addPath(
        pathData = parseSvgPathData("M 12.000 21.000 L 6.000 21.000 C 4.895 21.000 4.000 20.105 4.000 19.000 L 4.000 5.000 C 4.000 3.895 4.895 3.000 6.000 3.000 L 18.000 3.000 C 19.105 3.000 20.000 3.895 20.000 5.000 L 20.000 11.500"),
