...
val LucideIcons.Outline.Contrast: ImageVector
    get() {
        if (_contrast != null) return _contrast!!
        _contrast = lucideOutlineIcon(
            name = "Contrast",
    ...
    addPath(
        pathData = parseSvgPathData("M 12.000 18.000 C 15.314 18.000 18.000 15.314 18.000 12.000 C 18.000 8.686 15.314 6.000 12.000 6.000 L 12.000 18.000 Z"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
