...
val PhosphorIcons.Duotone.ArrowLineRight: ImageVector
    get() {
        ...
        _arrowLineRight = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M184 128l-72 72v-144Z"),
            ...
            addPath(
                pathData = parseSvgPathData("M117.66 50.34c-2.288-2.291-5.731-2.976-8.722-1.737C105.947 49.842 103.997 52.762 104 56v64h-72c-4.418 0-8 3.582-8 8 0 4.418 3.582 8 8 8h72v64c-.003 3.238 1.947 6.158 4.938 7.397 2.991 1.239 6.434 .554 8.722-1.737l72-72c1.502-1.501 2.346-3.537 2.346-5.66 0-2.123-.844-4.159-2.346-5.66ZM120 180.69v-105.38L172.69 128ZM224 40v176c0 4.418-3.582 8-8 8-4.418 0-8-3.582-8-8v-176c0-4.418 3.582-8 8-8 4.418 0 8 3.582 8 8Z"),
                pathFillType = PathFillType.NonZero,
                fill = SolidColor(Color(0xFF000000)),
                fillAlpha = 1f,
                stroke = null,
