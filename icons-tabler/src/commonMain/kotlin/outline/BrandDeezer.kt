...
val TablerIcons.Outline.BrandDeezer: ImageVector
    get() {
        ...
        _brandDeezer = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(21.5f, 17.0f),
                    PathNode.LineTo(19.0f, 17.0f),
                    PathNode.LineTo(19.0f, 16.5f),
                    PathNode.LineTo(21.5f, 16.5f),
                    PathNode.LineTo(21.5f, 17.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(21.5f, 13.5f),
                    PathNode.LineTo(21.5f, 13.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
