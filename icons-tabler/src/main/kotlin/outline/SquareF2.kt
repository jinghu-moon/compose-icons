...
val TablerIcons.Outline.SquareF2: ImageVector
    get() {
        ...
        _squareF2 = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 13.000 9.000 L 15.000 9.000 C 15.552 9.000 16.000 9.448 16.000 10.000 L 16.000 11.000 C 16.000 11.552 15.552 12.000 15.000 12.000 L 14.000 12.000 C 13.448 12.000 13.000 12.448 13.000 13.000 L 13.000 14.000 C 13.000 14.552 13.448 15.000 14.000 15.000 L 16.000 15.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
