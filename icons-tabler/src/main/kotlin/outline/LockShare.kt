...
val TablerIcons.Outline.LockShare: ImageVector
    get() {
        if (_lockShare != null) return _lockShare!!
        _lockShare = tablerOutlineIcon(
            name = "LockShare",
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 21.000 L 7.000 21.000 C 5.895 21.000 5.000 20.105 5.000 19.000 L 5.000 13.000 C 5.000 11.895 5.895 11.000 7.000 11.000 L 17.000 11.000 C 18.105 11.000 19.000 11.895 19.000 13.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
