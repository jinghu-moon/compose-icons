...
val PhosphorIcons.Duotone.BellRinging: ImageVector
    get() {
        if (_bellRinging != null) return _bellRinging!!
        _bellRinging = phosphorDuotoneIcon(
            name = "BellRinging",
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(224.0f, 71.1f),
                    PathNode.CurveTo(220.07863f, 73.13064f, 215.25356f, 71.59986f, 213.22f, 67.68f),
                    PathNode.CurveTo(205.58397f, 52.594906f, 194.02582f, 39.845f, 179.76f, 30.77f),
                    PathNode.CurveTo(176.02103f, 28.411745f, 174.90175f, 23.468967f, 177.26f, 19.73f),
                    PathNode.CurveTo(179.61826f, 15.991032f, 184.56104f, 14.871744f, 188.3f, 17.23f),
                    PathNode.CurveTo(204.92598f, 27.875362f, 218.42621f, 42.74563f, 227.42f, 60.32f),
                    PathNode.CurveTo(229.45064f, 64.24137f, 227.91986f, 69.066444f, 224.0f, 71.1f),
                    PathNode.Close,
                    ...
                    PathNode.CurveTo(80.008965f, 28.411745f, 81.12826f, 23.468967f, 78.77f, 19.73f),
                    PathNode.CurveTo(76.41174f, 15.991032f, 71.46897f, 14.871744f, 67.73f, 17.23f),
                    PathNode.CurveTo(51.104023f, 27.875362f, 37.603794f, 42.74563f, 28.61f, 60.32f),
                    ...
                    PathNode.LineTo(167.2f, 200.0f),
                    PathNode.CurveTo(163.41446f, 218.6426f, 147.02306f, 232.0401f, 128.0f, 232.0401f),
                    PathNode.CurveTo(108.976944f, 232.0401f, 92.58554f, 218.6426f, 88.8f, 200.0f),
