...
android {
    namespace = "composeicons.flagicons"
    compileSdk = 36
...
mavenPublishing {
    ...
    pom {
        name.set("icons-flagicons")
        description.set("Flag Icons for Jetpack Compose - generated via svg2compose pipeline")
