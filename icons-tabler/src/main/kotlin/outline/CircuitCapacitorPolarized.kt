...
val TablerIcons.Outline.CircuitCapacitorPolarized: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 22.000 12.000 L 14.000 12.000"),
    ...
    addPath(
        pathData = parseSvgPathData("M 2.000 12.000 L 10.000 12.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 10.000 7.000 L 10.000 17.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 19.000 3.000 L 19.000 7.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
