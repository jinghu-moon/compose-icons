...
val TablerIcons.Outline.BrandCarbon: ImageVector
    get() {
        ...
        _brandCarbon = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 14.000 10.000 L 14.000 9.800 C 14.000 8.806 13.194 8.000 12.200 8.000 L 11.800 8.000 C 10.806 8.000 10.000 8.806 10.000 9.800 L 10.000 14.200 C 10.000 15.194 10.806 16.000 11.800 16.000 L 12.200 16.000 C 13.194 16.000 14.000 15.194 14.000 14.200 L 14.000 14.000"),
