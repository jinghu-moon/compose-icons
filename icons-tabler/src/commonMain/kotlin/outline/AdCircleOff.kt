...
val TablerIcons.Outline.AdCircleOff: ImageVector
    get() {
        ...
        _adCircleOff = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(4.91f, 4.949f),
                    PathNode.CurveTo(3.043515f, 6.820555f, 1.996785f, 9.356807f, 2.0f, 12.0f),
                    PathNode.CurveTo(2.0f, 17.523f, 6.477f, 22.0f, 12.0f, 22.0f),
                    PathNode.CurveTo(14.642703f, 22.003216f, 17.178528f, 20.956873f, 19.05f, 19.091f)
                ),
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(20.778f, 16.793f),
                    PathNode.CurveTo(21.582083f, 15.323584f, 22.00239f, 13.675031f, 22.0f, 12.0f),
                    PathNode.CurveTo(22.0f, 6.477f, 17.523f, 2.0f, 12.0f, 2.0f),
                    PathNode.CurveTo(10.26f, 2.0f, 8.624f, 2.444f, 7.2f, 3.225f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(6.999848f, 9.98654f, 7.26234f, 9.508677f, 7.69576f, 9.23338f),
                    PathNode.CurveTo(8.12918f, 8.958083f, 8.6733f, 8.923608f, 9.138f, 9.142f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(9.854f, 9.853f),
                    PathNode.CurveTo(9.948f, 10.049f, 10.0f, 10.268f, 10.0f, 10.5f),
