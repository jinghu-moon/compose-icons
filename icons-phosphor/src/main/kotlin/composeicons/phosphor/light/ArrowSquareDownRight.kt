...
val PhosphorIcons.Light.ArrowSquareDownRight: ImageVector
    get() {
        ...
        _arrowSquareDownRight = phosphorLightIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M208 34h-160C40.268 34 34 40.268 34 48v160c0 7.732 6.268 14 14 14h160c7.732 0 14-6.268 14-14v-160c0-7.732-6.268-14-14-14ZM210 208c0 1.105-.895 2-2 2h-160c-1.105 0-2-.895-2-2v-160c0-1.105 .895-2 2-2h160c1.105 0 2 .895 2 2ZM166 112v48c0 3.314-2.686 6-6 6h-48c-3.314 0-6-2.686-6-6 0-3.314 2.686-6 6-6h33.52L91.76 100.24c-2.203-2.364-2.138-6.048 .147-8.333 2.285-2.285 5.969-2.35 8.333-.147L154 145.52v-33.52c0-3.314 2.686-6 6-6 3.314 0 6 2.686 6 6Z"),
