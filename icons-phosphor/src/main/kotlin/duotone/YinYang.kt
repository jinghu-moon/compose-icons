...
val PhosphorIcons.Duotone.YinYang: ImageVector
    get() {
        if (_yinYang != null) return _yinYang!!
        _yinYang = phosphorDuotoneIcon(
            name = "YinYang",
            ...
            group(
                ...
                addPath(
                    pathData = parseSvgPathData("M 224.000 128.000 C 224.000 181.019 181.019 224.000 128.000 224.000 C 101.490 224.000 80.000 202.510 80.000 176.000 C 80.000 149.490 101.490 128.000 128.000 128.000 C 154.510 128.000 176.000 106.510 176.000 80.000 C 176.000 53.490 154.510 32.000 128.000 32.000 C 181.019 32.000 224.000 74.981 224.000 128.000 Z"),
