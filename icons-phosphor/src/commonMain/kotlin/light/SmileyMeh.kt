        ...
        _smileyMeh = phosphorLightIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(174.0f, 163.3137f, 171.3137f, 166.0f, 168.0f, 166.0f),
                    PathNode.LineTo(88.0f, 166.0f),
                    PathNode.CurveTo(84.686295f, 166.0f, 82.0f, 163.3137f, 82.0f, 160.0f),
                    PathNode.CurveTo(82.0f, 156.6863f, 84.686295f, 154.0f, 88.0f, 154.0f),
                    PathNode.LineTo(168.0f, 154.0f),
                    PathNode.CurveTo(171.3137f, 154.0f, 174.0f, 156.6863f, 174.0f, 160.0f),
                    PathNode.Close,
