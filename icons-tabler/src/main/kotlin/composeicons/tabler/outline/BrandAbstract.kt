        ...
        _brandAbstract = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(8.0f, 14.880712f, 9.119288f, 16.0f, 10.5f, 16.0f),
                    PathNode.CurveTo(11.880712f, 16.0f, 13.0f, 14.880712f, 13.0f, 13.5f),
                    PathNode.CurveTo(13.0f, 12.119288f, 11.880712f, 11.0f, 10.5f, 11.0f),
                    PathNode.CurveTo(9.119288f, 11.0f, 8.0f, 12.119288f, 8.0f, 13.5f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
