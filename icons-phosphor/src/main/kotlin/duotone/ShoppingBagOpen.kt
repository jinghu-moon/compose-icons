...
val PhosphorIcons.Duotone.ShoppingBagOpen: ImageVector
    get() {
        if (_shoppingBagOpen != null) return _shoppingBagOpen!!
        _shoppingBagOpen = phosphorDuotoneIcon(
    ...
    group(
        ...
        addPath(
            pathData = parseSvgPathData("M 224.000 56.000 L 224.000 80.000 L 32.000 80.000 L 32.000 56.000 C 32.000 51.582 35.582 48.000 40.000 48.000 L 216.000 48.000 C 220.418 48.000 224.000 51.582 224.000 56.000 Z"),
