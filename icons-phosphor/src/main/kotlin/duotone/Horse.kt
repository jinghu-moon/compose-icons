...
val PhosphorIcons.Duotone.Horse: ImageVector
    get() {
        if (_horse != null) return _horse!!
        _horse = phosphorDuotoneIcon(
            name = "Horse",
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(224.0f, 129.37f),
                    PathNode.CurveTo(223.28f, 180.85f, 181.43f, 222.96f, 129.95f, 223.98f),
                    PathNode.CurveTo(117.03099f, 224.27246f, 104.18153f, 222.00911f, 92.14f, 217.32f),
                    PathNode.LineTo(128.0f, 168.0f),
                    PathNode.LineTo(128.0f, 168.0f),
                    PathNode.CurveTo(101.36f, 152.0f, 70.77f, 156.7f, 53.3f, 159.66f),
                    PathNode.CurveTo(44.261536f, 161.19461f, 35.138416f, 157.44603f, 29.79f, 150.0f),
                    PathNode.LineTo(16.0f, 128.0f),
                    PathNode.LineTo(120.0f, 64.0f),
                    PathNode.LineTo(120.0f, 32.0f),
                    PathNode.LineTo(128.0f, 32.0f),
                    PathNode.CurveTo(153.69994f, 31.997383f, 178.32785f, 42.299484f, 196.37125f, 60.600376f),
                    PathNode.CurveTo(214.41464f, 78.901276f, 224.36678f, 103.67268f, 224.0f, 129.37f),
                    PathNode.Close
                ),
