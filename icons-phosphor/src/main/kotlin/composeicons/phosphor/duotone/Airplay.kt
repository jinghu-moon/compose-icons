...
val PhosphorIcons.Duotone.Airplay: ImageVector
    get() {
        ...
        _airplay = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M224 64v112c0 8.837-7.163 16-16 16h-52.57L128 160l-27.43 32h-52.57c-8.837 0-16-7.163-16-16v-112C32 55.163 39.163 48 48 48h160c8.837 0 16 7.163 16 16Z"),
