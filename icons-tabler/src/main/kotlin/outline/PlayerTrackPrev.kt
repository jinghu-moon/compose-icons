...
val TablerIcons.Outline.PlayerTrackPrev: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 21.000 5.000 L 21.000 19.000 L 13.000 12.000 L 21.000 5.000"),
    ...
    addPath(
        pathData = parseSvgPathData("M 10.000 5.000 L 10.000 19.000 L 2.000 12.000 L 10.000 5.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
