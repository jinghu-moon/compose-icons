...
val TablerIcons.Outline.Typeface: ImageVector
    get() {
        ...
        _typeface = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 17.000 17.000 C 15.895 17.000 15.000 16.105 15.000 15.000 L 15.000 7.000 L 10.000 7.000 C 8.895 7.000 8.000 7.895 8.000 9.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 7.000 17.000 C 8.194 17.000 9.254 16.236 9.632 15.103 L 10.000 14.000 C 10.658 12.027 11.766 10.235 13.236 8.764 L 15.000 7.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 10.000 14.000 L 15.000 14.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
