...
val TablerIcons.Outline.CameraDollar: ImageVector
    get() {
        ...
        _cameraDollar = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 14.935 12.375 C 14.674 11.150 13.680 10.215 12.441 10.031 C 11.202 9.847 9.979 10.452 9.373 11.548 C 8.767 12.644 8.906 14.002 9.721 14.953 C 10.537 15.904 11.857 16.248 13.033 15.817"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
