...
val TablerIcons.Outline.Movie: ImageVector
    get() {
        if (_movie != null) return _movie!!
        _movie = tablerOutlineIcon(
            name = "Movie",
    ...
    addPath(
        pathData = parseSvgPathData("M 8.000 4.000 L 8.000 20.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 16.000 4.000 L 16.000 20.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
