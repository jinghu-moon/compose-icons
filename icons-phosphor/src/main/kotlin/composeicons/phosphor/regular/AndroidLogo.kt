...
val PhosphorIcons.Regular.AndroidLogo: ImageVector
    get() {
        ...
        _androidLogo = phosphorRegularIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M176 148c0 6.627-5.373 12-12 12-6.627 0-12-5.373-12-12 0-6.627 5.373-12 12-12 6.627 0 12 5.373 12 12ZM92 136c-6.627 0-12 5.373-12 12 0 6.627 5.373 12 12 12 6.627 0 12-5.373 12-12 0-6.627-5.373-12-12-12ZM240 160v24c0 8.837-7.163 16-16 16h-192c-8.837 0-16-7.163-16-16v-22.87C15.971 129.962 28.774 100.157 51.4 78.72L26.34 53.66c-3.126-3.126-3.126-8.194 0-11.32 3.126-3.126 8.194-3.126 11.32 0L63.82 68.5c38.491-27.265 89.979-27.341 128.55-.19l26-26c3.126-3.126 8.194-3.126 11.32 0 3.126 3.126 3.126 8.194 0 11.32L204.82 78.5c.75 .71 1.5 1.43 2.24 2.17C228.217 101.637 240.083 130.213 240 160ZM224 160C224 106.981 181.019 64 128 64h-.34C74.91 64.18 32 107.75 32 161.13v22.87h192Z"),
