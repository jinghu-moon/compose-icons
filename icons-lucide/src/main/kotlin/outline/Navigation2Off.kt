...
val LucideIcons.Outline.Navigation2Off: ImageVector
    get() {
        ...
        _navigation2Off = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 9.310 9.310 L 5.000 21.000 L 12.000 17.000 L 19.000 21.000 L 17.830 17.830"),
            ...
            addPath(
                pathData = parseSvgPathData("M 14.530 8.880 L 12.000 2.000 L 10.830 5.170"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
