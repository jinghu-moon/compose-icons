...
val PhosphorIcons.Duotone.MediumLogo: ImageVector
    get() {
        if (_mediumLogo != null) return _mediumLogo!!
        _mediumLogo = phosphorDuotoneIcon(
            name = "MediumLogo",
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(128.0f, 158.92795f, 102.92794f, 184.0f, 72.0f, 184.0f),
                    PathNode.CurveTo(41.072056f, 184.0f, 16.0f, 158.92795f, 16.0f, 128.0f),
                    PathNode.CurveTo(16.0f, 97.07206f, 41.072056f, 72.0f, 72.0f, 72.0f),
                    PathNode.CurveTo(102.92794f, 72.0f, 128.0f, 97.07206f, 128.0f, 128.0f),
                    PathNode.Close,
                    PathNode.MoveTo(184.0f, 72.0f),
                    PathNode.CurveTo(170.75f, 72.0f, 160.0f, 97.07f, 160.0f, 128.0f),
                    PathNode.CurveTo(160.0f, 158.93f, 170.75f, 184.0f, 184.0f, 184.0f),
                    PathNode.CurveTo(197.25f, 184.0f, 208.0f, 158.93f, 208.0f, 128.0f),
                    PathNode.CurveTo(208.0f, 97.07f, 197.25f, 72.0f, 184.0f, 72.0f),
                    PathNode.Close
                ),
