...
val LucideIcons.Outline.FileSignal: ImageVector
    get() {
        ...
        _fileSignal = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 11.500 13.500 C 12.167 14.389 12.167 15.611 11.500 16.500"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 15.000 12.000 C 16.333 13.778 16.333 16.222 15.000 18.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
