...
val LucideIcons.Outline.CctvOff: ImageVector
    get() {
        ...
        _cctvOff = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(12.309f, 6.652f),
                    PathNode.LineTo(17.106f, 9.053f),
                    PathNode.CurveTo(17.599527f, 9.300058f, 17.799587f, 9.900237f, 17.553f, 10.394f),
                    PathNode.LineTo(17.052f, 11.395f),
                    PathNode.LineTo(17.657f, 12.0f),
                    ...
                    PathNode.LineTo(20.552f, 14.895f)
                ),
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(15.166f, 15.166f),
                    ...
                    PathNode.CurveTo(3.894992f, 5.190222f, 4.194164f, 4.834847f, 4.563f, 4.563f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(9.001f, 14.998f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
