...
val TablerIcons.Outline.SettingsShare: ImageVector
    get() {
        ...
        _settingsShare = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 15.000 C 13.657 15.000 15.000 13.657 15.000 12.000 C 15.000 10.343 13.657 9.000 12.000 9.000 C 10.343 9.000 9.000 10.343 9.000 12.000 C 9.000 13.657 10.343 15.000 12.000 15.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
