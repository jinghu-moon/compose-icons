...
val LucideIcons.Outline.SquareFunction: ImageVector
    get() {
        if (_squareFunction != null) return _squareFunction!!
        _squareFunction = lucideOutlineIcon(
            name = "SquareFunction",
    ...
    addPath(
        pathData = parseSvgPathData("M 9.000 17.000 C 11.000 17.000 11.800 16.000 11.800 14.200 L 11.800 10.000 C 11.800 8.000 12.800 6.700 15.000 7.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 9.000 11.200 L 14.700 11.200"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
