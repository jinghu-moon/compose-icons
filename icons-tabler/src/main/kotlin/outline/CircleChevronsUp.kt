...
val TablerIcons.Outline.CircleChevronsUp: ImageVector
    get() {
        if (_circleChevronsUp != null) return _circleChevronsUp!!
        _circleChevronsUp = tablerOutlineIcon(
    ...
    addPath(
        pathData = parseSvgPathData("M 9.000 11.000 L 12.000 8.000 L 15.000 11.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
