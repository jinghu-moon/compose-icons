...
val TablerIcons.Outline.PlayCard2: ImageVector
    get() {
        if (_playCard2 != null) return _playCard2!!
        _playCard2 = tablerOutlineIcon(
            name = "PlayCard2",
    ...
    addPath(
        pathData = parseSvgPathData("M 10.000 9.000 L 13.000 9.000 C 13.552 9.000 14.000 9.448 14.000 10.000 L 14.000 11.000 C 14.000 11.552 13.552 12.000 13.000 12.000 L 11.000 12.000 C 10.448 12.000 10.000 12.448 10.000 13.000 L 10.000 14.000 C 10.000 14.552 10.448 15.000 11.000 15.000 L 14.000 15.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
