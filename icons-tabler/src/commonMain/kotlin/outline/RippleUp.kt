        ...
        _rippleUp = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.QuadTo(7.5f, 4.0f, 12.0f, 7.0f),
                    PathNode.QuadTo(16.5f, 10.0f, 21.0f, 7.0f)
                ),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.QuadTo(7.5f, 14.0f, 12.0f, 17.0f),
                    PathNode.QuadTo(12.218f, 17.144f, 12.434f, 17.275f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.QuadTo(7.5f, 9.0f, 12.0f, 12.0f),
                    PathNode.QuadTo(13.941f, 13.294f, 15.882f, 13.472f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
