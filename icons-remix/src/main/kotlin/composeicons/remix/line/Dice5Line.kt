...
val RemixIcons.Line.Dice5Line: ImageVector
    get() {
        ...
        _dice5Line = remixIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M5 5v14h14v-14h-14ZM3 5C3 3.895 3.895 3 5 3h14c1.105 0 2 .895 2 2v14c0 1.105-.895 2-2 2h-14C3.895 21 3 20.105 3 19v-14ZM15.5 17C16.328 17 17 16.328 17 15.5 17 14.672 16.328 14 15.5 14 14.672 14 14 14.672 14 15.5c0 .828 .672 1.5 1.5 1.5ZM10 15.5C10 16.328 9.328 17 8.5 17 7.672 17 7 16.328 7 15.5 7 14.672 7.672 14 8.5 14c.828 0 1.5 .672 1.5 1.5ZM8.5 10C9.328 10 10 9.328 10 8.5 10 7.672 9.328 7 8.5 7 7.672 7 7 7.672 7 8.5 7 9.328 7.672 10 8.5 10ZM17 8.5C17 9.328 16.328 10 15.5 10 14.672 10 14 9.328 14 8.5 14 7.672 14.672 7 15.5 7 16.328 7 17 7.672 17 8.5ZM12 13.5c.828 0 1.5-.672 1.5-1.5 0-.828-.672-1.5-1.5-1.5-.828 0-1.5 .672-1.5 1.5 0 .828 .672 1.5 1.5 1.5Z"),
