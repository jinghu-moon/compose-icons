...
val TablerIcons.Outline.FlagCog: ImageVector
    get() {
        if (_flagCog != null) return _flagCog!!
        _flagCog = tablerOutlineIcon(
            name = "FlagCog",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24.0f, height = 24.0f),
        ) {
    addPath(
        pathData = parseSvgPathData("M 12.901 14.702 C 12.575 14.503 12.273 14.268 12.000 14.000 C 10.056 12.094 6.944 12.094 5.000 14.000 L 5.000 5.000 C 6.944 3.094 10.056 3.094 12.000 5.000 C 13.944 6.906 17.056 6.906 19.000 5.000 L 19.000 11.500"),
