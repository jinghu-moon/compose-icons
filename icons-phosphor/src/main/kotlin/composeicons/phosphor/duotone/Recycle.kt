...
val PhosphorIcons.Duotone.Recycle: ImageVector
    get() {
        ...
        _recycle = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M216 208h-176c-5.713-.006-10.99-3.058-13.844-8.007C23.302 195.044 23.303 188.948 26.16 184L114.16 32c2.86-4.944 8.138-7.989 13.85-7.989 5.712 0 10.99 3.045 13.85 7.989l88 152c2.858 4.951 2.858 11.051-.001 16.002-2.859 4.951-8.142 8-13.859 7.998Z"),
