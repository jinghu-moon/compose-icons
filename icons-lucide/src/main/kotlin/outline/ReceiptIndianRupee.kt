...
val LucideIcons.Outline.ReceiptIndianRupee: ImageVector
    get() {
        if (_receiptIndianRupee != null) return _receiptIndianRupee!!
        _receiptIndianRupee = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 8.000 11.000 L 16.000 11.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 9.000 7.000 C 11.209 7.000 13.000 8.791 13.000 11.000 C 13.000 13.209 11.209 15.000 9.000 15.000 L 8.000 15.000 L 11.000 17.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
