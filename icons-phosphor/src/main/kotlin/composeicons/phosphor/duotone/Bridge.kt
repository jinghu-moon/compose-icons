...
val PhosphorIcons.Duotone.Bridge: ImageVector
    get() {
        ...
        _bridge = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M232 168h-208v-52.65C48.183 105.568 64.008 82.087 64 56c0 35.346 28.654 64 64 64 35.346 0 64-28.654 64-64-.008 26.087 15.817 49.568 40 59.35Z"),
