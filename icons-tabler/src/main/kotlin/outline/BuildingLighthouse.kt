...
val TablerIcons.Outline.BuildingLighthouse: ImageVector
    get() {
        ...
        _buildingLighthouse = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 3.000 L 14.000 6.000 L 16.000 21.000 L 8.000 21.000 L 10.000 6.000 L 12.000 3.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 3.000 11.000 L 5.000 9.000 L 3.000 7.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 21.000 11.000 L 19.000 9.000 L 21.000 7.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
