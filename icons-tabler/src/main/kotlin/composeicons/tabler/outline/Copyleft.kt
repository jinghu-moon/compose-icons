...
val TablerIcons.Outline.Copyleft: ImageVector
    get() {
        ...
        _copyleft = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(10.0f, 9.75f),
                    PathNode.CurveTo(11.2109f, 8.685834f, 13.044568f, 8.762035f, 14.163f, 9.923f),
                    PathNode.CurveTo(15.280304f, 11.082275f, 15.280304f, 12.917725f, 14.163f, 14.077f),
                    PathNode.CurveTo(13.044568f, 15.237965f, 11.2109f, 15.314166f, 10.0f, 14.25f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
