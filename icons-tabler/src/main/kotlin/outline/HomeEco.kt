...
val TablerIcons.Outline.HomeEco: ImageVector
    get() {
        ...
        _homeEco = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 9.000 21.000 L 9.000 15.000 C 9.000 13.895 9.895 13.000 11.000 13.000 L 13.000 13.000 C 13.325 13.000 13.631 13.077 13.902 13.215"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
