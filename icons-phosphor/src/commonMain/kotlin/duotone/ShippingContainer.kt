...
val PhosphorIcons.Duotone.ShippingContainer: ImageVector
    get() {
        ...
        _shippingContainer = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(240.0f, 86.0f),
                    PathNode.LineTo(240.0f, 170.0f),
                    PathNode.CurveTo(239.99931f, 173.5704f, 237.63275f, 176.70815f, 234.2f, 177.69f),
                    PathNode.LineTo(128.0f, 208.0f),
                    PathNode.LineTo(128.0f, 48.0f),
                    PathNode.LineTo(234.2f, 78.34f),
                    PathNode.CurveTo(237.62209f, 79.31878f, 239.98595f, 82.44072f, 240.0f, 86.0f),
                    PathNode.Close
                ),
