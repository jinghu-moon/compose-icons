...
val TablerIcons.Outline.Percentage90: ImageVector
    get() {
        ...
        _percentage90 = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 3.000 C 16.442 3.000 20.220 6.241 20.895 10.632 C 21.571 15.022 18.942 19.249 14.705 20.584 C 10.468 21.919 5.891 19.963 3.927 15.979 C 1.963 11.994 3.200 7.173 6.840 4.626 L 12.000 12.000 L 12.000 3.000"),
