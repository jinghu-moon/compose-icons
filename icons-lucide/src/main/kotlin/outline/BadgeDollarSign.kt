...
val LucideIcons.Outline.BadgeDollarSign: ImageVector
    get() {
        ...
        _badgeDollarSign = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 16.000 8.000 L 10.000 8.000 C 8.895 8.000 8.000 8.895 8.000 10.000 C 8.000 11.105 8.895 12.000 10.000 12.000 L 14.000 12.000 C 15.105 12.000 16.000 12.895 16.000 14.000 C 16.000 15.105 15.105 16.000 14.000 16.000 L 8.000 16.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
