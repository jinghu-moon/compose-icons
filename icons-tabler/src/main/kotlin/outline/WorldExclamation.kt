...
val TablerIcons.Outline.WorldExclamation: ImageVector
    get() {
        ...
        _worldExclamation = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 20.986 12.510 C 21.212 8.522 18.783 4.862 15.019 3.522 C 11.256 2.182 7.060 3.483 4.715 6.716 C 2.370 9.950 2.436 14.343 4.879 17.503 C 7.322 20.664 11.555 21.837 15.276 20.383"),
            ...
            addPath(
                pathData = parseSvgPathData("M 3.600 15.000 L 14.500 15.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 12.500 3.000 C 15.937 8.508 15.937 15.492 12.500 21.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
