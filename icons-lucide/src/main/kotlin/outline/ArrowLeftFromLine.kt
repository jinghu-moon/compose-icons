...
val LucideIcons.Outline.ArrowLeftFromLine: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 9.000 6.000 L 3.000 12.000 L 9.000 18.000"),
    ...
    addPath(
        pathData = parseSvgPathData("M 3.000 12.000 L 17.000 12.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 21.000 19.000 L 21.000 5.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
