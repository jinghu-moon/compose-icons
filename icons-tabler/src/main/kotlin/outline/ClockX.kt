...
val TablerIcons.Outline.ClockX: ImageVector
    get() {
        ...
        _clockX = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 20.926 13.150 C 21.417 9.336 19.431 5.631 15.982 3.929 C 12.533 2.228 8.385 2.905 5.657 5.616 C 2.928 8.326 2.224 12.470 3.903 15.930 C 5.582 19.390 9.274 21.400 13.091 20.934"),
