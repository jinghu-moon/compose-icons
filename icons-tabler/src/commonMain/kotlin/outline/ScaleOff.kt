...
val TablerIcons.Outline.ScaleOff: ImageVector
    get() {
        ...
        _scaleOff = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(18.873f, 14.871f),
                    PathNode.CurveTo(20.136736f, 14.486618f, 21.000366f, 13.3209f, 21.0f, 12.0f),
                    PathNode.LineTo(18.0f, 6.0f),
                    PathNode.LineTo(15.323f, 11.355f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
