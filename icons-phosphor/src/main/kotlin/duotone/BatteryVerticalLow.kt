...
val PhosphorIcons.Duotone.BatteryVerticalLow: ImageVector
    get() {
        if (_batteryVerticalLow != null) return _batteryVerticalLow!!
        _batteryVerticalLow = phosphorDuotoneIcon(
