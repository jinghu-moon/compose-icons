...
val LucideIcons.Outline.Fullscreen: ImageVector
    get() {
        ...
        _fullscreen = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 8.000 8.000 L 16.000 8.000 C 16.552 8.000 17.000 8.448 17.000 9.000 L 17.000 15.000 C 17.000 15.552 16.552 16.000 16.000 16.000 L 8.000 16.000 C 7.448 16.000 7.000 15.552 7.000 15.000 L 7.000 9.000 C 7.000 8.448 7.448 8.000 8.000 8.000 Z"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
