...
val PhosphorIcons.Duotone.MonitorArrowUp: ImageVector
    get() {
        if (_monitorArrowUp != null) return _monitorArrowUp!!
        _monitorArrowUp = phosphorDuotoneIcon(
            name = "MonitorArrowUp",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 256f, height = 256f),
        ) {
            addPath(
                pathData = parseSvgPathData("M224 64v112c0 8.837-7.163 16-16 16h-160c-8.837 0-16-7.163-16-16v-112C32 55.163 39.163 48 48 48h160c8.837 0 16 7.163 16 16Z"),
