...
val PhosphorIcons.Duotone.HandsPraying: ImageVector
    get() {
        ...
        _handsPraying = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(229.66f, 197.0f),
                    PathNode.LineTo(197.0f, 229.66f),
                    PathNode.CurveTo(193.87624f, 232.78172f, 188.81377f, 232.78172f, 185.69f, 229.66f),
                    PathNode.LineTo(167.34f, 211.31f),
                    PathNode.LineTo(211.34f, 167.31f),
                    PathNode.LineTo(229.69f, 185.66f),
                    PathNode.CurveTo(231.19438f, 187.16533f, 232.03696f, 189.20805f, 232.03133f, 191.33623f),
                    PathNode.CurveTo(232.02571f, 193.46442f, 231.17233f, 195.50264f, 229.66f, 197.0f),
                    PathNode.Close,
                    PathNode.MoveTo(26.34f, 185.66f),
                    PathNode.CurveTo(23.218275f, 188.78375f, 23.218275f, 193.84624f, 26.34f, 196.97f),
                    PathNode.LineTo(59.0f, 229.66f),
                    PathNode.CurveTo(62.123768f, 232.78172f, 67.18623f, 232.78172f, 70.31f, 229.66f),
                    PathNode.LineTo(88.66f, 211.31f),
                    PathNode.LineTo(44.66f, 167.31f),
                    PathNode.Close
                ),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(64.68f, 224.0f),
                    PathNode.LineTo(32.0f, 191.32f),
                    PathNode.LineTo(44.69f, 178.63f),
                    PathNode.LineTo(77.38f, 211.32f),
                    PathNode.Close,
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(143.0f, 175.75f),
                    PathNode.CurveTo(138.48859f, 171.24649f, 135.96774f, 165.12442f, 136.0f, 158.75f),
                    PathNode.LineTo(136.0f, 29.75f),
                    PathNode.CurveTo(136.00075f, 26.886368f, 138.09819f, 24.454998f, 140.93076f, 24.034246f),
                    PathNode.CurveTo(143.7633f, 23.613497f, 146.47691f, 25.330227f, 147.31f, 28.07f),
                    PathNode.LineTo(184.31f, 150.29f),
                    PathNode.CurveTo(184.69147f, 151.55103f, 185.37848f, 152.69833f, 186.31f, 153.63f),
                    PathNode.LineTo(200.8f, 168.12f),
                    PathNode.LineTo(167.4f, 200.12f),
                    PathNode.Close,
                    PathNode.MoveTo(191.32f, 224.0f),
                    PathNode.LineTo(178.76f, 211.43f),
                    PathNode.LineTo(212.15f, 179.43f),
                    PathNode.LineTo(224.0f, 191.32f),
                    PathNode.Close
                ),
                pathFillType = PathFillType.NonZero,
                fill = SolidColor(Color.Black),
