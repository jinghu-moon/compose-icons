...
val TablerIcons.Outline.CaptureOff: ImageVector
    get() {
        ...
        _captureOff = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 16.000 20.000 L 18.000 20.000 C 18.554 20.000 19.055 19.775 19.417 19.411"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 9.870 9.887 C 8.717 11.065 8.730 12.952 9.898 14.113 C 11.067 15.275 12.954 15.277 14.125 14.117M 14.705 10.701 C 14.410 10.089 13.917 9.594 13.305 9.298"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 4.000 8.000 L 4.000 6.000 C 4.000 5.452 4.220 4.956 4.577 4.595"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
