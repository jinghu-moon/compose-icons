...
val LucideIcons.Outline.BrickWall: ImageVector
    get() {
        if (_brickWall != null) return _brickWall!!
        _brickWall = lucideOutlineIcon(
            name = "BrickWall",
            ...
            addPath(
                pathData = parseSvgPathData("M 16.000 15.000 L 16.000 21.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 16.000 3.000 L 16.000 9.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
