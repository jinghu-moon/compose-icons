...
val TablerIcons.Outline.DatabaseExclamation: ImageVector
    get() {
        ...
        _databaseExclamation = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 4.000 6.000 L 4.000 12.000 C 4.000 13.657 7.582 15.000 12.000 15.000 C 13.118 15.000 14.182 14.914 15.148 14.759M 20.000 12.000 L 20.000 6.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 4.000 12.000 L 4.000 18.000 C 4.000 19.657 7.582 21.000 12.000 21.000 C 13.064 21.000 14.079 20.922 15.007 20.780"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
