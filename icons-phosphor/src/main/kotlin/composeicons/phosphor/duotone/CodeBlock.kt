...
val PhosphorIcons.Duotone.CodeBlock: ImageVector
    get() {
        ...
        _codeBlock = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M152 32v64c0 8.837-7.163 16-16 16h-104C23.163 112 16 104.837 16 96v-64C16 23.163 23.163 16 32 16h104c8.837 0 16 7.163 16 16Z"),
