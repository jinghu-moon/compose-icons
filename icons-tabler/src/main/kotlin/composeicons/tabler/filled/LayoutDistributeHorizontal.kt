        ...
        _layoutDistributeHorizontal = tablerFilledIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(17.656855f, 8.0f, 19.0f, 9.343145f, 19.0f, 11.0f),
                    PathNode.LineTo(19.0f, 13.0f),
                    PathNode.CurveTo(19.0f, 14.656855f, 17.656855f, 16.0f, 16.0f, 16.0f),
                    PathNode.LineTo(8.0f, 16.0f),
                    PathNode.CurveTo(6.343146f, 16.0f, 5.0f, 14.656855f, 5.0f, 13.0f),
                    PathNode.LineTo(5.0f, 11.0f),
                    PathNode.CurveTo(5.0f, 9.343145f, 6.343146f, 8.0f, 8.0f, 8.0f),
                    PathNode.Close
                ),
                pathFillType = PathFillType.NonZero,
                fill = SolidColor(Color.Black),
