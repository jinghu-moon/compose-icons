        ...
        _bookmark = phosphorLightIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(186.0f, 165.18f),
                    PathNode.LineTo(131.17f, 130.91f),
                    PathNode.CurveTo(129.22438f, 129.69398f, 126.75562f, 129.69398f, 124.81f, 130.91f),
                    PathNode.LineTo(70.0f, 165.17f),
                    PathNode.LineTo(70.0f, 48.0f),
                    PathNode.CurveTo(70.0f, 46.89543f, 70.89543f, 46.0f, 72.0f, 46.0f),
                    PathNode.Close,
                    PathNode.MoveTo(131.17f, 178.91f),
                    PathNode.CurveTo(129.22438f, 177.69398f, 126.75562f, 177.69398f, 124.81f, 178.91f),
                    PathNode.LineTo(70.0f, 213.17f),
                    PathNode.LineTo(70.0f, 179.33f),
                    PathNode.LineTo(128.0f, 143.08f),
                    PathNode.LineTo(186.0f, 179.33f),
                    PathNode.LineTo(186.0f, 213.17f),
                    PathNode.Close
                ),
