        ...
        _squareStack = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(8.9f, 16.0f, 8.0f, 15.1f, 8.0f, 14.0f),
                    PathNode.LineTo(8.0f, 10.0f),
                    PathNode.CurveTo(8.0f, 8.9f, 8.9f, 8.0f, 10.0f, 8.0f),
                    PathNode.LineTo(14.0f, 8.0f),
                    PathNode.CurveTo(15.1f, 8.0f, 16.0f, 8.9f, 16.0f, 10.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
