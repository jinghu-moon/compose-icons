...
val TablerIcons.Outline.AerialLift: ImageVector
    get() {
        ...
        _aerialLift = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(6.894f, 8.0f),
                    PathNode.LineTo(17.2f, 8.0f),
                    PathNode.CurveTo(19.65f, 11.0f, 19.65f, 17.0f, 17.0f, 20.0f),
                    PathNode.LineTo(6.894f, 20.0f),
                    PathNode.CurveTo(4.35f, 17.0f, 4.35f, 11.0f, 6.894f, 8.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
