...
val LucideIcons.Outline.Bandage: ImageVector
    get() {
        ...
        _bandage = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(10.0f, 10.01f),
                    PathNode.LineTo(10.01f, 10.01f)
                ),
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(10.0f, 14.01f),
                    PathNode.LineTo(10.01f, 14.01f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(14.0f, 10.01f),
                    PathNode.LineTo(14.01f, 10.01f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(14.0f, 14.01f),
                    PathNode.LineTo(14.01f, 14.01f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
