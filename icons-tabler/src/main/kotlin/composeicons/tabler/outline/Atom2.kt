...
val TablerIcons.Outline.Atom2: ImageVector
    get() {
        ...
        _atom2 = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(8.0f, 20.1f),
                    PathNode.CurveTo(5.226278f, 18.747103f, 3.339151f, 16.067383f, 3.0f, 13.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(16.0f, 20.1f),
                    PathNode.CurveTo(18.773722f, 18.747103f, 20.660849f, 16.067383f, 21.0f, 13.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(6.2f, 5.0f),
                    PathNode.CurveTo(9.515604f, 2.286549f, 14.284395f, 2.286549f, 17.6f, 5.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
