...
val TablerIcons.Outline.FileInfo: ImageVector
    get() {
        if (_fileInfo != null) return _fileInfo!!
        _fileInfo = tablerOutlineIcon(
            name = "FileInfo",
            ...
            addPath(
                pathData = parseSvgPathData("M 11.000 14.000 L 12.000 14.000 L 12.000 18.000 L 13.000 18.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
