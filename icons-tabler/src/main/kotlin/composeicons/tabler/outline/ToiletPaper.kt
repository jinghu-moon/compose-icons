        ...
        _toiletPaper = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(3.0f, 13.865993f, 4.343146f, 17.0f, 6.0f, 17.0f),
                    PathNode.CurveTo(7.656854f, 17.0f, 9.0f, 13.865993f, 9.0f, 10.0f),
                    PathNode.CurveTo(9.0f, 6.134007f, 7.656854f, 3.0f, 6.0f, 3.0f),
                    PathNode.CurveTo(4.343146f, 3.0f, 3.0f, 6.134007f, 3.0f, 10.0f)
                ),
