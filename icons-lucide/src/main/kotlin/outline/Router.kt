...
val LucideIcons.Outline.Router: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 6.010 18.000 L 6.000 18.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 10.010 18.000 L 10.000 18.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 17.840 7.170 C 17.090 6.419 16.072 5.997 15.010 5.997 C 13.948 5.997 12.930 6.419 12.180 7.170"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 20.660 4.340 C 17.536 1.218 12.474 1.218 9.350 4.340"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
