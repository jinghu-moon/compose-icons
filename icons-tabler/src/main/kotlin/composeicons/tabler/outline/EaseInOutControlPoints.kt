        ...
        _easeInOutControlPoints = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(17.0f, 21.10457f, 17.89543f, 22.0f, 19.0f, 22.0f),
                    PathNode.CurveTo(20.10457f, 22.0f, 21.0f, 21.10457f, 21.0f, 20.0f),
                    PathNode.CurveTo(21.0f, 18.89543f, 20.10457f, 18.0f, 19.0f, 18.0f),
                    PathNode.CurveTo(17.89543f, 18.0f, 17.0f, 18.89543f, 17.0f, 20.0f)
                ),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(7.0f, 5.10457f, 6.10457f, 6.0f, 5.0f, 6.0f),
                    PathNode.CurveTo(3.895431f, 6.0f, 3.0f, 5.10457f, 3.0f, 4.0f),
                    PathNode.CurveTo(3.0f, 2.895431f, 3.895431f, 2.0f, 5.0f, 2.0f),
                    PathNode.CurveTo(6.10457f, 2.0f, 7.0f, 2.895431f, 7.0f, 4.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(11.0f, 20.0f, 13.0f, 4.0f, 21.0f, 4.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
