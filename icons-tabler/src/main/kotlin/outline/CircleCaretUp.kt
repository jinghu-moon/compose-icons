...
val TablerIcons.Outline.CircleCaretUp: ImageVector
    get() {
        if (_circleCaretUp != null) return _circleCaretUp!!
        _circleCaretUp = tablerOutlineIcon(
            name = "CircleCaretUp",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24.0f, height = 24.0f),
        ) {
    addPath(
        pathData = parseSvgPathData("M 12.000 9.000 L 16.000 13.000 L 8.000 13.000 L 12.000 9.000"),
