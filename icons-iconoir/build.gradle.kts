...
android {
    namespace = "composeicons.iconoir"
    compileSdk = 36
...
mavenPublishing {
    ...
    pom {
        name.set("icons-iconoir")
        description.set("Iconoir for Jetpack Compose - generated via svg2compose pipeline")
