...
val TablerIcons.Outline.CalendarShare: ImageVector
    get() {
        ...
        _calendarShare = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 21.000 L 6.000 21.000 C 4.895 21.000 4.000 20.105 4.000 19.000 L 4.000 7.000 C 4.000 5.895 4.895 5.000 6.000 5.000 L 18.000 5.000 C 19.105 5.000 20.000 5.895 20.000 7.000 L 20.000 13.000"),
