...
val TablerIcons.Outline.DeviceTabletCode: ImageVector
    get() {
        ...
        _deviceTabletCode = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 11.500 21.000 L 6.000 21.000 C 5.448 21.000 5.000 20.552 5.000 20.000 L 5.000 4.000 C 5.000 3.448 5.448 3.000 6.000 3.000 L 18.000 3.000 C 18.552 3.000 19.000 3.448 19.000 4.000 L 19.000 13.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 12.344 16.060 C 11.908 15.900 11.419 16.061 11.164 16.449 C 10.909 16.837 10.954 17.350 11.274 17.687"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
