...
val PhosphorIcons.Fill.NumberSquareOne: ImageVector
    get() {
        ...
        _numberSquareOne = phosphorFillIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M208 32h-160C39.163 32 32 39.163 32 48v160c0 8.837 7.163 16 16 16h160c8.837 0 16-7.163 16-16v-160c0-8.837-7.163-16-16-16ZM140 176c0 4.418-3.582 8-8 8-4.418 0-8-3.582-8-8v-81l-11.56 7.71c-3.678 2.452-8.648 1.458-11.1-2.22-2.452-3.678-1.458-8.648 2.22-11.1l24-16c2.448-1.633 5.595-1.791 8.194-.41 2.599 1.381 4.23 4.077 4.246 7.02Z"),
