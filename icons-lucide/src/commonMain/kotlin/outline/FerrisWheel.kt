...
val LucideIcons.Outline.FerrisWheel: ImageVector
    get() {
        ...
        _ferrisWheel = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(20.7f, 7.0f),
                    PathNode.LineTo(17.2f, 9.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(6.8f, 9.0f),
                    PathNode.LineTo(3.3f, 7.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(18.0f, 18.7f),
                    PathNode.CurveTo(20.781328f, 16.212303f, 21.739048f, 12.266303f, 20.40755f, 8.780397f),
                    PathNode.CurveTo(19.076054f, 5.294492f, 15.731544f, 2.991796f, 12.0f, 2.991796f),
                    PathNode.CurveTo(8.268456f, 2.991796f, 4.923947f, 5.294492f, 3.592449f, 8.780397f),
                    PathNode.CurveTo(2.260951f, 12.266303f, 3.218671f, 16.212303f, 6.0f, 18.7f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
