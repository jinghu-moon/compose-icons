        ...
        _coin = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(232.0f, 128.0f, 192.0f, 152.0f, 128.0f, 152.0f),
                    PathNode.CurveTo(64.0f, 152.0f, 24.0f, 128.0f, 24.0f, 104.0f),
                    PathNode.CurveTo(24.0f, 80.0f, 64.0f, 56.0f, 128.0f, 56.0f),
                    PathNode.CurveTo(192.0f, 56.0f, 232.0f, 80.0f, 232.0f, 104.0f),
                    PathNode.Close
                ),
