...
val TablerIcons.Outline.ChartDonut4: ImageVector
    get() {
        ...
        _chartDonut4 = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 8.848 14.667 L 5.500 17.500"),
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 3.000 L 12.000 8.000M 16.000 12.000 L 21.000 12.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 14.219 15.328 L 17.000 19.500"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
