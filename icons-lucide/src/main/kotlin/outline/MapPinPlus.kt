...
val LucideIcons.Outline.MapPinPlus: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 19.914 11.105 C 19.971 10.739 19.999 10.370 20.000 10.000 C 20.000 5.582 16.418 2.000 12.000 2.000 C 7.582 2.000 4.000 5.582 4.000 10.000 C 4.000 14.993 9.539 20.193 11.399 21.799 C 11.755 22.067 12.245 22.067 12.601 21.799 C 12.880 21.558 13.155 21.312 13.425 21.061"),
    ...
    addPath(
        pathData = parseSvgPathData("M 19.000 15.000 L 19.000 21.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
