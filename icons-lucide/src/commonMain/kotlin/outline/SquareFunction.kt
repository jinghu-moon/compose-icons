        ...
        _squareFunction = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(11.0f, 17.0f, 11.8f, 16.0f, 11.8f, 14.2f),
                    PathNode.LineTo(11.8f, 10.0f),
                    PathNode.CurveTo(11.8f, 8.0f, 12.8f, 6.7f, 15.0f, 7.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(9.0f, 11.2f),
                    PathNode.LineTo(14.7f, 11.2f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
