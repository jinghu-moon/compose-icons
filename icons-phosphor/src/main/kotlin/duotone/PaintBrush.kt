...
val PhosphorIcons.Duotone.PaintBrush: ImageVector
    get() {
        ...
        _paintBrush = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(224.0f, 32.0f),
                    PathNode.CurveTo(224.0f, 64.81f, 192.36f, 99.43f, 165.36f, 123.05f),
                    PathNode.CurveTo(157.76715f, 109.47024f, 146.56801f, 98.25381f, 133.0f, 90.64f),
                    PathNode.CurveTo(156.57f, 63.64f, 191.19f, 32.0f, 224.0f, 32.0f),
                    PathNode.Close
                ),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(34.63f, 208.0f),
                    PathNode.CurveTo(41.38f, 198.41f, 48.0f, 183.92f, 48.0f, 164.0f),
                    PathNode.CurveTo(48.0f, 139.69948f, 67.69947f, 120.0f, 92.0f, 120.0f),
                    PathNode.CurveTo(116.30053f, 120.0f, 136.0f, 139.69948f, 136.0f, 164.0f),
                    PathNode.CurveTo(136.0f, 188.30052f, 116.30053f, 208.0f, 92.0f, 208.0f),
                    PathNode.Close,
