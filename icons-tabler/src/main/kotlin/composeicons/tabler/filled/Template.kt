        ...
        _template = tablerFilledIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(21.0f, 8.10457f, 20.10457f, 9.0f, 19.0f, 9.0f),
                    PathNode.LineTo(5.0f, 9.0f),
                    PathNode.CurveTo(3.895431f, 9.0f, 3.0f, 8.10457f, 3.0f, 7.0f),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(10.104569f, 11.0f, 11.0f, 11.895431f, 11.0f, 13.0f),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(13.447715f, 13.0f, 13.0f, 12.552285f, 13.0f, 12.0f),
                    PathNode.CurveTo(13.0f, 11.447715f, 13.447715f, 11.0f, 14.0f, 11.0f),
                    PathNode.Close
                ),
                pathFillType = PathFillType.NonZero,
                fill = SolidColor(Color.Black),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(13.447715f, 17.0f, 13.0f, 16.552284f, 13.0f, 16.0f),
                    PathNode.CurveTo(13.0f, 15.447715f, 13.447715f, 15.0f, 14.0f, 15.0f),
                    PathNode.Close
                ),
                pathFillType = PathFillType.NonZero,
                fill = SolidColor(Color.Black),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(13.0f, 19.447716f, 13.447715f, 19.0f, 14.0f, 19.0f),
                    PathNode.Close
                ),
                pathFillType = PathFillType.NonZero,
                fill = SolidColor(Color.Black),
