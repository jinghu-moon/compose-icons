        ...
        _typeface = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(15.895431f, 17.0f, 15.0f, 16.10457f, 15.0f, 15.0f),
                    PathNode.LineTo(15.0f, 7.0f),
                    PathNode.LineTo(10.0f, 7.0f),
                    PathNode.CurveTo(8.895431f, 7.0f, 8.0f, 7.895431f, 8.0f, 9.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(8.194101f, 16.999811f, 9.25419f, 16.235756f, 9.632f, 15.103f),
                    PathNode.LineTo(10.0f, 14.0f),
                    PathNode.CurveTo(10.657764f, 12.027213f, 11.765657f, 10.234591f, 13.236f, 8.764f),
                    PathNode.LineTo(15.0f, 7.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
