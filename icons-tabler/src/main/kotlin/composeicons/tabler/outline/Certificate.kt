...
val TablerIcons.Outline.Certificate: ImageVector
    get() {
        ...
        _certificate = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(13.0f, 17.5f),
                    PathNode.LineTo(13.0f, 22.0f),
                    PathNode.LineTo(15.0f, 20.5f),
                    PathNode.LineTo(17.0f, 22.0f),
                    PathNode.LineTo(17.0f, 17.5f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(3.0f, 5.9f, 3.9f, 5.0f, 5.0f, 5.0f),
                    PathNode.LineTo(19.0f, 5.0f),
                    PathNode.CurveTo(20.10457f, 5.0f, 21.0f, 5.895431f, 21.0f, 7.0f),
                    PathNode.LineTo(21.0f, 17.0f),
                    PathNode.CurveTo(20.999268f, 17.713799f, 20.618168f, 18.3731f, 20.0f, 18.73f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
