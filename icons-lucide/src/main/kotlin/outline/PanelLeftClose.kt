...
val LucideIcons.Outline.PanelLeftClose: ImageVector
    get() {
        if (_panelLeftClose != null) return _panelLeftClose!!
        _panelLeftClose = lucideOutlineIcon(
            name = "PanelLeftClose",
            ...
            addPath(
                pathData = parseSvgPathData("M 16.000 15.000 L 13.000 12.000 L 16.000 9.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
