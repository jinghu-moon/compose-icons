...
val TablerIcons.Outline.CoinEuro: ImageVector
    get() {
        ...
        _coinEuro = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 14.401 8.000 C 13.732 7.372 12.901 7.000 12.000 7.000 C 9.790 7.000 8.000 9.239 8.000 12.000 C 8.000 14.761 9.790 17.000 12.000 17.000 C 12.900 17.000 13.731 16.628 14.400 16.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 7.000 10.500 L 11.000 10.500"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 7.000 13.500 L 11.000 13.500"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
