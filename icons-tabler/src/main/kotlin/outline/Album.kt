...
val TablerIcons.Outline.Album: ImageVector
    get() {
        if (_album != null) return _album!!
        _album = tablerOutlineIcon(
            name = "Album",
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 4.000 L 12.000 11.000 L 14.000 9.000 L 16.000 11.000 L 16.000 4.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
