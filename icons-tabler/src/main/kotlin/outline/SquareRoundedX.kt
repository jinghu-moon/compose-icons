...
val TablerIcons.Outline.SquareRoundedX: ImageVector
    get() {
        if (_squareRoundedX != null) return _squareRoundedX!!
        _squareRoundedX = tablerOutlineIcon(
            name = "SquareRoundedX",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24f, height = 24f),
        ) {
            addPath(
                pathData = parseSvgPathData("M 10.000 10.000 L 14.000 14.000M 14.000 10.000 L 10.000 14.000"),
