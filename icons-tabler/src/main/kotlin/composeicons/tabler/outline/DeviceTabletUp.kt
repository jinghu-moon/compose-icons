...
val TablerIcons.Outline.DeviceTabletUp: ImageVector
    get() {
        ...
        _deviceTabletUp = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(12.906f, 16.576f),
                    PathNode.CurveTo(12.695667f, 16.12673f, 12.187768f, 15.899567f, 11.712668f, 16.04227f),
                    PathNode.CurveTo(11.23757f, 16.184975f, 10.938902f, 16.654402f, 11.010938f, 17.145212f),
                    PathNode.CurveTo(11.082973f, 17.636023f, 11.503932f, 17.999832f, 12.0f, 18.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
