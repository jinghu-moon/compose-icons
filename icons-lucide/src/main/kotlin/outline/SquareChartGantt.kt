...
val LucideIcons.Outline.SquareChartGantt: ImageVector
    get() {
        if (_squareChartGantt != null) return _squareChartGantt!!
        _squareChartGantt = lucideOutlineIcon(
    ...
    addPath(
        pathData = parseSvgPathData("M 9.000 8.000 L 16.000 8.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 11.000 16.000 L 16.000 16.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
