...
val PhosphorIcons.Duotone.FlipVertical: ImageVector
    get() {
        ...
        _flipVertical = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M219.11 159.37l-160 64c-2.47 1.042-5.298 .778-7.532-.704C49.343 221.184 48 218.681 48 216v-64c0-4.418 3.582-8 8-8h160c8.71 0 11.14 12 3.11 15.37Z"),
