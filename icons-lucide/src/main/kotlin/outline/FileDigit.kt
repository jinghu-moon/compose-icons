...
val LucideIcons.Outline.FileDigit: ImageVector
    get() {
        ...
        _fileDigit = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 10.000 16.000 L 12.000 16.000 L 12.000 22.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 10.000 22.000 L 14.000 22.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 4.000 16.000 L 4.000 16.000 C 5.105 16.000 6.000 16.895 6.000 18.000 L 6.000 20.000 C 6.000 21.105 5.105 22.000 4.000 22.000 L 4.000 22.000 C 2.895 22.000 2.000 21.105 2.000 20.000 L 2.000 18.000 C 2.000 16.895 2.895 16.000 4.000 16.000 Z"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
