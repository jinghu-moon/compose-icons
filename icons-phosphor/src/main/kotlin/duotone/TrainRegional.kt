...
val PhosphorIcons.Duotone.TrainRegional: ImageVector
    get() {
        if (_trainRegional != null) return _trainRegional!!
        _trainRegional = phosphorDuotoneIcon(
            name = "TrainRegional",
    ...
    group(
        ...
        addPath(
            pathData = parseSvgPathData("M 216.000 120.000 L 193.610 202.100 C 192.662 205.583 189.500 208.000 185.890 208.000 L 70.110 208.000 C 66.500 208.000 63.338 205.583 62.390 202.100 L 40.000 120.000 L 128.000 136.000 Z"),
