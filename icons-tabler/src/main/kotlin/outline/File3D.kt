...
val TablerIcons.Outline.File3D: ImageVector
    get() {
        ...
        _file3D = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 13.500 L 16.000 12.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 8.000 11.846 L 12.000 13.500 L 12.000 18.000 L 16.000 16.154 L 16.000 11.846 L 12.000 10.000 L 8.000 11.846"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 8.000 12.000 L 8.000 16.200 L 12.000 18.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
