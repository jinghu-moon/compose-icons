...
val TablerIcons.Outline.CornerUpLeftDouble: ImageVector
    get() {
        ...
        _cornerUpLeftDouble = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 19.000 18.000 L 19.000 12.000 C 19.000 10.343 17.657 9.000 16.000 9.000 L 9.000 9.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 13.000 13.000 L 9.000 9.000 L 13.000 5.000M 8.000 13.000 L 4.000 9.000 L 8.000 5.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
