...
val RemixIcons.Line.FileTransferLine: ImageVector
    get() {
        ...
        _fileTransferLine = remixIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M15 4h-10v16h14v-12h-4v-4ZM3 2.992C3 2.444 3.447 2 3.999 2h12.001l5 5L21 20.993c0 .556-.445 1.007-.993 1.007h-16.013C3.445 22 3 21.545 3 21.008v-18.016ZM12 11v-3l4 4-4 4v-3h-4v-2h4Z"),
