...
val TablerIcons.Outline.BrandLinkedin: ImageVector
    get() {
        ...
        _brandLinkedin = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 8.000 11.000 L 8.000 16.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 16.000 L 12.000 11.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 16.000 16.000 L 16.000 13.000 C 16.000 11.895 15.105 11.000 14.000 11.000 C 12.895 11.000 12.000 11.895 12.000 13.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
