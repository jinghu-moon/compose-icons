...
val TablerIcons.Outline.CreativeCommonsZero: ImageVector
    get() {
        ...
        _creativeCommonsZero = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 9.000 12.000 C 9.000 14.209 10.343 16.000 12.000 16.000 C 13.657 16.000 15.000 14.209 15.000 12.000 C 15.000 9.791 13.657 8.000 12.000 8.000 C 10.343 8.000 9.000 9.791 9.000 12.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 14.000 9.000 L 10.000 15.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
