...
val TablerIcons.Filled.CircleChevronDown: ImageVector
    get() {
        ...
        _circleChevronDown = tablerFilledIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M12 2c5.523 0 10 4.477 10 10 0 5.523-4.477 10-10 10C6.477 22 2 17.523 2 12 2 6.477 6.477 2 12 2M9.707 10.293C9.315 9.914 8.691 9.919 8.305 10.305c-.386 .386-.391 1.009-.012 1.402l3 3c.391 .39 1.023 .39 1.414 0l3-3c.39-.391 .39-1.023 0-1.414l-.094-.083c-.398-.309-.964-.273-1.32 .083l-2.294 2.292Z"),
