...
val LucideIcons.Outline.SquareChevronUp: ImageVector
    get() {
        if (_squareChevronUp != null) return _squareChevronUp!!
        _squareChevronUp = lucideOutlineIcon(
    ...
    addPath(
        pathData = parseSvgPathData("M 8.000 14.000 L 12.000 10.000 L 16.000 14.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
