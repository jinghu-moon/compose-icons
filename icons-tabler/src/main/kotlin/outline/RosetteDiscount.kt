...
val TablerIcons.Outline.RosetteDiscount: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 9.000 9.500 C 9.000 9.776 9.224 10.000 9.500 10.000 C 9.776 10.000 10.000 9.776 10.000 9.500 C 10.000 9.224 9.776 9.000 9.500 9.000 C 9.224 9.000 9.000 9.224 9.000 9.500"),
        pathFillType = PathFillType.NonZero,
    ...
    addPath(
        pathData = parseSvgPathData("M 14.000 14.500 C 14.000 14.776 14.224 15.000 14.500 15.000 C 14.776 15.000 15.000 14.776 15.000 14.500 C 15.000 14.224 14.776 14.000 14.500 14.000 C 14.224 14.000 14.000 14.224 14.000 14.500"),
        pathFillType = PathFillType.NonZero,
        fill = SolidColor(Color(0xFF000000)),
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
