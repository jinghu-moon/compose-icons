...
val LucideIcons.Outline.BadgeCent: ImageVector
    get() {
        if (_badgeCent != null) return _badgeCent!!
        _badgeCent = lucideOutlineIcon(
            name = "BadgeCent",
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(15.4f, 10.0f),
                    PathNode.CurveTo(14.494788f, 8.432128f, 12.649356f, 7.667725f, 10.900622f, 8.136297f),
                    PathNode.CurveTo(9.151888f, 8.604869f, 7.935899f, 10.189577f, 7.935899f, 12.0f),
                    PathNode.CurveTo(7.935899f, 13.810423f, 9.151888f, 15.395131f, 10.900622f, 15.863704f),
                    PathNode.CurveTo(12.649356f, 16.332275f, 14.494788f, 15.567872f, 15.4f, 14.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
