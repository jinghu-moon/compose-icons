...
val PhosphorIcons.Duotone.CurrencyJpy: ImageVector
    get() {
        if (_currencyJpy != null) return _currencyJpy!!
        _currencyJpy = phosphorDuotoneIcon(
            name = "CurrencyJpy",
            ...
            group(
                ...
                addPath(
                    pathData = parseSvgPathData("M 200.000 48.000 L 128.000 136.000 L 56.000 48.000 Z"),
