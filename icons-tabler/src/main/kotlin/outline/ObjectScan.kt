...
val TablerIcons.Outline.ObjectScan: ImageVector
    get() {
        ...
        _objectScan = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 8.000 10.000 C 8.000 8.895 8.895 8.000 10.000 8.000 L 14.000 8.000 C 15.105 8.000 16.000 8.895 16.000 10.000 L 16.000 14.000 C 16.000 15.105 15.105 16.000 14.000 16.000 L 10.000 16.000 C 8.895 16.000 8.000 15.105 8.000 14.000 L 8.000 10.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
