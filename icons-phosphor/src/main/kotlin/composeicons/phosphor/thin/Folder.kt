...
val PhosphorIcons.Thin.Folder: ImageVector
    get() {
        ...
        _folder = phosphorThinIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M216 76h-86.34L101.17 47.52C98.928 45.26 95.874 43.992 92.69 44h-52.69C33.373 44 28 49.373 28 56v144.62c.011 6.28 5.1 11.369 11.38 11.38h177.51c6.134-.006 11.104-4.976 11.11-11.11v-112.89c0-6.627-5.373-12-12-12ZM36 56c0-2.209 1.791-4 4-4h52.69c1.058 .002 2.072 .422 2.82 1.17L118.34 76h-82.34ZM220 200.89c-.005 1.715-1.395 3.105-3.11 3.11h-177.51c-1.864-.005-3.375-1.516-3.38-3.38v-116.62h180c2.209 0 4 1.791 4 4Z"),
