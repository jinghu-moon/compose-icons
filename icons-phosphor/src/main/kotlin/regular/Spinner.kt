        ...
        _spinner = phosphorRegularIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(173.25f, 90.75f),
                    PathNode.CurveTo(175.37381f, 90.749016f, 177.41006f, 89.90358f, 178.91f, 88.4f),
                    PathNode.LineTo(201.54f, 65.78f),
                    PathNode.CurveTo(204.66592f, 62.654068f, 204.66592f, 57.58593f, 201.54f, 54.46f),
                    PathNode.CurveTo(198.41406f, 51.33407f, 193.34593f, 51.33407f, 190.22f, 54.46f),
                    PathNode.LineTo(167.6f, 77.09f),
                    PathNode.CurveTo(165.31065f, 79.37681f, 164.62433f, 82.81755f, 165.86111f, 85.8077f),
                    PathNode.CurveTo(167.09789f, 88.79785f, 170.01416f, 90.748505f, 173.25f, 90.75f),
                    PathNode.Close,
