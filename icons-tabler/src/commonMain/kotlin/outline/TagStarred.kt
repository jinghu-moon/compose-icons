...
val TablerIcons.Outline.TagStarred: ImageVector
    get() {
        ...
        _tagStarred = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(12.5f, 13.847f),
                    PathNode.LineTo(11.0f, 15.0f),
                    PathNode.LineTo(11.532f, 13.143f),
                    PathNode.LineTo(10.0f, 12.0f),
                    PathNode.LineTo(11.902f, 12.0f),
                    PathNode.LineTo(12.5f, 10.2f),
                    PathNode.LineTo(13.098f, 12.0f),
                    PathNode.LineTo(15.0f, 12.0f),
                    PathNode.LineTo(13.468f, 13.143f),
                    PathNode.LineTo(14.0f, 15.0f),
                    PathNode.LineTo(12.5f, 13.847f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
