...
val TablerIcons.Outline.CircleChevronsDown: ImageVector
    get() {
        if (_circleChevronsDown != null) return _circleChevronsDown!!
        _circleChevronsDown = tablerOutlineIcon(
            name = "CircleChevronsDown",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24.0f, height = 24.0f),
        ) {
    addPath(
        pathData = parseSvgPathData("M 15.000 9.000 L 12.000 12.000 L 9.000 9.000"),
