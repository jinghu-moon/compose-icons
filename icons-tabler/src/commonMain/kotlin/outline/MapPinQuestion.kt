...
val TablerIcons.Outline.MapPinQuestion: ImageVector
    get() {
        ...
        _mapPinQuestion = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(14.997f, 19.317f),
                    ...
                    PathNode.CurveTo(3.776605f, 14.090176f, 3.25993f, 10.117208f, 5.084444f, 6.979357f),
                    PathNode.CurveTo(6.908958f, 3.841504f, 10.617371f, 2.325229f, 14.117667f, 3.285901f),
                    PathNode.CurveTo(17.617964f, 4.246574f, 20.03284f, 7.443415f, 20.0f, 11.073f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
