...
val LucideIcons.Outline.IndianRupee: ImageVector
    get() {
        ...
        _indianRupee = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 6.000 13.000 L 14.500 21.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 6.000 13.000 L 9.000 13.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 9.000 13.000 C 15.667 13.000 15.667 3.000 9.000 3.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
