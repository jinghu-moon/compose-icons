...
val LucideIcons.Outline.AArrowUp: ImageVector
    get() {
        if (_aArrowUp != null) return _aArrowUp!!
        _aArrowUp = lucideOutlineIcon(
            name = "AArrowUp",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24f, height = 24f),
        ) {
            addPath(
                pathData = parseSvgPathData("M 14.000 11.000 L 18.000 7.000 L 22.000 11.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 18.000 16.000 L 18.000 7.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
