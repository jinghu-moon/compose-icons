...
val PhosphorIcons.Duotone.Key: ImageVector
    get() {
        ...
        _key = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(232.0f, 98.36f),
                    PathNode.CurveTo(230.73f, 136.92f, 198.67f, 168.0f, 160.09f, 168.0f),
                    PathNode.CurveTo(150.86763f, 168.02449f, 141.72719f, 166.26906f, 133.17f, 162.83f),
                    PathNode.LineTo(133.17f, 162.83f),
                    ...
                    PathNode.LineTo(32.0f, 187.31f),
                    PathNode.CurveTo(32.00098f, 185.1911f, 32.84254f, 183.15912f, 34.34f, 181.66f),
                    PathNode.LineTo(93.17f, 122.83f),
                    PathNode.LineTo(93.17f, 122.83f),
                    PathNode.CurveTo(89.73094f, 114.272804f, 87.97552f, 105.13237f, 88.0f, 95.91f),
                    PathNode.CurveTo(88.0f, 57.33f, 119.08f, 25.27f, 157.64f, 24.04f),
                    PathNode.CurveTo(177.55054f, 23.37631f, 196.84619f, 30.99174f, 210.93668f, 45.07465f),
                    PathNode.CurveTo(225.02716f, 59.15756f, 232.65297f, 78.449104f, 232.0f, 98.36f),
                    PathNode.Close
                ),
