...
val PhosphorIcons.Fill.SkipBackCircle: ImageVector
    get() {
        ...
        _skipBackCircle = phosphorFillIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M128 24C70.562 24 24 70.562 24 128c0 57.438 46.562 104 104 104 57.438 0 104-46.562 104-104C231.939 70.588 185.412 24.061 128 24ZM168 168c0 2.997-1.675 5.742-4.339 7.114-2.665 1.371-5.872 1.138-8.311-.604L104 137.83v30.17c0 4.418-3.582 8-8 8-4.418 0-8-3.582-8-8v-80c0-4.418 3.582-8 8-8 4.418 0 8 3.582 8 8v30.17L155.35 81.49c2.439-1.742 5.646-1.975 8.311-.604 2.665 1.371 4.339 4.117 4.339 7.114Z"),
