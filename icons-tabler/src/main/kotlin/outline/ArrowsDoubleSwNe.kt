...
val TablerIcons.Outline.ArrowsDoubleSwNe: ImageVector
    get() {
        ...
        _arrowsDoubleSwNe = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 14.000 3.000 L 3.000 14.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 3.000 10.000 L 3.000 14.000 L 7.000 14.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 10.000 21.000 L 21.000 10.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
