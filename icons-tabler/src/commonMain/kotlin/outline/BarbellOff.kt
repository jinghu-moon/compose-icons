        ...
        _barbellOff = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(3.0f, 15.552285f, 3.447715f, 16.0f, 4.0f, 16.0f),
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(6.298f, 6.288f),
                    PathNode.CurveTo(6.107386f, 6.47589f, 6.000047f, 6.732351f, 6.0f, 7.0f),
                    PathNode.LineTo(6.0f, 17.0f),
                    PathNode.CurveTo(6.0f, 17.552284f, 6.447716f, 18.0f, 7.0f, 18.0f),
                    PathNode.LineTo(8.0f, 18.0f),
                    PathNode.CurveTo(8.552285f, 18.0f, 9.0f, 17.552284f, 9.0f, 17.0f),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(15.0f, 17.552284f, 15.447715f, 18.0f, 16.0f, 18.0f),
                    PathNode.LineTo(17.0f, 18.0f),
                    PathNode.CurveTo(17.275f, 18.0f, 17.523f, 17.89f, 17.704f, 17.71f),
                    PathNode.MoveTo(18.0f, 14.0f),
                    PathNode.LineTo(18.0f, 7.0f),
                    PathNode.CurveTo(18.0f, 6.447716f, 17.552284f, 6.0f, 17.0f, 6.0f),
