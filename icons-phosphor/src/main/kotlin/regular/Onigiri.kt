...
val PhosphorIcons.Regular.Onigiri: ImageVector
    get() {
        if (_onigiri != null) return _onigiri!!
        _onigiri = phosphorRegularIcon(
            name = "Onigiri",
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(218.86f, 195.45f),
                    PathNode.CurveTo(211.88391f, 208.21408f, 198.45564f, 216.10966f, 183.91f, 216.0f),
