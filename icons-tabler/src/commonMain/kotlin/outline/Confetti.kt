...
val TablerIcons.Outline.Confetti: ImageVector
    get() {
        ...
        _confetti = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(14.0f, 16.518f),
                    PathNode.LineTo(7.482f, 10.0f),
                    PathNode.LineTo(3.092f, 19.58f),
                    PathNode.CurveTo(2.91425f, 19.961035f, 2.99383f, 20.412558f, 3.291136f, 20.709864f),
                    PathNode.CurveTo(3.588443f, 21.00717f, 4.039966f, 21.08675f, 4.421f, 20.909f),
                    PathNode.LineTo(14.0f, 16.519f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
