...
val TablerIcons.Outline.Contrast2: ImageVector
    get() {
        ...
        _contrast2 = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 3.000 19.000 L 5.250 19.000 C 8.978 19.000 12.000 15.866 12.000 12.000 C 12.000 8.134 15.022 5.000 18.750 5.000 L 21.000 5.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
