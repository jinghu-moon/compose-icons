...
val TablerIcons.Outline.BeachOff: ImageVector
    get() {
        ...
        _beachOff = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(15.071f, 15.102f),
                    PathNode.CurveTo(12.277822f, 13.969488f, 9.078071f, 14.618575f, 6.947f, 16.75f)
                ),
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(10.27f, 6.269f),
                    PathNode.LineTo(20.196f, 12.0f),
                    PathNode.CurveTo(21.859797f, 9.152429f, 20.913399f, 5.495824f, 18.077045f, 3.812975f),
                    PathNode.CurveTo(15.240691f, 2.130127f, 11.577825f, 3.051991f, 9.876f, 5.877f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(14.261f, 10.279f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(12.794f, 12.82f),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(18.282911f, 19.605852f, 18.678638f, 19.306702f, 19.135f, 19.142f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
