...
val LucideIcons.Outline.CornerDownRight: ImageVector
    get() {
        ...
        _cornerDownRight = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 15.000 10.000 L 20.000 15.000 L 15.000 20.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 4.000 4.000 L 4.000 11.000 C 4.000 13.209 5.791 15.000 8.000 15.000 L 20.000 15.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
