...
val PhosphorIcons.Duotone.Train: ImageVector
    get() {
        if (_train != null) return _train!!
        _train = phosphorDuotoneIcon(
            name = "Train",
    ...
    group(
        ...
        addPath(
            pathData = parseSvgPathData("M 208.000 72.000 L 208.000 128.000 L 48.000 128.000 L 48.000 72.000 Z"),
