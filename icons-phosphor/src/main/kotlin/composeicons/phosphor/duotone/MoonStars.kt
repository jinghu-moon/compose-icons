...
val PhosphorIcons.Duotone.MoonStars: ImageVector
    get() {
        ...
        _moonStars = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M210.69 158.18c-13.995 38.272-52.435 61.928-92.908 57.177C77.31 210.606 45.394 178.69 40.643 138.218 35.892 97.745 59.548 59.305 97.82 45.31c-5.565 28.185 1.775 57.382 20.007 79.584C136.06 147.097 163.271 159.976 192 160c6.274 .001 12.534-.609 18.69-1.82Z"),
