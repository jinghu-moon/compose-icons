        ...
        _synagogue = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(184.0f, 71.163445f, 191.16344f, 64.0f, 200.0f, 64.0f),
                    PathNode.LineTo(200.0f, 64.0f),
                    PathNode.CurveTo(208.83656f, 64.0f, 216.0f, 71.163445f, 216.0f, 80.0f),
                    PathNode.Close,
                    PathNode.MoveTo(72.0f, 80.0f),
                    PathNode.CurveTo(72.0f, 71.163445f, 64.836555f, 64.0f, 56.0f, 64.0f),
                    PathNode.LineTo(56.0f, 64.0f),
                    PathNode.CurveTo(47.163445f, 64.0f, 40.0f, 71.163445f, 40.0f, 80.0f),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(80.0f, 140.64f),
                    PathNode.LineTo(128.0f, 113.21f),
                    PathNode.LineTo(176.0f, 140.64f),
