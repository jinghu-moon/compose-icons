...
val PhosphorIcons.Duotone.Hurricane: ImageVector
    get() {
        ...
        _hurricane = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(148.62f, 50.68f),
                    PathNode.LineTo(160.0f, 8.0f),
                    PathNode.CurveTo(160.0f, 8.0f, 48.0f, 32.0f, 48.0f, 128.0f),
                    PathNode.CurveTo(47.989548f, 164.24994f, 72.35488f, 195.97658f, 107.38f, 205.32f),
                    PathNode.LineTo(96.0f, 248.0f),
                    PathNode.CurveTo(96.0f, 248.0f, 208.0f, 224.0f, 208.0f, 128.0f),
                    PathNode.CurveTo(208.01045f, 91.75005f, 183.64513f, 60.023422f, 148.62f, 50.68f),
                    PathNode.Close,
