...
val TablerIcons.Outline.FileRss: ImageVector
    get() {
        if (_fileRss != null) return _fileRss!!
        _fileRss = tablerOutlineIcon(
            name = "FileRss",
    ...
    addPath(
        pathData = parseSvgPathData("M 12.000 17.000 C 12.000 15.343 10.657 14.000 9.000 14.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 15.000 17.000 C 15.000 13.686 12.314 11.000 9.000 11.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 9.000 17.000 L 9.010 17.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
