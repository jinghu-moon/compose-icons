        ...
        _calendarCheck = phosphorThinIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(166.83f, 125.17f),
                    PathNode.CurveTo(167.58112f, 125.92027f, 168.00314f, 126.93836f, 168.00314f, 128.0f),
                    PathNode.CurveTo(168.00314f, 129.06163f, 167.58112f, 130.07973f, 166.83f, 130.83f),
                    PathNode.LineTo(118.83f, 178.83f),
                    PathNode.CurveTo(118.07973f, 179.58112f, 117.06164f, 180.00314f, 116.0f, 180.00314f),
                    PathNode.CurveTo(114.93836f, 180.00314f, 113.92027f, 179.58112f, 113.17f, 178.83f),
                    PathNode.LineTo(89.17f, 154.83f),
                    PathNode.CurveTo(87.60703f, 153.26703f, 87.60703f, 150.73297f, 89.17f, 149.17f),
                    PathNode.CurveTo(90.73296f, 147.60704f, 93.26704f, 147.60704f, 94.83f, 149.17f),
                    PathNode.LineTo(116.0f, 170.34f),
                    PathNode.LineTo(161.17f, 125.17f),
                    PathNode.CurveTo(161.92027f, 124.418884f, 162.93837f, 123.99686f, 164.0f, 123.99686f),
                    PathNode.CurveTo(165.06163f, 123.99686f, 166.07973f, 124.418884f, 166.83f, 125.17f),
                    PathNode.Close
                ),
