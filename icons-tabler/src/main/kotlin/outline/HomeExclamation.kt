...
val TablerIcons.Outline.HomeExclamation: ImageVector
    get() {
        ...
        _homeExclamation = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 21.000 12.000 L 12.000 3.000 L 3.000 12.000 L 5.000 12.000 L 5.000 19.000 C 5.000 20.105 5.895 21.000 7.000 21.000 L 15.000 21.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 9.000 21.000 L 9.000 15.000 C 9.000 13.895 9.895 13.000 11.000 13.000 L 13.000 13.000 C 13.818 13.000 14.553 13.498 14.857 14.257"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
