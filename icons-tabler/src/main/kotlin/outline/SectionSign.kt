...
val TablerIcons.Outline.SectionSign: ImageVector
    get() {
        ...
        _sectionSign = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 9.172 19.000 C 9.681 20.438 11.188 21.266 12.674 20.923 C 14.161 20.581 15.154 19.177 14.981 17.661 C 14.809 16.145 13.526 15.000 12.000 15.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 14.830 5.000 C 14.322 3.562 12.815 2.734 11.328 3.077 C 9.842 3.419 8.849 4.822 9.021 6.338 C 9.193 7.854 10.475 8.999 12.000 9.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
