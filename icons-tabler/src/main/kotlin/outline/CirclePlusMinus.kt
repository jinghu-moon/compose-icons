...
val TablerIcons.Outline.CirclePlusMinus: ImageVector
    get() {
        if (_circlePlusMinus != null) return _circlePlusMinus!!
        _circlePlusMinus = tablerOutlineIcon(
            name = "CirclePlusMinus",
