...
val PhosphorIcons.Duotone.Shower: ImageVector
    get() {
        ...
        _shower = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M184 72 161.91 201.31c-.495 2.952-2.597 5.381-5.448 6.295-2.851 .914-5.973 .16-8.092-1.955L50.37 107.65c-2.114-2.119-2.868-5.241-1.955-8.092 .914-2.851 3.342-4.953 6.295-5.448Z"),
