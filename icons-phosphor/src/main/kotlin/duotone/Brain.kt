        ...
        _brain = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(240.00641f, 144.34715f, 227.18347f, 162.48763f, 208.0f, 169.27f),
                    PathNode.LineTo(208.0f, 169.27f),
                    PathNode.LineTo(208.0f, 176.0f),
                    PathNode.CurveTo(208.0f, 198.09138f, 190.09138f, 216.0f, 168.0f, 216.0f),
                    PathNode.CurveTo(145.90862f, 216.0f, 128.0f, 198.09138f, 128.0f, 176.0f),
                    PathNode.CurveTo(128.0f, 198.09138f, 110.09139f, 216.0f, 88.0f, 216.0f),
                    PathNode.CurveTo(65.90861f, 216.0f, 48.0f, 198.09138f, 48.0f, 176.0f),
                    PathNode.LineTo(48.0f, 169.27f),
                    PathNode.LineTo(48.0f, 169.27f),
                    PathNode.CurveTo(28.799574f, 162.50212f, 15.957039f, 144.3583f, 15.957039f, 124.0f),
                    PathNode.CurveTo(15.957039f, 103.64169f, 28.799574f, 85.49788f, 48.0f, 78.73f),
                    PathNode.LineTo(48.0f, 72.0f),
                    PathNode.CurveTo(48.0f, 49.90861f, 65.90861f, 32.0f, 88.0f, 32.0f),
                    PathNode.CurveTo(110.09139f, 32.0f, 128.0f, 49.90861f, 128.0f, 72.0f),
                    PathNode.CurveTo(128.0f, 49.90861f, 145.90862f, 32.0f, 168.0f, 32.0f),
                    PathNode.CurveTo(190.09138f, 32.0f, 208.0f, 49.90861f, 208.0f, 72.0f),
                    PathNode.LineTo(208.0f, 78.73f),
                    PathNode.CurveTo(227.18347f, 85.51238f, 240.00641f, 103.65285f, 240.0f, 124.0f),
                    PathNode.Close
                ),
