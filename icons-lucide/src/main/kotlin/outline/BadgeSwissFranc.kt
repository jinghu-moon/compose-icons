...
val LucideIcons.Outline.BadgeSwissFranc: ImageVector
    get() {
        if (_badgeSwissFranc != null) return _badgeSwissFranc!!
        _badgeSwissFranc = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 11.000 17.000 L 11.000 8.000 L 15.000 8.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 11.000 12.000 L 14.000 12.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
