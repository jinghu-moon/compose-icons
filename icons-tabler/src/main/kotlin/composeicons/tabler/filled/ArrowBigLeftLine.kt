        ...
        _arrowBigLeftLine = tablerFilledIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(18.993f, 8.883f),
                    PathNode.CurveTo(18.933683f, 8.379507f, 18.506975f, 8.000067f, 18.0f, 8.0f),
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(4.415f, 12.0f),
                    PathNode.LineTo(11.0f, 5.414f),
                    PathNode.LineTo(11.0f, 9.0f),
                    PathNode.LineTo(11.007f, 9.117f),
                    PathNode.CurveTo(11.066316f, 9.620493f, 11.493025f, 9.999933f, 12.0f, 10.0f),
                    PathNode.LineTo(17.0f, 9.999f),
                    PathNode.LineTo(17.0f, 13.999f),
                    PathNode.LineTo(12.0f, 14.0f),
                    PathNode.CurveTo(11.447715f, 14.0f, 11.0f, 14.447715f, 11.0f, 15.0f),
                    PathNode.LineTo(11.0f, 18.586f),
                    PathNode.LineTo(4.415f, 12.0f),
                    PathNode.Close
                ),
                pathFillType = PathFillType.NonZero,
                fill = SolidColor(Color.Black),
