        ...
        _squareOff = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.MoveTo(19.416f, 19.412f),
                    PathNode.CurveTo(19.040854f, 19.788322f, 18.53137f, 19.999887f, 18.0f, 20.0f),
                    PathNode.LineTo(6.0f, 20.0f),
                    PathNode.CurveTo(4.895431f, 20.0f, 4.0f, 19.10457f, 4.0f, 18.0f),
                    PathNode.LineTo(4.0f, 6.0f),
                    PathNode.CurveTo(4.0f, 5.448f, 4.224f, 4.948f, 4.586f, 4.586f)
                ),
