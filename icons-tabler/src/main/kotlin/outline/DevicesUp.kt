...
val TablerIcons.Outline.DevicesUp: ImageVector
    get() {
        if (_devicesUp != null) return _devicesUp!!
        _devicesUp = tablerOutlineIcon(
            name = "DevicesUp",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24f, height = 24f),
        ) {
            addPath(
                pathData = parseSvgPathData("M 13.000 16.500 L 13.000 9.000 C 13.000 8.448 13.448 8.000 14.000 8.000 L 20.000 8.000 C 20.552 8.000 21.000 8.448 21.000 9.000 L 21.000 12.500"),
