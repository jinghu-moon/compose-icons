...
val PhosphorIcons.Duotone.CalendarMinus: ImageVector
    get() {
        if (_calendarMinus != null) return _calendarMinus!!
        _calendarMinus = phosphorDuotoneIcon(
            name = "CalendarMinus",
