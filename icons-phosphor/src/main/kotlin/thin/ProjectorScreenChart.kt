        ...
        _projectorScreenChart = phosphorThinIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(98.20914f, 124.0f, 100.0f, 125.79086f, 100.0f, 128.0f),
                    PathNode.LineTo(100.0f, 144.0f),
                    PathNode.CurveTo(100.0f, 146.20914f, 98.20914f, 148.0f, 96.0f, 148.0f),
                    ...
                    PathNode.CurveTo(164.0f, 109.79086f, 162.20914f, 108.0f, 160.0f, 108.0f),
                    PathNode.CurveTo(157.79086f, 108.0f, 156.0f, 109.79086f, 156.0f, 112.0f),
                    PathNode.LineTo(156.0f, 144.0f),
                    PathNode.CurveTo(156.0f, 146.20914f, 157.79086f, 148.0f, 160.0f, 148.0f),
                    PathNode.Close,
                    PathNode.MoveTo(212.0f, 76.0f),
                    PathNode.LineTo(212.0f, 180.0f),
                    PathNode.LineTo(224.0f, 180.0f),
                    PathNode.CurveTo(226.20914f, 180.0f, 228.0f, 181.79086f, 228.0f, 184.0f),
                    PathNode.CurveTo(228.0f, 186.20914f, 226.20914f, 188.0f, 224.0f, 188.0f),
                    PathNode.LineTo(132.0f, 188.0f),
                    PathNode.LineTo(132.0f, 212.4f),
                    PathNode.CurveTo(142.05986f, 214.45346f, 148.93068f, 223.7908f, 147.89873f, 234.0061f),
                    PathNode.CurveTo(146.86678f, 244.2214f, 138.2673f, 251.99591f, 128.0f, 251.99591f),
                    PathNode.CurveTo(117.732704f, 251.99591f, 109.13323f, 244.2214f, 108.10128f, 234.0061f),
                    PathNode.CurveTo(107.06932f, 223.7908f, 113.94015f, 214.45346f, 124.0f, 212.4f),
                    ...
                    PathNode.CurveTo(121.37258f, 220.0f, 116.0f, 225.37259f, 116.0f, 232.0f),
                    ...
                    PathNode.CurveTo(140.0f, 225.37259f, 134.62741f, 220.0f, 128.0f, 220.0f),
                    PathNode.Close,
