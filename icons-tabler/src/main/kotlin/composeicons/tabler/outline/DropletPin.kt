...
val TablerIcons.Outline.DropletPin: ImageVector
    get() {
        ...
        _dropletPin = tablerOutlineIcon(
            ...
            addPathData("M18.064 10.877 13.174 3.617c-.42-.625-1.287-.803-1.936-.397-.163 .102-.303 .237-.41 .397L5.935 10.877c-1.695 2.838-1.035 6.441 1.567 8.546 1.437 1.155 3.265 1.712 5.102 1.554")
