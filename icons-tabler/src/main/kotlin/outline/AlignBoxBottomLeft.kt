...
val TablerIcons.Outline.AlignBoxBottomLeft: ImageVector
    get() {
        if (_alignBoxBottomLeft != null) return _alignBoxBottomLeft!!
        _alignBoxBottomLeft = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 7.000 15.000 L 7.000 17.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 13.000 13.000 L 13.000 17.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
