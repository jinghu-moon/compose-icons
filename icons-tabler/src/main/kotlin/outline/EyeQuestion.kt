...
val TablerIcons.Outline.EyeQuestion: ImageVector
    get() {
        ...
        _eyeQuestion = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 14.071 17.764 C 13.392 17.923 12.697 18.002 12.000 18.000 C 8.400 18.000 5.400 16.000 3.000 12.000 C 5.400 8.000 8.400 6.000 12.000 6.000 C 15.346 6.000 18.173 7.727 20.482 11.182"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
