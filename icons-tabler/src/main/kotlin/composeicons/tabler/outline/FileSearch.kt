...
val TablerIcons.Outline.FileSearch: ImageVector
    get() {
        ...
        _fileSearch = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(14.0f, 17.5f),
                    PathNode.CurveTo(14.0f, 18.880713f, 15.119288f, 20.0f, 16.5f, 20.0f),
                    PathNode.CurveTo(17.880713f, 20.0f, 19.0f, 18.880713f, 19.0f, 17.5f),
                    PathNode.CurveTo(19.0f, 16.119287f, 17.880713f, 15.0f, 16.5f, 15.0f),
                    PathNode.CurveTo(15.119288f, 15.0f, 14.0f, 16.119287f, 14.0f, 17.5f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
