...
val TablerIcons.Outline.LoadBalancer: ImageVector
    get() {
        ...
        _loadBalancer = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(14.894f, 12.227f),
                    PathNode.LineTo(21.004f, 10.003f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(17.159f, 8.21f),
                    PathNode.LineTo(21.004f, 10.003f),
                    PathNode.LineTo(19.211f, 13.848f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(9.101f, 12.214f),
                    PathNode.LineTo(3.026f, 10.003f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(6.871f, 8.21f),
                    PathNode.LineTo(3.026f, 10.003f),
                    PathNode.LineTo(4.819f, 13.848f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
