        ...
        _hierarchy3 = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(14.0f, 17.89543f, 13.104569f, 17.0f, 12.0f, 17.0f),
                    PathNode.CurveTo(10.895431f, 17.0f, 10.0f, 17.89543f, 10.0f, 19.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(18.0f, 20.10457f, 18.89543f, 21.0f, 20.0f, 21.0f),
                    PathNode.CurveTo(21.10457f, 21.0f, 22.0f, 20.10457f, 22.0f, 19.0f),
                    PathNode.CurveTo(22.0f, 17.89543f, 21.10457f, 17.0f, 20.0f, 17.0f),
                    PathNode.CurveTo(18.89543f, 17.0f, 18.0f, 17.89543f, 18.0f, 19.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(5.10457f, 21.0f, 6.0f, 20.10457f, 6.0f, 19.0f),
                    PathNode.CurveTo(6.0f, 17.89543f, 5.10457f, 17.0f, 4.0f, 17.0f),
                    PathNode.CurveTo(2.895431f, 17.0f, 2.0f, 17.89543f, 2.0f, 19.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(14.895431f, 10.0f, 14.0f, 10.895431f, 14.0f, 12.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
