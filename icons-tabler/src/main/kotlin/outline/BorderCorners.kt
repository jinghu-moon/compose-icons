...
val TablerIcons.Outline.BorderCorners: ImageVector
    get() {
        ...
        _borderCorners = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 20.000 16.000 L 20.000 18.000 C 20.000 19.105 19.105 20.000 18.000 20.000 L 16.000 20.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 8.000 20.000 L 6.000 20.000 C 4.895 20.000 4.000 19.105 4.000 18.000 L 4.000 16.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
