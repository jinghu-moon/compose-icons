...
val PhosphorIcons.Duotone.Sticker: ImageVector
    get() {
        if (_sticker != null) return _sticker!!
        _sticker = phosphorDuotoneIcon(
            name = "Sticker",
            ...
            group(
                ...
                addPath(
                    pathData = parseSvgPathData("M 216.000 136.000 C 208.000 160.000 160.000 208.000 136.000 216.000 L 136.000 184.000 C 136.000 157.490 157.490 136.000 184.000 136.000 Z"),
