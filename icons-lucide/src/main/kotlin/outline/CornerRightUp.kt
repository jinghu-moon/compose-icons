...
val LucideIcons.Outline.CornerRightUp: ImageVector
    get() {
        ...
        _cornerRightUp = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 10.000 9.000 L 15.000 4.000 L 20.000 9.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 4.000 20.000 L 11.000 20.000 C 13.209 20.000 15.000 18.209 15.000 16.000 L 15.000 4.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
