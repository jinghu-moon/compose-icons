...
val LucideIcons.Outline.Move3D: ImageVector
    get() {
        ...
        _move3D = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 5.000 3.000 L 5.000 19.000 L 21.000 19.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 5.000 19.000 L 11.000 13.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 2.000 6.000 L 5.000 3.000 L 8.000 6.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
