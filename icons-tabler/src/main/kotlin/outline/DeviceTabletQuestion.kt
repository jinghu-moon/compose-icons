...
val TablerIcons.Outline.DeviceTabletQuestion: ImageVector
    get() {
        ...
        _deviceTabletQuestion = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 15.000 21.000 L 6.000 21.000 C 5.448 21.000 5.000 20.552 5.000 20.000 L 5.000 4.000 C 5.000 3.448 5.448 3.000 6.000 3.000 L 18.000 3.000 C 18.552 3.000 19.000 3.448 19.000 4.000 L 19.000 11.000"),
