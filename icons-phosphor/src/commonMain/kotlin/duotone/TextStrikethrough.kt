        ...
        _textStrikethrough = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(120.69f, 123.05f),
                    PathNode.CurveTo(96.69f, 116.35f, 75.11f, 108.79f, 75.11f, 88.05f),
                    PathNode.CurveTo(75.11f, 65.96f, 97.11f, 48.05f, 128.0f, 48.05f),
                    PathNode.CurveTo(151.2f, 48.0f, 168.37f, 57.64f, 176.0f, 72.0f),
                    PathNode.Close,
                    PathNode.MoveTo(120.69f, 123.05f),
                    PathNode.LineTo(72.0f, 168.0f),
                    PathNode.CurveTo(72.0f, 190.09f, 97.07f, 208.0f, 128.0f, 208.0f),
                    PathNode.CurveTo(158.93f, 208.0f, 184.0f, 190.09f, 184.0f, 168.0f),
                    PathNode.CurveTo(184.0f, 138.43f, 150.52f, 131.4f, 120.69f, 123.05f),
                    PathNode.Close
                ),
