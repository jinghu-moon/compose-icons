...
val PhosphorIcons.Duotone.HighDefinition: ImageVector
    get() {
        if (_highDefinition != null) return _highDefinition!!
        _highDefinition = phosphorDuotoneIcon(
            name = "HighDefinition",
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(206.92795f, 184.0f, 232.0f, 158.92795f, 232.0f, 128.0f),
                    PathNode.CurveTo(232.0f, 97.07206f, 206.92795f, 72.0f, 176.0f, 72.0f),
                    PathNode.Close,
                    ...
                    PathNode.CurveTo(52.418278f, 72.0f, 56.0f, 75.58172f, 56.0f, 80.0f),
