        ...
        _fileCv = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(11.0f, 11.671573f, 10.328427f, 11.0f, 9.5f, 11.0f),
                    PathNode.CurveTo(8.671573f, 11.0f, 8.0f, 11.671573f, 8.0f, 12.5f),
                    PathNode.LineTo(8.0f, 15.5f),
                    PathNode.CurveTo(8.0f, 16.328426f, 8.671573f, 17.0f, 9.5f, 17.0f),
                    PathNode.CurveTo(10.328427f, 17.0f, 11.0f, 16.328426f, 11.0f, 15.5f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
