...
val PhosphorIcons.Duotone.Bird: ImageVector
    get() {
        ...
        _bird = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M232 80 208 96v24c0 53.019-42.981 96-96 96h-88c-3.077 .002-5.882-1.761-7.215-4.534-1.333-2.773-.958-6.065 .965-8.466L104 99.52v-22.63C104 48.12 127 24.14 155.74 24c23.77-.123 44.597 15.888 50.59 38.89Z"),
