...
val LucideIcons.Outline.GitPullRequestCreateArrow: ImageVector
    get() {
        ...
        _gitPullRequestCreateArrow = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 6.000 L 17.000 6.000 C 18.105 6.000 19.000 6.895 19.000 8.000 L 19.000 11.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 22.000 18.000 L 16.000 18.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
