...
val PhosphorIcons.Duotone.Link: ImageVector
    get() {
        ...
        _link = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(218.34f, 119.6f),
                    PathNode.LineTo(183.6f, 154.34f),
                    PathNode.CurveTo(172.01625f, 165.93881f, 155.18832f, 170.59488f, 139.29f, 166.6f),
                    PathNode.CurveTo(138.98f, 166.94f, 138.67f, 167.27f, 138.34f, 167.6f),
                    PathNode.LineTo(103.6f, 202.34f),
                    PathNode.CurveTo(91.86932f, 214.35658f, 74.58335f, 219.13736f, 58.34518f, 214.85611f),
                    PathNode.CurveTo(42.107014f, 210.57487f, 29.425129f, 197.89299f, 25.143887f, 181.65482f),
                    PathNode.CurveTo(20.862646f, 165.41666f, 25.643421f, 148.13069f, 37.66f, 136.4f),
                    PathNode.LineTo(72.4f, 101.66f),
                    PathNode.CurveTo(83.98584f, 90.06475f, 100.81172f, 85.40925f, 116.71f, 89.4f),
                    PathNode.CurveTo(117.02f, 89.06f, 117.33f, 88.73f, 117.71f, 88.4f),
                    PathNode.LineTo(152.4f, 53.66f),
                    PathNode.CurveTo(170.67137f, 35.823334f, 199.89014f, 35.99921f, 217.94547f, 54.054535f),
                    PathNode.CurveTo(236.0008f, 72.10986f, 236.17667f, 101.32863f, 218.34f, 119.6f),
                    PathNode.Close
                ),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(143.94084f, 137.83195f, 144.72746f, 139.89043f, 146.18668f, 141.43216f),
                    PathNode.CurveTo(147.64587f, 142.97388f, 149.658f, 143.87245f, 151.78f, 143.93f),
                    PathNode.LineTo(152.0f, 143.93f),
                    PathNode.CurveTo(156.33377f, 143.93164f, 159.88083f, 140.48213f, 160.0f, 136.15f),
                    PathNode.CurveTo(160.38539f, 121.141106f, 154.60268f, 106.63008f, 144.0f, 96.0f),
