...
val RemixIcons.Fill.SpotifyFill: ImageVector
    get() {
        ...
        _spotifyFill = remixIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M12.001 2C6.501 2 2.001 6.5 2.001 12c0 5.5 4.5 10 10 10 5.5 0 10-4.5 10-10C22.001 6.5 17.551 2 12.001 2ZM15.751 16.65C13.401 15.2 10.451 14.899 6.95 15.699c-.348 .102-.649-.149-.749-.449-.1-.351 .15-.65 .45-.75 3.8-.851 7.1-.5 9.7 1.1 .35 .15 .399 .549 .251 .85-.2 .299-.55 .4-.851 .2ZM16.75 13.95C14.051 12.3 9.951 11.8 6.801 12.8c-.399 .1-.85-.1-.95-.5-.1-.4 .1-.851 .5-.951 3.65-1.099 8.15-.548 11.25 1.351 .301 .151 .45 .65 .201 1-.251 .35-.701 .5-1.052 .25ZM6.301 9.751c-.5 .149-1-.151-1.15-.601-.15-.501 .15-1 .6-1.151C9.301 6.949 15.151 7.149 18.852 9.35c.449 .25 .599 .85 .349 1.3-.249 .351-.85 .499-1.299 .25C14.701 9 9.351 8.8 6.301 9.751Z"),
