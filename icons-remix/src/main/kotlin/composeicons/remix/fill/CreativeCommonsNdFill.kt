...
val RemixIcons.Fill.CreativeCommonsNdFill: ImageVector
    get() {
        ...
        _creativeCommonsNdFill = remixIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M12 2c5.523 0 10 4.477 10 10 0 5.523-4.477 10-10 10C6.477 22 2 17.523 2 12 2 6.477 6.477 2 12 2ZM16 13h-8v2h8v-2ZM16 9h-8v2h8v-2Z"),
