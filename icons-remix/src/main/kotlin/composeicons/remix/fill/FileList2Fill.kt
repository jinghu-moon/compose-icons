...
val RemixIcons.Fill.FileList2Fill: ImageVector
    get() {
        ...
        _fileList2Fill = remixIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M20 22h-16C3.448 22 3 21.552 3 21v-18C3 2.448 3.448 2 4 2h16c.552 0 1 .448 1 1v18c0 .552-.448 1-1 1ZM8 7v2h8v-2h-8ZM8 11v2h8v-2h-8ZM8 15v2h5v-2h-5Z"),
