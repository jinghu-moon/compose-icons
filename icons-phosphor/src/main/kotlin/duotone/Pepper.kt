...
val PhosphorIcons.Duotone.Pepper: ImageVector
    get() {
        ...
        _pepper = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(214.83f, 92.58f),
                    PathNode.LineTo(192.0f, 104.0f),
                    PathNode.LineTo(160.0f, 88.0f),
                    PathNode.LineTo(128.0f, 104.0f),
                    PathNode.LineTo(105.17f, 92.58f),
                    PathNode.CurveTo(110.56656f, 66.59555f, 133.46107f, 47.967323f, 160.0f, 47.967323f),
                    PathNode.CurveTo(186.53893f, 47.967323f, 209.43344f, 66.59555f, 214.83f, 92.58f),
                    PathNode.Close
                ),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(74.658936f, 217.0998f, 49.081074f, 216.62788f, 24.0f, 212.37f),
