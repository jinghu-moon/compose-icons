...
val PhosphorIcons.Duotone.RocketLaunch: ImageVector
    get() {
        ...
        _rocketLaunch = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M184 120v61.65c-.001 2.119-.843 4.151-2.34 5.65l-34.35 34.35c-2.144 2.139-5.311 2.884-8.184 1.925-2.872-.959-4.957-3.458-5.386-6.455L128 176ZM136 72h-61.65c-2.119 .001-4.151 .843-5.65 2.34L34.35 108.69c-2.139 2.144-2.884 5.311-1.925 8.184 .959 2.872 3.458 4.957 6.455 5.386L80 128ZM40 216c37.65 0 50.69-19.69 54.56-28.18L68.18 161.44C59.69 165.31 40 178.35 40 216Z"),
