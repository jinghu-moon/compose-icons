        ...
        _filePy = phosphorThinIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(77.25484f, 196.0f, 88.0f, 185.25484f, 88.0f, 172.0f),
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(151.39f, 154.12f),
                    PathNode.LineTo(132.0f, 185.12f),
                    PathNode.LineTo(132.0f, 208.0f),
                    PathNode.CurveTo(132.0f, 210.20914f, 130.20914f, 212.0f, 128.0f, 212.0f),
                    PathNode.CurveTo(125.79086f, 212.0f, 124.0f, 210.20914f, 124.0f, 208.0f),
                    PathNode.LineTo(124.0f, 185.15f),
                    PathNode.LineTo(104.61f, 154.15f),
                    PathNode.CurveTo(103.516426f, 152.28276f, 104.10604f, 149.88443f, 105.94071f, 148.73708f),
                    PathNode.CurveTo(107.77538f, 147.58974f, 110.18984f, 148.10942f, 111.39f, 149.91f),
                    PathNode.LineTo(128.0f, 176.45f),
                    PathNode.LineTo(144.61f, 149.88f),
                    PathNode.CurveTo(145.3462f, 148.62294f, 146.70763f, 147.86554f, 148.16393f, 147.9028f),
                    PathNode.CurveTo(149.62022f, 147.94006f, 150.94112f, 148.7661f, 151.61208f, 150.05916f),
                    PathNode.CurveTo(152.28304f, 151.35222f, 152.19797f, 152.90782f, 151.39f, 154.12f),
                    PathNode.Close
                ),
