...
val LucideIcons.Outline.Settings2: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 14.000 17.000 L 5.000 17.000"),
    ...
    addPath(
        pathData = parseSvgPathData("M 19.000 7.000 L 10.000 7.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 10.000 7.000 C 10.000 8.657 8.657 10.000 7.000 10.000 C 5.343 10.000 4.000 8.657 4.000 7.000 C 4.000 5.343 5.343 4.000 7.000 4.000 C 8.657 4.000 10.000 5.343 10.000 7.000 Z"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
