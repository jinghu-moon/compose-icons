...
val TablerIcons.Outline.BasketSearch: ImageVector
    get() {
        ...
        _basketSearch = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 13.483 12.658 C 12.924 12.042 12.042 11.835 11.268 12.140 C 10.494 12.445 9.990 13.198 10.001 14.029 C 10.013 14.861 10.539 15.599 11.321 15.882"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
