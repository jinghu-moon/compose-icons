        ...
        _currencyKroneCzech = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(8.5f, 12.0f, 11.0f, 9.0f, 11.0f, 6.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(5.0f, 12.0f),
                    PathNode.CurveTo(8.5f, 12.0f, 11.0f, 15.0f, 11.0f, 18.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(15.343145f, 12.0f, 14.0f, 13.343145f, 14.0f, 15.0f),
                    PathNode.CurveTo(14.0f, 16.656855f, 15.343145f, 18.0f, 17.0f, 18.0f),
