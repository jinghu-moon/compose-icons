...
val LucideIcons.Outline.FileTerminal: ImageVector
    get() {
        if (_fileTerminal != null) return _fileTerminal!!
        _fileTerminal = lucideOutlineIcon(
            name = "FileTerminal",
            ...
            addPath(
                pathData = parseSvgPathData("M 8.000 16.000 L 10.000 14.000 L 8.000 12.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 18.000 L 16.000 18.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
