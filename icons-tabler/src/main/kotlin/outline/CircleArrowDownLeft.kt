...
val TablerIcons.Outline.CircleArrowDownLeft: ImageVector
    get() {
        if (_circleArrowDownLeft != null) return _circleArrowDownLeft!!
        _circleArrowDownLeft = tablerOutlineIcon(
    ...
    addPath(
        pathData = parseSvgPathData("M 15.000 15.000 L 9.000 15.000 L 9.000 9.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
