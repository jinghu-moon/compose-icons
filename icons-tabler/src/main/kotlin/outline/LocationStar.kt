...
val TablerIcons.Outline.LocationStar: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 10.336 14.672 L 10.000 14.000 L 3.000 10.500 C 2.804 10.410 2.679 10.215 2.679 10.000 C 2.679 9.785 2.804 9.590 3.000 9.500 L 21.000 3.000 L 18.435 10.104"),
