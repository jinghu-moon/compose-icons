...
val TablerIcons.Outline.CircleCaretDown: ImageVector
    get() {
        if (_circleCaretDown != null) return _circleCaretDown!!
        _circleCaretDown = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 15.000 L 8.000 11.000 L 16.000 11.000 L 12.000 15.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
