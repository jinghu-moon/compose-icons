...
val TablerIcons.Outline.Badge5K: ImageVector
    get() {
        ...
        _badge5K = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 7.000 15.000 L 9.000 15.000 C 9.552 15.000 10.000 14.552 10.000 14.000 L 10.000 13.000 C 10.000 12.448 9.552 12.000 9.000 12.000 L 7.000 12.000 L 7.000 9.000 L 10.000 9.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
