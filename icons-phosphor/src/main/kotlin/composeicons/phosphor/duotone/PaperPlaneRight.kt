...
val PhosphorIcons.Duotone.PaperPlaneRight: ImageVector
    get() {
        ...
        _paperPlaneRight = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M227.91 134.86 59.93 231c-2.91 1.627-6.523 1.28-9.069-.872-2.546-2.152-3.491-5.658-2.371-8.798L80 128 48.49 34.72c-1.12-3.14-.176-6.645 2.371-8.798 2.546-2.152 6.16-2.5 9.069-.872l168 95.85c2.524 1.418 4.085 4.09 4.081 6.986-.004 2.896-1.573 5.563-4.101 6.974Z"),
