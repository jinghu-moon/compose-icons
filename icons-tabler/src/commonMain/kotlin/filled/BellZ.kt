        ...
        _bellZ = tablerFilledIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(9.379507f, 8.066316f, 9.000067f, 8.493025f, 9.0f, 9.0f),
                    PathNode.LineTo(9.007f, 9.117f),
                    PathNode.CurveTo(9.066316f, 9.620493f, 9.493025f, 9.999933f, 10.0f, 10.0f),
                    PathNode.LineTo(11.584f, 10.0f),
                    PathNode.LineTo(9.293f, 12.293f),
                    PathNode.LineTo(9.217f, 12.377f),
                    PathNode.CurveTo(8.703f, 13.014f, 9.147f, 14.0f, 10.0f, 14.0f),
                    ...
                    PathNode.LineTo(12.414f, 12.0f),
                    PathNode.LineTo(14.707f, 9.707f),
                    PathNode.LineTo(14.783f, 9.623f),
                    PathNode.CurveTo(15.297f, 8.986f, 14.853f, 8.0f, 14.0f, 8.0f),
                    PathNode.Close
                ),
                pathFillType = PathFillType.NonZero,
                fill = SolidColor(Color.Black),
