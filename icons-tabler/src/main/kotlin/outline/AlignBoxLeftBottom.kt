...
val TablerIcons.Outline.AlignBoxLeftBottom: ImageVector
    get() {
        if (_alignBoxLeftBottom != null) return _alignBoxLeftBottom!!
        _alignBoxLeftBottom = tablerOutlineIcon(
    ...
    addPath(
        pathData = parseSvgPathData("M 13.000 14.000 L 7.000 14.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 11.000 11.000 L 7.000 11.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
