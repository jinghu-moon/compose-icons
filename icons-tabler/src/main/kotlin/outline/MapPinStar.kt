...
val TablerIcons.Outline.MapPinStar: ImageVector
    get() {
        ...
        _mapPinStar = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 15.000 11.000 C 15.000 9.462 13.836 8.174 12.306 8.016 C 10.777 7.859 9.376 8.885 9.063 10.390 C 8.750 11.896 9.626 13.395 11.092 13.860"),
            ...
            addPath(
                pathData = parseSvgPathData("M 11.059 21.250 C 10.885 21.157 10.726 21.039 10.587 20.900 L 6.343 16.657 C 3.820 14.134 3.273 10.244 5.003 7.123 C 6.732 4.002 10.320 2.403 13.797 3.205 C 17.275 4.007 19.801 7.014 19.989 10.578"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
