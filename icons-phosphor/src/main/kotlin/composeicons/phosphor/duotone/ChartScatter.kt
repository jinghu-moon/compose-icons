...
val PhosphorIcons.Duotone.ChartScatter: ImageVector
    get() {
        ...
        _chartScatter = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M232 208c0 4.418-3.582 8-8 8h-192c-4.418 0-8-3.582-8-8v-160c0-4.418 3.582-8 8-8 4.418 0 8 3.582 8 8v152h184c4.418 0 8 3.582 8 8ZM132 160c6.627 0 12-5.373 12-12 0-6.627-5.373-12-12-12-6.627 0-12 5.373-12 12 0 6.627 5.373 12 12 12ZM108 104c6.627 0 12-5.373 12-12 0-6.627-5.373-12-12-12-6.627 0-12 5.373-12 12 0 6.627 5.373 12 12 12ZM76 176c6.627 0 12-5.373 12-12 0-6.627-5.373-12-12-12-6.627 0-12 5.373-12 12 0 6.627 5.373 12 12 12ZM172 128c6.627 0 12-5.373 12-12 0-6.627-5.373-12-12-12-6.627 0-12 5.373-12 12 0 6.627 5.373 12 12 12ZM196 88c6.627 0 12-5.373 12-12 0-6.627-5.373-12-12-12-6.627 0-12 5.373-12 12 0 6.627 5.373 12 12 12ZM176 164c0 6.627 5.373 12 12 12 6.627 0 12-5.373 12-12 0-6.627-5.373-12-12-12-6.627 0-12 5.373-12 12Z"),
                pathFillType = PathFillType.NonZero,
                fill = SolidColor(Color(0xFF000000)),
                fillAlpha = 1f,
                stroke = null,
