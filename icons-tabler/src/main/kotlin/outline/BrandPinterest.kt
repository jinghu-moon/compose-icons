...
val TablerIcons.Outline.BrandPinterest: ImageVector
    get() {
        ...
        _brandPinterest = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 8.000 20.000 L 12.000 11.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 10.700 14.000 C 11.137 15.263 12.130 16.000 13.250 16.000 C 15.321 16.000 17.000 14.446 17.000 12.000 C 17.002 10.004 15.817 8.198 13.985 7.405 C 12.153 6.613 10.026 6.986 8.572 8.354 C 7.119 9.722 6.619 11.824 7.300 13.700"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
