...
val TablerIcons.Outline.BoxMultiple4: ImageVector
    get() {
        if (_boxMultiple4 != null) return _boxMultiple4!!
        _boxMultiple4 = tablerOutlineIcon(
            name = "BoxMultiple4",
            ...
            addPath(
                pathData = parseSvgPathData("M 15.000 14.000 L 15.000 6.000 L 11.000 12.000 L 16.000 12.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
