...
val RemixIcons.Fill.Forward15Fill: ImageVector
    get() {
        ...
        _forward15Fill = remixIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M12 2C6.477 2 2 6.477 2 12c0 5.523 4.477 10 10 10 5.523 0 10-4.477 10-10h-2c0 4.418-3.582 8-8 8C7.582 20 4 16.418 4 12 4 7.582 7.582 4 12 4c2.464 0 4.668 1.114 6.135 2.865L16.5 8.5h-4.5v4.25h2.875c.345 0 .625 .28 .625 .625 0 .345-.28 .625-.625 .625h-2.875v1.5h2.875c1.174 0 2.125-.951 2.125-2.125 0-1.174-.951-2.125-2.125-2.125h-1.375v-1.25h3.25v-1h5.25v-6L19.553 5.446C17.72 3.335 15.016 2 12 2ZM8.5 8.5h1.5v7h-1.5v-7Z"),
