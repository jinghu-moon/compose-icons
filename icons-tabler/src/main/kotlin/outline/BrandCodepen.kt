...
val TablerIcons.Outline.BrandCodepen: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 3.000 15.000 L 12.000 21.000 L 21.000 15.000 L 12.000 9.000 L 3.000 15.000"),
    ...
    addPath(
        pathData = parseSvgPathData("M 21.000 9.000 L 21.000 15.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
