...
val TablerIcons.Outline.ClipboardData: ImageVector
    get() {
        if (_clipboardData != null) return _clipboardData!!
        _clipboardData = tablerOutlineIcon(
            name = "ClipboardData",
    ...
    addPath(
        pathData = parseSvgPathData("M 9.000 17.000 L 9.000 13.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 12.000 17.000 L 12.000 16.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
