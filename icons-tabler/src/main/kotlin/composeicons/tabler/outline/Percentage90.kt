...
val TablerIcons.Outline.Percentage90: ImageVector
    get() {
        ...
        _percentage90 = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M12 3c4.442 0 8.22 3.241 8.895 7.632 .675 4.391-1.954 8.617-6.19 9.952C10.468 21.919 5.891 19.963 3.927 15.979 1.963 11.994 3.2 7.173 6.84 4.626L12 12v-9"),
