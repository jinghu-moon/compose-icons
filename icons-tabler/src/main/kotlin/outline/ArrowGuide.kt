...
val TablerIcons.Outline.ArrowGuide: ImageVector
    get() {
        ...
        _arrowGuide = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 7.000 19.000 L 10.000 19.000 C 11.105 19.000 12.000 18.105 12.000 17.000 L 12.000 9.000 C 12.000 7.895 12.895 7.000 14.000 7.000 L 21.000 7.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
