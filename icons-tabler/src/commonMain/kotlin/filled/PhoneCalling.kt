        ...
        _phoneCalling = tablerFilledIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(16.0f, 7.01f),
                    PathNode.CurveTo(16.0f, 7.562285f, 15.552285f, 8.01f, 15.0f, 8.01f),
                    PathNode.CurveTo(14.447715f, 8.01f, 14.0f, 7.562285f, 14.0f, 7.01f),
                    PathNode.LineTo(14.0f, 7.0f),
                    PathNode.CurveTo(14.0f, 6.447716f, 14.447715f, 6.0f, 15.0f, 6.0f),
                    PathNode.CurveTo(15.552285f, 6.0f, 16.0f, 6.447716f, 16.0f, 7.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = SolidColor(Color.Black),
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(19.0f, 7.01f),
                    PathNode.CurveTo(19.0f, 7.562285f, 18.552284f, 8.01f, 18.0f, 8.01f),
                    PathNode.CurveTo(17.447716f, 8.01f, 17.0f, 7.562285f, 17.0f, 7.01f),
                    PathNode.LineTo(17.0f, 7.0f),
                    PathNode.CurveTo(17.0f, 6.447716f, 17.447716f, 6.0f, 18.0f, 6.0f),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(22.0f, 7.01f),
                    PathNode.CurveTo(22.0f, 7.562285f, 21.552284f, 8.01f, 21.0f, 8.01f),
                    PathNode.CurveTo(20.447716f, 8.01f, 20.0f, 7.562285f, 20.0f, 7.01f),
                    PathNode.LineTo(20.0f, 7.0f),
                    PathNode.CurveTo(20.0f, 6.447716f, 20.447716f, 6.0f, 21.0f, 6.0f),
