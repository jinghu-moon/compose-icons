...
val PhosphorIcons.Duotone.Handshake: ImageVector
    get() {
        ...
        _handshake = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M200 152l-40 40L96 176 40 136 72.68 70.63 128 56l55.32 14.63 .28 1.37h-39.6L98.34 116.29c-1.719 1.719-2.564 4.126-2.296 6.542 .268 2.416 1.621 4.579 3.676 5.878C117.23 139.9 141 139.13 160 120Z"),
