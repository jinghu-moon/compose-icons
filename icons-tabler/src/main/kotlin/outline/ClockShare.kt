...
val TablerIcons.Outline.ClockShare: ImageVector
    get() {
        ...
        _clockShare = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 20.943 13.016 C 21.365 9.304 19.450 5.718 16.131 4.004 C 12.812 2.289 8.779 2.804 5.996 5.296 C 3.214 7.788 2.260 11.740 3.599 15.227 C 4.938 18.714 8.292 21.011 12.028 21.000"),
