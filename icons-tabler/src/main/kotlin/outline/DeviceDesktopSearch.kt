...
val TablerIcons.Outline.DeviceDesktopSearch: ImageVector
    get() {
        if (_deviceDesktopSearch != null) return _deviceDesktopSearch!!
        _deviceDesktopSearch = tablerOutlineIcon(
            name = "DeviceDesktopSearch",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24.0f, height = 24.0f),
        ) {
    addPath(
        pathData = parseSvgPathData("M 11.500 16.000 L 4.000 16.000 C 3.448 16.000 3.000 15.552 3.000 15.000 L 3.000 5.000 C 3.000 4.448 3.448 4.000 4.000 4.000 L 20.000 4.000 C 20.552 4.000 21.000 4.448 21.000 5.000 L 21.000 11.500"),
    ...
    addPath(
        pathData = parseSvgPathData("M 7.000 20.000 L 11.000 20.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
