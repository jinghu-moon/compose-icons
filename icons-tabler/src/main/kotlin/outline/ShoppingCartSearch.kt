...
val TablerIcons.Outline.ShoppingCartSearch: ImageVector
    get() {
        if (_shoppingCartSearch != null) return _shoppingCartSearch!!
        _shoppingCartSearch = tablerOutlineIcon(
    ...
    addPath(
        pathData = parseSvgPathData("M 11.000 17.000 L 6.000 17.000 L 6.000 3.000 L 4.000 3.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 6.000 5.000 L 20.000 6.000 L 19.282 11.023M 13.000 13.000 L 6.000 13.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
