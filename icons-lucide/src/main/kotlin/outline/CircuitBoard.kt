...
val LucideIcons.Outline.CircuitBoard: ImageVector
    get() {
        ...
        _circuitBoard = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 11.000 9.000 L 15.000 9.000 C 16.105 9.000 17.000 8.105 17.000 7.000 L 17.000 3.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 7.000 21.000 L 7.000 17.000 C 7.000 15.895 7.895 15.000 9.000 15.000 L 13.000 15.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 17.000 15.000 C 17.000 16.105 16.105 17.000 15.000 17.000 C 13.895 17.000 13.000 16.105 13.000 15.000 C 13.000 13.895 13.895 13.000 15.000 13.000 C 16.105 13.000 17.000 13.895 17.000 15.000 Z"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
