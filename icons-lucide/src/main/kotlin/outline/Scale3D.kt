...
val LucideIcons.Outline.Scale3D: ImageVector
    get() {
        ...
        _scale3D = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 5.000 7.000 L 5.000 18.000 C 5.000 18.552 5.448 19.000 6.000 19.000 L 17.000 19.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 5.293 18.707 L 11.000 13.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
