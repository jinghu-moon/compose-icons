...
val PhosphorIcons.Duotone.MetaLogo: ImageVector
    get() {
        ...
        _metaLogo = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M128.49 114.6l-18.71 32.75C93.88 175.86 77.52 200 58.56 200-3.16 200 27.7 56 74 56c20.25 0 37.56 27.58 54.49 58.6ZM182 56c-12.62 0-24.1 10.7-35 26.27l-18.51 32.33C150.25 154.46 171.4 200 197.44 200 259.16 200 228.3 56 182 56Z"),
