...
val TablerIcons.Outline.MapEast: ImageVector
    get() {
        if (_mapEast != null) return _mapEast!!
        _mapEast = tablerOutlineIcon(
            name = "MapEast",
            ...
            addPath(
                pathData = parseSvgPathData("M 14.000 9.000 L 10.000 9.000 L 10.000 15.000 L 14.000 15.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
