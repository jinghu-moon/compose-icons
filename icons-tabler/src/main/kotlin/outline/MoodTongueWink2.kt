...
val TablerIcons.Outline.MoodTongueWink2: ImageVector
    get() {
        ...
        _moodTongueWink2 = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 10.000 14.000 L 10.000 16.000 C 10.000 17.105 10.895 18.000 12.000 18.000 C 13.105 18.000 14.000 17.105 14.000 16.000 L 14.000 14.000M 15.500 14.000 L 8.500 14.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 7.000 10.000 C 7.500 9.000 9.500 9.000 10.000 10.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
