...
val PhosphorIcons.Duotone.GraduationCap: ImageVector
    get() {
        ...
        _graduationCap = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(216.0f, 113.07f),
                    PathNode.LineTo(216.0f, 166.29f),
                    PathNode.CurveTo(216.00452f, 168.24492f, 215.29306f, 170.13382f, 214.0f, 171.6f),
                    PathNode.CurveTo(202.7f, 184.19f, 175.1f, 208.0f, 128.0f, 208.0f),
                    PathNode.CurveTo(80.9f, 208.0f, 53.32f, 184.19f, 42.0f, 171.6f),
                    PathNode.CurveTo(40.70694f, 170.13382f, 39.995487f, 168.24492f, 40.0f, 166.29f),
                    PathNode.LineTo(40.0f, 113.07f),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(176.0f, 244.41827f, 179.58173f, 248.0f, 184.0f, 248.0f),
                    PathNode.CurveTo(188.41827f, 248.0f, 192.0f, 244.41827f, 192.0f, 240.0f),
                    ...
                    PathNode.CurveTo(84.73f, 200.0f, 59.28f, 178.86f, 48.0f, 166.29f),
                    PathNode.LineTo(48.0f, 126.4f),
                    PathNode.LineTo(124.24f, 167.06f),
                    PathNode.CurveTo(126.59045f, 168.31155f, 129.40956f, 168.31155f, 131.76f, 167.06f),
                    PathNode.LineTo(176.0f, 143.47f),
                    PathNode.LineTo(176.0f, 189.81f),
                    PathNode.CurveTo(163.4f, 195.69f, 147.52f, 200.0f, 128.0f, 200.0f),
                    PathNode.Close,
                    PathNode.MoveTo(208.0f, 166.25f),
                    PathNode.CurveTo(203.20447f, 171.57146f, 197.83896f, 176.35011f, 192.0f, 180.5f),
                    PathNode.LineTo(192.0f, 134.93f),
                    PathNode.LineTo(208.0f, 126.4f),
                    PathNode.Close,
                    PathNode.MoveTo(188.0f, 118.94f),
                    PathNode.LineTo(187.78f, 118.81f),
                    PathNode.LineTo(131.78f, 88.94f),
                    PathNode.CurveTo(127.892876f, 86.95456f, 123.13175f, 88.45138f, 121.07999f, 92.3039f),
                    PathNode.CurveTo(119.02821f, 96.156425f, 120.44321f, 100.942505f, 124.26f, 103.06f),
