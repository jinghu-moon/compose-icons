        ...
        _layoutAlignLeft = tablerFilledIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(21.0f, 14.656855f, 19.656855f, 16.0f, 18.0f, 16.0f),
                    PathNode.LineTo(10.0f, 16.0f),
                    PathNode.CurveTo(8.343146f, 16.0f, 7.0f, 14.656855f, 7.0f, 13.0f),
                    PathNode.LineTo(7.0f, 11.0f),
                    PathNode.CurveTo(7.0f, 9.343145f, 8.343146f, 8.0f, 10.0f, 8.0f),
                    PathNode.Close
                ),
                pathFillType = PathFillType.NonZero,
                fill = SolidColor(Color.Black),
