...
val TablerIcons.Outline.DeviceDesktopCog: ImageVector
    get() {
        if (_deviceDesktopCog != null) return _deviceDesktopCog!!
        _deviceDesktopCog = tablerOutlineIcon(
            name = "DeviceDesktopCog",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24f, height = 24f),
        ) {
            addPath(
                pathData = parseSvgPathData("M 12.000 16.000 L 4.000 16.000 C 3.448 16.000 3.000 15.552 3.000 15.000 L 3.000 5.000 C 3.000 4.448 3.448 4.000 4.000 4.000 L 20.000 4.000 C 20.552 4.000 21.000 4.448 21.000 5.000 L 21.000 12.000"),
