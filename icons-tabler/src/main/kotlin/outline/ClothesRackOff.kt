...
val TablerIcons.Outline.ClothesRackOff: ImageVector
    get() {
        ...
        _clothesRackOff = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 7.000 L 12.000 8.000M 12.000 12.000 L 12.000 21.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 7.757 9.243 C 8.610 10.096 9.701 10.672 10.886 10.896M 14.464 10.472 C 15.127 10.173 15.729 9.757 16.243 9.243"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
