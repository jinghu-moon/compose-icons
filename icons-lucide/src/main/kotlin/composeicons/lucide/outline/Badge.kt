...
val LucideIcons.Outline.Badge: ImageVector
    get() {
        ...
        _badge = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M3.85 8.62C3.553 7.284 3.961 5.889 4.929 4.922 5.898 3.955 7.294 3.551 8.63 3.85 9.365 2.7 10.635 2.005 12 2.005c1.365 0 2.635 .696 3.37 1.845 1.338-.301 2.736 .105 3.706 1.074 .97 .97 1.375 2.368 1.074 3.706 1.15 .735 1.845 2.005 1.845 3.37 0 1.365-.696 2.635-1.845 3.37 .299 1.336-.105 2.732-1.072 3.701-.967 .969-2.362 1.376-3.698 1.079-.734 1.154-2.007 1.853-3.375 1.853-1.368 0-2.641-.699-3.375-1.853C7.294 20.449 5.898 20.045 4.929 19.078 3.961 18.111 3.553 16.716 3.85 15.38 2.691 14.647 1.989 13.371 1.989 12c0-1.371 .702-2.647 1.861-3.38Z"),
