        ...
        _fileScissors = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(16.0f, 16.447716f, 15.552285f, 16.0f, 15.0f, 16.0f),
                    PathNode.CurveTo(14.447715f, 16.0f, 14.0f, 16.447716f, 14.0f, 17.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(8.0f, 17.552284f, 8.447715f, 18.0f, 9.0f, 18.0f),
                    PathNode.CurveTo(9.552285f, 18.0f, 10.0f, 17.552284f, 10.0f, 17.0f),
                    PathNode.CurveTo(10.0f, 16.447716f, 9.552285f, 16.0f, 9.0f, 16.0f),
                    PathNode.CurveTo(8.447715f, 16.0f, 8.0f, 16.447716f, 8.0f, 17.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
