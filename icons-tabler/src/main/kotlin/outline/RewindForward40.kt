...
val TablerIcons.Outline.RewindForward40: ImageVector
    get() {
        if (_rewindForward40 != null) return _rewindForward40!!
        _rewindForward40 = tablerOutlineIcon(
            name = "RewindForward40",
    ...
    addPath(
        pathData = parseSvgPathData("M 9.000 14.000 L 9.000 16.000 C 9.000 16.552 9.448 17.000 10.000 17.000 L 11.000 17.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
