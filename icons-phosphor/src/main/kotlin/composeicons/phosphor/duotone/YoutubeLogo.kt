...
val PhosphorIcons.Duotone.YoutubeLogo: ImageVector
    get() {
        ...
        _youtubeLogo = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M226.59 71.53c-1.249-5.005-4.835-9.1-9.63-11C183.48 47.65 128 48 128 48c0 0-55.48-.35-89 12.58-4.795 1.9-8.381 5.995-9.63 11C27.07 80.54 24 98.09 24 128c0 29.91 3.07 47.46 5.41 56.47 1.255 4.977 4.822 9.05 9.59 10.95C72.52 208.35 128 208 128 208c0 0 55.48 .35 89-12.58 4.783-1.89 8.367-5.964 9.63-10.95 2.34-9 5.41-26.56 5.41-56.47 0-29.91-3.11-47.46-5.45-56.47ZM112 160v-64l48 32Z"),
