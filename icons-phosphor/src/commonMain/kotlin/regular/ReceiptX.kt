...
val PhosphorIcons.Regular.ReceiptX: ImageVector
    get() {
        if (_receiptX != null) return _receiptX!!
        _receiptX = phosphorRegularIcon(
            name = "ReceiptX",
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(216.0f, 195.06f),
                    PathNode.LineTo(195.58f, 184.84f),
                    PathNode.CurveTo(193.32652f, 183.71236f, 190.67348f, 183.71236f, 188.42f, 184.84f),
                    PathNode.LineTo(160.0f, 199.06f),
                    PathNode.LineTo(131.58f, 184.84f),
                    PathNode.CurveTo(129.32652f, 183.71236f, 126.67347f, 183.71236f, 124.42f, 184.84f),
                    PathNode.LineTo(96.0f, 199.06f),
                    PathNode.LineTo(67.58f, 184.84f),
                    PathNode.CurveTo(65.32653f, 183.71236f, 62.673473f, 183.71236f, 60.42f, 184.84f),
                    PathNode.LineTo(40.0f, 195.06f),
                    PathNode.LineTo(40.0f, 56.0f),
                    PathNode.LineTo(216.0f, 56.0f),
                    PathNode.Close,
                    PathNode.MoveTo(98.34f, 138.34f),
