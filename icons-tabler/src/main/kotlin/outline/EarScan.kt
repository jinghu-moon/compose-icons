...
val TablerIcons.Outline.EarScan: ImageVector
    get() {
        ...
        _earScan = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 15.000 15.000 C 15.000 16.105 14.105 17.000 13.000 17.000 C 12.268 17.000 11.445 16.753 11.280 16.020 C 10.646 13.220 8.110 13.392 8.000 11.000 L 8.000 10.500 C 7.999 8.859 9.139 7.438 10.740 7.082 C 12.342 6.726 13.976 7.530 14.671 9.017"),
            ...
            addPath(
                pathData = parseSvgPathData("M 13.000 12.000 L 13.000 12.010"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
