...
val PhosphorIcons.Duotone.ReadCvLogo: ImageVector
    get() {
        ...
        _readCvLogo = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M215.88 56.39l-29.75 169c-.368 2.09-1.552 3.948-3.29 5.165-1.739 1.217-3.89 1.694-5.98 1.325l-130.25-23c-4.348-.767-7.253-4.911-6.49-9.26L69.87 30.62c.368-2.09 1.552-3.948 3.29-5.165 1.739-1.217 3.89-1.694 5.98-1.325L209.39 47.13c4.348 .767 7.253 4.911 6.49 9.26Z"),
