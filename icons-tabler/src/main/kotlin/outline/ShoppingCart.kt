...
val TablerIcons.Outline.ShoppingCart: ImageVector
    get() {
        if (_shoppingCart != null) return _shoppingCart!!
        _shoppingCart = tablerOutlineIcon(
            name = "ShoppingCart",
    ...
    addPath(
        pathData = parseSvgPathData("M 17.000 17.000 L 6.000 17.000 L 6.000 3.000 L 4.000 3.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
