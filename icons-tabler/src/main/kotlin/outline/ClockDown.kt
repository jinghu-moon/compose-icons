...
val TablerIcons.Outline.ClockDown: ImageVector
    get() {
        ...
        _clockDown = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 20.984 12.535 C 21.206 8.802 19.097 5.321 15.686 3.789 C 12.274 2.258 8.271 2.996 5.630 5.642 C 2.988 8.289 2.258 12.294 3.797 15.702 C 5.335 19.111 8.821 21.213 12.553 20.983"),
