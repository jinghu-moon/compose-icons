        ...
        _flask = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(45.11654f, 216.0009f, 42.455704f, 214.45001f, 41.035374f, 211.94063f),
                    PathNode.CurveTo(39.615044f, 209.43124f, 39.655018f, 206.35167f, 41.14f, 203.88f),
                    PathNode.LineTo(71.62f, 153.08f),
                    PathNode.LineTo(71.62f, 153.08f),
                    PathNode.CurveTo(84.85f, 150.6f, 103.62f, 151.67f, 127.99f, 164.0f),
                    PathNode.CurveTo(160.24f, 180.33f, 182.74f, 176.91f, 195.49f, 171.65f),
                    PathNode.LineTo(195.49f, 171.65f),
                    PathNode.LineTo(214.83f, 203.88f),
                    PathNode.CurveTo(216.31224f, 206.34708f, 216.35503f, 209.42021f, 214.94203f, 211.9276f),
                    PathNode.CurveTo(213.52905f, 214.43498f, 210.8781f, 215.99011f, 208.0f, 216.0f),
                    PathNode.Close
                ),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(90.79f, 158.69f, 106.85f, 162.27f, 124.36f, 171.14f),
