...
val TablerIcons.Outline.BrandAmigo: ImageVector
    get() {
        ...
        _brandAmigo = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 9.591 3.635 L 2.461 17.717 C 0.749 21.097 4.220 23.167 6.151 21.290 L 8.011 19.480 C 11.153 16.426 12.970 16.490 16.050 19.590 L 17.379 20.927 C 19.751 23.314 23.244 21.005 21.555 17.702 L 14.360 3.635 C 13.246 1.455 10.694 1.455 9.590 3.635"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
