...
val TablerIcons.Outline.ArrowBearRight: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 12.000 3.000 L 17.000 3.000 L 17.000 8.000"),
    ...
    addPath(
        pathData = parseSvgPathData("M 17.000 3.000 L 9.464 10.536 C 8.527 11.473 8.000 12.745 8.000 14.070 L 8.000 21.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
