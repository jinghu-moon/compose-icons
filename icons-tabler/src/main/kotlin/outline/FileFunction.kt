...
val TablerIcons.Outline.FileFunction: ImageVector
    get() {
        ...
        _fileFunction = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 10.500 17.000 L 10.833 17.000 C 11.307 17.000 11.703 16.677 11.749 16.254 L 12.251 11.746 C 12.298 11.323 12.694 11.000 13.167 11.000 L 13.500 11.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 10.500 14.000 L 13.500 14.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
