        ...
        _buildingCircus = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(12.0f, 7.5f, 7.0f, 11.0f, 4.0f, 11.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(12.0f, 6.5f),
                    PathNode.CurveTo(12.0f, 7.5f, 17.0f, 11.0f, 20.0f, 11.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(5.667f, 16.333f, 5.0f, 19.667f, 4.0f, 21.0f),
                    PathNode.LineTo(8.0f, 21.0f),
                    PathNode.CurveTo(9.0f, 21.0f, 12.0f, 17.0f, 12.0f, 12.0f),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(18.333f, 16.333f, 19.0f, 19.667f, 20.0f, 21.0f),
                    PathNode.LineTo(16.0f, 21.0f),
                    PathNode.CurveTo(15.0f, 21.0f, 12.0f, 17.0f, 12.0f, 12.0f),
                    PathNode.LineTo(12.0f, 11.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
