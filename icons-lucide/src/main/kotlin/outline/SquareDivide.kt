...
val LucideIcons.Outline.SquareDivide: ImageVector
    get() {
        if (_squareDivide != null) return _squareDivide!!
        _squareDivide = lucideOutlineIcon(
            name = "SquareDivide",
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 16.000 L 12.000 16.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 8.000 L 12.000 8.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
