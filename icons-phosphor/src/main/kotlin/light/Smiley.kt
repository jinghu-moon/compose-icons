        ...
        _smiley = phosphorLightIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(97.52285f, 118.0f, 102.0f, 113.52285f, 102.0f, 108.0f),
                    PathNode.CurveTo(102.0f, 102.47715f, 97.52285f, 98.0f, 92.0f, 98.0f),
                    PathNode.CurveTo(86.47715f, 98.0f, 82.0f, 102.47715f, 82.0f, 108.0f),
                    PathNode.CurveTo(82.0f, 113.52285f, 86.47715f, 118.0f, 92.0f, 118.0f),
                    PathNode.Close,
                    PathNode.MoveTo(164.0f, 98.0f),
                    PathNode.CurveTo(158.47716f, 98.0f, 154.0f, 102.47715f, 154.0f, 108.0f),
                    PathNode.CurveTo(154.0f, 113.52285f, 158.47716f, 118.0f, 164.0f, 118.0f),
                    PathNode.CurveTo(169.52284f, 118.0f, 174.0f, 113.52285f, 174.0f, 108.0f),
                    PathNode.CurveTo(174.0f, 102.47715f, 169.52284f, 98.0f, 164.0f, 98.0f),
                    PathNode.Close
                ),
