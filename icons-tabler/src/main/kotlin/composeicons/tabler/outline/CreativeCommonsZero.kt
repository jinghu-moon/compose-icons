        ...
        _creativeCommonsZero = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(9.0f, 14.209139f, 10.343145f, 16.0f, 12.0f, 16.0f),
                    PathNode.CurveTo(13.656855f, 16.0f, 15.0f, 14.209139f, 15.0f, 12.0f),
                    PathNode.CurveTo(15.0f, 9.790861f, 13.656855f, 8.0f, 12.0f, 8.0f),
                    PathNode.CurveTo(10.343145f, 8.0f, 9.0f, 9.790861f, 9.0f, 12.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
