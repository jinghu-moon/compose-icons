...
val PhosphorIcons.Duotone.Moped: ImageVector
    get() {
        ...
        _moped = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(131.0f, 168.0f),
                    PathNode.LineTo(8.0f, 168.0f),
                    PathNode.CurveTo(7.993572f, 147.65285f, 20.816523f, 129.51237f, 40.0f, 122.73f),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(16.81f, 160.0f),
                    PathNode.CurveTo(19.625458f, 146.2435f, 29.43631f, 134.96443f, 42.67f, 130.27f),
                    PathNode.CurveTo(45.8642f, 129.13908f, 47.99945f, 126.1185f, 48.0f, 122.73f),
                    PathNode.LineTo(48.0f, 104.0f),
                    PathNode.LineTo(98.46f, 104.0f),
                    PathNode.LineTo(119.46f, 160.0f),
                    PathNode.Close,
