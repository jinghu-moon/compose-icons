...
val PhosphorIcons.Duotone.Cardholder: ImageVector
    get() {
        ...
        _cardholder = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M224 72v48h-64c0 17.673-14.327 32-32 32C110.327 152 96 137.673 96 120h-64v-48C32 63.163 39.163 56 48 56h160c8.837 0 16 7.163 16 16Z"),
