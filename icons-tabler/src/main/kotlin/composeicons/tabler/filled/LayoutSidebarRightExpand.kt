...
val TablerIcons.Filled.LayoutSidebarRightExpand: ImageVector
    get() {
        ...
        _layoutSidebarRightExpand = tablerFilledIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M18 3c1.589-0 2.902 1.238 2.995 2.824L21 6v12c0 1.589-1.238 2.902-2.824 2.995L18 21h-12C4.411 21 3.098 19.762 3.005 18.176L3 18v-12C3 4.411 4.238 3.098 5.824 3.005L6 3h12ZM15 5h-9c-.507 0-.934 .38-.993 .883L5 6v12c0 .507 .38 .934 .883 .993L6 19h9v-14ZM11.707 9.293c.356 .356 .392 .922 .083 1.32l-.083 .094L10.415 12l1.292 1.293c.356 .356 .392 .922 .083 1.32l-.083 .094c-.356 .356-.922 .392-1.32 .083l-.094-.083-2-2c-.356-.356-.392-.922-.083-1.32l.083-.094 2-2c.391-.39 1.023-.39 1.414 0Z"),
