...
val TablerIcons.Outline.CameraUp: ImageVector
    get() {
        if (_cameraUp != null) return _cameraUp!!
        _cameraUp = tablerOutlineIcon(
            name = "CameraUp",
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 16.000 C 13.657 16.000 15.000 14.657 15.000 13.000 C 15.000 11.343 13.657 10.000 12.000 10.000 C 10.343 10.000 9.000 11.343 9.000 13.000 C 9.000 14.657 10.343 16.000 12.000 16.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
