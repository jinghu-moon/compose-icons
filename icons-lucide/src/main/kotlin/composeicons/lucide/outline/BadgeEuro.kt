...
val LucideIcons.Outline.BadgeEuro: ImageVector
    get() {
        if (_badgeEuro != null) return _badgeEuro!!
        _badgeEuro = lucideOutlineIcon(
            name = "BadgeEuro",
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(15.0f, 9.4f),
                    PathNode.CurveTo(13.911466f, 8.127363f, 12.145381f, 7.667537f, 10.574432f, 8.247738f),
                    PathNode.CurveTo(9.003485f, 8.827939f, 7.960264f, 10.325333f, 7.960264f, 12.0f),
                    PathNode.CurveTo(7.960264f, 13.674667f, 9.003485f, 15.172061f, 10.574432f, 15.752262f),
                    PathNode.CurveTo(12.145381f, 16.332464f, 13.911466f, 15.872638f, 15.0f, 14.6f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
