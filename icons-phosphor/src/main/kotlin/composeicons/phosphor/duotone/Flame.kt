...
val PhosphorIcons.Duotone.Flame: ImageVector
    get() {
        ...
        _flame = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M208 144c.014 43.391-34.564 78.883-77.94 80 21.283-1.098 37.968-18.689 37.94-40 0-40-40-64-40-64 0 0-40 24-40 64-.028 21.311 16.657 38.902 37.94 40C82.564 222.883 47.986 187.391 48 144 48 72 128 24 128 24c0 0 80 48 80 120Z"),
