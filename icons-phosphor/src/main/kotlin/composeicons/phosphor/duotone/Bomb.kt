...
val PhosphorIcons.Duotone.Bomb: ImageVector
    get() {
        ...
        _bomb = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M192 160c-.009 39.953-29.494 73.774-69.073 79.231C83.348 244.689 45.811 220.108 34.99 181.648 24.169 143.188 43.382 102.641 80 86.66v-14.66c0-4.418 3.582-8 8-8h48c4.418 0 8 3.582 8 8v14.66c29.16 12.727 48.007 41.523 48 73.34Z"),
