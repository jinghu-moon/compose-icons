...
val TablerIcons.Outline.MessageCircleHeart: ImageVector
    get() {
        ...
        _messageCircleHeart = tablerOutlineIcon(
            ...
            addPathData("M10.59 19.88C9.587 19.738 8.612 19.442 7.7 19L3 20 4.3 16.1C1.976 12.663 2.874 8.228 6.4 5.726 9.926 3.225 14.99 3.43 18.245 6.206c1.565 1.335 2.479 3.065 2.71 4.861")
