...
val TablerIcons.Outline.CircleArrowUpLeft: ImageVector
    get() {
        if (_circleArrowUpLeft != null) return _circleArrowUpLeft!!
        _circleArrowUpLeft = tablerOutlineIcon(
    ...
    addPath(
        pathData = parseSvgPathData("M 15.000 9.000 L 9.000 9.000 L 9.000 15.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
