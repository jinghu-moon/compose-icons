...
val LucideIcons.Outline.Ticket: ImageVector
    get() {
        if (_ticket != null) return _ticket!!
        _ticket = lucideOutlineIcon(
            name = "Ticket",
    ...
    addPath(
        pathData = parseSvgPathData("M 13.000 5.000 L 13.000 7.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 13.000 17.000 L 13.000 19.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 13.000 11.000 L 13.000 13.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
