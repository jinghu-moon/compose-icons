...
val TablerIcons.Filled.LayoutDistributeVertical: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 13.000 5.000 C 14.657 5.000 16.000 6.343 16.000 8.000 L 16.000 16.000 C 16.000 17.657 14.657 19.000 13.000 19.000 L 11.000 19.000 C 9.343 19.000 8.000 17.657 8.000 16.000 L 8.000 8.000 C 8.000 6.343 9.343 5.000 11.000 5.000 Z"),
        pathFillType = PathFillType.NonZero,
        fill = SolidColor(Color(0xFF000000)),
        fillAlpha = 1.0f,
        stroke = null,
