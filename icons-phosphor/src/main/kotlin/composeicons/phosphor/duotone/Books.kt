...
val PhosphorIcons.Duotone.Books: ImageVector
    get() {
        ...
        _books = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M48 72h64v112h-64ZM190.64 38.39c-.43-2.087-1.675-3.916-3.458-5.081-1.783-1.166-3.958-1.572-6.042-1.129l-46.81 10c-4.332 .957-7.079 5.232-6.15 9.57L139.79 107 202.25 93.58Z"),
