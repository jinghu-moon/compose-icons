...
val PhosphorIcons.Duotone.PaypalLogo: ImageVector
    get() {
        ...
        _paypalLogo = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M191.91 82.7c-.18 3.016-.639 6.009-1.37 8.94h0C185.201 112.999 166.016 127.987 144 128h-36c-3.671 .001-6.87 2.499-7.76 6.06l12-48c.89-3.561 4.089-6.059 7.76-6.06h56c5.417 0 10.796 .913 15.91 2.7Z"),
