...
val TablerIcons.Outline.FileSettings: ImageVector
    get() {
        ...
        _fileSettings = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(15.031f, 12.25f),
                    PathNode.LineTo(13.732f, 13.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(10.268f, 15.0f),
                    PathNode.LineTo(8.968f, 15.75f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(15.0f, 15.803f),
                    PathNode.LineTo(13.715f, 15.03f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(10.285f, 12.97f),
                    PathNode.LineTo(9.0f, 12.197f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
