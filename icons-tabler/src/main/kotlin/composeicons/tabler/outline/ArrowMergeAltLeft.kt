...
val TablerIcons.Outline.ArrowMergeAltLeft: ImageVector
    get() {
        ...
        _arrowMergeAltLeft = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(18.0f, 18.01f),
                    PathNode.LineTo(18.0f, 18.02f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(17.0f, 15.02f),
                    PathNode.LineTo(17.0f, 15.03f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(14.0f, 13.03f),
                    PathNode.LineTo(14.0f, 13.04f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
