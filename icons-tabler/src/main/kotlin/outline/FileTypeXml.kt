...
val TablerIcons.Outline.FileTypeXml: ImageVector
    get() {
        ...
        _fileTypeXml = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 19.000 15.000 L 19.000 21.000 L 22.000 21.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 11.000 21.000 L 11.000 15.000 L 13.500 18.000 L 16.000 15.000 L 16.000 21.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
