...
val TablerIcons.Outline.DatabaseCog: ImageVector
    get() {
        ...
        _databaseCog = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 4.000 6.000 L 4.000 12.000 C 4.000 13.657 7.582 15.000 12.000 15.000 C 12.210 15.000 12.420 14.997 12.626 14.990"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 20.000 11.500 L 20.000 6.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
