...
val PhosphorIcons.Duotone.SteeringWheel: ImageVector
    get() {
        ...
        _steeringWheel = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M222.4 145.55c-.911 4.909-2.202 9.74-3.86 14.45h-53c-3.338-.004-6.328 2.065-7.5 5.19l-21.9 58.47c-2.69 .22-5.41 .34-8.15 .34-2.74 0-5.5-.12-8.2-.35L97.94 165.2C96.772 162.074 93.787 160.002 90.45 160h-53c-1.658-4.71-2.949-9.541-3.86-14.45 24.246-26.478 58.498-41.556 94.4-41.556 35.902 0 70.154 15.078 94.4 41.556Z"),
