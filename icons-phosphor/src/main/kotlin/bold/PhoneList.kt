        ...
        _phoneList = phosphorBoldIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(89.64635f, 31.898012f, 81.20247f, 27.082806f, 72.42f, 28.15f),
                    ...
                    PathNode.CurveTo(132.0f, 57.37258f, 137.37259f, 52.0f, 144.0f, 52.0f),
                    PathNode.LineTo(208.0f, 52.0f),
                    PathNode.CurveTo(214.62741f, 52.0f, 220.0f, 57.37258f, 220.0f, 64.0f),
                    PathNode.CurveTo(220.0f, 70.62742f, 214.62741f, 76.0f, 208.0f, 76.0f),
                    PathNode.LineTo(144.0f, 76.0f),
                    PathNode.CurveTo(137.37259f, 76.0f, 132.0f, 70.62742f, 132.0f, 64.0f),
                    PathNode.Close,
                    PathNode.MoveTo(132.0f, 104.0f),
                    PathNode.CurveTo(132.0f, 97.37258f, 137.37259f, 92.0f, 144.0f, 92.0f),
                    ...
                    PathNode.CurveTo(137.37259f, 116.0f, 132.0f, 110.62742f, 132.0f, 104.0f),
                    PathNode.Close
                ),
