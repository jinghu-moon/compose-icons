        ...
        _batteryVerticalFull = phosphorLightIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(92.686295f, 74.0f, 90.0f, 76.686295f, 90.0f, 80.0f),
                    PathNode.CurveTo(90.0f, 83.313705f, 92.686295f, 86.0f, 96.0f, 86.0f),
                    PathNode.LineTo(160.0f, 86.0f),
                    PathNode.CurveTo(163.3137f, 86.0f, 166.0f, 83.313705f, 166.0f, 80.0f),
                    PathNode.CurveTo(166.0f, 76.686295f, 163.3137f, 74.0f, 160.0f, 74.0f),
                    PathNode.Close,
