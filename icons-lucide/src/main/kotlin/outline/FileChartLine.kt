...
val LucideIcons.Outline.FileChartLine: ImageVector
    get() {
        if (_fileChartLine != null) return _fileChartLine!!
        _fileChartLine = lucideOutlineIcon(
            name = "FileChartLine",
    ...
    addPath(
        pathData = parseSvgPathData("M 16.000 13.000 L 12.500 16.500 L 10.500 14.500 L 8.000 17.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
