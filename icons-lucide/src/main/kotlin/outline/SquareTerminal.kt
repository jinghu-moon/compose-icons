...
val LucideIcons.Outline.SquareTerminal: ImageVector
    get() {
        if (_squareTerminal != null) return _squareTerminal!!
        _squareTerminal = lucideOutlineIcon(
            name = "SquareTerminal",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24f, height = 24f),
        ) {
            addPath(
                pathData = parseSvgPathData("M 7.000 11.000 L 9.000 9.000 L 7.000 7.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 11.000 13.000 L 15.000 13.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
