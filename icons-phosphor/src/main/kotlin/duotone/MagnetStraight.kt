...
val PhosphorIcons.Duotone.MagnetStraight: ImageVector
    get() {
        if (_magnetStraight != null) return _magnetStraight!!
        _magnetStraight = phosphorDuotoneIcon(
            name = "MagnetStraight",
    ...
    group(
        ...
        addPath(
            pathData = parseSvgPathData("M 104.000 56.000 L 104.000 96.000 L 48.000 96.000 L 48.000 56.000 C 48.000 51.582 51.582 48.000 56.000 48.000 L 96.000 48.000 C 100.418 48.000 104.000 51.582 104.000 56.000 ZM 200.000 48.000 L 160.000 48.000 C 155.582 48.000 152.000 51.582 152.000 56.000 L 152.000 96.000 L 208.000 96.000 L 208.000 56.000 C 208.000 51.582 204.418 48.000 200.000 48.000 Z"),
