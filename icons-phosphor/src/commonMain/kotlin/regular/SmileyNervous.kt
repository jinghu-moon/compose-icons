        ...
        _smileyNervous = phosphorRegularIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(88.94f, 150.74f, 94.0f, 144.0f, 104.0f, 144.0f),
                    PathNode.CurveTo(114.0f, 144.0f, 119.06f, 150.74f, 122.4f, 155.2f),
                    PathNode.CurveTo(125.4f, 159.2f, 126.32f, 160.0f, 128.0f, 160.0f),
                    PathNode.CurveTo(129.68f, 160.0f, 130.57f, 159.24f, 133.6f, 155.2f),
                    PathNode.CurveTo(136.94f, 150.74f, 142.0f, 144.0f, 152.0f, 144.0f),
                    PathNode.CurveTo(162.0f, 144.0f, 167.06f, 150.74f, 170.4f, 155.2f),
