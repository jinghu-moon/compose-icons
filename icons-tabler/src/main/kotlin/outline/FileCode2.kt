...
val TablerIcons.Outline.FileCode2: ImageVector
    get() {
        if (_fileCode2 != null) return _fileCode2!!
        _fileCode2 = tablerOutlineIcon(
            name = "FileCode2",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24f, height = 24f),
        ) {
            addPath(
                pathData = parseSvgPathData("M 10.000 12.000 L 9.000 12.000 L 9.000 17.000 L 10.000 17.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 14.000 12.000 L 15.000 12.000 L 15.000 17.000 L 14.000 17.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
