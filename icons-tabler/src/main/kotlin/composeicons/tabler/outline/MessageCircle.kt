...
val TablerIcons.Outline.MessageCircle: ImageVector
    get() {
        ...
        _messageCircle = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M3 20 4.3 16.1C1.976 12.663 2.874 8.228 6.4 5.726 9.926 3.225 14.99 3.43 18.245 6.206c3.255 2.777 3.695 7.266 1.029 10.501C16.608 19.942 11.659 20.922 7.7 19L3 20"),
