        ...
        _zodiacVirgo = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(13.0f, 18.761423f, 16.134007f, 21.0f, 20.0f, 21.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(15.865993f, 21.0f, 19.0f, 18.761423f, 19.0f, 16.0f),
                    PathNode.LineTo(19.0f, 14.0f),
                    PathNode.CurveTo(19.0f, 12.343145f, 17.656855f, 11.0f, 16.0f, 11.0f),
                    PathNode.CurveTo(14.343145f, 11.0f, 13.0f, 12.343145f, 13.0f, 14.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
