        ...
        _qrcodeOff = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.MoveTo(9.703f, 9.711f),
                    PathNode.CurveTo(9.515839f, 9.896107f, 9.263237f, 9.999949f, 9.0f, 10.0f),
                    PathNode.LineTo(5.0f, 10.0f),
                    PathNode.CurveTo(4.447716f, 10.0f, 4.0f, 9.552285f, 4.0f, 9.0f),
                    PathNode.LineTo(4.0f, 5.0f),
                    PathNode.CurveTo(4.0f, 4.725f, 4.11f, 4.476f, 4.29f, 4.295f)
                ),
