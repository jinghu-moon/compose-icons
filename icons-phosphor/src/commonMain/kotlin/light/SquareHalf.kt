        ...
        _squareHalf = phosphorLightIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(134.0f, 106.0f),
                    PathNode.LineTo(134.0f, 86.0f),
                    PathNode.LineTo(202.0f, 86.0f),
                    PathNode.LineTo(202.0f, 106.0f),
                    PathNode.Close,
                    PathNode.MoveTo(134.0f, 150.0f),
                    PathNode.LineTo(202.0f, 150.0f),
                    PathNode.LineTo(202.0f, 170.0f),
                    PathNode.LineTo(134.0f, 170.0f),
                    PathNode.Close,
                    PathNode.MoveTo(202.0f, 56.0f),
                    PathNode.LineTo(202.0f, 74.0f),
