...
val PhosphorIcons.Duotone.Trolley: ImageVector
    get() {
        if (_trolley != null) return _trolley!!
        _trolley = phosphorDuotoneIcon(
            name = "Trolley",
            ...
            group(
                ...
                addPath(
                    pathData = parseSvgPathData("M 240.000 88.000 L 240.000 184.000 L 48.000 184.000 L 48.000 72.000 L 224.000 72.000 C 232.837 72.000 240.000 79.163 240.000 88.000 Z"),
