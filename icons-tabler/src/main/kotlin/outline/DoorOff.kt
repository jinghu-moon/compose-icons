...
val TablerIcons.Outline.DoorOff: ImageVector
    get() {
        ...
        _doorOff = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 6.000 21.000 L 6.000 6.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 7.180 3.175 C 7.430 3.063 7.708 3.000 8.000 3.000 L 16.000 3.000 C 17.105 3.000 18.000 3.895 18.000 5.000 L 18.000 14.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
