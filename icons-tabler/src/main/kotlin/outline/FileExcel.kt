...
val TablerIcons.Outline.FileExcel: ImageVector
    get() {
        if (_fileExcel != null) return _fileExcel!!
        _fileExcel = tablerOutlineIcon(
            name = "FileExcel",
    ...
    addPath(
        pathData = parseSvgPathData("M 10.000 12.000 L 14.000 17.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 10.000 17.000 L 14.000 12.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
