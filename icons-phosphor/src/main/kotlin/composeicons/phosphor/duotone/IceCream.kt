...
val PhosphorIcons.Duotone.IceCream: ImageVector
    get() {
        ...
        _iceCream = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M216 120c0 8.837-7.163 16-16 16h-144c-8.837 0-16-7.163-16-16 0-8.837 7.163-16 16-16v-8C56 56.235 88.235 24 128 24c39.764 0 72 32.235 72 72v8c8.837 0 16 7.163 16 16Z"),
