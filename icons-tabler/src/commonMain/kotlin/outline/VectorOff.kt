...
val TablerIcons.Outline.VectorOff: ImageVector
    get() {
        ...
        _vectorOff = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(6.68f, 6.733f),
                    PathNode.CurveTo(6.495117f, 6.904573f, 6.252228f, 6.999943f, 6.0f, 7.0f),
                    PathNode.LineTo(4.0f, 7.0f),
                    PathNode.CurveTo(3.447715f, 7.0f, 3.0f, 6.552285f, 3.0f, 6.0f),
                    PathNode.LineTo(3.0f, 4.0f),
                    PathNode.CurveTo(3.0f, 3.724f, 3.112f, 3.473f, 3.293f, 3.292f)
                ),
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(20.72f, 20.693f),
                    PathNode.CurveTo(20.531681f, 20.88891f, 20.271744f, 20.999744f, 20.0f, 21.0f),
                    PathNode.LineTo(18.0f, 21.0f),
                    PathNode.CurveTo(17.447716f, 21.0f, 17.0f, 20.552284f, 17.0f, 20.0f),
                    PathNode.LineTo(17.0f, 18.0f),
                    PathNode.CurveTo(17.0f, 17.718f, 17.116f, 17.464f, 17.304f, 17.282f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
