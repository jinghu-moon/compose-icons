...
val PhosphorIcons.Duotone.MicrophoneStage: ImageVector
    get() {
        ...
        _microphoneStage = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M156.5 151 59 222.45c-3.182 2.332-7.588 1.996-10.38-.79L34.32 207.36C31.551 204.566 31.225 200.173 33.55 197L105 99.5h0c4.77 26.207 25.275 46.72 51.48 51.5Z"),
