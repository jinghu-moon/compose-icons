...
val LucideIcons.Outline.CalendarSearch: ImageVector
    get() {
        ...
        _calendarSearch = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 21.000 11.750 L 21.000 6.000 C 21.000 4.895 20.105 4.000 19.000 4.000 L 5.000 4.000 C 3.895 4.000 3.000 4.895 3.000 6.000 L 3.000 20.000 C 3.000 21.105 3.895 22.000 5.000 22.000 L 12.250 22.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
