...
val TablerIcons.Outline.MapPinSearch: ImageVector
    get() {
        ...
        _mapPinSearch = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 14.916 11.707 C 15.217 10.464 14.698 9.167 13.622 8.476 C 12.547 7.785 11.151 7.851 10.146 8.642 C 9.141 9.432 8.747 10.773 9.165 11.981 C 9.583 13.189 10.721 14.000 12.000 14.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 11.991 21.485 C 11.464 21.483 10.959 21.273 10.587 20.900 L 6.343 16.657 C 3.756 14.070 3.254 10.057 5.123 6.912 C 6.993 3.767 10.758 2.291 14.267 3.328 C 17.776 4.365 20.134 7.650 19.994 11.306"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
