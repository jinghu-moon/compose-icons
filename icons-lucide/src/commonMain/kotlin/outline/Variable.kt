        ...
        _variable = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(8.0f, 21.0f, 4.0f, 18.0f, 4.0f, 12.0f),
                    PathNode.CurveTo(4.0f, 6.0f, 8.0f, 3.0f, 8.0f, 3.0f)
                ),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(16.0f, 3.0f, 20.0f, 6.0f, 20.0f, 12.0f),
                    PathNode.CurveTo(20.0f, 18.0f, 16.0f, 21.0f, 16.0f, 21.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
