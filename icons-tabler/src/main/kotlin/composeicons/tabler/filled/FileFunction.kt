...
val TablerIcons.Filled.FileFunction: ImageVector
    get() {
        ...
        _fileFunction = tablerFilledIcon(
            ...
            addPathData("M12 2l.117 .007c.459 .054 .822 .417 .876 .876L13 3v4l.005 .15c.074 .984 .854 1.767 1.838 1.844L15 9h4l.117 .007c.459 .054 .822 .417 .876 .876L20 10v9c0 1.589-1.238 2.902-2.824 2.995L17 22h-10C5.411 22 4.098 20.762 4.005 19.176L4 19v-14C4 3.411 5.238 2.098 6.824 2.005L7 2ZM13.5 11h-.333l-.16 .006c-.895 .07-1.65 .732-1.75 1.63L11.105 14h-.605c-.552 0-1 .448-1 1 0 .552 .448 1 1 1h.382l-.111 1h-.271c-.552 0-1 .448-1 1 0 .552 .448 1 1 1h.333l.16-.006c.896-.071 1.652-.733 1.75-1.632L12.894 16h.606c.552 0 1-.448 1-1 0-.552-.448-1-1-1h-.383l.111-1h.272c.552 0 1-.448 1-1 0-.552-.448-1-1-1")
