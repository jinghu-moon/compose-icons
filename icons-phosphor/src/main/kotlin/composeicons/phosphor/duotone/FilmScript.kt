...
val PhosphorIcons.Duotone.FilmScript: ImageVector
    get() {
        ...
        _filmScript = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M200 24h-144C47.163 24 40 31.163 40 40v176c0 8.837 7.163 16 16 16h144c8.837 0 16-7.163 16-16v-176c0-8.837-7.163-16-16-16ZM200 216h-144v-176h144v176ZM96 80c0 6.627-5.373 12-12 12C77.373 92 72 86.627 72 80 72 73.373 77.373 68 84 68c6.627 0 12 5.373 12 12ZM96 176c0 6.627-5.373 12-12 12-6.627 0-12-5.373-12-12 0-6.627 5.373-12 12-12 6.627 0 12 5.373 12 12ZM96 128c0 6.627-5.373 12-12 12-6.627 0-12-5.373-12-12 0-6.627 5.373-12 12-12 6.627 0 12 5.373 12 12Z"),
                pathFillType = PathFillType.NonZero,
                fill = SolidColor(Color(0xFF000000)),
                fillAlpha = 1f,
                stroke = null,
