...
val PhosphorIcons.Duotone.BeachBall: ImageVector
    get() {
        ...
        _beachBall = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(161.23f, 93.36f),
                    PathNode.CurveTo(138.38445f, 70.67794f, 110.17817f, 54.135998f, 79.23f, 45.27f),
                    PathNode.CurveTo(99.93037f, 33.1158f, 124.42069f, 29.122036f, 147.91f, 34.07f),
                    PathNode.CurveTo(155.47069f, 53.00049f, 159.96704f, 73.01467f, 161.23f, 93.36f),
                    PathNode.Close,
                    PathNode.MoveTo(221.93f, 108.06f),
                    PathNode.CurveTo(202.99635f, 100.51431f, 182.98299f, 96.028275f, 162.64f, 94.77f),
                    PathNode.CurveTo(185.32448f, 117.61369f, 201.8668f, 145.82063f, 210.73f, 176.77f),
                    PathNode.CurveTo(222.88446f, 156.0734f, 226.87833f, 131.58604f, 221.93f, 108.1f),
                    PathNode.Close,
                    PathNode.MoveTo(32.27f, 135.19f),
                    PathNode.CurveTo(35.826332f, 182.53809f, 73.461914f, 220.17366f, 120.81f, 223.73f),
                    PathNode.CurveTo(149.54097f, 187.08209f, 163.93848f, 141.22333f, 161.31f, 94.73f),
                    PathNode.CurveTo(114.8088f, 92.08496f, 68.936226f, 106.468124f, 32.27f, 135.19f),
                    PathNode.Close
                ),
