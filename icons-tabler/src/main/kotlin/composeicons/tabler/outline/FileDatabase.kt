...
val TablerIcons.Outline.FileDatabase: ImageVector
    get() {
        ...
        _fileDatabase = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(8.0f, 12.75f),
                    PathNode.CurveTo(8.0f, 13.716498f, 9.790861f, 14.5f, 12.0f, 14.5f),
                    PathNode.CurveTo(14.209139f, 14.5f, 16.0f, 13.716498f, 16.0f, 12.75f),
                    PathNode.CurveTo(16.0f, 11.783502f, 14.209139f, 11.0f, 12.0f, 11.0f),
                    PathNode.CurveTo(9.790861f, 11.0f, 8.0f, 11.783502f, 8.0f, 12.75f)
                ),
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(8.0f, 12.5f),
                    PathNode.LineTo(8.0f, 16.25f),
                    PathNode.CurveTo(8.0f, 17.216f, 9.79f, 18.0f, 12.0f, 18.0f),
                    PathNode.CurveTo(14.21f, 18.0f, 16.0f, 17.216f, 16.0f, 16.25f),
                    PathNode.LineTo(16.0f, 12.5f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
