        ...
        _ghost = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(186.67f, 192.0f),
                    PathNode.LineTo(157.33f, 216.0f),
                    PathNode.LineTo(128.0f, 192.0f),
                    PathNode.LineTo(98.67f, 216.0f),
                    PathNode.LineTo(69.33f, 192.0f),
                    PathNode.LineTo(40.0f, 216.0f),
                    PathNode.LineTo(40.0f, 120.0f),
                    PathNode.CurveTo(40.0f, 71.39894f, 79.39894f, 32.0f, 128.0f, 32.0f),
                    PathNode.CurveTo(176.60106f, 32.0f, 216.0f, 71.39894f, 216.0f, 120.0f),
                    PathNode.Close
                ),
