...
val TablerIcons.Outline.FileTypePng: ImageVector
    get() {
        if (_fileTypePng != null) return _fileTypePng!!
        _fileTypePng = tablerOutlineIcon(
            name = "FileTypePng",
    ...
    addPath(
        pathData = parseSvgPathData("M 11.000 21.000 L 11.000 15.000 L 14.000 21.000 L 14.000 15.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
