        ...
        _popcorn = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(70.34f, 216.0f),
                    PathNode.CurveTo(66.62591f, 216.00098f, 63.399597f, 213.44562f, 62.55f, 209.83f),
                    PathNode.LineTo(32.0f, 80.0f),
                    PathNode.Close,
                    PathNode.MoveTo(168.0f, 96.0f),
                    PathNode.LineTo(152.0f, 216.0f),
                    PathNode.LineTo(185.66f, 216.0f),
                    PathNode.CurveTo(189.3741f, 216.00098f, 192.6004f, 213.44562f, 193.45f, 209.83f),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(159.25f, 101.11f),
                    PathNode.LineTo(145.0f, 208.0f),
                    PathNode.LineTo(111.0f, 208.0f),
                    PathNode.LineTo(96.75f, 101.11f),
                    PathNode.LineTo(128.0f, 88.62f),
                    PathNode.Close,
                    PathNode.MoveTo(42.91f, 91.44f),
                    PathNode.LineTo(80.76f, 102.25f),
                    PathNode.LineTo(94.86f, 208.0f),
                    PathNode.LineTo(70.34f, 208.0f),
                    PathNode.Close,
