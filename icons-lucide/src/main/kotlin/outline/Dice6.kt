...
val LucideIcons.Outline.Dice6: ImageVector
    get() {
        if (_dice6 != null) return _dice6!!
        _dice6 = lucideOutlineIcon(
            name = "Dice6",
            ...
            addPath(
                pathData = parseSvgPathData("M 16.000 8.000 L 16.010 8.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 8.000 8.000 L 8.010 8.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
