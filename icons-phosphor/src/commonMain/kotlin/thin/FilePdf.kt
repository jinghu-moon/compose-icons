        ...
        _filePdf = phosphorThinIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(188.0f, 208.0f),
                    PathNode.CurveTo(188.0f, 210.20914f, 186.20914f, 212.0f, 184.0f, 212.0f),
                    PathNode.CurveTo(181.79086f, 212.0f, 180.0f, 210.20914f, 180.0f, 208.0f),
                    PathNode.LineTo(180.0f, 152.0f),
                    PathNode.CurveTo(180.0f, 149.79086f, 181.79086f, 148.0f, 184.0f, 148.0f),
                    ...
                    PathNode.CurveTo(160.0f, 197.67311f, 145.67311f, 212.0f, 128.0f, 212.0f),
                    PathNode.LineTo(112.0f, 212.0f),
                    PathNode.CurveTo(109.79086f, 212.0f, 108.0f, 210.20914f, 108.0f, 208.0f),
                    PathNode.LineTo(108.0f, 152.0f),
                    PathNode.CurveTo(108.0f, 149.79086f, 109.79086f, 148.0f, 112.0f, 148.0f),
                    PathNode.LineTo(128.0f, 148.0f),
                    PathNode.CurveTo(145.67311f, 148.0f, 160.0f, 162.32689f, 160.0f, 180.0f),
                    PathNode.Close,
                    PathNode.MoveTo(152.0f, 180.0f),
                    PathNode.CurveTo(152.0f, 166.74516f, 141.25484f, 156.0f, 128.0f, 156.0f),
                    PathNode.LineTo(116.0f, 156.0f),
                    PathNode.LineTo(116.0f, 204.0f),
                    PathNode.LineTo(128.0f, 204.0f),
                    PathNode.CurveTo(141.25484f, 204.0f, 152.0f, 193.25484f, 152.0f, 180.0f),
                    PathNode.Close,
