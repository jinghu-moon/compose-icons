...
val TablerIcons.Outline.XboxX: ImageVector
    get() {
        if (_xboxX != null) return _xboxX!!
        _xboxX = tablerOutlineIcon(
            name = "XboxX",
            ...
            addPath(
                pathData = parseSvgPathData("M 9.000 8.000 L 15.000 16.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 15.000 8.000 L 9.000 16.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
