...
val LucideIcons.Outline.SquareStop: ImageVector
    get() {
        ...
        _squareStop = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 10.000 9.000 L 14.000 9.000 C 14.552 9.000 15.000 9.448 15.000 10.000 L 15.000 14.000 C 15.000 14.552 14.552 15.000 14.000 15.000 L 10.000 15.000 C 9.448 15.000 9.000 14.552 9.000 14.000 L 9.000 10.000 C 9.000 9.448 9.448 9.000 10.000 9.000 Z"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
