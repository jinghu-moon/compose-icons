        ...
        _squareSplitHorizontal = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(4.0f, 19.0f, 3.0f, 18.0f, 3.0f, 17.0f),
                    PathNode.LineTo(3.0f, 7.0f),
                    PathNode.CurveTo(3.0f, 6.0f, 4.0f, 5.0f, 5.0f, 5.0f),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(20.0f, 5.0f, 21.0f, 6.0f, 21.0f, 7.0f),
                    PathNode.LineTo(21.0f, 17.0f),
                    PathNode.CurveTo(21.0f, 18.0f, 20.0f, 19.0f, 19.0f, 19.0f),
