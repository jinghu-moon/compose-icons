...
val LucideIcons.Outline.CandyOff: ImageVector
    get() {
        ...
        _candyOff = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 10.000 10.000 L 10.000 17.900"),
            ...
            addPath(
                pathData = parseSvgPathData("M 11.802 6.145 C 13.502 5.725 15.298 6.225 16.536 7.464 C 17.775 8.702 18.275 10.498 17.855 12.198"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 14.000 6.100 L 14.000 8.343"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 15.500 15.571 L 14.536 16.535 C 12.583 18.488 9.418 18.488 7.465 16.535 C 5.513 14.583 5.513 11.417 7.465 9.465 L 8.429 8.500"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
