...
val LucideIcons.Outline.UmbrellaOff: ImageVector
    get() {
        ...
        _umbrellaOff = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 18.656 13.000 L 20.992 13.000 C 21.307 13.003 21.605 12.857 21.796 12.606 C 21.987 12.355 22.048 12.029 21.962 11.726 C 20.595 6.397 15.276 3.088 9.892 4.216"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 5.961 5.957 C 4.021 7.364 2.634 9.405 2.039 11.726 C 1.953 12.028 2.014 12.352 2.202 12.602 C 2.391 12.853 2.686 13.000 3.000 13.000 L 13.000 13.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
