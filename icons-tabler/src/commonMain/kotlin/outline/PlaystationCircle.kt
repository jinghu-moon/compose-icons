        ...
        _playstationCircle = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(7.5f, 14.485281f, 9.514719f, 16.5f, 12.0f, 16.5f),
                    PathNode.CurveTo(14.485281f, 16.5f, 16.5f, 14.485281f, 16.5f, 12.0f),
                    PathNode.CurveTo(16.5f, 9.514719f, 14.485281f, 7.5f, 12.0f, 7.5f),
                    PathNode.CurveTo(9.514719f, 7.5f, 7.5f, 9.514719f, 7.5f, 12.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
