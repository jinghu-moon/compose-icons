...
val PhosphorIcons.Regular.Bug: ImageVector
    get() {
        if (_bug != null) return _bug!!
        _bug = phosphorRegularIcon(
            name = "Bug",
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(120.0f, 215.54f),
                    PathNode.LineTo(120.0f, 136.0f),
                    PathNode.LineTo(56.0f, 136.0f),
                    PathNode.LineTo(56.0f, 144.0f),
                    PathNode.CurveTo(56.043575f, 180.64941f, 83.58154f, 211.4317f, 120.0f, 215.54f),
                    PathNode.Close,
                    PathNode.MoveTo(200.0f, 144.0f),
                    PathNode.LineTo(200.0f, 136.0f),
                    PathNode.LineTo(136.0f, 136.0f),
                    PathNode.LineTo(136.0f, 215.54f),
                    PathNode.CurveTo(172.41846f, 211.4317f, 199.95642f, 180.64941f, 200.0f, 144.0f),
                    PathNode.Close
                ),
