...
val LucideIcons.Outline.Cog: ImageVector
    get() {
        ...
        _cog = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(11.0f, 10.27f),
                    PathNode.LineTo(7.0f, 3.34f)
                ),
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(11.0f, 13.73f),
                    PathNode.LineTo(7.0f, 20.66f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(16.418278f, 4.0f, 20.0f, 7.581722f, 20.0f, 12.0f),
                    PathNode.Close
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
