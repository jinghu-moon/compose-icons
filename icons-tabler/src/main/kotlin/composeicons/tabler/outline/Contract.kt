        ...
        _contract = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(6.343146f, 3.0f, 5.0f, 4.343146f, 5.0f, 6.0f),
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(18.42f, 12.61f),
                    PathNode.CurveTo(19.240143f, 11.789857f, 20.569857f, 11.789857f, 21.39f, 12.61f),
                    PathNode.CurveTo(22.210142f, 13.430142f, 22.210142f, 14.759857f, 21.39f, 15.58f),
                    PathNode.LineTo(15.0f, 22.0f),
                    PathNode.LineTo(12.0f, 22.0f),
                    PathNode.LineTo(12.0f, 19.0f),
                    PathNode.LineTo(18.42f, 12.61f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
