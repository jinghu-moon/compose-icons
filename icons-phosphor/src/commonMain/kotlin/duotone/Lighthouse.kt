...
val PhosphorIcons.Duotone.Lighthouse: ImageVector
    get() {
        ...
        _lighthouse = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(181.61f, 112.0f),
                    PathNode.LineTo(74.39f, 112.0f),
                    PathNode.LineTo(80.0f, 56.0f),
                    PathNode.LineTo(176.0f, 56.0f),
                    PathNode.Close,
                    PathNode.MoveTo(192.0f, 215.24f),
                    PathNode.LineTo(187.23f, 168.0f),
                    PathNode.LineTo(68.77f, 168.0f),
                    PathNode.LineTo(64.0f, 215.24f),
                    PathNode.CurveTo(63.785255f, 217.49002f, 64.53232f, 219.72589f, 66.05651f, 221.39488f),
                    PathNode.CurveTo(67.5807f, 223.06387f, 69.73978f, 224.01022f, 72.0f, 224.0f),
                    PathNode.LineTo(184.0f, 224.0f),
                    PathNode.CurveTo(186.26022f, 224.01022f, 188.4193f, 223.06387f, 189.9435f, 221.39488f),
                    PathNode.CurveTo(191.46768f, 219.72589f, 192.21475f, 217.49002f, 192.0f, 215.24f),
                    PathNode.Close
                ),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(183.79518f, 53.190487f, 182.83777f, 51.33284f, 181.32f, 50.0f),
                    ...
                    PathNode.CurveTo(73.162224f, 51.33284f, 72.20483f, 53.190487f, 72.0f, 55.2f),
                    ...
                    PathNode.LineTo(155.0f, 48.0f),
                    PathNode.LineTo(101.0f, 48.0f),
                    PathNode.Close,
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(178.39f, 160.0f),
                    PathNode.LineTo(77.61f, 160.0f),
                    PathNode.LineTo(81.61f, 120.0f),
                    PathNode.LineTo(174.37f, 120.0f),
                    PathNode.Close
                ),
                pathFillType = PathFillType.NonZero,
                fill = SolidColor(Color.Black),
