...
val PhosphorIcons.Regular.Trolley: ImageVector
    get() {
        ...
        _trolley = phosphorRegularIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M88 224c0 8.837-7.163 16-16 16-8.837 0-16-7.163-16-16 0-8.837 7.163-16 16-16 8.837 0 16 7.163 16 16ZM216 208c-8.837 0-16 7.163-16 16 0 8.837 7.163 16 16 16 8.837 0 16-7.163 16-16 0-8.837-7.163-16-16-16ZM240 176h-184v-100.69C56.014 71.064 54.324 66.99 51.31 64L29.66 42.34c-3.126-3.126-8.194-3.126-11.32 0-3.126 3.126-3.126 8.194 0 11.32L40 75.31v100.69h-8c-4.418 0-8 3.582-8 8 0 4.418 3.582 8 8 8h208c4.418 0 8-3.582 8-8 0-4.418-3.582-8-8-8Z"),
