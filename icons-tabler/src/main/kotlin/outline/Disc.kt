...
val TablerIcons.Outline.Disc: ImageVector
    get() {
        if (_disc != null) return _disc!!
        _disc = tablerOutlineIcon(
            name = "Disc",
            ...
            addPath(
                pathData = parseSvgPathData("M 7.000 12.000 C 7.000 9.239 9.239 7.000 12.000 7.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 17.000 C 14.761 17.000 17.000 14.761 17.000 12.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
