...
val TablerIcons.Outline.ArrowBigDownLines: ImageVector
    get() {
        ...
        _arrowBigDownLines = tablerOutlineIcon(
            ...
            addPathData("M15 12h3.586c.404 0 .769 .244 .924 .617 .155 .374 .069 .804-.217 1.09l-6.586 6.586c-.391 .39-1.023 .39-1.414 0L4.707 13.707c-.286-.286-.371-.716-.217-1.09 .155-.374 .519-.617 .924-.617h3.586v-3h6v3")
            addPathData("M15 3h-6")
            addPathData("M15 6h-6")
        }
