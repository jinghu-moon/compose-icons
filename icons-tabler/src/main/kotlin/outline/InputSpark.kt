...
val TablerIcons.Outline.InputSpark: ImageVector
    get() {
        ...
        _inputSpark = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 20.000 11.500 L 20.000 9.000 C 20.000 7.895 19.105 7.000 18.000 7.000 L 6.000 7.000 C 4.895 7.000 4.000 7.895 4.000 9.000 L 4.000 14.000 C 4.000 15.105 4.895 16.000 6.000 16.000 L 13.000 16.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
