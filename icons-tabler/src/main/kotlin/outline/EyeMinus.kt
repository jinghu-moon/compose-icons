...
val TablerIcons.Outline.EyeMinus: ImageVector
    get() {
        if (_eyeMinus != null) return _eyeMinus!!
        _eyeMinus = tablerOutlineIcon(
            name = "EyeMinus",
    ...
    addPath(
        pathData = parseSvgPathData("M 12.000 18.000 C 8.400 18.000 5.400 16.000 3.000 12.000 C 5.400 8.000 8.400 6.000 12.000 6.000 C 15.600 6.000 18.600 8.000 21.000 12.000 C 20.287 13.188 19.522 14.199 18.704 15.034"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
