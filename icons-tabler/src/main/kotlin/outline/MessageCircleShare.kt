...
val TablerIcons.Outline.MessageCircleShare: ImageVector
    get() {
        ...
        _messageCircleShare = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 12.580 19.963 C 10.898 20.062 9.218 19.731 7.700 19.000 L 3.000 20.000 L 4.300 16.100 C 1.976 12.663 2.874 8.228 6.400 5.726 C 9.926 3.225 14.990 3.430 18.245 6.206 C 20.375 8.023 21.300 10.574 20.937 13.026"),
