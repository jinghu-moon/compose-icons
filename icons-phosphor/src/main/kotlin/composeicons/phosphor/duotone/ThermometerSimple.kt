...
val PhosphorIcons.Duotone.ThermometerSimple: ImageVector
    get() {
        ...
        _thermometerSimple = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M160 138v-90C160 30.327 145.673 16 128 16 110.327 16 96 30.327 96 48v90C75.92 151.982 67.243 177.381 74.57 200.726c7.327 23.345 28.962 39.23 53.43 39.23 24.468 0 46.103-15.885 53.43-39.23C188.757 177.381 180.08 151.982 160 138ZM128 208c-13.255 0-24-10.745-24-24 0-13.255 10.745-24 24-24 13.255 0 24 10.745 24 24 0 13.255-10.745 24-24 24Z"),
