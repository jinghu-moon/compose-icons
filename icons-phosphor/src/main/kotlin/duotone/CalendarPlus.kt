...
val PhosphorIcons.Duotone.CalendarPlus: ImageVector
    get() {
        if (_calendarPlus != null) return _calendarPlus!!
        _calendarPlus = phosphorDuotoneIcon(
            name = "CalendarPlus",
