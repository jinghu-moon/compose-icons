...
val TablerIcons.Outline.WorldLongitude: ImageVector
    get() {
        ...
        _worldLongitude = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 11.500 3.000 C 8.648 5.112 6.966 8.451 6.966 12.000 C 6.966 15.549 8.648 18.888 11.500 21.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 12.500 3.000 C 15.352 5.112 17.034 8.451 17.034 12.000 C 17.034 15.549 15.352 18.888 12.500 21.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
