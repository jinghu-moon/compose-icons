        ...
        _excludeSquare = phosphorLightIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(46.0f, 54.48f),
                    PathNode.LineTo(90.0f, 98.48f),
                    PathNode.LineTo(90.0f, 137.48f),
                    PathNode.LineTo(46.0f, 93.48f),
                    PathNode.Close,
                    PathNode.MoveTo(93.52f, 46.0f),
                    PathNode.LineTo(137.52f, 90.0f),
                    PathNode.LineTo(98.52f, 90.0f),
                    PathNode.LineTo(54.52f, 46.0f),
                    PathNode.Close,
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(154.0f, 89.52f),
                    PathNode.LineTo(110.48f, 46.0f),
                    PathNode.LineTo(154.0f, 46.0f),
                    PathNode.Close,
                    PathNode.MoveTo(46.0f, 110.52f),
                    PathNode.LineTo(89.52f, 154.0f),
                    PathNode.LineTo(46.0f, 154.0f),
                    PathNode.Close,
                    PathNode.MoveTo(102.0f, 166.52f),
