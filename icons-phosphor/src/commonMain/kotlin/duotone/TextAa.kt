...
val PhosphorIcons.Duotone.TextAa: ImageVector
    get() {
        if (_textAa != null) return _textAa!!
        _textAa = phosphorDuotoneIcon(
            name = "TextAa",
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(232.0f, 179.46f, 217.67f, 192.0f, 200.0f, 192.0f),
                    PathNode.CurveTo(182.33f, 192.0f, 168.0f, 179.46f, 168.0f, 164.0f),
                    PathNode.CurveTo(168.0f, 148.54f, 182.33f, 136.0f, 200.0f, 136.0f),
                    PathNode.CurveTo(217.67f, 136.0f, 232.0f, 148.54f, 232.0f, 164.0f),
                    PathNode.Close,
                    PathNode.MoveTo(34.82f, 152.0f),
                    PathNode.LineTo(125.18f, 152.0f),
