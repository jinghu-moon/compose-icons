...
val PhosphorIcons.Duotone.GenderTransgender: ImageVector
    get() {
        ...
        _genderTransgender = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(141.25f, 205.25f),
                    PathNode.CurveTo(122.947205f, 223.5567f, 95.41859f, 229.03477f, 71.50175f, 219.1296f),
                    PathNode.CurveTo(47.58491f, 209.22441f, 31.990332f, 185.88683f, 31.990332f, 160.0f),
                    PathNode.CurveTo(31.990332f, 134.11317f, 47.58491f, 110.77558f, 71.50175f, 100.8704f),
                    PathNode.CurveTo(95.41859f, 90.96522f, 122.947205f, 96.44329f, 141.25f, 114.75f),
                    PathNode.CurveTo(166.2371f, 139.74245f, 166.2371f, 180.25755f, 141.25f, 205.25f),
                    PathNode.Close
                ),
