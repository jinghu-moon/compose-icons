...
val LucideIcons.Outline.CalendarClock: ImageVector
    get() {
        ...
        _calendarClock = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 16.000 14.000 L 16.000 16.200 L 17.600 17.200"),
            ...
            addPath(
                pathData = parseSvgPathData("M 21.000 7.500 L 21.000 6.000 C 21.000 4.895 20.105 4.000 19.000 4.000 L 5.000 4.000 C 3.895 4.000 3.000 4.895 3.000 6.000 L 3.000 20.000 C 3.000 21.105 3.895 22.000 5.000 22.000 L 8.500 22.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 3.000 10.000 L 8.000 10.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
