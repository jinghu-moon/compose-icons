        ...
        _spade = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(224.00215f, 154.82108f, 213.00446f, 171.90677f, 195.87206f, 179.69872f),
                    PathNode.CurveTo(178.73969f, 187.49068f, 158.63425f, 184.55093f, 144.45f, 172.18f),
                    PathNode.LineTo(160.0f, 224.0f),
                    PathNode.LineTo(96.0f, 224.0f),
                    PathNode.LineTo(111.55f, 172.18f),
                    PathNode.CurveTo(97.36575f, 184.55093f, 77.26032f, 187.49068f, 60.12794f, 179.69872f),
                    PathNode.CurveTo(42.99556f, 171.90677f, 31.99786f, 154.82108f, 32.0f, 136.0f),
                    PathNode.CurveTo(32.0f, 72.0f, 128.0f, 24.0f, 128.0f, 24.0f),
                    PathNode.CurveTo(128.0f, 24.0f, 224.0f, 72.0f, 224.0f, 136.0f),
                    PathNode.Close
                ),
