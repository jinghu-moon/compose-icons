...
val TablerIcons.Outline.Packages: ImageVector
    get() {
        ...
        _packages = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(7.0f, 16.545f),
                    PathNode.LineTo(12.0f, 13.515f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(7.0f, 5.03f),
                    PathNode.LineTo(7.0f, 10.485f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
