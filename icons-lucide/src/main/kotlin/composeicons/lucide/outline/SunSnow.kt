        ...
        _sunSnow = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(8.343146f, 9.0f, 7.0f, 10.343145f, 7.0f, 12.0f),
                    PathNode.CurveTo(7.0f, 13.656855f, 8.343146f, 15.0f, 10.0f, 15.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(3.64f, 18.36f),
                    PathNode.LineTo(4.34f, 17.66f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(4.34f, 6.34f),
                    PathNode.LineTo(3.64f, 5.64f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
