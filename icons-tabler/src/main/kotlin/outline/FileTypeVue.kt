...
val TablerIcons.Outline.FileTypeVue: ImageVector
    get() {
        ...
        _fileTypeVue = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 4.000 15.000 L 6.000 21.000 L 8.000 15.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 11.000 15.000 L 11.000 19.500 C 11.000 20.328 11.672 21.000 12.500 21.000 C 13.328 21.000 14.000 20.328 14.000 19.500 L 14.000 15.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 20.000 15.000 L 17.000 15.000 L 17.000 21.000 L 20.000 21.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
