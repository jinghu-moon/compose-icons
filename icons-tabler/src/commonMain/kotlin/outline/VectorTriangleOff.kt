...
val TablerIcons.Outline.VectorTriangleOff: ImageVector
    get() {
        ...
        _vectorTriangleOff = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(20.705f, 20.709f),
                    PathNode.CurveTo(20.517672f, 20.895327f, 20.264215f, 20.999945f, 20.0f, 21.0f),
                    PathNode.LineTo(18.0f, 21.0f),
                    PathNode.CurveTo(17.447716f, 21.0f, 17.0f, 20.552284f, 17.0f, 20.0f),
                    PathNode.LineTo(17.0f, 18.0f),
                    PathNode.CurveTo(17.0f, 17.72f, 17.115f, 17.468f, 17.3f, 17.286f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(6.5f, 17.1f),
                    PathNode.LineTo(10.249f, 10.277f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(13.158f, 9.197f),
