...
val PhosphorIcons.Light.WhatsappLogo: ImageVector
    get() {
        ...
        _whatsappLogo = phosphorLightIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(186.68f, 146.63f),
                    PathNode.LineTo(154.68f, 130.63f),
                    PathNode.CurveTo(152.75623f, 129.67325f, 150.4677f, 129.81819f, 148.68f, 131.01f),
                    PathNode.LineTo(133.0f, 141.46f),
                    PathNode.CurveTo(125.06195f, 137.39632f, 118.60369f, 130.93805f, 114.54f, 123.0f),
                    PathNode.LineTo(125.0f, 107.33f),
                    PathNode.CurveTo(126.19181f, 105.5423f, 126.33675f, 103.25378f, 125.38f, 101.33f),
                    PathNode.LineTo(109.38f, 69.33f),
                    PathNode.CurveTo(108.3652f, 67.2878f, 106.28043f, 65.99741f, 104.0f, 66.0f),
                    PathNode.CurveTo(83.013176f, 66.0f, 66.0f, 83.013176f, 66.0f, 104.0f),
                    PathNode.CurveTo(66.05511f, 151.47365f, 104.52636f, 189.9449f, 152.0f, 190.0f),
                    PathNode.CurveTo(172.98682f, 190.0f, 190.0f, 172.98682f, 190.0f, 152.0f),
                    PathNode.CurveTo(190.00069f, 149.7254f, 188.71509f, 147.646f, 186.68f, 146.63f),
                    PathNode.Close,
                    PathNode.MoveTo(152.0f, 178.0f),
                    PathNode.CurveTo(111.15149f, 177.95041f, 78.04959f, 144.84851f, 78.0f, 104.0f),
                    PathNode.CurveTo(78.001175f, 91.02478f, 87.568375f, 80.03659f, 100.42f, 78.25f),
                    PathNode.LineTo(113.08f, 103.57f),
                    PathNode.LineTo(102.69f, 119.15f),
                    PathNode.CurveTo(101.5813f, 120.8188f, 101.37872f, 122.93088f, 102.15f, 124.78f),
                    PathNode.CurveTo(107.66727f, 137.89757f, 118.102425f, 148.33273f, 131.22f, 153.85f),
                    PathNode.CurveTo(133.06912f, 154.62128f, 135.1812f, 154.4187f, 136.85f, 153.31f),
                    PathNode.LineTo(152.43f, 142.92f),
                    PathNode.LineTo(177.75f, 155.58f),
                    PathNode.CurveTo(175.96341f, 168.43163f, 164.97522f, 177.99883f, 152.0f, 178.0f),
                    PathNode.Close,
