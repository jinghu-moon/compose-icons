...
val TablerIcons.Outline.PlaystationTriangle: ImageVector
    get() {
        if (_playstationTriangle != null) return _playstationTriangle!!
        _playstationTriangle = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 7.500 15.000 L 16.500 15.000 L 12.000 7.000 L 7.500 15.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
