...
val PhosphorIcons.Duotone.HourglassSimpleHigh: ImageVector
    get() {
        if (_hourglassSimpleHigh != null) return _hourglassSimpleHigh!!
        _hourglassSimpleHigh = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(186.48f, 72.0f),
                    PathNode.LineTo(128.0f, 128.0f),
                    PathNode.LineTo(69.52f, 72.0f),
                    PathNode.Close
                ),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(56.0f, 48.0f),
                    PathNode.Close,
                    PathNode.MoveTo(89.43f, 80.0f),
                    PathNode.LineTo(166.57f, 80.0f),
                    PathNode.LineTo(128.0f, 116.92f),
                    PathNode.Close,
                    PathNode.MoveTo(200.0f, 48.0f),
                    PathNode.LineTo(183.3f, 64.0f),
                    PathNode.LineTo(72.72f, 64.0f),
                    PathNode.LineTo(56.0f, 48.0f),
                    PathNode.Close,
