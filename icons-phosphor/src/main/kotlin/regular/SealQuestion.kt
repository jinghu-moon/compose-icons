...
val PhosphorIcons.Regular.SealQuestion: ImageVector
    get() {
        if (_sealQuestion != null) return _sealQuestion!!
        _sealQuestion = phosphorRegularIcon(
            name = "SealQuestion",
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(124.0f, 224.0f, 118.85f, 219.08f, 113.89f, 214.31f),
                    PathNode.CurveTo(108.93f, 209.54f, 103.72f, 204.56f, 97.37f, 201.93f),
                    PathNode.CurveTo(91.27f, 199.41f, 84.3f, 199.3f, 77.55f, 199.2f),
                    PathNode.CurveTo(70.55f, 199.1f, 63.22f, 198.99f, 60.12f, 195.88f),
                    PathNode.CurveTo(57.02f, 192.77f, 56.9f, 185.49f, 56.8f, 178.45f),
                    ...
                    PathNode.CurveTo(32.0f, 124.0f, 36.92f, 118.85f, 41.69f, 113.89f),
                    PathNode.CurveTo(46.46f, 108.93f, 51.44f, 103.72f, 54.07f, 97.37f),
                    ...
                    PathNode.CurveTo(132.0f, 32.0f, 137.15f, 36.92f, 142.11f, 41.69f),
                    PathNode.CurveTo(147.07f, 46.46f, 152.28f, 51.44f, 158.63f, 54.07f),
                    ...
                    PathNode.CurveTo(224.0f, 132.0f, 219.08f, 137.15f, 214.31f, 142.11f),
                    PathNode.Close,
