...
val TablerIcons.Outline.PlayCard6: ImageVector
    get() {
        if (_playCard6 != null) return _playCard6!!
        _playCard6 = tablerOutlineIcon(
            name = "PlayCard6",
    ...
    addPath(
        pathData = parseSvgPathData("M 14.000 9.000 L 11.000 9.000 C 10.448 9.000 10.000 9.448 10.000 10.000 L 10.000 14.000 C 10.000 14.552 10.448 15.000 11.000 15.000 L 13.000 15.000 C 13.552 15.000 14.000 14.552 14.000 14.000 L 14.000 13.000 C 14.000 12.448 13.552 12.000 13.000 12.000 L 10.000 12.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
