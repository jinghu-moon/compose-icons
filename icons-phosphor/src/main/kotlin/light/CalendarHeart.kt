        ...
        _calendarHeart = phosphorLightIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(120.25225f, 91.66967f, 106.76343f, 87.45608f, 94.51317f, 91.5395f),
                    PathNode.CurveTo(82.2629f, 95.622925f, 74.0f, 107.08709f, 74.0f, 120.0f),
                    PathNode.CurveTo(74.0f, 155.3f, 123.22f, 180.32f, 125.32f, 181.37f),
                    PathNode.CurveTo(127.00737f, 182.2124f, 128.99263f, 182.2124f, 130.68f, 181.37f),
                    PathNode.CurveTo(132.78f, 180.32f, 182.0f, 155.3f, 182.0f, 120.0f),
                    PathNode.CurveTo(182.0f, 103.43146f, 168.56854f, 90.0f, 152.0f, 90.0f),
                    PathNode.Close,
                    PathNode.MoveTo(148.33f, 155.25f),
                    PathNode.CurveTo(141.98274f, 160.49382f, 135.17894f, 165.15909f, 128.0f, 169.19f),
                    PathNode.CurveTo(120.823364f, 165.15538f, 114.01989f, 160.49033f, 107.67f, 155.25f),
                    PathNode.CurveTo(97.78f, 147.0f, 86.0f, 134.15f, 86.0f, 120.0f),
                    ...
                    PathNode.CurveTo(170.0f, 134.15f, 158.22f, 147.0f, 148.33f, 155.25f),
                    PathNode.Close
                ),
