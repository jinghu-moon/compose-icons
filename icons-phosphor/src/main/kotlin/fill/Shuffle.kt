        ...
        _shuffle = phosphorFillIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(211.3719f, 215.95064f, 207.92874f, 216.63632f, 204.93768f, 215.39697f),
                    PathNode.CurveTo(201.94662f, 214.15764f, 199.99745f, 211.23764f, 200.0f, 208.0f),
                    PathNode.LineTo(200.0f, 192.0f),
                    PathNode.CurveTo(177.08746f, 191.67818f, 155.69011f, 180.49144f, 142.35f, 161.86f),
                    PathNode.LineTo(100.63f, 103.46f),
                    PathNode.CurveTo(90.10883f, 88.752525f, 73.14326f, 80.01844f, 55.06f, 80.0f),
                    ...
                    PathNode.CurveTo(165.69649f, 166.99002f, 182.25026f, 175.6879f, 200.0f, 176.0f),
                    PathNode.LineTo(200.0f, 160.0f),
                    PathNode.CurveTo(199.99745f, 156.76236f, 201.94662f, 153.84236f, 204.93768f, 152.60303f),
                    PathNode.CurveTo(207.92874f, 151.36368f, 211.3719f, 152.04936f, 213.66f, 154.34f),
                    PathNode.Close,
                    ...
                    PathNode.CurveTo(165.68428f, 89.019615f, 182.24313f, 80.313614f, 200.0f, 80.0f),
                    PathNode.LineTo(200.0f, 96.0f),
                    PathNode.CurveTo(199.99745f, 99.237656f, 201.94662f, 102.15764f, 204.93768f, 103.39698f),
                    PathNode.CurveTo(207.92874f, 104.63632f, 211.3719f, 103.95064f, 213.66f, 101.66f),
                    ...
                    PathNode.CurveTo(211.3719f, 40.04936f, 207.92874f, 39.363674f, 204.93768f, 40.60302f),
                    PathNode.CurveTo(201.94662f, 41.84236f, 199.99745f, 44.76235f, 200.0f, 48.0f),
                    PathNode.LineTo(200.0f, 64.0f),
                    PathNode.CurveTo(177.08746f, 64.321815f, 155.69011f, 75.50856f, 142.35f, 94.14f),
                    PathNode.LineTo(141.15f, 95.81f),
                    PathNode.CurveTo(139.90617f, 97.53744f, 139.40208f, 99.68936f, 139.7493f, 101.7895f),
                    PathNode.CurveTo(140.0965f, 103.88964f, 141.26637f, 105.76481f, 143.0f, 107.0f),
                    PathNode.Close,
