...
val LucideIcons.Outline.BadgeJapaneseYen: ImageVector
    get() {
        if (_badgeJapaneseYen != null) return _badgeJapaneseYen!!
        _badgeJapaneseYen = lucideOutlineIcon(
    ...
    addPath(
        pathData = parseSvgPathData("M 9.000 8.000 L 12.000 11.000 L 12.000 18.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 12.000 11.000 L 15.000 8.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
