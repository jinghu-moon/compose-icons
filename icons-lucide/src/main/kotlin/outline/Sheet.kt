...
val LucideIcons.Outline.Sheet: ImageVector
    get() {
        if (_sheet != null) return _sheet!!
        _sheet = lucideOutlineIcon(
            name = "Sheet",
    ...
    addPath(
        pathData = parseSvgPathData("M 9.000 9.000 L 9.000 21.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 15.000 9.000 L 15.000 21.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
