...
val PhosphorIcons.Duotone.BugDroid: ImageVector
    get() {
        if (_bugDroid != null) return _bugDroid!!
        _bugDroid = phosphorDuotoneIcon(
            name = "BugDroid",
            ...
            group(
                ...
                addPath(
                    pathData = parseSvgPathData("M 208.000 128.000 L 208.000 152.000 C 208.000 196.183 172.183 232.000 128.000 232.000 C 83.817 232.000 48.000 196.183 48.000 152.000 L 48.000 128.000 Z"),
