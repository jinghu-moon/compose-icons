...
val TablerIcons.Outline.ZoomReplace: ImageVector
    get() {
        ...
        _zoomReplace = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(3.291f, 8.0f),
                    PathNode.CurveTo(4.004962f, 5.607109f, 5.939579f, 3.775757f, 8.368f, 3.194f),
                    PathNode.CurveTo(11.834921f, 2.354903f, 15.380023f, 4.248749f, 16.61f, 7.597f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(16.705f, 12.0f),
                    PathNode.CurveTo(15.989149f, 14.389024f, 14.056288f, 16.216747f, 11.631f, 16.798f),
                    PathNode.CurveTo(8.164404f, 17.636524f, 4.619934f, 15.742786f, 3.39f, 12.395f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
