...
val TablerIcons.Outline.CameraStar: ImageVector
    get() {
        ...
        _cameraStar = tablerOutlineIcon(
            ...
            addPathData("M10.5 20h-5.5C3.895 20 3 19.105 3 18v-9C3 7.895 3.895 7 5 7h1C7.105 7 8 6.105 8 5 8 4.448 8.448 4 9 4h6c.552 0 1 .448 1 1 0 1.105 .895 2 2 2h1c1.105 0 2 .895 2 2v2.5")
            addPathData("M14.569 11.45C13.956 10.433 12.801 9.874 11.623 10.023c-1.178 .149-2.157 .979-2.497 2.117-.34 1.138 .023 2.369 .925 3.14")
