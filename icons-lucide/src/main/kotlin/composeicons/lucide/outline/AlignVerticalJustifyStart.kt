        ...
        _alignVerticalJustifyStart = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(16.10457f, 6.0f, 17.0f, 6.895431f, 17.0f, 8.0f),
                    PathNode.LineTo(17.0f, 10.0f),
                    PathNode.CurveTo(17.0f, 11.104569f, 16.10457f, 12.0f, 15.0f, 12.0f),
                    PathNode.LineTo(9.0f, 12.0f),
                    PathNode.CurveTo(7.895431f, 12.0f, 7.0f, 11.104569f, 7.0f, 10.0f),
                    PathNode.LineTo(7.0f, 8.0f),
                    PathNode.CurveTo(7.0f, 6.895431f, 7.895431f, 6.0f, 9.0f, 6.0f),
                    PathNode.Close
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
