...
val TablerIcons.Outline.PlayCardA: ImageVector
    get() {
        if (_playCardA != null) return _playCardA!!
        _playCardA = tablerOutlineIcon(
            name = "PlayCardA",
            ...
            addPath(
                pathData = parseSvgPathData("M 10.000 15.000 L 10.000 11.000 C 10.000 9.895 10.895 9.000 12.000 9.000 C 13.105 9.000 14.000 9.895 14.000 11.000 L 14.000 15.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
