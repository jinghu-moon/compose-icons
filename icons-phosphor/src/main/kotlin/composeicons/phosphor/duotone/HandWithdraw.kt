...
val PhosphorIcons.Duotone.HandWithdraw: ImageVector
    get() {
        ...
        _handWithdraw = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M184 64v138.31L173.32 186c-4.916-8.465-15.237-12.128-24.39-8.656-9.153 3.473-14.447 13.06-12.51 22.656h-80.42v-136c0-4.418 3.582-8 8-8h112c4.418 0 8 3.582 8 8Z"),
