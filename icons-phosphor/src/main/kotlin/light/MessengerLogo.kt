...
val PhosphorIcons.Light.MessengerLogo: ImageVector
    get() {
        ...
        _messengerLogo = phosphorLightIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(180.24f, 107.76f),
                    PathNode.CurveTo(182.57962f, 110.10254f, 182.57962f, 113.89746f, 180.24f, 116.24f),
                    PathNode.LineTo(148.24f, 148.24f),
                    PathNode.CurveTo(145.89746f, 150.57962f, 142.10254f, 150.57962f, 139.76f, 148.24f),
                    PathNode.LineTo(112.0f, 120.49f),
                    PathNode.LineTo(84.24f, 148.24f),
                    PathNode.CurveTo(81.87592f, 150.44287f, 78.191925f, 150.37787f, 75.90703f, 148.09297f),
                    PathNode.CurveTo(73.62213f, 145.80807f, 73.55713f, 142.12408f, 75.76f, 139.76f),
                    PathNode.LineTo(107.76f, 107.76f),
                    PathNode.CurveTo(110.10254f, 105.42038f, 113.89746f, 105.42038f, 116.24f, 107.76f),
                    PathNode.LineTo(144.0f, 135.51f),
                    PathNode.LineTo(171.76f, 107.76f),
                    PathNode.CurveTo(174.10254f, 105.42038f, 177.89746f, 105.42038f, 180.24f, 107.76f),
                    PathNode.Close,
