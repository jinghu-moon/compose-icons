...
val TablerIcons.Outline.LiveView: ImageVector
    get() {
        ...
        _liveView = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 18.000 L 8.500 13.000 C 7.569 11.318 7.967 9.211 9.448 7.984 C 10.928 6.757 13.072 6.757 14.552 7.984 C 16.033 9.211 16.431 11.318 15.500 13.000 L 12.000 18.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
