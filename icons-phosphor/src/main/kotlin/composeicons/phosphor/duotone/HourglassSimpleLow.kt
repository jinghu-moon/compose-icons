...
val PhosphorIcons.Duotone.HourglassSimpleLow: ImageVector
    get() {
        ...
        _hourglassSimpleLow = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M200 216h-144c-3.238 .003-6.158-1.947-7.397-4.938-1.239-2.991-.554-6.434 1.737-8.722L77.87 176h100.26l27.51 26.34c2.288 2.286 2.975 5.724 1.741 8.713-1.234 2.989-4.147 4.941-7.381 4.947Z"),
