...
val PhosphorIcons.Duotone.CloudMoon: ImageVector
    get() {
        ...
        _cloudMoon = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(106.31f, 130.38f),
                    PathNode.Close,
                    PathNode.MoveTo(102.38f, 17.62f),
                    PathNode.LineTo(102.38f, 17.62f),
                    PathNode.CurveTo(107.31109f, 39.118652f, 100.835236f, 61.64204f, 85.23864f, 77.23864f),
                    PathNode.CurveTo(69.64204f, 92.835236f, 47.118652f, 99.31109f, 25.62f, 94.38f),
                    PathNode.LineTo(25.62f, 94.38f),
                    PathNode.CurveTo(30.242235f, 114.35149f, 44.134968f, 130.90904f, 63.0f, 138.93f),
                    PathNode.LineTo(63.0f, 138.93f),
                    PathNode.CurveTo(74.87295f, 128.5315f, 91.39933f, 125.27428f, 106.33f, 130.39f),
                    PathNode.CurveTo(112.390884f, 107.875175f, 129.54465f, 90.02349f, 151.8f, 83.07f),
                    PathNode.LineTo(151.95f, 83.07f),
                    PathNode.CurveTo(151.95f, 82.07f, 152.02f, 81.07f, 152.02f, 80.07f),
                    PathNode.CurveTo(152.05815f, 50.22552f, 131.46356f, 24.316336f, 102.38f, 17.62f),
                    PathNode.Close
                ),
