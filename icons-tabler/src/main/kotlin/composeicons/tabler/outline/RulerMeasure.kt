...
val TablerIcons.Outline.RulerMeasure: ImageVector
    get() {
        ...
        _rulerMeasure = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(19.875f, 12.0f),
                    PathNode.CurveTo(20.496f, 12.0f, 21.0f, 12.512f, 21.0f, 13.143f),
                    PathNode.LineTo(21.0f, 18.857f),
                    PathNode.CurveTo(21.0f, 19.488f, 20.496f, 20.0f, 19.875f, 20.0f),
                    PathNode.LineTo(4.0f, 20.0f),
                    PathNode.CurveTo(3.447715f, 20.0f, 3.0f, 19.552284f, 3.0f, 19.0f),
                    PathNode.LineTo(3.0f, 13.143f),
                    PathNode.CurveTo(3.0f, 12.512f, 3.504f, 12.0f, 4.125f, 12.0f),
                    PathNode.LineTo(19.875f, 12.0f)
                ),
