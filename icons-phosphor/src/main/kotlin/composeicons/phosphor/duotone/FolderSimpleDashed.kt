...
val PhosphorIcons.Duotone.FolderSimpleDashed: ImageVector
    get() {
        ...
        _folderSimpleDashed = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M224 88v112.89c0 3.927-3.183 7.11-7.11 7.11h-176.89c-4.418 0-8-3.582-8-8v-136c0-4.418 3.582-8 8-8h53.33c1.731 0 3.415 .561 4.8 1.6l27.74 20.8c1.385 1.039 3.069 1.6 4.8 1.6h85.33c4.418 0 8 3.582 8 8Z"),
