        ...
        _ampersand = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(17.5f, 16.418278f, 13.918278f, 20.0f, 9.5f, 20.0f),
                    PathNode.CurveTo(7.014719f, 20.0f, 5.0f, 17.98528f, 5.0f, 15.5f),
                    PathNode.CurveTo(5.0f, 9.5f, 13.0f, 11.5f, 13.0f, 7.0f),
                    PathNode.CurveTo(13.0f, 5.343146f, 11.656855f, 4.0f, 10.0f, 4.0f),
                    PathNode.CurveTo(8.343146f, 4.0f, 7.0f, 5.343146f, 7.0f, 7.0f),
                    PathNode.CurveTo(7.0f, 10.0f, 9.5f, 15.5f, 19.0f, 20.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
