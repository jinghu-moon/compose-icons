...
val TablerIcons.Outline.CloudRain: ImageVector
    get() {
        if (_cloudRain != null) return _cloudRain!!
        _cloudRain = tablerOutlineIcon(
            name = "CloudRain",
    ...
    addPath(
        pathData = parseSvgPathData("M 11.000 13.000 L 11.000 15.000M 11.000 18.000 L 11.000 20.000M 15.000 15.000 L 15.000 17.000M 15.000 20.000 L 15.000 22.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
