        ...
        _appsOff = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.MoveTo(9.71f, 9.704f),
                    PathNode.CurveTo(9.522266f, 9.893387f, 9.266666f, 9.999947f, 9.0f, 10.0f),
                    PathNode.LineTo(5.0f, 10.0f),
                    PathNode.CurveTo(4.447716f, 10.0f, 4.0f, 9.552285f, 4.0f, 9.0f),
                    PathNode.LineTo(4.0f, 5.0f),
                    PathNode.CurveTo(4.0f, 4.724f, 4.111f, 4.475f, 4.292f, 4.294f)
                ),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.MoveTo(19.71f, 19.704f),
                    PathNode.CurveTo(19.522266f, 19.893387f, 19.266666f, 19.999947f, 19.0f, 20.0f),
                    PathNode.LineTo(15.0f, 20.0f),
                    PathNode.CurveTo(14.447715f, 20.0f, 14.0f, 19.552284f, 14.0f, 19.0f),
                    PathNode.LineTo(14.0f, 15.0f),
                    PathNode.CurveTo(14.0f, 14.724f, 14.111f, 14.475f, 14.292f, 14.294f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
