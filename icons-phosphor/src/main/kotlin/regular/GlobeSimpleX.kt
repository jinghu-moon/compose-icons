...
val PhosphorIcons.Regular.GlobeSimpleX: ImageVector
    get() {
        if (_globeSimpleX != null) return _globeSimpleX!!
        _globeSimpleX = phosphorRegularIcon(
            name = "GlobeSimpleX",
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(118.46f, 52.92f, 98.54f, 78.42f, 96.23f, 120.0f),
                    PathNode.LineTo(159.77f, 120.0f),
                    PathNode.CurveTo(157.46f, 78.4f, 137.55f, 52.9f, 128.0f, 43.0f),
                    PathNode.Close,
                    PathNode.MoveTo(40.37f, 120.0f),
                    PathNode.LineTo(80.21f, 120.0f),
                    PathNode.CurveTo(82.0f, 83.49f, 96.06f, 57.67f, 107.59f, 42.4f),
                    PathNode.CurveTo(70.8846f, 51.214382f, 43.859447f, 82.41272f, 40.37f, 120.0f),
                    PathNode.Close,
                    PathNode.MoveTo(80.21f, 136.0f),
                    PathNode.LineTo(40.37f, 136.0f),
                    PathNode.CurveTo(43.859447f, 173.58728f, 70.8846f, 204.78561f, 107.59f, 213.6f),
                    PathNode.CurveTo(96.06f, 198.33f, 82.0f, 172.51f, 80.21f, 136.0f),
                    PathNode.Close
                ),
