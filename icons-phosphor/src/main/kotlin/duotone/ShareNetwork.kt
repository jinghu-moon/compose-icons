        ...
        _shareNetwork = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(158.32689f, 232.0f, 144.0f, 217.67311f, 144.0f, 200.0f),
                    PathNode.CurveTo(144.0f, 182.32689f, 158.32689f, 168.0f, 176.0f, 168.0f),
                    PathNode.CurveTo(193.67311f, 168.0f, 208.0f, 182.32689f, 208.0f, 200.0f),
                    PathNode.Close,
                    PathNode.MoveTo(176.0f, 88.0f),
                    PathNode.CurveTo(193.67311f, 88.0f, 208.0f, 73.67311f, 208.0f, 56.0f),
                    PathNode.CurveTo(208.0f, 38.32689f, 193.67311f, 24.0f, 176.0f, 24.0f),
                    PathNode.CurveTo(158.32689f, 24.0f, 144.0f, 38.32689f, 144.0f, 56.0f),
                    PathNode.CurveTo(144.0f, 73.67311f, 158.32689f, 88.0f, 176.0f, 88.0f),
                    PathNode.Close
                ),
