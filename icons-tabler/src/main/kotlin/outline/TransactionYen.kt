...
val TablerIcons.Outline.TransactionYen: ImageVector
    get() {
        if (_transactionYen != null) return _transactionYen!!
        _transactionYen = tablerOutlineIcon(
            name = "TransactionYen",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24f, height = 24f),
        ) {
            addPath(
                pathData = parseSvgPathData("M 15.000 16.000 L 21.000 16.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 15.000 12.000 L 18.000 16.500"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 21.000 12.000 L 18.000 16.500 L 18.000 21.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 15.000 19.000 L 21.000 19.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
