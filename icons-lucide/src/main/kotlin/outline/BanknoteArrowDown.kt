...
val LucideIcons.Outline.BanknoteArrowDown: ImageVector
    get() {
        ...
        _banknoteArrowDown = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 18.000 L 4.000 18.000 C 2.895 18.000 2.000 17.105 2.000 16.000 L 2.000 8.000 C 2.000 6.895 2.895 6.000 4.000 6.000 L 20.000 6.000 C 21.105 6.000 22.000 6.895 22.000 8.000 L 22.000 13.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 16.000 19.000 L 19.000 22.000 L 22.000 19.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
