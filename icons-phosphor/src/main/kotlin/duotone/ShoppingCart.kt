...
val PhosphorIcons.Duotone.ShoppingCart: ImageVector
    get() {
        if (_shoppingCart != null) return _shoppingCart!!
        _shoppingCart = phosphorDuotoneIcon(
            name = "ShoppingCart",
            ...
            group(
                ...
                addPath(
                    pathData = parseSvgPathData("M 224.000 64.000 L 211.840 130.860 C 210.458 138.468 203.833 143.999 196.100 144.000 L 70.550 144.000 L 56.000 64.000 Z"),
