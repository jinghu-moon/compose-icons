...
val RemixIcons.Fill.HourglassFill: ImageVector
    get() {
        ...
        _hourglassFill = remixIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M6 4h-2v-2h16v2h-2v2c0 1.615-.816 2.915-1.844 3.977-.703 .726-1.558 1.395-2.425 2.023 .867 .628 1.722 1.297 2.425 2.023C17.184 15.085 18 16.385 18 18v2h2v2h-16v-2h2v-2c0-1.615 .816-2.915 1.844-3.977C8.547 13.297 9.402 12.628 10.269 12 9.402 11.372 8.547 10.703 7.844 9.977 6.816 8.915 6 7.615 6 6v-2ZM8 4v2c0 .685 .26 1.335 .771 2h6.457C15.74 7.335 16 6.685 16 6v-2h-8ZM12 13.222c-1.045 .738-1.992 1.441-2.719 2.192-.191 .197-.361 .392-.51 .586h6.457c-.149-.194-.319-.388-.51-.586C13.992 14.663 13.045 13.96 12 13.222Z"),
