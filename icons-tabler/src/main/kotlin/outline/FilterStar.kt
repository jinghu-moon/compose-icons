...
val TablerIcons.Outline.FilterStar: ImageVector
    get() {
        if (_filterStar != null) return _filterStar!!
        _filterStar = tablerOutlineIcon(
            name = "FilterStar",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24.0f, height = 24.0f),
        ) {
    addPath(
        pathData = parseSvgPathData("M 11.042 20.320 L 9.000 21.000 L 9.000 12.500 L 4.520 7.572 C 4.185 7.204 4.000 6.724 4.000 6.227 L 4.000 4.000 L 20.000 4.000 L 20.000 6.172 C 20.000 6.702 19.789 7.211 19.414 7.586 L 15.000 12.000"),
