        ...
        _bellRinging = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(18.152615f, 15.260797f, 18.894886f, 16.374203f, 20.0f, 17.0f),
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(21.0f, 6.727f),
                    PathNode.CurveTo(20.344067f, 5.300253f, 19.391573f, 4.029695f, 18.206f, 3.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(3.0f, 6.727f),
                    PathNode.CurveTo(3.65535f, 5.30044f, 4.60715f, 4.029896f, 5.792f, 3.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
