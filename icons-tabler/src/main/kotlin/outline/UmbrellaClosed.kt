...
val TablerIcons.Outline.UmbrellaClosed: ImageVector
    get() {
        ...
        _umbrellaClosed = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 9.000 16.000 L 12.000 3.000 L 15.000 16.000 L 9.000 16.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 16.000 L 12.000 19.000 C 12.000 21.667 16.000 21.667 16.000 19.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
