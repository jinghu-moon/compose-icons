...
val TablerIcons.Outline.ColorPicker: ImageVector
    get() {
        ...
        _colorPicker = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 4.000 16.000 L 15.700 4.300 C 16.089 3.919 16.711 3.919 17.100 4.300 L 19.700 6.900 C 20.081 7.289 20.081 7.911 19.700 8.300 L 8.000 20.000 L 4.000 20.000 L 4.000 16.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
