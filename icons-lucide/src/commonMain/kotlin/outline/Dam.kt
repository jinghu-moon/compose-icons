...
val LucideIcons.Outline.Dam: ImageVector
    get() {
        ...
        _dam = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(11.0f, 11.31f),
                    PathNode.CurveTo(12.17f, 11.87f, 12.54f, 13.0f, 14.5f, 13.0f),
                    PathNode.CurveTo(17.0f, 13.0f, 17.0f, 11.0f, 19.5f, 11.0f),
                    PathNode.CurveTo(20.8f, 11.0f, 21.4f, 11.5f, 22.0f, 12.0f)
                ),
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(11.75f, 18.0f),
                    PathNode.CurveTo(12.1f, 18.5f, 13.2f, 19.0f, 14.5f, 19.0f),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(10.0f, 3.447715f, 9.552285f, 3.0f, 9.0f, 3.0f),
                    PathNode.Close
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
