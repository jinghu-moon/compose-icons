        ...
        _carCrash = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(8.0f, 18.10457f, 8.895431f, 19.0f, 10.0f, 19.0f),
                    PathNode.CurveTo(11.104569f, 19.0f, 12.0f, 18.10457f, 12.0f, 17.0f),
                    PathNode.CurveTo(12.0f, 15.895431f, 11.104569f, 15.0f, 10.0f, 15.0f),
                    PathNode.CurveTo(8.895431f, 15.0f, 8.0f, 15.895431f, 8.0f, 17.0f)
                ),
