...
val TablerIcons.Outline.WorldPlus: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 20.985 12.518 C 21.200 8.788 19.088 5.313 15.678 3.786 C 12.268 2.259 8.269 2.998 5.630 5.642 C 2.991 8.286 2.259 12.287 3.793 15.694 C 5.326 19.101 8.805 21.206 12.535 20.984"),
    ...
    addPath(
        pathData = parseSvgPathData("M 3.600 15.000 L 15.000 15.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 12.500 3.000 C 14.761 6.622 15.576 10.962 14.783 15.157"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
