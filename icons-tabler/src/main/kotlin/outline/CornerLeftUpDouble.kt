...
val TablerIcons.Outline.CornerLeftUpDouble: ImageVector
    get() {
        ...
        _cornerLeftUpDouble = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 18.000 19.000 L 12.000 19.000 C 10.343 19.000 9.000 17.657 9.000 16.000 L 9.000 9.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 13.000 13.000 L 9.000 9.000 L 5.000 13.000M 13.000 8.000 L 9.000 4.000 L 5.000 8.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
