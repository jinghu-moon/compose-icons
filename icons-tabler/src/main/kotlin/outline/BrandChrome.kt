...
val TablerIcons.Outline.BrandChrome: ImageVector
    get() {
        if (_brandChrome != null) return _brandChrome!!
        _brandChrome = tablerOutlineIcon(
            name = "BrandChrome",
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 9.000 L 20.400 9.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 14.598 13.500 L 10.398 20.775"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 9.402 13.500 L 5.202 6.225"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
