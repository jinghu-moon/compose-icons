        ...
        _arrowBigRightDash = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(13.207f, 19.794f),
                    PathNode.CurveTo(13.004797f, 19.996264f, 12.70065f, 20.056782f, 12.436422f, 19.947325f),
                    PathNode.CurveTo(12.172194f, 19.83787f, 11.999939f, 19.580002f, 12.0f, 19.294f),
                    PathNode.LineTo(12.0f, 16.0f),
                    PathNode.CurveTo(12.0f, 15.447715f, 11.552285f, 15.0f, 11.0f, 15.0f),
                    PathNode.LineTo(9.0f, 15.0f),
                    PathNode.CurveTo(8.447715f, 15.0f, 8.0f, 14.552285f, 8.0f, 14.0f),
                    PathNode.LineTo(8.0f, 10.0f),
                    PathNode.CurveTo(8.0f, 9.447715f, 8.447715f, 9.0f, 9.0f, 9.0f),
                    PathNode.Close
                ),
