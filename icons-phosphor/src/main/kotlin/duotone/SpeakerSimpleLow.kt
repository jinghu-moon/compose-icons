...
val PhosphorIcons.Duotone.SpeakerSimpleLow: ImageVector
    get() {
        if (_speakerSimpleLow != null) return _speakerSimpleLow!!
        _speakerSimpleLow = phosphorDuotoneIcon(
