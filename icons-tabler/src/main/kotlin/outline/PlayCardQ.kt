...
val TablerIcons.Outline.PlayCardQ: ImageVector
    get() {
        ...
        _playCardQ = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 9.000 C 13.105 9.000 14.000 9.895 14.000 11.000 L 14.000 13.000 C 14.000 14.105 13.105 15.000 12.000 15.000 C 10.895 15.000 10.000 14.105 10.000 13.000 L 10.000 11.000 C 10.000 9.895 10.895 9.000 12.000 9.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 13.000 14.000 L 14.500 15.500"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
