...
val TablerIcons.Outline.MoodDollar: ImageVector
    get() {
        ...
        _moodDollar = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 20.870 10.480 C 20.042 5.649 15.500 2.368 10.654 3.101 C 5.807 3.834 2.438 8.310 3.076 13.170 C 3.713 18.030 8.122 21.487 12.994 20.945"),
            ...
            addPath(
                pathData = parseSvgPathData("M 9.500 15.000 C 10.158 15.640 11.060 16.000 12.000 16.000 C 12.357 16.000 12.709 15.948 13.043 15.849"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
