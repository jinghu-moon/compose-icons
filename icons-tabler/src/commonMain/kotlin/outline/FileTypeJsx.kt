        ...
        _fileTypeJsx = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(7.0f, 19.5f),
                    PathNode.CurveTo(7.0f, 20.328426f, 6.328428f, 21.0f, 5.5f, 21.0f),
                    PathNode.CurveTo(4.671573f, 21.0f, 4.0f, 20.328426f, 4.0f, 19.5f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(10.0f, 20.25f),
                    PathNode.CurveTo(10.0f, 20.664f, 10.336f, 21.0f, 10.75f, 21.0f),
                    ...
                    PathNode.LineTo(12.25f, 15.0f),
                    PathNode.CurveTo(12.664213f, 15.0f, 13.0f, 15.335787f, 13.0f, 15.75f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
