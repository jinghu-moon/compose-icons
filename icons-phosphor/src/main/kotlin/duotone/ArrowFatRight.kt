...
val PhosphorIcons.Duotone.ArrowFatRight: ImageVector
    get() {
        if (_arrowFatRight != null) return _arrowFatRight!!
        _arrowFatRight = phosphorDuotoneIcon(
            name = "ArrowFatRight",
    ...
    group(
        ...
        addPath(
            pathData = parseSvgPathData("M 136.000 224.000 L 136.000 176.000 L 48.000 176.000 C 43.582 176.000 40.000 172.418 40.000 168.000 L 40.000 88.000 C 40.000 83.582 43.582 80.000 48.000 80.000 L 136.000 80.000 L 136.000 32.000 L 232.000 128.000 Z"),
