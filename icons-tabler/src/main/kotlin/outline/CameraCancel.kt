...
val TablerIcons.Outline.CameraCancel: ImageVector
    get() {
        ...
        _cameraCancel = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 14.984 13.307 C 15.117 12.011 14.398 10.778 13.205 10.254 C 12.012 9.731 10.617 10.037 9.754 11.013 C 8.890 11.988 8.754 13.409 9.418 14.530 C 10.082 15.651 11.394 16.216 12.664 15.927"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
