        ...
        _paintRoller = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(18.0f, 7.10457f, 17.10457f, 8.0f, 16.0f, 8.0f),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(10.0f, 12.895431f, 10.895431f, 12.0f, 12.0f, 12.0f),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(11.552285f, 16.0f, 12.0f, 16.447716f, 12.0f, 17.0f),
                    PathNode.LineTo(12.0f, 21.0f),
                    PathNode.CurveTo(12.0f, 21.552284f, 11.552285f, 22.0f, 11.0f, 22.0f),
                    PathNode.LineTo(9.0f, 22.0f),
                    PathNode.CurveTo(8.447715f, 22.0f, 8.0f, 21.552284f, 8.0f, 21.0f),
                    PathNode.LineTo(8.0f, 17.0f),
                    PathNode.CurveTo(8.0f, 16.447716f, 8.447715f, 16.0f, 9.0f, 16.0f),
                    PathNode.Close
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
