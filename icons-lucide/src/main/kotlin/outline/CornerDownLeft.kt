...
val LucideIcons.Outline.CornerDownLeft: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 20.000 4.000 L 20.000 11.000 C 20.000 13.209 18.209 15.000 16.000 15.000 L 4.000 15.000"),
    ...
    addPath(
        pathData = parseSvgPathData("M 9.000 10.000 L 4.000 15.000 L 9.000 20.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
