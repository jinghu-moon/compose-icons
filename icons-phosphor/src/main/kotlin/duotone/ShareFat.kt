        ...
        _shareFat = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(90.6f, 144.0f, 47.39f, 181.19f, 30.93f, 198.72f),
                    PathNode.CurveTo(29.752682f, 199.98274f, 27.898054f, 200.34763f, 26.330122f, 199.62502f),
                    PathNode.CurveTo(24.762188f, 198.9024f, 23.8348f, 197.25537f, 24.03f, 195.54f),
                    PathNode.CurveTo(31.51f, 130.45f, 99.19f, 80.0f, 152.0f, 80.0f),
