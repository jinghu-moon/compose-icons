...
val TablerIcons.Outline.Sphere: ImageVector
    get() {
        if (_sphere != null) return _sphere!!
        _sphere = tablerOutlineIcon(
            name = "Sphere",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24f, height = 24f),
        ) {
            addPath(
                pathData = parseSvgPathData("M 3.000 12.000 C 3.000 13.657 7.030 15.000 12.000 15.000 C 16.970 15.000 21.000 13.657 21.000 12.000"),
