...
val TablerIcons.Outline.ArrowRampLeft3: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 18.000 3.000 L 18.000 9.000"),
    ...
    addPath(
        pathData = parseSvgPathData("M 18.000 21.000 L 18.000 15.000 C 18.000 13.343 16.657 12.000 15.000 12.000 L 4.000 12.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
