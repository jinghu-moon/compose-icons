...
val RemixIcons.Line.ShoppingCartLine: ImageVector
    get() {
        ...
        _shoppingCartLine = remixIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M4.005 16v-12h-2v-2h3c.552 0 1 .448 1 1v12h12.438l2-8h-12.438v-2h13.719c.552 0 1 .448 1 1 0 .082-.01 .163-.03 .243l-2.5 10c-.111 .445-.511 .757-.97 .757h-14.219c-.552 0-1-.448-1-1ZM6.005 23c-1.105 0-2-.895-2-2 0-1.105 .895-2 2-2 1.105 0 2 .895 2 2 0 1.105-.895 2-2 2ZM18.005 23c-1.105 0-2-.895-2-2 0-1.105 .895-2 2-2 1.105 0 2 .895 2 2 0 1.105-.895 2-2 2Z"),
