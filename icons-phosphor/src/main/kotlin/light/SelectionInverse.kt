...
val PhosphorIcons.Light.SelectionInverse: ImageVector
    get() {
        ...
        _selectionInverse = phosphorLightIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(150.0f, 216.0f),
                    PathNode.CurveTo(150.0f, 219.3137f, 147.3137f, 222.0f, 144.0f, 222.0f),
                    PathNode.LineTo(112.0f, 222.0f),
                    PathNode.CurveTo(108.686295f, 222.0f, 106.0f, 219.3137f, 106.0f, 216.0f),
                    PathNode.CurveTo(106.0f, 212.6863f, 108.686295f, 210.0f, 112.0f, 210.0f),
                    PathNode.LineTo(144.0f, 210.0f),
                    PathNode.CurveTo(147.3137f, 210.0f, 150.0f, 212.6863f, 150.0f, 216.0f),
                    PathNode.Close,
                    ...
                    PathNode.CurveTo(178.0f, 212.6863f, 180.6863f, 210.0f, 184.0f, 210.0f),
                    PathNode.LineTo(201.51f, 210.0f),
                    PathNode.LineTo(46.0f, 54.48f),
                    PathNode.LineTo(46.0f, 72.0f),
                    PathNode.CurveTo(46.0f, 75.313705f, 43.31371f, 78.0f, 40.0f, 78.0f),
