...
val PhosphorIcons.Thin.ArrowBendDoubleUpLeft: ImageVector
    get() {
        ...
        _arrowBendDoubleUpLeft = phosphorThinIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(82.83f, 149.17f),
                    ...
                    PathNode.LineTo(37.66f, 104.0f),
                    PathNode.Close,
                    PathNode.MoveTo(128.0f, 100.0f),
                    PathNode.LineTo(89.66f, 100.0f),
                    PathNode.LineTo(130.83f, 58.83f),
                    PathNode.CurveTo(132.39296f, 57.267033f, 132.39296f, 54.732967f, 130.83f, 53.17f),
                    PathNode.CurveTo(129.26703f, 51.607033f, 126.73296f, 51.607033f, 125.17f, 53.17f),
                    PathNode.LineTo(77.17f, 101.17f),
                    PathNode.CurveTo(76.418884f, 101.92027f, 75.99686f, 102.93836f, 75.99686f, 104.0f),
                    PathNode.CurveTo(75.99686f, 105.06164f, 76.418884f, 106.07973f, 77.17f, 106.83f),
                    PathNode.LineTo(125.17f, 154.83f),
                    PathNode.CurveTo(126.73296f, 156.39296f, 129.26703f, 156.39296f, 130.83f, 154.83f),
                    PathNode.CurveTo(132.39296f, 153.26703f, 132.39296f, 150.73297f, 130.83f, 149.17f),
                    PathNode.LineTo(89.66f, 108.0f),
                    PathNode.LineTo(128.0f, 108.0f),
                    PathNode.CurveTo(178.78735f, 108.055115f, 219.94489f, 149.21265f, 220.0f, 200.0f),
                    PathNode.CurveTo(220.0f, 202.20914f, 221.79086f, 204.0f, 224.0f, 204.0f),
                    PathNode.CurveTo(226.20914f, 204.0f, 228.0f, 202.20914f, 228.0f, 200.0f),
                    PathNode.CurveTo(227.93938f, 144.79666f, 183.20334f, 100.06062f, 128.0f, 100.0f),
                    PathNode.Close
                ),
