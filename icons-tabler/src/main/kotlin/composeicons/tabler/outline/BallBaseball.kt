...
val TablerIcons.Outline.BallBaseball: ImageVector
    get() {
        ...
        _ballBaseball = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(5.636f, 18.364f),
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(12.495f, 3.02f),
                    PathNode.CurveTo(12.633701f, 5.572926f, 11.680068f, 8.064362f, 9.872214f, 9.872214f),
                    PathNode.CurveTo(8.064362f, 11.680068f, 5.572926f, 12.633701f, 3.02f, 12.495f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(20.98f, 11.505f),
                    PathNode.CurveTo(18.427074f, 11.366299f, 15.935638f, 12.319932f, 14.127786f, 14.127786f),
                    PathNode.CurveTo(12.319932f, 15.935638f, 11.366299f, 18.427074f, 11.505f, 20.98f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
