...
val TablerIcons.Outline.DatabaseExport: ImageVector
    get() {
        if (_databaseExport != null) return _databaseExport!!
        _databaseExport = tablerOutlineIcon(
            name = "DatabaseExport",
    ...
    addPath(
        pathData = parseSvgPathData("M 4.000 6.000 L 4.000 12.000 C 4.000 13.657 7.582 15.000 12.000 15.000 C 13.118 15.000 14.183 14.914 15.150 14.759"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 4.000 12.000 L 4.000 18.000 C 4.000 19.657 7.582 21.000 12.000 21.000 C 12.157 21.000 12.312 20.998 12.466 20.995"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
