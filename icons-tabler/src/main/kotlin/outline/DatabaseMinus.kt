...
val TablerIcons.Outline.DatabaseMinus: ImageVector
    get() {
        ...
        _databaseMinus = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 4.000 12.000 L 4.000 18.000 C 4.000 19.657 7.582 21.000 12.000 21.000 C 12.164 21.000 12.328 20.998 12.490 20.994"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 20.000 15.000 L 20.000 12.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
