...
val LucideIcons.Outline.BadgeEuro: ImageVector
    get() {
        ...
        _badgeEuro = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 7.000 12.000 L 12.000 12.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 15.000 9.400 C 13.911 8.127 12.145 7.668 10.574 8.248 C 9.003 8.828 7.960 10.325 7.960 12.000 C 7.960 13.675 9.003 15.172 10.574 15.752 C 12.145 16.332 13.911 15.873 15.000 14.600"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
