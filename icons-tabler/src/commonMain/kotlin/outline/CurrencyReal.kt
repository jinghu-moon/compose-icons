        ...
        _currencyReal = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(8.656855f, 6.0f, 10.0f, 7.343146f, 10.0f, 9.0f),
                    PathNode.CurveTo(10.0f, 10.656855f, 8.656855f, 12.0f, 7.0f, 12.0f),
                    PathNode.LineTo(4.0f, 12.0f),
                    PathNode.CurveTo(9.5f, 12.0f, 9.0f, 16.0f, 10.0f, 18.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
