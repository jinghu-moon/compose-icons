...
val TablerIcons.Outline.HeartCog: ImageVector
    get() {
        ...
        _heartCog = tablerOutlineIcon(
            ...
            addPathData("M12 20 4.5 12.572C3.151 11.26 2.654 9.301 3.212 7.504 3.771 5.707 5.292 4.376 7.147 4.06 9.002 3.743 10.877 4.496 12 6.006 13.614 3.856 16.64 3.368 18.849 4.9c2.209 1.533 2.81 4.538 1.361 6.803")
