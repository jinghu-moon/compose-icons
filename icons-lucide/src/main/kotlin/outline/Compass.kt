...
val LucideIcons.Outline.Compass: ImageVector
    get() {
        ...
        _compass = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 16.240 7.760 L 14.436 13.171 C 14.237 13.768 13.768 14.237 13.171 14.436 L 7.760 16.240 L 9.564 10.829 C 9.763 10.232 10.232 9.763 10.829 9.564 Z"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
