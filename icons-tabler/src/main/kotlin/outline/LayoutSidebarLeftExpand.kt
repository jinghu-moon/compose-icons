...
val TablerIcons.Outline.LayoutSidebarLeftExpand: ImageVector
    get() {
        if (_layoutSidebarLeftExpand != null) return _layoutSidebarLeftExpand!!
        _layoutSidebarLeftExpand = tablerOutlineIcon(
    ...
    addPath(
        pathData = parseSvgPathData("M 14.000 10.000 L 16.000 12.000 L 14.000 14.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
