...
val TablerIcons.Outline.DeviceHeartMonitor: ImageVector
    get() {
        if (_deviceHeartMonitor != null) return _deviceHeartMonitor!!
        _deviceHeartMonitor = tablerOutlineIcon(
    ...
    addPath(
        pathData = parseSvgPathData("M 4.000 9.000 L 10.000 9.000 L 11.000 7.000 L 13.000 11.000 L 14.000 9.000 L 20.000 9.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
