...
val TablerIcons.Outline.Rating21Plus: ImageVector
    get() {
        ...
        _rating21Plus = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 13.000 15.000 L 13.000 9.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 7.000 10.500 C 7.000 9.672 7.672 9.000 8.500 9.000 C 9.328 9.000 10.000 9.672 10.000 10.500 C 10.000 10.943 9.687 11.489 9.388 11.893 L 7.000 15.000 L 10.000 15.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
