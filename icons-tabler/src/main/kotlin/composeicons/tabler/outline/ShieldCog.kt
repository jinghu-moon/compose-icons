...
val TablerIcons.Outline.ShieldCog: ImageVector
    get() {
        ...
        _shieldCog = tablerOutlineIcon(
            ...
            addPathData("M12 21C8.855 20.184 6.175 18.128 4.573 15.301 2.971 12.473 2.584 9.118 3.5 6 6.616 6.143 9.664 5.067 12 3c2.336 2.067 5.384 3.143 8.5 3 .568 1.933 .635 3.957 .223 5.89")
