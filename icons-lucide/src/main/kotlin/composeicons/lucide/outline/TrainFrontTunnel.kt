...
val LucideIcons.Outline.TrainFrontTunnel: ImageVector
    get() {
        ...
        _trainFrontTunnel = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(15.0f, 6.8f),
                    PathNode.LineTo(15.0f, 8.2f),
                    PathNode.CurveTo(15.0f, 9.746397f, 13.656855f, 11.0f, 12.0f, 11.0f),
                    PathNode.CurveTo(10.343145f, 11.0f, 9.0f, 9.746397f, 9.0f, 8.2f),
                    PathNode.LineTo(9.0f, 6.8f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(7.790861f, 19.0f, 6.0f, 17.209139f, 6.0f, 15.0f),
                    ...
                    PathNode.CurveTo(18.0f, 17.209139f, 16.209139f, 19.0f, 14.0f, 19.0f),
                    PathNode.Close
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
