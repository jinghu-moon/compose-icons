        ...
        _rollercoasterOff = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(5.388835f, 20.999908f, 7.509612f, 19.471256f, 8.265001f, 17.205f),
                    PathNode.LineTo(9.0f, 15.0f),
                    PathNode.CurveTo(9.464348f, 13.604698f, 10.272521f, 12.348763f, 11.35f, 11.348f),
                    PathNode.MoveTo(13.753f, 9.759f),
                    PathNode.CurveTo(14.877127f, 9.257879f, 16.094234f, 8.999261f, 17.325f, 9.0f),
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(9.446f, 5.415f),
                    PathNode.LineTo(10.0f, 5.0f),
                    PathNode.LineTo(12.0f, 7.5f),
                    PathNode.LineTo(11.715f, 7.713f),
                    PathNode.MoveTo(9.447f, 9.415f),
                    PathNode.LineTo(8.0f, 10.5f),
                    PathNode.LineTo(6.2f, 10.0f),
                    PathNode.LineTo(6.0f, 8.0f),
                    PathNode.LineTo(7.139f, 7.146f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
