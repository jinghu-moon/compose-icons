...
val PhosphorIcons.Thin.PencilLine: ImageVector
    get() {
        ...
        _pencilLine = phosphorThinIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M224.49 76.2 179.8 31.51c-2.252-2.259-5.31-3.529-8.5-3.529-3.19 0-6.248 1.27-8.5 3.529L39.51 154.83c-2.247 2.25-3.51 5.3-3.51 8.48v44.69c0 6.627 5.373 12 12 12h168c2.209 0 4-1.791 4-4 0-2.209-1.791-4-4-4h-110.34L224.49 93.17c4.686-4.686 4.686-12.284 0-16.97ZM73.66 188 164 97.66 186.35 120 96 210.34ZM68 182.34 45.66 160 136 69.66 158.35 92ZM44 208v-38.34l21.17 21.17h0L86.34 212h-38.34c-2.209 0-4-1.791-4-4ZM218.83 87.51 192 114.34 141.66 64 168.49 37.17c.75-.751 1.768-1.173 2.83-1.173 1.062 0 2.08 .422 2.83 1.173l44.68 44.69c1.558 1.561 1.558 4.089 0 5.65Z"),
