...
val RemixIcons.Fill.RestaurantFill: ImageVector
    get() {
        ...
        _restaurantFill = remixIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M21 2v20h-2v-8h-3v-7C16 4.239 18.239 2 21 2ZM9 13.9v8.1h-2v-8.1C4.718 13.437 3 11.419 3 9v-6h2v7h2v-7h2v7h2v-7h2v6c0 2.419-1.718 4.437-4 4.9Z"),
