        ...
        _parachute = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(128.0f, 24.0f, 88.0f, 48.0f, 88.0f, 120.0f),
                    PathNode.LineTo(32.0f, 120.0f),
                    PathNode.CurveTo(32.0f, 66.98067f, 74.98067f, 24.0f, 128.0f, 24.0f),
                    PathNode.Close,
                    PathNode.MoveTo(128.0f, 24.0f),
                    PathNode.CurveTo(128.0f, 24.0f, 168.0f, 48.0f, 168.0f, 120.0f),
                    PathNode.LineTo(224.0f, 120.0f),
                    PathNode.CurveTo(224.0f, 66.98067f, 181.01933f, 24.0f, 128.0f, 24.0f),
                    PathNode.Close
                ),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(24.002855f, 122.47949f, 25.155247f, 124.81751f, 27.12f, 126.33f),
                    PathNode.LineTo(27.2f, 126.4f),
