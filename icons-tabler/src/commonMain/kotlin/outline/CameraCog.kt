...
val TablerIcons.Outline.CameraCog: ImageVector
    get() {
        if (_cameraCog != null) return _cameraCog!!
        _cameraCog = tablerOutlineIcon(
            name = "CameraCog",
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(14.973f, 13.406f),
                    PathNode.CurveTo(15.142233f, 12.167016f, 14.525188f, 10.953009f, 13.424537f, 10.359469f),
                    PathNode.CurveTo(12.323885f, 9.76593f, 10.97051f, 9.917365f, 10.028264f, 10.739493f),
                    PathNode.CurveTo(9.086018f, 11.561622f, 8.752555f, 12.881985f, 9.191444f, 14.052924f),
                    PathNode.CurveTo(9.630335f, 15.223863f, 10.749512f, 15.99975f, 12.0f, 16.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
