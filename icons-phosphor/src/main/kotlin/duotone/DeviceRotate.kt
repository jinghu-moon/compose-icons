...
val PhosphorIcons.Duotone.DeviceRotate: ImageVector
    get() {
        if (_deviceRotate != null) return _deviceRotate!!
        _deviceRotate = phosphorDuotoneIcon(
            name = "DeviceRotate",
    ...
    group(
        ...
        addPath(
            pathData = parseSvgPathData("M 192.000 56.000 L 192.000 200.000 C 192.000 208.837 184.837 216.000 176.000 216.000 L 80.000 216.000 C 71.163 216.000 64.000 208.837 64.000 200.000 L 64.000 56.000 C 64.000 47.163 71.163 40.000 80.000 40.000 L 176.000 40.000 C 184.837 40.000 192.000 47.163 192.000 56.000 Z"),
