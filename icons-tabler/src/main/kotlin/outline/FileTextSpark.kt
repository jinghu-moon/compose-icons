...
val TablerIcons.Outline.FileTextSpark: ImageVector
    get() {
        ...
        _fileTextSpark = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 21.000 L 7.000 21.000 C 5.895 21.000 5.000 20.105 5.000 19.000 L 5.000 5.000 C 5.000 3.895 5.895 3.000 7.000 3.000 L 14.000 3.000 L 19.000 8.000 L 19.000 11.500"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
