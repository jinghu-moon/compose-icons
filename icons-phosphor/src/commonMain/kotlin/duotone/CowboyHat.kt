...
val PhosphorIcons.Duotone.CowboyHat: ImageVector
    get() {
        if (_cowboyHat != null) return _cowboyHat!!
        _cowboyHat = phosphorDuotoneIcon(
            name = "CowboyHat",
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(190.53f, 160.18f),
                    PathNode.CurveTo(158.13f, 192.0f, 128.0f, 192.0f, 128.0f, 192.0f),
                    PathNode.CurveTo(128.0f, 192.0f, 97.87f, 192.0f, 65.47f, 160.18f),
                    PathNode.LineTo(70.06f, 136.0f),
                    PathNode.LineTo(185.94f, 136.0f),
                    PathNode.Close
                ),
