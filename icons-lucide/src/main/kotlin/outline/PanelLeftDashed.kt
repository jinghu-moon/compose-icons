...
val LucideIcons.Outline.PanelLeftDashed: ImageVector
    get() {
        if (_panelLeftDashed != null) return _panelLeftDashed!!
        _panelLeftDashed = lucideOutlineIcon(
    ...
    addPath(
        pathData = parseSvgPathData("M 9.000 19.000 L 9.000 21.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 9.000 3.000 L 9.000 5.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
