...
val TablerIcons.Outline.NavigationCog: ImageVector
    get() {
        if (_navigationCog != null) return _navigationCog!!
        _navigationCog = tablerOutlineIcon(
            name = "NavigationCog",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24f, height = 24f),
        ) {
            addPath(
                pathData = parseSvgPathData("M 16.387 12.510 L 12.000 3.000 L 4.030 20.275 C 3.960 20.475 4.013 20.699 4.165 20.847 C 4.315 20.995 4.539 21.040 4.735 20.963 L 12.000 18.500"),
