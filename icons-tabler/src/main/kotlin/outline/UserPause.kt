...
val TablerIcons.Outline.UserPause: ImageVector
    get() {
        if (_userPause != null) return _userPause!!
        _userPause = tablerOutlineIcon(
            name = "UserPause",
            ...
            addPath(
                pathData = parseSvgPathData("M 6.000 21.000 L 6.000 19.000 C 6.000 16.791 7.791 15.000 10.000 15.000 L 13.500 15.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
