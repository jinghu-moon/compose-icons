...
val TablerIcons.Outline.TriangleMinus2: ImageVector
    get() {
        ...
        _triangleMinus2 = tablerOutlineIcon(
            ...
            addPathData("M20.48 15.016 13.637 3.59C13.29 3.017 12.669 2.668 12 2.668c-.669 0-1.29 .35-1.637 .922L2.257 17.125c-.34 .589-.342 1.314-.005 1.905 .337 .591 .962 .959 1.641 .966h8.107")
