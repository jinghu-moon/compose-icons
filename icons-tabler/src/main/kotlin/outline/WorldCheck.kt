...
val TablerIcons.Outline.WorldCheck: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 20.946 12.990 C 21.351 9.329 19.485 5.790 16.234 4.057 C 12.983 2.325 9.005 2.748 6.191 5.126 C 3.378 7.504 2.297 11.356 3.464 14.850 C 4.630 18.344 7.808 20.774 11.486 20.985"),
    ...
    addPath(
        pathData = parseSvgPathData("M 3.600 15.000 L 17.500 15.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 12.500 3.000 C 14.732 6.575 15.555 10.852 14.811 15.001"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
