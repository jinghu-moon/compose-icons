...
val PhosphorIcons.Duotone.Horse: ImageVector
    get() {
        ...
        _horse = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M224 129.37c-.72 51.48-42.57 93.59-94.05 94.61-12.919 .292-25.768-1.971-37.81-6.66L128 168h0C101.36 152 70.77 156.7 53.3 159.66 44.262 161.195 35.138 157.446 29.79 150L16 128 120 64v-32h8c25.7-.003 50.328 10.299 68.371 28.6 18.043 18.301 27.996 43.072 27.629 68.77Z"),
