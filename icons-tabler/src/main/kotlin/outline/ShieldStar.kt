...
val TablerIcons.Outline.ShieldStar: ImageVector
    get() {
        if (_shieldStar != null) return _shieldStar!!
        _shieldStar = tablerOutlineIcon(
            name = "ShieldStar",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24f, height = 24f),
        ) {
            addPath(
                pathData = parseSvgPathData("M 11.143 20.743 C 5.057 18.670 1.687 12.168 3.500 6.000 C 6.616 6.143 9.664 5.067 12.000 3.000 C 14.336 5.067 17.384 6.143 20.500 6.000 C 21.004 7.716 21.114 9.505 20.843 11.237"),
