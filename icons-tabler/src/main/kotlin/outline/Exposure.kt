...
val TablerIcons.Outline.Exposure: ImageVector
    get() {
        ...
        _exposure = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 3.600 20.400 L 20.400 3.600"),
            ...
            addPath(
                pathData = parseSvgPathData("M 6.000 8.000 L 10.000 8.000M 8.000 6.000 L 8.000 10.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 14.000 16.000 L 18.000 16.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
