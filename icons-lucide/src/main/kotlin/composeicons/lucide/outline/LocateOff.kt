...
val LucideIcons.Outline.LocateOff: ImageVector
    get() {
        ...
        _locateOff = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(18.89f, 13.24f),
                    PathNode.CurveTo(19.29646f, 10.983372f, 18.57196f, 8.670748f, 16.950605f, 7.049394f),
                    PathNode.CurveTo(15.329252f, 5.42804f, 13.016628f, 4.703541f, 10.76f, 5.11f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(7.05f, 7.05f),
                    PathNode.CurveTo(4.316191f, 9.78381f, 4.316191f, 14.21619f, 7.05f, 16.95f),
                    PathNode.CurveTo(9.78381f, 19.68381f, 14.21619f, 19.68381f, 16.95f, 16.95f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
