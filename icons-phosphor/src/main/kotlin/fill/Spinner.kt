...
val PhosphorIcons.Fill.Spinner: ImageVector
    get() {
        if (_spinner != null) return _spinner!!
        _spinner = phosphorFillIcon(
            name = "Spinner",
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(161.94f, 82.75f),
                    PathNode.LineTo(178.94f, 65.75f),
                    PathNode.CurveTo(182.06593f, 62.62407f, 187.13406f, 62.62407f, 190.26f, 65.75f),
                    PathNode.CurveTo(193.38593f, 68.87593f, 193.38593f, 73.94407f, 190.26f, 77.07f),
                    PathNode.LineTo(173.26f, 94.07f),
                    PathNode.CurveTo(170.11469f, 97.05823f, 165.16075f, 96.994804f, 162.09297f, 93.927025f),
                    PathNode.CurveTo(159.0252f, 90.859245f, 158.96176f, 85.90531f, 161.95f, 82.76f),
                    PathNode.Close,
