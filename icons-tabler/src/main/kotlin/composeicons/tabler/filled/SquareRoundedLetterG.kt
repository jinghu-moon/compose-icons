...
val TablerIcons.Filled.SquareRoundedLetterG: ImageVector
    get() {
        ...
        _squareRoundedLetterG = tablerFilledIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M11.676 2.001 12 2c7.752 0 10 2.248 10 10l-.005 .642C21.869 19.877 19.534 22 12 22l-.642-.005C4.228 21.87 2.063 19.6 2 12.325v-.325C2 4.357 4.185 2.064 11.676 2.001M14 7h-2C10.343 7 9 8.343 9 10v4c0 1.657 1.343 3 3 3h2c.552 0 1-.448 1-1v-4c0-.552-.448-1-1-1h-1c-.552 0-1 .448-1 1l.007 .117c.059 .503 .486 .883 .993 .883v2h-1c-.552 0-1-.448-1-1v-4c0-.552 .448-1 1-1h2c.552 0 1-.448 1-1C15 7.448 14.552 7 14 7"),
