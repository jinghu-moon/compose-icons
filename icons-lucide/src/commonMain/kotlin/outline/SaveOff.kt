...
val LucideIcons.Outline.SaveOff: ImageVector
    get() {
        ...
        _saveOff = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(20.41f, 20.41f),
                    PathNode.CurveTo(20.03665f, 20.785587f, 19.529577f, 20.997766f, 19.0f, 21.0f),
                    PathNode.LineTo(5.0f, 21.0f),
                    PathNode.CurveTo(3.895431f, 21.0f, 3.0f, 20.10457f, 3.0f, 19.0f),
                    PathNode.LineTo(3.0f, 5.0f),
                    PathNode.CurveTo(3.002233f, 4.470423f, 3.214412f, 3.96335f, 3.59f, 3.59f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(29.5f, 11.5f),
                    PathNode.CurveTo(29.5f, 11.5f, 34.5f, 16.5f, 33.5f, 16.5f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(15.2f, 3.0f),
                    PathNode.CurveTo(15.727538f, 3.007514f, 16.23074f, 3.223172f, 16.6f, 3.6f),
                    PathNode.LineTo(20.4f, 7.4f),
                    PathNode.CurveTo(20.776829f, 7.769261f, 20.992485f, 8.272462f, 21.0f, 8.8f),
