...
val TablerIcons.Outline.LockX: ImageVector
    get() {
        if (_lockX != null) return _lockX!!
        _lockX = tablerOutlineIcon(
            name = "LockX",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24f, height = 24f),
        ) {
            addPath(
                pathData = parseSvgPathData("M 13.000 21.000 L 7.000 21.000 C 5.895 21.000 5.000 20.105 5.000 19.000 L 5.000 13.000 C 5.000 11.895 5.895 11.000 7.000 11.000 L 17.000 11.000 C 18.105 11.000 19.000 11.895 19.000 13.000 L 19.000 13.500"),
