...
val PhosphorIcons.Duotone.PersonSimpleSnowboard: ImageVector
    get() {
        ...
        _personSimpleSnowboard = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M144 52c0-11.046 8.954-20 20-20 11.046 0 20 8.954 20 20 0 11.046-8.954 20-20 20C152.954 72 144 63.046 144 52ZM195.56 190.33 38.12 144.7c-5.204-1.532-10.826-.526-15.176 2.715-4.35 3.241-6.922 8.34-6.944 13.765h0c.014 7.653 5.085 14.375 12.44 16.49l157.44 45.63c9.113 2.673 18.667-2.547 21.34-11.66 2.673-9.113-2.547-18.667-11.66-21.34Z"),
