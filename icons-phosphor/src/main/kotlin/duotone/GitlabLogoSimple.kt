    ...
    get() {
        ...
        _gitlabLogoSimple = phosphorDuotoneIcon(
            ...
            group(
                ...
                addPath(
                    pathData = parseSvgPathData("M 203.520 171.520 L 130.260 223.280 C 128.906 224.239 127.094 224.239 125.740 223.280 L 52.480 171.520 C 35.910 159.673 28.397 138.811 33.610 119.120 L 53.500 43.000 C 53.925 41.330 55.389 40.131 57.110 40.044 C 58.831 39.957 60.408 41.001 61.000 42.620 L 80.650 96.000 L 175.350 96.000 L 195.000 42.620 C 195.576 40.975 197.167 39.906 198.907 39.994 C 200.648 40.082 202.122 41.306 202.530 43.000 L 222.420 119.120 C 227.626 138.817 220.101 159.681 203.520 171.520 Z"),
