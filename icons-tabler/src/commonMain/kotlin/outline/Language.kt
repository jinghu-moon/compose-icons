...
val TablerIcons.Outline.Language: ImageVector
    get() {
        ...
        _language = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(9.0f, 6.371f),
                    PathNode.CurveTo(9.0f, 10.789f, 6.761f, 13.0f, 4.0f, 13.0f)
                ),
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(6.694f, 3.0f),
                    PathNode.LineTo(7.487f, 3.582f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
