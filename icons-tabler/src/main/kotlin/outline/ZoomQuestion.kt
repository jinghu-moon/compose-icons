...
val TablerIcons.Outline.ZoomQuestion: ImageVector
    get() {
        ...
        _zoomQuestion = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 10.000 13.000 L 10.000 13.010"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 10.000 10.000 C 10.694 10.000 11.297 9.525 11.459 8.851 C 11.621 8.176 11.300 7.478 10.682 7.164 C 10.064 6.849 9.310 6.998 8.860 7.526"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
