...
val RemixIcons.Fill.TerminalWindowFill: ImageVector
    get() {
        ...
        _terminalWindowFill = remixIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M20 10h-16v9h16v-9ZM3 3h18c.552 0 1 .448 1 1v16c0 .552-.448 1-1 1h-18C2.448 21 2 20.552 2 20v-16C2 3.448 2.448 3 3 3ZM5 6v2h2v-2h-2ZM9 6v2h2v-2h-2ZM5 11h3v5h-3v-5Z"),
