...
val TablerIcons.Filled.InnerShadowBottomLeft: ImageVector
    get() {
        ...
        _innerShadowBottomLeft = tablerFilledIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M12 2c5.523 0 10 4.477 10 10 0 5.523-4.477 10-10 10C6.477 22 2 17.523 2 12 2 6.477 6.477 2 12 2ZM6 11c-.552 0-1 .448-1 1 0 3.866 3.134 7 7 7 .552 0 1-.448 1-1 0-.552-.448-1-1-1C9.239 17 7 14.761 7 12 7 11.448 6.552 11 6 11Z"),
