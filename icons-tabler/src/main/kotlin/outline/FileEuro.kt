...
val TablerIcons.Outline.FileEuro: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 12.000 14.000 L 9.000 14.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 14.000 11.172 C 12.757 10.732 11.372 11.155 10.587 12.216 C 9.803 13.276 9.803 14.724 10.587 15.784 C 11.372 16.845 12.757 17.268 14.000 16.828"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
