...
val LucideIcons.Outline.ScanBarcode: ImageVector
    get() {
        if (_scanBarcode != null) return _scanBarcode!!
        _scanBarcode = lucideOutlineIcon(
            name = "ScanBarcode",
    ...
    addPath(
        pathData = parseSvgPathData("M 8.000 7.000 L 8.000 17.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 17.000 7.000 L 17.000 17.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
