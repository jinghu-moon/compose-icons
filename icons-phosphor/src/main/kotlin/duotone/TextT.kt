...
val PhosphorIcons.Duotone.TextT: ImageVector
    get() {
        if (_textT != null) return _textT!!
        _textT = phosphorDuotoneIcon(
            name = "TextT",
            ...
            group(
                ...
                addPath(
                    pathData = parseSvgPathData("M 200.000 56.000 L 200.000 184.000 C 200.000 192.837 192.837 200.000 184.000 200.000 L 72.000 200.000 C 63.163 200.000 56.000 192.837 56.000 184.000 L 56.000 56.000 Z"),
