...
val TablerIcons.Outline.Ruler3: ImageVector
    get() {
        ...
        _ruler3 = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(19.875f, 8.0f),
                    PathNode.CurveTo(20.496f, 8.0f, 21.0f, 8.512f, 21.0f, 9.143f),
                    PathNode.LineTo(21.0f, 14.857f),
                    PathNode.CurveTo(21.0f, 15.488f, 20.496f, 16.0f, 19.875f, 16.0f),
                    PathNode.LineTo(4.0f, 16.0f),
                    PathNode.CurveTo(3.447715f, 16.0f, 3.0f, 15.552285f, 3.0f, 15.0f),
                    PathNode.LineTo(3.0f, 9.143f),
                    PathNode.CurveTo(3.0f, 8.512f, 3.504f, 8.0f, 4.125f, 8.0f),
                    PathNode.LineTo(19.875f, 8.0f)
                ),
