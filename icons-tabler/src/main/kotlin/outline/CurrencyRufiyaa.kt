...
val TablerIcons.Outline.CurrencyRufiyaa: ImageVector
    get() {
        ...
        _currencyRufiyaa = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 20.000 16.000 L 20.010 16.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 4.000 16.000 C 13.500 12.000 15.500 8.000 18.000 7.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 8.000 L 17.000 11.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
