...
val LucideIcons.Outline.InspectionPanel: ImageVector
    get() {
        if (_inspectionPanel != null) return _inspectionPanel!!
        _inspectionPanel = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 7.000 7.000 L 7.010 7.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 17.000 17.000 L 17.010 17.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
