...
val TablerIcons.Outline.RewindBackward40: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 6.000 14.000 L 6.000 16.000 C 6.000 16.552 6.448 17.000 7.000 17.000 L 8.000 17.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 9.000 14.000 L 9.000 20.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
