        ...
        _behanceLogo = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(160.0f, 129.90862f, 177.90862f, 112.0f, 200.0f, 112.0f),
                    PathNode.CurveTo(222.09138f, 112.0f, 240.0f, 129.90862f, 240.0f, 152.0f),
                    PathNode.Close,
                    PathNode.MoveTo(94.0f, 124.0f),
                    PathNode.LineTo(90.0f, 124.0f),
                    PathNode.CurveTo(106.56854f, 124.0f, 120.0f, 110.56854f, 120.0f, 94.0f),
                    PathNode.CurveTo(120.0f, 77.43146f, 106.56854f, 64.0f, 90.0f, 64.0f),
                    PathNode.LineTo(32.0f, 64.0f),
                    PathNode.LineTo(32.0f, 192.0f),
                    PathNode.LineTo(94.0f, 192.0f),
                    PathNode.CurveTo(112.77768f, 192.0f, 128.0f, 176.77768f, 128.0f, 158.0f),
                    PathNode.CurveTo(128.0f, 139.22232f, 112.77768f, 124.0f, 94.0f, 124.0f),
                    PathNode.Close
                ),
