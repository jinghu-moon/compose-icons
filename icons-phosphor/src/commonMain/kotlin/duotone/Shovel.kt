...
val PhosphorIcons.Duotone.Shovel: ImageVector
    get() {
        ...
        _shovel = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(173.66f, 173.66f),
                    PathNode.LineTo(117.66f, 229.66f),
                    PathNode.CurveTo(116.158424f, 231.15993f, 114.12237f, 232.00166f, 112.0f, 232.0f),
                    PathNode.LineTo(32.0f, 232.0f),
                    PathNode.CurveTo(27.581722f, 232.0f, 24.0f, 228.41827f, 24.0f, 224.0f),
                    PathNode.LineTo(24.0f, 144.0f),
                    PathNode.CurveTo(23.998331f, 141.87762f, 24.840092f, 139.84158f, 26.34f, 138.34f),
                    PathNode.LineTo(82.34f, 82.34f),
                    PathNode.CurveTo(83.840546f, 80.83778f, 85.876724f, 79.993706f, 88.0f, 79.993706f),
                    PathNode.CurveTo(90.123276f, 79.993706f, 92.159454f, 80.83778f, 93.66f, 82.34f),
                    PathNode.LineTo(173.66f, 162.34f),
                    PathNode.CurveTo(175.16223f, 163.84055f, 176.00629f, 165.87672f, 176.00629f, 168.0f),
                    PathNode.CurveTo(176.00629f, 170.12328f, 175.16223f, 172.15945f, 173.66f, 173.66f),
                    PathNode.Close
                ),
