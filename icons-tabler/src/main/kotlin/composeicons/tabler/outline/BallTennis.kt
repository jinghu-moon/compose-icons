...
val TablerIcons.Outline.BallTennis: ImageVector
    get() {
        ...
        _ballTennis = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(6.0f, 5.3f),
                    PathNode.CurveTo(7.903378f, 7.00712f, 8.99084f, 9.443224f, 8.99084f, 12.0f),
                    PathNode.CurveTo(8.99084f, 14.556776f, 7.903378f, 16.99288f, 6.0f, 18.7f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(18.0f, 5.3f),
                    PathNode.CurveTo(16.096622f, 7.00712f, 15.00916f, 9.443224f, 15.00916f, 12.0f),
                    PathNode.CurveTo(15.00916f, 14.556776f, 16.096622f, 16.99288f, 18.0f, 18.7f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
