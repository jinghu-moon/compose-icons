...
val LucideIcons.Outline.UserX: ImageVector
    get() {
        if (_userX != null) return _userX!!
        _userX = lucideOutlineIcon(
            name = "UserX",
            ...
            addPath(
                pathData = parseSvgPathData("M 17.000 8.000 L 22.000 13.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 22.000 8.000 L 17.000 13.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
