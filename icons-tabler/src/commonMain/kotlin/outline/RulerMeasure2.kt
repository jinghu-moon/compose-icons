...
val TablerIcons.Outline.RulerMeasure2: ImageVector
    get() {
        ...
        _rulerMeasure2 = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(12.0f, 19.875f),
                    PathNode.CurveTo(12.0f, 20.496f, 11.488f, 21.0f, 10.857f, 21.0f),
                    PathNode.LineTo(5.143f, 21.0f),
                    PathNode.CurveTo(4.842242f, 21.002396f, 4.552851f, 20.885214f, 4.338495f, 20.674234f),
                    PathNode.CurveTo(4.124138f, 20.463255f, 4.002378f, 20.175758f, 4.0f, 19.875f),
                    PathNode.LineTo(4.0f, 4.0f),
                    PathNode.CurveTo(4.0f, 3.447715f, 4.447716f, 3.0f, 5.0f, 3.0f),
                    PathNode.LineTo(10.857f, 3.0f),
                    PathNode.CurveTo(11.488f, 3.0f, 12.0f, 3.504f, 12.0f, 4.125f),
                    PathNode.LineTo(12.0f, 19.875f)
                ),
