...
val PhosphorIcons.Duotone.AmazonLogo: ImageVector
    get() {
        if (_amazonLogo != null) return _amazonLogo!!
        _amazonLogo = phosphorDuotoneIcon(
            name = "AmazonLogo",
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(168.0f, 156.30052f, 148.30052f, 176.0f, 124.0f, 176.0f),
                    PathNode.CurveTo(99.69947f, 176.0f, 80.0f, 156.30052f, 80.0f, 132.0f),
                    PathNode.CurveTo(80.0f, 107.69947f, 99.69947f, 88.0f, 124.0f, 88.0f),
                    PathNode.CurveTo(148.30052f, 88.0f, 168.0f, 107.69947f, 168.0f, 132.0f),
                    PathNode.Close
                ),
