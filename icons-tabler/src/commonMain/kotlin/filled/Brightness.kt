        ...
        _brightness = tablerFilledIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(4.864309f, 6.882605f, 3.335696f, 10.573612f, 4.273082f, 14.071062f),
                    PathNode.CurveTo(5.210468f, 17.568512f, 8.38011f, 20.000294f, 12.001f, 20.0f),
                    PathNode.LineTo(12.0f, 4.0f),
                    PathNode.CurveTo(10.595688f, 4.000062f, 9.216134f, 4.369783f, 8.0f, 5.072f)
                ),
