...
val PhosphorIcons.Duotone.HourglassMedium: ImageVector
    get() {
        ...
        _hourglassMedium = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(180.92f, 88.0f),
                    PathNode.LineTo(128.0f, 128.0f),
                    PathNode.LineTo(74.67f, 88.0f),
                    PathNode.Close
                ),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(178.23f, 80.0f),
                    PathNode.LineTo(77.33f, 80.0f),
                    PathNode.LineTo(72.0f, 76.0f),
                    PathNode.Close,
                    PathNode.MoveTo(128.0f, 118.0f),
                    PathNode.LineTo(98.67f, 96.0f),
                    PathNode.LineTo(157.07f, 96.0f),
                    PathNode.Close,
                    ...
                    PathNode.LineTo(136.0f, 144.08f),
                    PathNode.LineTo(184.0f, 180.36f),
                    PathNode.Close
                ),
                pathFillType = PathFillType.NonZero,
                fill = SolidColor(Color.Black),
