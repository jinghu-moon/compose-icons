...
val TablerIcons.Outline.FileDelta: ImageVector
    get() {
        if (_fileDelta != null) return _fileDelta!!
        _fileDelta = tablerOutlineIcon(
            name = "FileDelta",
            ...
            addPath(
                pathData = parseSvgPathData("M 9.000 17.000 L 15.000 17.000 L 12.000 11.000 L 9.000 17.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
