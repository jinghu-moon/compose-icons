        ...
        _brandStackshare = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(17.0f, 19.10457f, 17.89543f, 20.0f, 19.0f, 20.0f),
                    PathNode.CurveTo(20.10457f, 20.0f, 21.0f, 19.10457f, 21.0f, 18.0f),
                    PathNode.CurveTo(21.0f, 16.89543f, 20.10457f, 16.0f, 19.0f, 16.0f),
                    PathNode.CurveTo(17.89543f, 16.0f, 17.0f, 16.89543f, 17.0f, 18.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(3.0f, 13.104569f, 3.895431f, 14.0f, 5.0f, 14.0f),
                    PathNode.CurveTo(6.10457f, 14.0f, 7.0f, 13.104569f, 7.0f, 12.0f),
                    PathNode.CurveTo(7.0f, 10.895431f, 6.10457f, 10.0f, 5.0f, 10.0f),
                    PathNode.CurveTo(3.895431f, 10.0f, 3.0f, 10.895431f, 3.0f, 12.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
