...
val TablerIcons.Outline.CurrencyDollarAustralian: ImageVector
    get() {
        ...
        _currencyDollarAustralian = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 3.000 18.000 L 6.279 6.524 C 6.371 6.202 6.665 5.981 7.000 5.981 C 7.335 5.981 7.629 6.202 7.721 6.524 L 11.000 18.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 4.500 14.000 L 9.500 14.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
