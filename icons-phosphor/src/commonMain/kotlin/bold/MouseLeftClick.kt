        ...
        _mouseLeftClick = phosphorBoldIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(68.005905f, 75.59049f, 68.68024f, 71.20737f, 70.0f, 67.0f),
                    PathNode.LineTo(103.0f, 100.0f),
                    PathNode.LineTo(68.0f, 100.0f),
                    PathNode.Close,
                    PathNode.MoveTo(116.0f, 36.0f),
                    PathNode.LineTo(116.0f, 79.0f),
                    PathNode.LineTo(83.49f, 46.52f),
                    PathNode.CurveTo(91.43469f, 39.725613f, 101.5462f, 35.99453f, 112.0f, 36.0f),
                    PathNode.Close,
