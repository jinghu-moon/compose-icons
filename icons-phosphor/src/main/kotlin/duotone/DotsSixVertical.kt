...
val PhosphorIcons.Duotone.DotsSixVertical: ImageVector
    get() {
        if (_dotsSixVertical != null) return _dotsSixVertical!!
        _dotsSixVertical = phosphorDuotoneIcon(
    ...
    group(
        ...
        addPath(
            pathData = parseSvgPathData("M 208.000 32.000 L 208.000 224.000 C 208.000 232.837 200.837 240.000 192.000 240.000 L 64.000 240.000 C 55.163 240.000 48.000 232.837 48.000 224.000 L 48.000 32.000 C 48.000 23.163 55.163 16.000 64.000 16.000 L 192.000 16.000 C 200.837 16.000 208.000 23.163 208.000 32.000 Z"),
