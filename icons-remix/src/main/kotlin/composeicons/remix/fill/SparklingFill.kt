...
val RemixIcons.Fill.SparklingFill: ImageVector
    get() {
        ...
        _sparklingFill = remixIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M14 4.438c1.346 0 2.438-1.091 2.438-2.438h1.125c0 1.346 1.091 2.438 2.438 2.438v1.125C18.654 5.562 17.562 6.654 17.562 8h-1.125C16.438 6.654 15.346 5.562 14 5.562v-1.125ZM1 11C4.314 11 7 8.314 7 5h2c0 3.314 2.686 6 6 6v2c-3.314 0-6 2.686-6 6h-2C7 15.686 4.314 13 1 13v-2ZM17.25 14c0 1.795-1.455 3.25-3.25 3.25v1.5c1.795 0 3.25 1.455 3.25 3.25h1.5c0-1.795 1.455-3.25 3.25-3.25v-1.5c-1.795 0-3.25-1.455-3.25-3.25h-1.5Z"),
