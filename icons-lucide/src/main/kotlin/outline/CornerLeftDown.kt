...
val LucideIcons.Outline.CornerLeftDown: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 14.000 15.000 L 9.000 20.000 L 4.000 15.000"),
    ...
    addPath(
        pathData = parseSvgPathData("M 20.000 4.000 L 13.000 4.000 C 10.791 4.000 9.000 5.791 9.000 8.000 L 9.000 20.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
