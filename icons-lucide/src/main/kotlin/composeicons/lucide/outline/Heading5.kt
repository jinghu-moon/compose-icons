...
val LucideIcons.Outline.Heading5: ImageVector
    get() {
        ...
        _heading5 = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(17.0f, 17.7f),
                    PathNode.CurveTo(17.4f, 17.9f, 17.8f, 18.0f, 18.3f, 18.0f),
                    PathNode.CurveTo(19.8f, 18.0f, 21.0f, 16.9f, 21.0f, 15.5f),
                    PathNode.CurveTo(21.0f, 14.1f, 19.8f, 13.0f, 18.3f, 13.0f),
