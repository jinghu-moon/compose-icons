...
val PhosphorIcons.Duotone.Balloon: ImageVector
    get() {
        ...
        _balloon = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(137.89f, 199.13f),
                    PathNode.LineTo(137.89f, 199.13f),
                    PathNode.LineTo(152.0f, 232.0f),
                    PathNode.LineTo(104.0f, 232.0f),
                    PathNode.LineTo(118.09f, 199.13f),
                    PathNode.LineTo(118.09f, 199.13f),
                    PathNode.CurveTo(78.59f, 192.18f, 48.0f, 144.83f, 48.0f, 104.0f),
                    ...
                    PathNode.CurveTo(208.0f, 144.83f, 177.41f, 192.18f, 137.89f, 199.13f),
                    PathNode.Close
                ),
