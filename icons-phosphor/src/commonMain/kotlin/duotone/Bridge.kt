...
val PhosphorIcons.Duotone.Bridge: ImageVector
    get() {
        if (_bridge != null) return _bridge!!
        _bridge = phosphorDuotoneIcon(
            name = "Bridge",
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(24.0f, 115.35f),
                    PathNode.CurveTo(48.182888f, 105.56754f, 64.008316f, 82.086555f, 64.0f, 56.0f),
                    PathNode.CurveTo(64.0f, 91.34622f, 92.65378f, 120.0f, 128.0f, 120.0f),
                    PathNode.CurveTo(163.34622f, 120.0f, 192.0f, 91.34622f, 192.0f, 56.0f),
                    PathNode.CurveTo(191.99168f, 82.086555f, 207.81711f, 105.56754f, 232.0f, 115.35f),
                    PathNode.Close
                ),
