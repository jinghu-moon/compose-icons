...
val TablerIcons.Outline.DeviceTvOld: ImageVector
    get() {
        if (_deviceTvOld != null) return _deviceTvOld!!
        _deviceTvOld = tablerOutlineIcon(
            name = "DeviceTvOld",
    ...
    addPath(
        pathData = parseSvgPathData("M 18.000 15.000 L 18.000 15.010"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 18.000 12.000 L 18.000 12.010"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
