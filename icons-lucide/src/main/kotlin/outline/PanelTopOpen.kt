...
val LucideIcons.Outline.PanelTopOpen: ImageVector
    get() {
        if (_panelTopOpen != null) return _panelTopOpen!!
        _panelTopOpen = lucideOutlineIcon(
            name = "PanelTopOpen",
    ...
    addPath(
        pathData = parseSvgPathData("M 15.000 14.000 L 12.000 17.000 L 9.000 14.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
