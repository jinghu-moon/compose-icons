        ...
        _excludeSquare = phosphorRegularIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(88.0f, 132.69f),
                    PathNode.LineTo(48.0f, 92.69f),
                    PathNode.Close,
                    PathNode.MoveTo(92.69f, 48.0f),
                    PathNode.LineTo(132.69f, 88.0f),
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(152.0f, 84.69f),
                    PathNode.LineTo(115.31f, 48.0f),
                    PathNode.LineTo(152.0f, 48.0f),
                    PathNode.Close,
                    PathNode.MoveTo(48.0f, 115.31f),
                    PathNode.LineTo(84.69f, 152.0f),
