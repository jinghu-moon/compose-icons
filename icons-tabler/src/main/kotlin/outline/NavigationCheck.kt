...
val TablerIcons.Outline.NavigationCheck: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 17.487 14.894 L 12.000 3.000 L 4.030 20.275 C 3.960 20.475 4.013 20.699 4.165 20.847 C 4.315 20.995 4.539 21.040 4.735 20.963 L 11.010 18.836"),
