...
val PhosphorIcons.Duotone.Dna: ImageVector
    get() {
        ...
        _dna = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(103.8f, 140.1f),
                    PathNode.LineTo(128.0f, 128.0f),
                    PathNode.LineTo(152.2f, 140.1f),
                    PathNode.CurveTo(176.5926f, 152.29662f, 192.0006f, 177.22809f, 192.0f, 204.5f),
                    PathNode.LineTo(192.0f, 208.0f),
                    PathNode.LineTo(64.0f, 208.0f),
                    PathNode.LineTo(64.0f, 204.5f),
                    PathNode.CurveTo(63.999413f, 177.22809f, 79.407394f, 152.29662f, 103.8f, 140.1f),
                    PathNode.Close,
                    PathNode.MoveTo(192.0f, 51.5f),
                    PathNode.LineTo(192.0f, 48.0f),
                    PathNode.LineTo(64.0f, 48.0f),
                    PathNode.LineTo(64.0f, 51.5f),
                    PathNode.CurveTo(63.999413f, 78.7719f, 79.407394f, 103.7034f, 103.8f, 115.9f),
                    PathNode.LineTo(128.0f, 128.0f),
                    PathNode.LineTo(152.2f, 115.9f),
                    PathNode.CurveTo(176.5926f, 103.7034f, 192.0006f, 78.7719f, 192.0f, 51.5f),
                    PathNode.Close
                ),
