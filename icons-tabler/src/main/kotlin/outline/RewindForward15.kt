...
val TablerIcons.Outline.RewindForward15: ImageVector
    get() {
        ...
        _rewindForward15 = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 16.000 20.000 L 18.000 20.000 C 18.552 20.000 19.000 19.552 19.000 19.000 L 19.000 18.000 C 19.000 17.448 18.552 17.000 18.000 17.000 L 16.000 17.000 L 16.000 14.000 L 19.000 14.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 13.000 14.000 L 13.000 20.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
