...
val TablerIcons.Outline.ChartPie3: ImageVector
    get() {
        if (_chartPie3 != null) return _chartPie3!!
        _chartPie3 = tablerOutlineIcon(
            name = "ChartPie3",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24f, height = 24f),
        ) {
            addPath(
                pathData = parseSvgPathData("M 12.000 12.000 L 5.500 17.500"),
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 3.000 L 12.000 12.000 L 21.000 12.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
