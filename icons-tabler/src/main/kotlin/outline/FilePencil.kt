...
val TablerIcons.Outline.FilePencil: ImageVector
    get() {
        if (_filePencil != null) return _filePencil!!
        _filePencil = tablerOutlineIcon(
            name = "FilePencil",
    ...
    addPath(
        pathData = parseSvgPathData("M 10.000 18.000 L 15.000 13.000 C 15.552 12.448 15.552 11.552 15.000 11.000 C 14.448 10.448 13.552 10.448 13.000 11.000 L 8.000 16.000 L 8.000 18.000 L 10.000 18.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
