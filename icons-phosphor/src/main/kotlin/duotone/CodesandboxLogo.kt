...
val PhosphorIcons.Duotone.CodesandboxLogo: ImageVector
    get() {
        ...
        _codesandboxLogo = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(32.0f, 125.73f),
                    PathNode.LineTo(80.0f, 152.0f),
                    PathNode.LineTo(80.0f, 206.84f),
                    ...
                    PathNode.LineTo(176.0f, 206.84f),
                    PathNode.LineTo(219.84f, 182.84f),
                    PathNode.CurveTo(222.39926f, 181.4397f, 223.99338f, 178.7573f, 224.0f, 175.84f),
                    PathNode.LineTo(224.0f, 125.74f),
                    PathNode.Close,
                    PathNode.MoveTo(124.16f, 25.0f),
                    PathNode.LineTo(83.16f, 47.46f),
                    PathNode.LineTo(83.16f, 47.46f),
                    PathNode.LineTo(128.0f, 72.0f),
                    PathNode.LineTo(172.86f, 47.44f),
