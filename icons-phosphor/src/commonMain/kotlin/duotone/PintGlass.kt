...
val PhosphorIcons.Duotone.PintGlass: ImageVector
    get() {
        ...
        _pintGlass = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(195.2f, 72.0f),
                    PathNode.LineTo(176.85f, 225.0f),
                    PathNode.CurveTo(176.34544f, 229.00482f, 172.93648f, 232.00641f, 168.9f, 232.0f),
                    PathNode.LineTo(87.1f, 232.0f),
                    PathNode.CurveTo(83.06352f, 232.00641f, 79.65456f, 229.00482f, 79.15f, 225.0f),
                    PathNode.LineTo(60.8f, 72.0f),
                    PathNode.Close
                ),
