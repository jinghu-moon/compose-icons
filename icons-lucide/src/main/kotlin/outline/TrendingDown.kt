...
val LucideIcons.Outline.TrendingDown: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 16.000 17.000 L 22.000 17.000 L 22.000 11.000"),
    ...
    addPath(
        pathData = parseSvgPathData("M 22.000 17.000 L 13.500 8.500 L 8.500 13.500 L 2.000 7.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
