        ...
        _batteryFull = phosphorLightIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(182.0f, 160.0f),
                    PathNode.CurveTo(182.0f, 163.3137f, 179.3137f, 166.0f, 176.0f, 166.0f),
                    PathNode.CurveTo(172.6863f, 166.0f, 170.0f, 163.3137f, 170.0f, 160.0f),
                    PathNode.LineTo(170.0f, 96.0f),
                    PathNode.CurveTo(170.0f, 92.686295f, 172.6863f, 90.0f, 176.0f, 90.0f),
                    PathNode.CurveTo(179.3137f, 90.0f, 182.0f, 92.686295f, 182.0f, 96.0f),
                    PathNode.Close,
                    PathNode.MoveTo(142.0f, 96.0f),
                    PathNode.LineTo(142.0f, 160.0f),
                    PathNode.CurveTo(142.0f, 163.3137f, 139.3137f, 166.0f, 136.0f, 166.0f),
                    PathNode.CurveTo(132.6863f, 166.0f, 130.0f, 163.3137f, 130.0f, 160.0f),
                    PathNode.LineTo(130.0f, 96.0f),
                    PathNode.CurveTo(130.0f, 92.686295f, 132.6863f, 90.0f, 136.0f, 90.0f),
                    PathNode.CurveTo(139.3137f, 90.0f, 142.0f, 92.686295f, 142.0f, 96.0f),
                    PathNode.Close,
                    PathNode.MoveTo(102.0f, 96.0f),
                    ...
                    PathNode.CurveTo(99.313705f, 90.0f, 102.0f, 92.686295f, 102.0f, 96.0f),
                    PathNode.Close,
