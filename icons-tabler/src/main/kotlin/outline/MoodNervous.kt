...
val TablerIcons.Outline.MoodNervous: ImageVector
    get() {
        if (_moodNervous != null) return _moodNervous!!
        _moodNervous = tablerOutlineIcon(
            name = "MoodNervous",
            ...
            addPath(
                pathData = parseSvgPathData("M 8.000 16.000 L 10.000 14.000 L 12.000 16.000 L 14.000 14.000 L 16.000 16.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
