...
val TablerIcons.Outline.PhotoScan: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 6.000 13.000 L 8.644 10.356 C 8.871 10.129 9.179 10.001 9.500 10.001 C 9.821 10.001 10.129 10.129 10.356 10.356 L 14.000 14.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 13.000 13.000 L 14.644 11.356 C 14.871 11.129 15.179 11.001 15.500 11.001 C 15.821 11.001 16.129 11.129 16.356 11.356 L 18.000 13.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
