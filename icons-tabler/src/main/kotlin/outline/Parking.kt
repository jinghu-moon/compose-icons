...
val TablerIcons.Outline.Parking: ImageVector
    get() {
        if (_parking != null) return _parking!!
        _parking = tablerOutlineIcon(
            name = "Parking",
    ...
    addPath(
        pathData = parseSvgPathData("M 10.000 16.000 L 10.000 8.000 L 12.667 8.000 C 13.403 8.000 14.000 8.895 14.000 10.000 C 14.000 11.105 13.403 12.000 12.667 12.000 L 10.000 12.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
