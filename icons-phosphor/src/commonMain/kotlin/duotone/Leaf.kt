...
val PhosphorIcons.Duotone.Leaf: ImageVector
    get() {
        ...
        _leaf = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(63.81f, 192.19f),
                    PathNode.CurveTo(15.92f, 112.38f, 79.81f, 32.57f, 215.45f, 40.55f),
                    PathNode.CurveTo(223.43f, 176.23f, 143.62f, 240.08f, 63.81f, 192.19f),
                    PathNode.Close
                ),
