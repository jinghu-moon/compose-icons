        ...
        _mouseSimple = phosphorLightIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(134.0f, 64.0f),
                    PathNode.LineTo(134.0f, 112.0f),
                    PathNode.CurveTo(134.0f, 115.313705f, 131.3137f, 118.0f, 128.0f, 118.0f),
                    PathNode.CurveTo(124.686295f, 118.0f, 122.0f, 115.313705f, 122.0f, 112.0f),
                    PathNode.LineTo(122.0f, 64.0f),
                    PathNode.CurveTo(122.0f, 60.68629f, 124.686295f, 58.0f, 128.0f, 58.0f),
