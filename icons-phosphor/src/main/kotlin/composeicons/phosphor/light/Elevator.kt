...
val PhosphorIcons.Light.Elevator: ImageVector
    get() {
        ...
        _elevator = phosphorLightIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M208 34h-160C40.268 34 34 40.268 34 48v160c0 7.732 6.268 14 14 14h160c7.732 0 14-6.268 14-14v-160c0-7.732-6.268-14-14-14ZM178 110v100h-44v-100ZM122 210h-44v-100h44ZM210 208c0 1.105-.895 2-2 2h-18v-106c0-3.314-2.686-6-6-6h-112c-3.314 0-6 2.686-6 6v106h-18c-1.105 0-2-.895-2-2v-160c0-1.105 .895-2 2-2h160c1.105 0 2 .895 2 2ZM150 72c0 3.314-2.686 6-6 6h-32c-3.314 0-6-2.686-6-6 0-3.314 2.686-6 6-6h32c3.314 0 6 2.686 6 6Z"),
