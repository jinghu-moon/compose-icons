...
val PhosphorIcons.Duotone.Hammer: ImageVector
    get() {
        ...
        _hammer = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(245.66f, 129.0f),
                    PathNode.LineTo(217.0f, 157.66f),
                    PathNode.CurveTo(213.87738f, 160.77507f, 208.82262f, 160.77507f, 205.7f, 157.66f),
                    PathNode.LineTo(168.1f, 120.0f),
                    PathNode.LineTo(140.1f, 148.0f),
                    PathNode.LineTo(108.1f, 116.0f),
                    PathNode.LineTo(136.1f, 88.0f),
                    PathNode.LineTo(80.0f, 31.78f),
                    PathNode.CurveTo(113.32151f, 16.72674f, 152.48367f, 23.897108f, 178.31f, 49.78f),
                    PathNode.LineTo(245.66f, 117.67f),
                    PathNode.CurveTo(247.16528f, 119.17095f, 248.0113f, 121.209274f, 248.0113f, 123.335f),
                    PathNode.CurveTo(248.0113f, 125.46072f, 247.16528f, 127.499054f, 245.66f, 129.0f),
                    PathNode.Close
                ),
