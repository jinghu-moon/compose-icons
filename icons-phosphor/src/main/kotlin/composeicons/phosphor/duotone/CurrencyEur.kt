...
val PhosphorIcons.Duotone.CurrencyEur: ImageVector
    get() {
        ...
        _currencyEur = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M184 58.33v139.34c-21.164 18.929-51.476 23.653-77.396 12.06C80.684 198.138 63.998 172.394 64 144v-32C63.998 83.606 80.684 57.862 106.604 46.27 132.524 34.677 162.836 39.401 184 58.33Z"),
