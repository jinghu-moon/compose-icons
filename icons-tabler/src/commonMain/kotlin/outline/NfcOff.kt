        ...
        _nfcOff = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.MoveTo(19.127f, 19.116f),
                    PathNode.CurveTo(18.564505f, 19.682894f, 17.798603f, 20.00121f, 17.0f, 20.0f),
                    PathNode.LineTo(7.0f, 20.0f),
                    PathNode.CurveTo(5.343146f, 20.0f, 4.0f, 18.656855f, 4.0f, 17.0f),
                    PathNode.LineTo(4.0f, 7.0f),
                    PathNode.CurveTo(4.0f, 6.17f, 4.337f, 5.418f, 4.882f, 4.875f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
