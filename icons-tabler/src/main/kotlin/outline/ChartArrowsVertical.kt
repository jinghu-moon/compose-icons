...
val TablerIcons.Outline.ChartArrowsVertical: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 18.000 21.000 L 18.000 7.000"),
    ...
    addPath(
        pathData = parseSvgPathData("M 15.000 10.000 L 18.000 7.000 L 21.000 10.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 6.000 21.000 L 6.000 3.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
