...
val TablerIcons.Outline.ArrowBigRightLine: ImageVector
    get() {
        ...
        _arrowBigRightLine = tablerOutlineIcon(
            ...
            addPathData("M12 9v-3.586c0-.404 .244-.769 .617-.924 .374-.155 .804-.069 1.09 .217l6.586 6.586c.39 .391 .39 1.023 0 1.414l-6.586 6.586c-.286 .286-.716 .371-1.09 .217-.374-.155-.617-.519-.617-.924v-3.586h-6v-6h6")
            addPathData("M3 9v6")
        }
