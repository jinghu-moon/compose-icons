...
val PhosphorIcons.Duotone.ArrowSquareUp: ImageVector
    get() {
        if (_arrowSquareUp != null) return _arrowSquareUp!!
        _arrowSquareUp = phosphorDuotoneIcon(
            name = "ArrowSquareUp",
