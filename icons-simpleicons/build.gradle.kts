...
android {
    namespace = "composeicons.simpleicons"
    compileSdk = 36
...
mavenPublishing {
    ...
    pom {
        name.set("simpleicons")
        description.set("Simple Icons for Jetpack Compose - generated via svg2compose pipeline")
