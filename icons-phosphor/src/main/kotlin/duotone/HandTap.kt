        ...
        _handTap = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(216.0f, 208.0f, 208.0f, 224.0f, 208.0f, 224.0f),
                    PathNode.LineTo(72.0f, 224.0f),
                    PathNode.LineTo(42.68f, 174.0f),
                    PathNode.CurveTo(37.246193f, 164.4428f, 40.54517f, 152.2916f, 50.066113f, 146.79451f),
                    PathNode.CurveTo(59.58706f, 141.29742f, 71.75989f, 144.51573f, 77.32f, 154.0f),
                    PathNode.LineTo(96.0f, 184.0f),
                    PathNode.LineTo(96.0f, 76.0f),
                    PathNode.CurveTo(96.0f, 64.95431f, 104.95431f, 56.0f, 116.0f, 56.0f),
                    PathNode.CurveTo(127.04569f, 56.0f, 136.0f, 64.95431f, 136.0f, 76.0f),
                    PathNode.LineTo(136.0f, 132.0f),
                    PathNode.CurveTo(136.0f, 120.95431f, 144.9543f, 112.0f, 156.0f, 112.0f),
                    PathNode.CurveTo(167.0457f, 112.0f, 176.0f, 120.95431f, 176.0f, 132.0f),
                    PathNode.LineTo(176.0f, 148.0f),
                    PathNode.CurveTo(176.0f, 136.9543f, 184.9543f, 128.0f, 196.0f, 128.0f),
                    PathNode.CurveTo(207.0457f, 128.0f, 216.0f, 136.9543f, 216.0f, 148.0f),
                    PathNode.Close
                ),
