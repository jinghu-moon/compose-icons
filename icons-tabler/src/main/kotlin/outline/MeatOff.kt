...
val TablerIcons.Outline.MeatOff: ImageVector
    get() {
        ...
        _meatOff = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 12.975 21.425 C 14.557 19.843 15.654 18.018 16.217 16.225"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 16.600 12.600 C 16.440 11.362 15.947 10.255 15.096 9.405 C 14.246 8.555 13.141 8.061 11.904 7.902"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 8.274 8.284 C 6.482 8.847 4.658 9.944 3.076 11.526"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
