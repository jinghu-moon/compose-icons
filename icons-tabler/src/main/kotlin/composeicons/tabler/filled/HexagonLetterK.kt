...
val TablerIcons.Filled.HexagonLetterK: ImageVector
    get() {
        ...
        _hexagonLetterK = tablerFilledIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M13.666 1.429l6.75 3.98 .096 .063 .093 .078 .106 .074c.759 .569 1.229 1.443 1.284 2.39L22 8.218v7.284c0 1.175-.643 2.256-1.623 2.793l-6.804 4.302c-.98 .538-2.166 .538-3.2-.032L3.678 18.328C2.645 17.762 2.002 16.679 2 15.502v-7.285C2 7.111 2.57 6.089 3.476 5.512L10.426 1.414c1-.552 2.214-.552 3.24 .015M14.53 7.152c-.225-.141-.496-.186-.755-.126-.258 .06-.483 .219-.623 .444L11 10.912v-2.912c-0-.507-.38-.934-.883-.993L10 7C9.448 7 9 7.448 9 8v8c0 .552 .448 1 1 1 .552 0 1-.448 1-1v-2.914l2.152 3.444c.269 .43 .817 .591 1.276 .374l.102-.056 .095-.068c.396-.317 .491-.88 .223-1.31L12.678 12 14.848 8.53c.141-.225 .186-.496 .126-.755-.06-.258-.219-.483-.444-.623"),
