...
val TablerIcons.Outline.BrandDeno: ImageVector
    get() {
        ...
        _brandDeno = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(13.47f, 20.882f),
                    PathNode.LineTo(12.0f, 15.0f),
                    PathNode.CurveTo(9.351f, 14.912f, 7.0f, 13.376f, 7.0f, 11.5f),
                    PathNode.CurveTo(7.0f, 9.567f, 9.239f, 8.0f, 12.0f, 8.0f),
                    PathNode.CurveTo(14.761f, 8.0f, 16.0f, 9.0f, 17.0f, 11.0f),
                    PathNode.CurveTo(17.024f, 11.048f, 17.69f, 13.215f, 19.0f, 17.5f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
