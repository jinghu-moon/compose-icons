        ...
        _brandTypescript = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(15.32f, 17.82f, 15.754f, 18.0f, 16.207f, 18.0f),
                    PathNode.LineTo(16.75f, 18.0f),
                    PathNode.CurveTo(17.44f, 18.0f, 18.0f, 17.44f, 18.0f, 16.75f),
                    PathNode.LineTo(18.0f, 16.5f),
                    PathNode.CurveTo(18.0f, 15.671573f, 17.328426f, 15.0f, 16.5f, 15.0f),
                    PathNode.CurveTo(15.671573f, 15.0f, 15.0f, 14.328427f, 15.0f, 13.5f),
                    PathNode.LineTo(15.0f, 13.25f),
                    PathNode.CurveTo(15.0f, 12.56f, 15.56f, 12.0f, 16.25f, 12.0f),
                    PathNode.LineTo(16.793f, 12.0f),
                    PathNode.CurveTo(17.246f, 12.0f, 17.68f, 12.18f, 18.0f, 12.5f)
                ),
