...
val LucideIcons.Outline.PanelTopClose: ImageVector
    get() {
        if (_panelTopClose != null) return _panelTopClose!!
        _panelTopClose = lucideOutlineIcon(
            name = "PanelTopClose",
    ...
    addPath(
        pathData = parseSvgPathData("M 9.000 16.000 L 12.000 13.000 L 15.000 16.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
