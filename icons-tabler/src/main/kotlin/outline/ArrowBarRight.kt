...
val TablerIcons.Outline.ArrowBarRight: ImageVector
    get() {
        ...
        _arrowBarRight = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 20.000 12.000 L 10.000 12.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 20.000 12.000 L 16.000 16.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 20.000 12.000 L 16.000 8.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
