...
val PhosphorIcons.Duotone.CellTower: ImageVector
    get() {
        ...
        _cellTower = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M200 88c.001 27.272-15.407 52.203-39.8 64.4L128 88 95.8 152.4C64.061 136.53 48.618 99.903 59.412 66.099 70.207 32.296 104.02 11.398 139.083 16.86 174.145 22.322 199.999 52.515 200 88Z"),
