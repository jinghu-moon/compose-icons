...
mavenPublishing {
    ...
    pom {
        name.set("icons-remix")
        description.set("Remix Icons for Jetpack Compose - generated via svg2compose pipeline")
