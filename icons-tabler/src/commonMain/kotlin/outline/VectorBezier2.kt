        ...
        _vectorBezier2 = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(17.447716f, 21.0f, 17.0f, 20.552284f, 17.0f, 20.0f),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(9.552285f, 20.0f, 10.0f, 19.552284f, 10.0f, 19.0f),
                    PathNode.CurveTo(10.0f, 18.447716f, 9.552285f, 18.0f, 9.0f, 18.0f),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(14.0f, 5.552285f, 14.447715f, 6.0f, 15.0f, 6.0f),
                    PathNode.CurveTo(15.552285f, 6.0f, 16.0f, 5.552285f, 16.0f, 5.0f),
                    PathNode.CurveTo(16.0f, 4.447716f, 15.552285f, 4.0f, 15.0f, 4.0f),
                    PathNode.CurveTo(14.447715f, 4.0f, 14.0f, 4.447716f, 14.0f, 5.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(7.0f, 5.5f),
                    PathNode.CurveTo(9.761424f, 5.5f, 12.0f, 8.41015f, 12.0f, 12.0f),
                    PathNode.CurveTo(12.0f, 15.58985f, 14.238576f, 18.5f, 17.0f, 18.5f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
