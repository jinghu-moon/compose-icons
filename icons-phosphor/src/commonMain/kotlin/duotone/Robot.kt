        ...
        _robot = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(42.745167f, 56.0f, 32.0f, 66.74516f, 32.0f, 80.0f),
                    PathNode.LineTo(32.0f, 192.0f),
                    PathNode.CurveTo(32.0f, 205.25484f, 42.745167f, 216.0f, 56.0f, 216.0f),
                    ...
                    PathNode.CurveTo(80.95431f, 184.0f, 72.0f, 175.0457f, 72.0f, 164.0f),
                    PathNode.CurveTo(72.0f, 152.9543f, 80.95431f, 144.0f, 92.0f, 144.0f),
                    PathNode.LineTo(164.0f, 144.0f),
                    PathNode.CurveTo(175.0457f, 144.0f, 184.0f, 152.9543f, 184.0f, 164.0f),
                    PathNode.CurveTo(184.0f, 175.0457f, 175.0457f, 184.0f, 164.0f, 184.0f),
                    PathNode.Close
                ),
