...
val TablerIcons.Outline.ArrowNarrowDownDashed: ImageVector
    get() {
        ...
        _arrowNarrowDownDashed = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 5.000 L 12.000 5.500M 12.000 8.500 L 12.000 10.000M 12.000 13.000 L 12.000 19.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 16.000 15.000 L 12.000 19.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 8.000 15.000 L 12.000 19.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
