...
val TablerIcons.Outline.ArrowsDiagonalMinimize2: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 18.000 10.000 L 14.000 10.000 L 14.000 6.000"),
    ...
    addPath(
        pathData = parseSvgPathData("M 20.000 4.000 L 14.000 10.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 6.000 14.000 L 10.000 14.000 L 10.000 18.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 10.000 14.000 L 4.000 20.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
