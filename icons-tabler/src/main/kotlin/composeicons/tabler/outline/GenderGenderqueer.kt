        ...
        _genderGenderqueer = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(14.761424f, 11.0f, 17.0f, 13.238576f, 17.0f, 16.0f),
                    ...
                    PathNode.CurveTo(7.0f, 13.238576f, 9.238576f, 11.0f, 12.0f, 11.0f)
                ),
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(14.5f, 4.5f),
                    PathNode.LineTo(9.5f, 7.5f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(9.5f, 4.5f),
                    PathNode.LineTo(14.5f, 7.5f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
