...
val RemixIcons.Fill.MapPinUserFill: ImageVector
    get() {
        ...
        _mapPinUserFill = remixIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M17.084 15.812c2.599-2.743 2.554-7.074-.134-9.762C14.216 3.317 9.784 3.317 7.05 6.05 4.362 8.738 4.317 13.069 6.916 15.812 7.978 14.123 9.858 13 12 13c2.142 0 4.022 1.123 5.084 2.812ZM12 23.728 5.636 17.364C2.121 13.849 2.121 8.151 5.636 4.636c3.515-3.515 9.213-3.515 12.728 0 3.515 3.515 3.515 9.213 0 12.728L12 23.728ZM12 12C10.343 12 9 10.657 9 9 9 7.343 10.343 6 12 6c1.657 0 3 1.343 3 3 0 1.657-1.343 3-3 3Z"),
