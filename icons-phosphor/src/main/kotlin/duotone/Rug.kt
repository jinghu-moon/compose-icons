        ...
        _rug = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(121.14f, 172.12f),
                    PathNode.CurveTo(122.58577f, 174.5297f, 125.18986f, 176.00414f, 128.0f, 176.00414f),
                    PathNode.CurveTo(130.81013f, 176.00414f, 133.41423f, 174.5297f, 134.86f, 172.12f),
                    PathNode.LineTo(158.86f, 132.12f),
                    PathNode.CurveTo(160.3833f, 129.58453f, 160.3833f, 126.41546f, 158.86f, 123.88f),
                    PathNode.LineTo(134.86f, 83.88f),
                    PathNode.CurveTo(133.41423f, 81.47031f, 130.81013f, 79.99587f, 128.0f, 79.99587f),
                    PathNode.CurveTo(125.18986f, 79.99587f, 122.58577f, 81.47031f, 121.14f, 83.88f),
                    PathNode.LineTo(97.14f, 123.88f),
                    PathNode.CurveTo(95.61669f, 126.41546f, 95.61669f, 129.58453f, 97.14f, 132.12f),
                    PathNode.Close,
                    PathNode.MoveTo(128.0f, 103.55f),
                    PathNode.LineTo(142.67f, 128.0f),
                    PathNode.LineTo(128.0f, 152.45f),
                    PathNode.LineTo(113.33f, 128.0f),
                    PathNode.Close
                ),
                pathFillType = PathFillType.NonZero,
                fill = SolidColor(Color.Black),
