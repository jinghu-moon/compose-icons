...
val TablerIcons.Outline.PointerQuestion: ImageVector
    get() {
        ...
        _pointerQuestion = tablerOutlineIcon(
            ...
            addPathData("M15.062 12.506l-.284-.284 3.113-2.09c.441-.238 .688-.725 .62-1.221-.069-.497-.439-.898-.929-1.007L4 4 7.904 17.563c.109 .489 .51 .859 1.007 .928 .497 .069 .983-.179 1.221-.62l2.09-3.093 1.278 1.278")
