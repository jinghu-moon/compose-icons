...
val TablerIcons.Filled.ArrowBigDownLine: ImageVector
    get() {
        ...
        _arrowBigDownLine = tablerFilledIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 9.000 5.000 L 8.883 5.007 C 8.380 5.066 8.000 5.493 8.000 6.000 L 8.000 10.999 L 5.414 11.000 C 4.605 11.000 3.876 11.487 3.567 12.235 C 3.257 12.982 3.428 13.842 4.000 14.414 L 10.586 21.000 C 11.367 21.781 12.633 21.781 13.414 21.000 L 20.000 14.414 C 20.572 13.842 20.744 12.982 20.434 12.234 L 20.366 12.089 C 20.024 11.421 19.337 11.000 18.586 11.000 L 16.000 10.999 L 16.000 6.000 C 16.000 5.448 15.552 5.000 15.000 5.000 L 9.000 5.000 Z"),
