        ...
        _textbox = phosphorFillIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(137.79086f, 192.0f, 136.0f, 190.20914f, 136.0f, 188.0f),
                    PathNode.LineTo(136.0f, 68.0f),
                    PathNode.CurveTo(136.0f, 65.79086f, 137.79086f, 64.0f, 140.0f, 64.0f),
                    ...
                    PathNode.CurveTo(15.163444f, 192.0f, 8.0f, 184.83656f, 8.0f, 176.0f),
                    PathNode.LineTo(8.0f, 80.0f),
                    PathNode.CurveTo(8.0f, 71.163445f, 15.163444f, 64.0f, 24.0f, 64.0f),
                    PathNode.LineTo(104.0f, 64.0f),
                    PathNode.LineTo(104.0f, 48.0f),
                    PathNode.CurveTo(104.0f, 43.581722f, 107.58172f, 40.0f, 112.0f, 40.0f),
                    PathNode.CurveTo(116.41828f, 40.0f, 120.0f, 43.581722f, 120.0f, 48.0f),
                    PathNode.Close,
                    PathNode.MoveTo(88.0f, 112.0f),
                    PathNode.CurveTo(88.0f, 107.58172f, 84.41828f, 104.0f, 80.0f, 104.0f),
                    ...
                    PathNode.CurveTo(68.41828f, 152.0f, 72.0f, 148.41827f, 72.0f, 144.0f),
                    PathNode.LineTo(72.0f, 120.0f),
                    PathNode.LineTo(80.0f, 120.0f),
                    PathNode.CurveTo(84.41828f, 120.0f, 88.0f, 116.41828f, 88.0f, 112.0f),
                    PathNode.Close
                ),
