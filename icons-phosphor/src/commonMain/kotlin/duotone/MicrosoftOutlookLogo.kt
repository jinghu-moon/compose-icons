...
val PhosphorIcons.Duotone.MicrosoftOutlookLogo: ImageVector
    get() {
        if (_microsoftOutlookLogo != null) return _microsoftOutlookLogo!!
        _microsoftOutlookLogo = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(165.66f, 164.0f),
                    PathNode.LineTo(216.0f, 127.65f),
                    ...
                    PathNode.CurveTo(152.0f, 71.163445f, 144.83656f, 64.0f, 136.0f, 64.0f),
                    PathNode.LineTo(112.0f, 64.0f),
                    PathNode.Close,
                    PathNode.MoveTo(40.0f, 80.0f),
                    PathNode.LineTo(136.0f, 80.0f),
                    PathNode.LineTo(136.0f, 157.9f),
                    PathNode.CurveTo(136.0f, 158.02f, 136.0f, 158.14f, 136.0f, 158.26f),
                    ...
                    PathNode.LineTo(199.26f, 208.0f),
