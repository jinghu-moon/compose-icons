...
val TablerIcons.Outline.BotId: ImageVector
    get() {
        ...
        _botId = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 7.000 10.500 C 7.000 9.672 7.746 9.000 8.667 9.000 L 15.333 9.000 C 16.253 9.000 17.000 9.672 17.000 10.500 L 17.000 13.500 C 17.000 14.328 16.254 15.000 15.333 15.000 L 8.667 15.000 C 7.747 15.000 7.000 14.328 7.000 13.500 L 7.000 10.500"),
