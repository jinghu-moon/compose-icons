        ...
        _cylinder = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(192.0f, 79.88f, 163.35f, 96.0f, 128.0f, 96.0f),
                    PathNode.CurveTo(92.65f, 96.0f, 64.0f, 79.88f, 64.0f, 60.0f),
                    PathNode.CurveTo(64.0f, 40.12f, 92.65f, 24.0f, 128.0f, 24.0f),
                    PathNode.CurveTo(163.35f, 24.0f, 192.0f, 40.12f, 192.0f, 60.0f),
                    PathNode.Close
                ),
