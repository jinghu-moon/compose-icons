        ...
        _uniteSquare = phosphorThinIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(153.66f, 212.0f),
                    PathNode.LineTo(44.0f, 102.34f),
                    PathNode.LineTo(44.0f, 49.66f),
                    PathNode.LineTo(206.34f, 212.0f),
                    PathNode.Close,
                    PathNode.MoveTo(49.66f, 44.0f),
                    PathNode.LineTo(102.34f, 44.0f),
                    PathNode.LineTo(212.0f, 153.66f),
                    PathNode.LineTo(212.0f, 206.34f),
                    PathNode.Close,
                    PathNode.MoveTo(212.0f, 142.34f),
                    PathNode.LineTo(169.66f, 100.0f),
                    PathNode.LineTo(212.0f, 100.0f),
                    PathNode.Close,
                    PathNode.MoveTo(156.0f, 86.34f),
                    PathNode.LineTo(113.66f, 44.0f),
                    PathNode.LineTo(156.0f, 44.0f),
                    PathNode.Close,
                    PathNode.MoveTo(44.0f, 113.66f),
                    PathNode.LineTo(86.34f, 156.0f),
                    PathNode.LineTo(44.0f, 156.0f),
                    PathNode.Close,
                    PathNode.MoveTo(100.0f, 169.66f),
                    PathNode.LineTo(142.34f, 212.0f),
