        ...
        _smiley = phosphorThinIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(96.41828f, 116.0f, 100.0f, 112.41828f, 100.0f, 108.0f),
                    PathNode.CurveTo(100.0f, 103.58172f, 96.41828f, 100.0f, 92.0f, 100.0f),
                    PathNode.CurveTo(87.58172f, 100.0f, 84.0f, 103.58172f, 84.0f, 108.0f),
                    PathNode.CurveTo(84.0f, 112.41828f, 87.58172f, 116.0f, 92.0f, 116.0f),
                    PathNode.Close,
                    PathNode.MoveTo(164.0f, 100.0f),
                    PathNode.CurveTo(159.58173f, 100.0f, 156.0f, 103.58172f, 156.0f, 108.0f),
                    PathNode.CurveTo(156.0f, 112.41828f, 159.58173f, 116.0f, 164.0f, 116.0f),
                    PathNode.CurveTo(168.41827f, 116.0f, 172.0f, 112.41828f, 172.0f, 108.0f),
                    PathNode.CurveTo(172.0f, 103.58172f, 168.41827f, 100.0f, 164.0f, 100.0f),
                    PathNode.Close
                ),
