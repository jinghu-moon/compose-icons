...
val PhosphorIcons.Duotone.Images: ImageVector
    get() {
        ...
        _images = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M224 56v82.06L200.28 114.34c-3.124-3.122-8.186-3.122-11.31 0L163.31 140 113.66 90.34C112.159 88.838 110.123 87.994 108 87.994c-2.123 0-4.159 .844-5.66 2.346L64 128.69v-72.69c0-4.418 3.582-8 8-8h144c4.418 0 8 3.582 8 8Z"),
