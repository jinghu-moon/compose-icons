...
val TablerIcons.Outline.ReceiptRefund: ImageVector
    get() {
        ...
        _receiptRefund = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 15.000 14.000 L 15.000 12.000 C 15.000 10.895 14.105 10.000 13.000 10.000 L 9.000 10.000 L 11.000 8.000M 11.000 12.000 L 9.000 10.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
