...
val PhosphorIcons.Duotone.SprayBottle: ImageVector
    get() {
        ...
        _sprayBottle = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(200.0f, 211.47f),
                    ...
                    PathNode.CurveTo(83.58172f, 232.0f, 80.0f, 228.41827f, 80.0f, 224.0f),
                    PathNode.LineTo(80.0f, 167.38f),
                    PathNode.CurveTo(79.99392f, 157.65628f, 84.409424f, 148.45732f, 92.0f, 142.38f),
                    PathNode.LineTo(108.0f, 129.6f),
                    PathNode.CurveTo(115.590576f, 123.52268f, 120.00608f, 114.32371f, 120.0f, 104.6f),
                    PathNode.LineTo(120.0f, 72.0f),
                    PathNode.LineTo(160.0f, 72.0f),
                    PathNode.CurveTo(186.14018f, 113.82278f, 200.00046f, 162.15009f, 200.0f, 211.47f),
                    PathNode.Close
                ),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(192.0f, 211.47f),
                    PathNode.LineTo(192.0f, 224.0f),
                    PathNode.LineTo(88.0f, 224.0f),
                    PathNode.LineTo(88.0f, 167.38f),
                    PathNode.CurveTo(87.97938f, 160.0864f, 91.29449f, 153.1836f, 97.0f, 148.64f),
                    PathNode.LineTo(113.0f, 135.85f),
                    PathNode.CurveTo(122.507484f, 128.27744f, 128.03236f, 116.77463f, 128.0f, 104.62f),
                    PathNode.LineTo(128.0f, 80.0f),
                    PathNode.LineTo(155.52f, 80.0f),
                    PathNode.CurveTo(179.40225f, 119.69356f, 192.01422f, 165.1457f, 192.0f, 211.47f),
                    PathNode.Close
                ),
                pathFillType = PathFillType.NonZero,
                fill = SolidColor(Color.Black),
