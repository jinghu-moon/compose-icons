...
val LucideIcons.Outline.BookmarkX: ImageVector
    get() {
        if (_bookmarkX != null) return _bookmarkX!!
        _bookmarkX = lucideOutlineIcon(
            name = "BookmarkX",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24.0f, height = 24.0f),
        ) {
    addPath(
        pathData = parseSvgPathData("M 14.500 7.500 L 9.500 12.500"),
    ...
    addPath(
        pathData = parseSvgPathData("M 9.500 7.500 L 14.500 12.500"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
