        ...
        _sealQuestion = phosphorThinIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(164.0f, 124.44f, 150.0f, 138.0f, 132.0f, 139.8f),
                    ...
                    PathNode.CurveTo(124.0f, 133.79086f, 125.79086f, 132.0f, 128.0f, 132.0f),
                    PathNode.CurveTo(143.44f, 132.0f, 156.0f, 121.23f, 156.0f, 108.0f),
                    PathNode.CurveTo(156.0f, 94.77f, 143.44f, 84.0f, 128.0f, 84.0f),
                    PathNode.CurveTo(112.56f, 84.0f, 100.0f, 94.77f, 100.0f, 108.0f),
                    PathNode.LineTo(100.0f, 112.0f),
                    PathNode.CurveTo(100.0f, 114.20914f, 98.20914f, 116.0f, 96.0f, 116.0f),
                    PathNode.CurveTo(93.79086f, 116.0f, 92.0f, 114.20914f, 92.0f, 112.0f),
                    PathNode.LineTo(92.0f, 108.0f),
                    PathNode.CurveTo(92.0f, 90.36f, 108.15f, 76.0f, 128.0f, 76.0f),
                    PathNode.CurveTo(147.85f, 76.0f, 164.0f, 90.36f, 164.0f, 108.0f),
                    PathNode.Close
                ),
