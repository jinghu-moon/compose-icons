...
val TablerIcons.Outline.Sunset2: ImageVector
    get() {
        ...
        _sunset2 = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(5.6f, 6.6f),
                    PathNode.LineTo(6.3f, 7.3f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(8.0f, 10.790861f, 9.790861f, 9.0f, 12.0f, 9.0f),
                    PathNode.CurveTo(14.209139f, 9.0f, 16.0f, 10.790861f, 16.0f, 13.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
