...
android {
    namespace = "composeicons.circleflags"
    compileSdk = 36
...
mavenPublishing {
    ...
    pom {
        name.set("icons-circleflags")
        description.set("Circle Flags for Jetpack Compose - generated via svg2compose pipeline")
