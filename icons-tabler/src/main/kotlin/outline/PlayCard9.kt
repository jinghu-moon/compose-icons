...
val TablerIcons.Outline.PlayCard9: ImageVector
    get() {
        if (_playCard9 != null) return _playCard9!!
        _playCard9 = tablerOutlineIcon(
            name = "PlayCard9",
            ...
            addPath(
                pathData = parseSvgPathData("M 10.000 15.000 L 13.000 15.000 C 13.552 15.000 14.000 14.552 14.000 14.000 L 14.000 10.000 C 14.000 9.448 13.552 9.000 13.000 9.000 L 11.000 9.000 C 10.448 9.000 10.000 9.448 10.000 10.000 L 10.000 11.000 C 10.000 11.552 10.448 12.000 11.000 12.000 L 14.000 12.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
