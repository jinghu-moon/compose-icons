...
val TablerIcons.Outline.LogicNand: ImageVector
    get() {
        ...
        _logicNand = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 22.000 12.000 L 19.000 12.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 2.000 9.000 L 5.000 9.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 2.000 15.000 L 5.000 15.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 7.000 5.000 C 13.000 5.000 15.000 8.500 15.000 12.000 C 15.000 15.500 13.000 19.000 7.000 19.000 L 5.000 19.000 L 5.000 5.000 L 7.000 5.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
