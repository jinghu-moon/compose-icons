...
val PhosphorIcons.Duotone.PhoneX: ImageVector
    get() {
        if (_phoneX != null) return _phoneX!!
        _phoneX = phosphorDuotoneIcon(
            name = "PhoneX",
