...
val TablerIcons.Outline.ZodiacPisces: ImageVector
    get() {
        ...
        _zodiacPisces = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 5.000 3.000 C 7.702 8.696 7.702 15.304 5.000 21.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 19.000 3.000 C 16.298 8.696 16.298 15.304 19.000 21.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
