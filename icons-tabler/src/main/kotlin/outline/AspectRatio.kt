...
val TablerIcons.Outline.AspectRatio: ImageVector
    get() {
        if (_aspectRatio != null) return _aspectRatio!!
        _aspectRatio = tablerOutlineIcon(
            name = "AspectRatio",
            ...
            addPath(
                pathData = parseSvgPathData("M 17.000 12.000 L 17.000 15.000 L 14.000 15.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
