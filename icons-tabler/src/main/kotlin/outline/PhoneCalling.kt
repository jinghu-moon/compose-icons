...
val TablerIcons.Outline.PhoneCalling: ImageVector
    get() {
        if (_phoneCalling != null) return _phoneCalling!!
        _phoneCalling = tablerOutlineIcon(
            name = "PhoneCalling",
            ...
            addPath(
                pathData = parseSvgPathData("M 15.000 7.000 L 15.000 7.010"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 21.000 7.000 L 21.000 7.010"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
