...
val PhosphorIcons.Fill.CallBell: ImageVector
    get() {
        ...
        _callBell = phosphorFillIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(16.0f, 176.0f),
                    PathNode.CurveTo(16.0f, 171.58173f, 19.581722f, 168.0f, 24.0f, 168.0f),
                    PathNode.LineTo(32.0f, 168.0f),
                    PathNode.LineTo(32.0f, 152.0f),
                    PathNode.CurveTo(32.060425f, 102.106834f, 70.28514f, 60.55483f, 120.0f, 56.34f),
                    ...
                    PathNode.LineTo(136.0f, 56.34f),
                    PathNode.CurveTo(185.71486f, 60.55483f, 223.93958f, 102.106834f, 224.0f, 152.0f),
                    PathNode.LineTo(224.0f, 168.0f),
                    PathNode.LineTo(232.0f, 168.0f),
                    PathNode.CurveTo(236.41827f, 168.0f, 240.0f, 171.58173f, 240.0f, 176.0f),
                    ...
                    PathNode.CurveTo(19.581722f, 200.0f, 16.0f, 203.58173f, 16.0f, 208.0f),
                    PathNode.CurveTo(16.0f, 212.41827f, 19.581722f, 216.0f, 24.0f, 216.0f),
                    PathNode.LineTo(232.0f, 216.0f),
                    PathNode.CurveTo(236.41827f, 216.0f, 240.0f, 212.41827f, 240.0f, 208.0f),
                    PathNode.CurveTo(240.0f, 203.58173f, 236.41827f, 200.0f, 232.0f, 200.0f),
                    PathNode.Close
                ),
