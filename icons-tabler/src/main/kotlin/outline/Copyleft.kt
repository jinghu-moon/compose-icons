...
val TablerIcons.Outline.Copyleft: ImageVector
    get() {
        ...
        _copyleft = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 10.000 9.750 C 11.211 8.686 13.045 8.762 14.163 9.923 C 15.280 11.082 15.280 12.918 14.163 14.077 C 13.045 15.238 11.211 15.314 10.000 14.250"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
