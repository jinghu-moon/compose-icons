...
val TablerIcons.Outline.ScanLetterA: ImageVector
    get() {
        ...
        _scanLetterA = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 9.000 16.000 L 9.000 10.000 C 9.000 8.895 9.895 8.000 11.000 8.000 L 13.000 8.000 C 14.105 8.000 15.000 8.895 15.000 10.000 L 15.000 16.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
