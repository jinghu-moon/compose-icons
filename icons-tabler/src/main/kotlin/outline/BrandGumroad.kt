...
val TablerIcons.Outline.BrandGumroad: ImageVector
    get() {
        ...
        _brandGumroad = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 13.500 13.000 L 16.000 13.000 L 16.000 16.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 15.024 9.382 C 13.816 7.986 11.809 7.599 10.168 8.444 C 8.527 9.290 7.677 11.148 8.112 12.943 C 8.547 14.737 10.154 16.000 12.000 16.000 C 13.862 16.000 14.554 14.722 15.000 13.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
