...
val TablerIcons.Outline.BoxMultiple8: ImageVector
    get() {
        if (_boxMultiple8 != null) return _boxMultiple8!!
        _boxMultiple8 = tablerOutlineIcon(
            name = "BoxMultiple8",
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(12.0f, 13.104569f, 12.895431f, 14.0f, 14.0f, 14.0f),
                    PathNode.CurveTo(15.104569f, 14.0f, 16.0f, 13.104569f, 16.0f, 12.0f),
                    PathNode.CurveTo(16.0f, 10.895431f, 15.104569f, 10.0f, 14.0f, 10.0f),
                    PathNode.CurveTo(12.895431f, 10.0f, 12.0f, 10.895431f, 12.0f, 12.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
