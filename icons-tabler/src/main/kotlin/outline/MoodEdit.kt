...
val TablerIcons.Outline.MoodEdit: ImageVector
    get() {
        ...
        _moodEdit = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 20.955 11.104 C 20.484 6.395 16.446 2.855 11.715 3.005 C 6.985 3.154 3.178 6.942 3.006 11.672 C 2.833 16.402 6.353 20.457 11.060 20.951"),
            ...
            addPath(
                pathData = parseSvgPathData("M 9.500 15.000 C 10.158 15.672 11.060 16.000 12.000 16.000 C 12.126 16.000 12.251 15.994 12.376 15.982"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
