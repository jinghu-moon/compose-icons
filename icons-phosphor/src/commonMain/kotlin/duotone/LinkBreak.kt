...
val PhosphorIcons.Duotone.LinkBreak: ImageVector
    get() {
        ...
        _linkBreak = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(204.28f, 108.28f),
                    PathNode.LineTo(108.28f, 204.28f),
                    PathNode.CurveTo(92.58485f, 219.43889f, 67.636604f, 219.22209f, 52.207256f, 203.79274f),
                    PathNode.CurveTo(36.777905f, 188.36339f, 36.56111f, 163.41516f, 51.72f, 147.72f),
                    PathNode.LineTo(147.72f, 51.72f),
                    PathNode.CurveTo(163.41516f, 36.56111f, 188.36339f, 36.777905f, 203.79274f, 52.207256f),
                    PathNode.CurveTo(219.22209f, 67.636604f, 219.43889f, 92.58485f, 204.28f, 108.28f),
                    PathNode.Close
                ),
