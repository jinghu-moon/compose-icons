        ...
        _badge8K = tablerFilledIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(6.005f, 11.15f),
                    PathNode.CurveTo(6.027f, 11.445f, 6.113f, 11.723f, 6.25f, 11.969f),
                    PathNode.LineTo(6.269f, 12.0f),
                    PathNode.LineTo(6.249f, 12.031f),
                    PathNode.CurveTo(6.085247f, 12.327688f, 5.999566f, 12.661121f, 6.0f, 13.0f),
                    PathNode.LineTo(6.0f, 14.0f),
                    PathNode.CurveTo(6.0f, 15.104569f, 6.895431f, 16.0f, 8.0f, 16.0f),
                    PathNode.LineTo(9.0f, 16.0f),
                    PathNode.CurveTo(10.104569f, 16.0f, 11.0f, 15.104569f, 11.0f, 14.0f),
                    PathNode.LineTo(11.0f, 13.0f),
                    PathNode.LineTo(10.995f, 12.85f),
                    PathNode.CurveTo(10.973314f, 12.562533f, 10.889738f, 12.283152f, 10.75f, 12.031f),
                    PathNode.LineTo(10.731f, 12.0f),
                    PathNode.LineTo(10.751f, 11.969f),
                    PathNode.CurveTo(10.909f, 11.682f, 11.0f, 11.351f, 11.0f, 11.0f),
                    PathNode.LineTo(11.0f, 10.0f),
                    PathNode.CurveTo(11.0f, 8.895431f, 10.104569f, 8.0f, 9.0f, 8.0f),
