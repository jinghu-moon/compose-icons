...
val TablerIcons.Outline.BrandVolkswagen: ImageVector
    get() {
        ...
        _brandVolkswagen = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 5.000 7.000 L 9.500 18.000 L 11.000 13.000 L 13.000 13.000 L 14.500 18.000 L 19.000 7.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 9.000 4.000 L 11.000 10.000 L 13.000 10.000 L 15.000 4.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
