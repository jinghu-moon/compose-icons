...
val PhosphorIcons.Duotone.GitBranch: ImageVector
    get() {
        if (_gitBranch != null) return _gitBranch!!
        _gitBranch = phosphorDuotoneIcon(
            name = "GitBranch",
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(224.0f, 77.25484f, 213.25484f, 88.0f, 200.0f, 88.0f),
                    PathNode.CurveTo(186.74516f, 88.0f, 176.0f, 77.25484f, 176.0f, 64.0f),
                    PathNode.CurveTo(176.0f, 50.745167f, 186.74516f, 40.0f, 200.0f, 40.0f),
                    PathNode.CurveTo(213.25484f, 40.0f, 224.0f, 50.745167f, 224.0f, 64.0f),
                    PathNode.Close
                ),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(191.16344f, 80.0f, 184.0f, 72.836555f, 184.0f, 64.0f),
                    PathNode.CurveTo(184.0f, 55.163445f, 191.16344f, 48.0f, 200.0f, 48.0f),
                    PathNode.CurveTo(208.83656f, 48.0f, 216.0f, 55.163445f, 216.0f, 64.0f),
                    PathNode.CurveTo(216.0f, 72.836555f, 208.83656f, 80.0f, 200.0f, 80.0f),
                    PathNode.Close
                ),
                pathFillType = PathFillType.NonZero,
                fill = SolidColor(Color.Black),
