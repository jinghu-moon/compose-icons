...
val PhosphorIcons.Duotone.Volleyball: ImageVector
    get() {
        ...
        _volleyball = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(216.25f, 165.8f),
                    PathNode.CurveTo(205.44624f, 191.03078f, 184.35979f, 210.43071f, 158.31789f, 219.09859f),
                    PathNode.CurveTo(132.27597f, 227.76648f, 103.76939f, 224.8733f, 80.0f, 211.15f),
                    PathNode.LineTo(80.0f, 211.15f),
                    PathNode.CurveTo(68.744675f, 204.66893f, 58.925545f, 195.96576f, 51.14f, 185.57f),
                    PathNode.LineTo(51.14f, 185.57f),
                    PathNode.CurveTo(46.97076f, 145.1224f, 68.7359f, 106.4355f, 105.47f, 89.0f),
                    PathNode.LineTo(80.0f, 44.86f),
                    PathNode.CurveTo(91.23751f, 38.349613f, 103.684265f, 34.198425f, 116.58f, 32.66f),
                    PathNode.LineTo(116.58f, 32.66f),
                    PathNode.CurveTo(153.69974f, 49.269535f, 176.32703f, 87.465096f, 173.06f, 128.0f),
                    PathNode.LineTo(128.0f, 128.0f),
                    PathNode.LineTo(105.47f, 167.0f),
                    PathNode.CurveTo(138.92996f, 190.09096f, 183.30669f, 189.60225f, 216.25f, 165.78f),
                    PathNode.Close
                ),
