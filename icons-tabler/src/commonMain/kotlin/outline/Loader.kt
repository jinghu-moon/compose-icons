...
val TablerIcons.Outline.Loader: ImageVector
    get() {
        ...
        _loader = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(16.25f, 7.75f),
                    PathNode.LineTo(18.4f, 5.6f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(7.75f, 7.75f),
                    PathNode.LineTo(5.6f, 5.6f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
