...
val TablerIcons.Outline.PlayerTrackNext: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 3.000 5.000 L 3.000 19.000 L 11.000 12.000 L 3.000 5.000"),
    ...
    addPath(
        pathData = parseSvgPathData("M 14.000 5.000 L 14.000 19.000 L 22.000 12.000 L 14.000 5.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
