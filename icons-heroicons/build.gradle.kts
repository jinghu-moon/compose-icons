...
android {
    namespace = "composeicons.heroicons"
    compileSdk = 36
...
mavenPublishing {
    ...
    pom {
        name.set("icons-heroicons")
        description.set("Heroicons for Jetpack Compose - generated via svg2compose pipeline")
