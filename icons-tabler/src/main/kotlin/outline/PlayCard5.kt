...
val TablerIcons.Outline.PlayCard5: ImageVector
    get() {
        if (_playCard5 != null) return _playCard5!!
        _playCard5 = tablerOutlineIcon(
            name = "PlayCard5",
    ...
    addPath(
        pathData = parseSvgPathData("M 10.000 15.000 L 13.000 15.000 C 13.552 15.000 14.000 14.552 14.000 14.000 L 14.000 13.000 C 14.000 12.448 13.552 12.000 13.000 12.000 L 10.000 12.000 L 10.000 9.000 L 14.000 9.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
