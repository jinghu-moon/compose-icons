        ...
        _seatbelt = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(92.0f, 48.11775f, 108.11775f, 32.0f, 128.0f, 32.0f),
                    PathNode.CurveTo(147.88223f, 32.0f, 164.0f, 48.11775f, 164.0f, 68.0f),
                    PathNode.CurveTo(164.0f, 87.88225f, 147.88223f, 104.0f, 128.0f, 104.0f),
                    PathNode.CurveTo(108.11775f, 104.0f, 92.0f, 87.88225f, 92.0f, 68.0f),
                    PathNode.Close,
                    PathNode.MoveTo(128.0f, 120.0f),
                    PathNode.CurveTo(88.2355f, 120.0f, 56.0f, 152.2355f, 56.0f, 192.0f),
                    PathNode.LineTo(56.0f, 224.0f),
                    PathNode.LineTo(200.0f, 224.0f),
                    PathNode.LineTo(200.0f, 192.0f),
                    PathNode.CurveTo(200.0f, 152.2355f, 167.7645f, 120.0f, 128.0f, 120.0f),
                    PathNode.Close
                ),
