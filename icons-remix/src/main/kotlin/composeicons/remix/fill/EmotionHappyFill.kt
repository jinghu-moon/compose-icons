...
val RemixIcons.Fill.EmotionHappyFill: ImageVector
    get() {
        ...
        _emotionHappyFill = remixIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M12 22C6.477 22 2 17.523 2 12 2 6.477 6.477 2 12 2c5.523 0 10 4.477 10 10 0 5.523-4.477 10-10 10ZM7 13c0 2.761 2.239 5 5 5 2.761 0 5-2.239 5-5h-2c0 1.657-1.343 3-3 3C10.343 16 9 14.657 9 13h-2ZM8 11c.828 0 1.5-.672 1.5-1.5C9.5 8.672 8.828 8 8 8 7.172 8 6.5 8.672 6.5 9.5 6.5 10.328 7.172 11 8 11ZM16 11c.828 0 1.5-.672 1.5-1.5C17.5 8.672 16.828 8 16 8c-.828 0-1.5 .672-1.5 1.5 0 .828 .672 1.5 1.5 1.5Z"),
