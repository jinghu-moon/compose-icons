...
val TablerIcons.Outline.MessageCircleCog: ImageVector
    get() {
        ...
        _messageCircleCog = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 11.996 19.980 C 10.508 19.981 9.040 19.646 7.700 19.000 L 3.000 20.000 L 4.300 16.100 C 1.976 12.663 2.874 8.228 6.400 5.726 C 9.926 3.225 14.990 3.430 18.245 6.206 C 20.087 7.778 21.028 9.897 21.015 12.027"),
