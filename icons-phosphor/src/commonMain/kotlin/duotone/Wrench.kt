        ...
        _wrench = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(223.99142f, 118.64335f, 212.01857f, 139.59673f, 192.51524f, 151.1007f),
                    PathNode.CurveTo(173.01192f, 162.60466f, 148.88152f, 162.94664f, 129.06f, 152.0f),
                    PathNode.LineTo(73.0f, 217.0f),
                    PathNode.CurveTo(63.61116f, 226.38882f, 48.38884f, 226.38882f, 39.0f, 217.0f),
                    PathNode.CurveTo(29.61116f, 207.61118f, 29.61116f, 192.38882f, 39.0f, 183.0f),
                    PathNode.LineTo(104.0f, 126.94f),
                    PathNode.CurveTo(90.89478f, 103.22354f, 94.145134f, 73.82436f, 112.11466f, 53.543507f),
                    PathNode.CurveTo(130.08418f, 33.26265f, 158.87807f, 26.495907f, 184.0f, 36.65f),
                    PathNode.LineTo(144.0f, 80.0f),
                    PathNode.LineTo(149.66f, 106.34f),
                    PathNode.LineTo(176.0f, 112.0f),
                    PathNode.LineTo(219.35f, 72.0f),
                    PathNode.CurveTo(222.43253f, 79.62548f, 224.0115f, 87.775055f, 224.0f, 96.0f),
                    PathNode.Close
                ),
