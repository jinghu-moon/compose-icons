...
val TablerIcons.Outline.UmbrellaClosed2: ImageVector
    get() {
        ...
        _umbrellaClosed2 = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 6.697 12.071 L 18.010 5.000 L 10.940 16.314 L 6.697 12.071"),
            ...
            addPath(
                pathData = parseSvgPathData("M 8.743 14.475 L 6.622 16.596 C 4.736 18.482 7.565 21.311 9.450 19.425"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
