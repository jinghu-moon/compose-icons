...
val TablerIcons.Outline.HeartExclamation: ImageVector
    get() {
        ...
        _heartExclamation = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 15.030 17.000 L 12.000 20.000 L 4.500 12.572 C 3.151 11.260 2.654 9.301 3.212 7.504 C 3.771 5.707 5.292 4.376 7.147 4.060 C 9.002 3.743 10.877 4.496 12.000 6.006 C 13.084 4.573 14.853 3.832 16.635 4.065 C 18.416 4.297 19.936 5.468 20.616 7.131 C 21.296 8.794 21.031 10.694 19.922 12.108"),
