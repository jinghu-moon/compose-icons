...
val PhosphorIcons.Light.DotsNine: ImageVector
    get() {
        ...
        _dotsNine = phosphorLightIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(70.0f, 60.0f),
                    PathNode.CurveTo(70.0f, 65.52285f, 65.52285f, 70.0f, 60.0f, 70.0f),
                    PathNode.CurveTo(54.477154f, 70.0f, 50.0f, 65.52285f, 50.0f, 60.0f),
                    PathNode.CurveTo(50.0f, 54.477154f, 54.477154f, 50.0f, 60.0f, 50.0f),
                    PathNode.CurveTo(65.52285f, 50.0f, 70.0f, 54.477154f, 70.0f, 60.0f),
                    PathNode.Close,
                    PathNode.MoveTo(128.0f, 50.0f),
                    PathNode.CurveTo(122.47715f, 50.0f, 118.0f, 54.477154f, 118.0f, 60.0f),
                    PathNode.CurveTo(118.0f, 65.52285f, 122.47715f, 70.0f, 128.0f, 70.0f),
                    PathNode.CurveTo(133.52284f, 70.0f, 138.0f, 65.52285f, 138.0f, 60.0f),
                    PathNode.CurveTo(138.0f, 54.477154f, 133.52284f, 50.0f, 128.0f, 50.0f),
                    PathNode.Close,
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(196.0f, 186.0f),
                    PathNode.CurveTo(190.47716f, 186.0f, 186.0f, 190.47716f, 186.0f, 196.0f),
                    PathNode.CurveTo(186.0f, 201.52284f, 190.47716f, 206.0f, 196.0f, 206.0f),
                    PathNode.CurveTo(201.52284f, 206.0f, 206.0f, 201.52284f, 206.0f, 196.0f),
                    PathNode.CurveTo(206.0f, 190.47716f, 201.52284f, 186.0f, 196.0f, 186.0f),
                    PathNode.Close
                ),
