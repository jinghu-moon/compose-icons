...
val RemixIcons.Line.EmpathizeLine: ImageVector
    get() {
        ...
        _empathizeLine = remixIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M18.364 10.979c1.562 1.562 1.562 4.095 0 5.657l-5.657 5.657c-.391 .39-1.024 .39-1.414 0L5.636 16.636c-1.562-1.562-1.562-4.095 0-5.657 1.562-1.562 4.095-1.562 5.657 0l.706 .706 .708-.706c1.562-1.562 4.095-1.562 5.657 0ZM7.051 12.393c-.781 .781-.781 2.047 0 2.828l4.95 4.95 4.95-4.95c.781-.781 .781-2.047 0-2.828-.781-.781-2.047-.781-2.83 .001l-2.122 2.118L9.879 12.393c-.781-.781-2.047-.781-2.828 0ZM12 1c2.209 0 4 1.791 4 4 0 2.209-1.791 4-4 4C9.791 9 8 7.209 8 5c0-2.209 1.791-4 4-4ZM12 3c-1.105 0-2 .895-2 2 0 1.105 .895 2 2 2 1.105 0 2-.895 2-2 0-1.105-.895-2-2-2Z"),
