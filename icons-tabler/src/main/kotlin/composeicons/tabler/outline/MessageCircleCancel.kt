...
val TablerIcons.Outline.MessageCircleCancel: ImageVector
    get() {
        ...
        _messageCircleCancel = tablerOutlineIcon(
            ...
            addPathData("M12.015 19.98C10.521 19.984 9.046 19.649 7.7 19L3 20 4.3 16.1C1.976 12.663 2.874 8.228 6.4 5.726 9.926 3.225 14.99 3.43 18.245 6.206c1.927 1.644 2.867 3.887 2.761 6.114")
