...
val TablerIcons.Outline.SocialOff: ImageVector
    get() {
        ...
        _socialOff = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(17.57f, 17.602f),
                    PathNode.CurveTo(16.789345f, 18.383482f, 16.790016f, 19.649845f, 17.5715f, 20.4305f),
                    PathNode.CurveTo(18.352983f, 21.211155f, 19.619345f, 21.210484f, 20.4f, 20.429f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(11.113f, 11.133f),
                    PathNode.CurveTo(9.745304f, 11.556698f, 8.867654f, 12.887857f, 9.01714f, 14.311853f),
                    PathNode.CurveTo(9.166628f, 15.735849f, 10.301582f, 16.85573f, 11.727449f, 16.986168f),
                    PathNode.CurveTo(13.153316f, 17.116606f, 14.472624f, 16.221237f, 14.878f, 14.848f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(6.7f, 17.8f),
                    PathNode.LineTo(9.5f, 15.8f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(17.3f, 17.8f),
                    PathNode.LineTo(14.5f, 15.8f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
