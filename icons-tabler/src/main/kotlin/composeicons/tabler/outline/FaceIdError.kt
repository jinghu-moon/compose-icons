...
val TablerIcons.Outline.FaceIdError: ImageVector
    get() {
        if (_faceIdError != null) return _faceIdError!!
        _faceIdError = tablerOutlineIcon(
            name = "FaceIdError",
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(9.5f, 15.05f),
                    PathNode.CurveTo(10.158311f, 14.378114f, 11.05936f, 13.99949f, 12.0f, 13.99949f),
                    PathNode.CurveTo(12.94064f, 13.99949f, 13.841689f, 14.378114f, 14.5f, 15.05f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
