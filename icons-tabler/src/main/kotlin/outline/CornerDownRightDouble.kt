...
val TablerIcons.Outline.CornerDownRightDouble: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 4.000 5.000 L 4.000 11.000 C 4.000 12.657 5.343 14.000 7.000 14.000 L 14.000 14.000"),
    ...
    addPath(
        pathData = parseSvgPathData("M 10.000 10.000 L 14.000 14.000 L 10.000 18.000M 15.000 10.000 L 19.000 14.000 L 15.000 18.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
