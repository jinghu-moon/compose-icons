...
val TablerIcons.Outline.AlignBoxBottomRight: ImageVector
    get() {
        if (_alignBoxBottomRight != null) return _alignBoxBottomRight!!
        _alignBoxBottomRight = tablerOutlineIcon(
    ...
    addPath(
        pathData = parseSvgPathData("M 11.000 15.000 L 11.000 17.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 17.000 13.000 L 17.000 17.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
