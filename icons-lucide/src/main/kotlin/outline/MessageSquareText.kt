...
val LucideIcons.Outline.MessageSquareText: ImageVector
    get() {
        if (_messageSquareText != null) return _messageSquareText!!
        _messageSquareText = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 7.000 11.000 L 17.000 11.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 7.000 15.000 L 13.000 15.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 7.000 7.000 L 15.000 7.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
