...
val PhosphorIcons.Duotone.Bulldozer: ImageVector
    get() {
        if (_bulldozer != null) return _bulldozer!!
        _bulldozer = phosphorDuotoneIcon(
            name = "Bulldozer",
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(192.0f, 193.67311f, 177.67311f, 208.0f, 160.0f, 208.0f),
                    PathNode.LineTo(40.0f, 208.0f),
                    PathNode.CurveTo(22.326887f, 208.0f, 8.0f, 193.67311f, 8.0f, 176.0f),
                    PathNode.LineTo(8.0f, 176.0f),
                    PathNode.CurveTo(8.0f, 158.32689f, 22.326887f, 144.0f, 40.0f, 144.0f),
                    PathNode.LineTo(160.0f, 144.0f),
                    PathNode.CurveTo(177.67311f, 144.0f, 192.0f, 158.32689f, 192.0f, 176.0f),
                    PathNode.Close
                ),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(195.77742f, 151.39548f, 182.28008f, 138.73895f, 165.49f, 136.39f),
                    ...
                    PathNode.CurveTo(26.745167f, 200.0f, 16.0f, 189.25484f, 16.0f, 176.0f),
                    PathNode.CurveTo(16.0f, 162.74516f, 26.745167f, 152.0f, 40.0f, 152.0f),
                    PathNode.LineTo(160.0f, 152.0f),
                    PathNode.CurveTo(173.25484f, 152.0f, 184.0f, 162.74516f, 184.0f, 176.0f),
                    PathNode.CurveTo(184.0f, 189.25484f, 173.25484f, 200.0f, 160.0f, 200.0f),
                    PathNode.Close,
