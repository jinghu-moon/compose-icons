...
val PhosphorIcons.Duotone.Bicycle: ImageVector
    get() {
        ...
        _bicycle = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M248 160c0 22.091-17.909 40-40 40-22.091 0-40-17.909-40-40 0-22.091 17.909-40 40-40 22.091 0 40 17.909 40 40ZM48 120C25.909 120 8 137.909 8 160c0 22.091 17.909 40 40 40 22.091 0 40-17.909 40-40C88 137.909 70.091 120 48 120Z"),
