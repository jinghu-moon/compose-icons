...
val TablerIcons.Outline.EyeCheck: ImageVector
    get() {
        ...
        _eyeCheck = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 11.102 17.957 C 7.898 17.650 5.198 15.663 3.000 12.000 C 5.400 8.000 8.400 6.000 12.000 6.000 C 15.600 6.000 18.600 8.000 21.000 12.000 C 20.790 12.351 20.569 12.695 20.337 13.032"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
