...
val RemixIcons.Line.MoneyRupeeCircleLine: ImageVector
    get() {
        ...
        _moneyRupeeCircleLine = remixIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M20 12C20 7.582 16.418 4 12 4 7.582 4 4 7.582 4 12c0 4.418 3.582 8 8 8 4.418 0 8-3.582 8-8ZM22 12c0 5.523-4.477 10-10 10C6.477 22 2 17.523 2 12 2 6.477 6.477 2 12 2c5.523 0 10 4.477 10 10ZM13.5 8c.327 .436 .562 .946 .675 1.5h1.825v1.5h-1.825c-.347 1.712-1.861 3-3.675 3h-.189l3.72 3.72-1.061 1.061L8 13.811v-1.311h2.5c.98 0 1.813-.626 2.122-1.5h-4.622v-1.5h4.622C12.313 8.626 11.48 8 10.5 8h-2.5v-1.5h8v1.5h-2.5Z"),
