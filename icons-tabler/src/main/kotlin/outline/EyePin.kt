...
val TablerIcons.Outline.EyePin: ImageVector
    get() {
        if (_eyePin != null) return _eyePin!!
        _eyePin = tablerOutlineIcon(
            name = "EyePin",
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 18.000 C 8.400 18.000 5.400 16.000 3.000 12.000 C 5.400 8.000 8.400 6.000 12.000 6.000 C 15.362 6.000 18.202 7.745 20.517 11.234"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
