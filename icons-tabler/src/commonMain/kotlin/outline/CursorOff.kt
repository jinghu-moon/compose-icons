        ...
        _cursorOff = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(10.656855f, 4.0f, 12.0f, 5.343146f, 12.0f, 7.0f),
                    PathNode.LineTo(12.0f, 8.0f),
                    PathNode.MoveTo(12.0f, 17.0f),
                    PathNode.CurveTo(12.0f, 18.656855f, 10.656855f, 20.0f, 9.0f, 20.0f)
                ),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(13.343145f, 4.0f, 12.0f, 5.343146f, 12.0f, 7.0f),
                    PathNode.LineTo(12.0f, 8.0f),
                    PathNode.MoveTo(12.0f, 12.0f),
                    PathNode.LineTo(12.0f, 17.0f),
                    PathNode.CurveTo(12.0f, 18.656855f, 13.343145f, 20.0f, 15.0f, 20.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
