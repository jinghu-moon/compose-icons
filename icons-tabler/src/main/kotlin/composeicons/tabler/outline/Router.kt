...
val TablerIcons.Outline.Router: ImageVector
    get() {
        ...
        _router = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(11.75f, 8.75f),
                    PathNode.CurveTo(12.501328f, 7.702839f, 13.711186f, 7.081845f, 15.0f, 7.081845f),
                    PathNode.CurveTo(16.288815f, 7.081845f, 17.498672f, 7.702839f, 18.25f, 8.75f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(10.002657f, 4.405678f, 12.422373f, 3.16369f, 15.0f, 3.16369f),
                    PathNode.CurveTo(17.577627f, 3.16369f, 19.997343f, 4.405678f, 21.5f, 6.5f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
