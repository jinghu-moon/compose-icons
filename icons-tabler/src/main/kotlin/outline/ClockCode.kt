...
val TablerIcons.Outline.ClockCode: ImageVector
    get() {
        ...
        _clockCode = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 20.931 13.111 C 21.387 9.445 19.557 5.873 16.315 4.102 C 13.073 2.331 9.078 2.721 6.240 5.085 C 3.401 7.449 2.296 11.308 3.452 14.816 C 4.608 18.325 7.790 20.771 11.478 20.985"),
