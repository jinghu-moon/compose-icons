...
val TablerIcons.Outline.CashBanknoteMove: ImageVector
    get() {
        if (_cashBanknoteMove != null) return _cashBanknoteMove!!
        _cashBanknoteMove = tablerOutlineIcon(
            name = "CashBanknoteMove",
    ...
    addPath(
        pathData = parseSvgPathData("M 12.000 18.000 L 5.000 18.000 C 3.895 18.000 3.000 17.105 3.000 16.000 L 3.000 8.000 C 3.000 6.895 3.895 6.000 5.000 6.000 L 19.000 6.000 C 20.105 6.000 21.000 6.895 21.000 8.000 L 21.000 12.500"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
