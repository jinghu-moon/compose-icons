...
val LucideIcons.Outline.ImageOff: ImageVector
    get() {
        ...
        _imageOff = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(10.41f, 10.41f),
                    PathNode.CurveTo(9.628517f, 11.191483f, 8.361483f, 11.191483f, 7.58f, 10.41f),
                    PathNode.CurveTo(6.798517f, 9.628517f, 6.798517f, 8.361483f, 7.58f, 7.58f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(3.59f, 3.59f),
                    PathNode.CurveTo(3.213481f, 3.962723f, 3.001133f, 4.470201f, 3.0f, 5.0f),
                    PathNode.LineTo(3.0f, 19.0f),
                    PathNode.CurveTo(3.0f, 20.10457f, 3.895431f, 21.0f, 5.0f, 21.0f),
                    PathNode.LineTo(19.0f, 21.0f),
                    PathNode.CurveTo(19.55f, 21.0f, 20.052f, 20.78f, 20.41f, 20.41f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
