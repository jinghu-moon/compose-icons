...
val TablerIcons.Outline.MoodKid: ImageVector
    get() {
        if (_moodKid != null) return _moodKid!!
        _moodKid = tablerOutlineIcon(
            name = "MoodKid",
    ...
    addPath(
        pathData = parseSvgPathData("M 12.000 3.000 C 10.895 3.000 10.000 3.895 10.000 5.000 C 10.000 6.105 10.895 7.000 12.000 7.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
