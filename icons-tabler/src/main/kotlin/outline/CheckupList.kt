...
val TablerIcons.Outline.CheckupList: ImageVector
    get() {
        ...
        _checkupList = tablerOutlineIcon(
            name = "CheckupList",
    ...
    addPath(
        pathData = parseSvgPathData("M 9.000 14.000 L 9.010 14.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 12.000 16.000 L 13.000 17.000 L 16.000 14.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
