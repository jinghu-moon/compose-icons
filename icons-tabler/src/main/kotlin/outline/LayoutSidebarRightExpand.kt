...
val TablerIcons.Outline.LayoutSidebarRightExpand: ImageVector
    get() {
        if (_layoutSidebarRightExpand != null) return _layoutSidebarRightExpand!!
        _layoutSidebarRightExpand = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 15.000 4.000 L 15.000 20.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 10.000 10.000 L 8.000 12.000 L 10.000 14.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
