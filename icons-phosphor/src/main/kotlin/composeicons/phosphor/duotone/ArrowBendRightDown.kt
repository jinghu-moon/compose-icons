...
val PhosphorIcons.Duotone.ArrowBendRightDown: ImageVector
    get() {
        ...
        _arrowBendRightDown = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M200 176l-48 48L104 176Z"),
            ...
            addPath(
                pathData = parseSvgPathData("M207.39 172.94C206.152 169.95 203.236 168.001 200 168h-40v-40C159.939 70.588 113.412 24.061 56 24c-4.418 0-8 3.582-8 8 0 4.418 3.582 8 8 8 48.578 .055 87.945 39.422 88 88v40h-40c-3.238-.003-6.158 1.947-7.397 4.938-1.239 2.991-.554 6.434 1.737 8.722l48 48c1.501 1.502 3.537 2.346 5.66 2.346 2.123 0 4.159-.844 5.66-2.346l48-48c2.287-2.289 2.97-5.731 1.73-8.72ZM152 212.69 123.31 184h57.38Z"),
                pathFillType = PathFillType.NonZero,
                fill = SolidColor(Color(0xFF000000)),
                fillAlpha = 1f,
                stroke = null,
