...
val TablerIcons.Outline.Gradienter: ImageVector
    get() {
        ...
        _gradienter = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(3.227f, 14.0f),
                    PathNode.CurveTo(4.144f, 18.0f, 7.724f, 21.0f, 12.0f, 21.0f),
                    PathNode.CurveTo(16.277f, 21.0f, 19.858f, 18.0f, 20.773f, 14.0f)
                ),
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(20.78f, 10.0f),
                    PathNode.CurveTo(19.846245f, 5.903166f, 16.201897f, 2.997649f, 12.0f, 3.0f),
                    PathNode.CurveTo(7.795398f, 2.991107f, 4.146889f, 5.899277f, 3.218f, 10.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
