        ...
        _layoutAlignRight = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(4.0f, 9.895431f, 4.895431f, 9.0f, 6.0f, 9.0f),
                    PathNode.LineTo(14.0f, 9.0f),
                    PathNode.CurveTo(15.104569f, 9.0f, 16.0f, 9.895431f, 16.0f, 11.0f),
                    PathNode.LineTo(16.0f, 13.0f),
                    PathNode.CurveTo(16.0f, 14.104569f, 15.104569f, 15.0f, 14.0f, 15.0f),
                    PathNode.LineTo(6.0f, 15.0f),
                    PathNode.CurveTo(4.895431f, 15.0f, 4.0f, 14.104569f, 4.0f, 13.0f),
