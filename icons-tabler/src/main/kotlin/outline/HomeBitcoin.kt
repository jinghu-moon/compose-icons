...
val TablerIcons.Outline.HomeBitcoin: ImageVector
    get() {
        ...
        _homeBitcoin = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 19.500 10.500 L 12.000 3.000 L 3.000 12.000 L 5.000 12.000 L 5.000 19.000 C 5.000 20.105 5.895 21.000 7.000 21.000 L 13.000 21.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
