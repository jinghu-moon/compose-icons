...
val TablerIcons.Outline.PlayCardK: ImageVector
    get() {
        if (_playCardK != null) return _playCardK!!
        _playCardK = tablerOutlineIcon(
            name = "PlayCardK",
    ...
    addPath(
        pathData = parseSvgPathData("M 14.000 9.000 L 11.000 12.000 L 14.000 15.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 10.000 12.000 L 11.000 12.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
