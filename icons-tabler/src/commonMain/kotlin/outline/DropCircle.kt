...
val TablerIcons.Outline.DropCircle: ImageVector
    get() {
        ...
        _dropCircle = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(10.07f, 15.34f),
                    PathNode.CurveTo(11.185f, 16.22f, 12.81f, 16.22f, 13.925f, 15.34f),
                    PathNode.CurveTo(15.04f, 14.46f, 15.323f, 12.952f, 14.596f, 11.765f),
                    PathNode.LineTo(12.0f, 8.0f),
                    PathNode.LineTo(9.398f, 11.765f),
                    PathNode.CurveTo(8.672f, 12.952f, 8.955f, 14.459f, 10.07f, 15.34f)
                ),
