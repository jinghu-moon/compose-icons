...
val TablerIcons.Outline.FlagHeart: ImageVector
    get() {
        ...
        _flagHeart = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 11.330 13.447 C 9.359 12.095 6.707 12.327 5.000 14.000 L 5.000 5.000 C 6.944 3.094 10.056 3.094 12.000 5.000 C 13.944 6.906 17.056 6.906 19.000 5.000 L 19.000 11.000"),
