...
val LucideIcons.Outline.SquareParking: ImageVector
    get() {
        if (_squareParking != null) return _squareParking!!
        _squareParking = lucideOutlineIcon(
            name = "SquareParking",
    ...
    addPath(
        pathData = parseSvgPathData("M 9.000 17.000 L 9.000 7.000 L 13.000 7.000 C 14.657 7.000 16.000 8.343 16.000 10.000 C 16.000 11.657 14.657 13.000 13.000 13.000 L 9.000 13.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
