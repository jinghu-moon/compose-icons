...
val LucideIcons.Outline.CalendarCheck: ImageVector
    get() {
        if (_calendarCheck != null) return _calendarCheck!!
        _calendarCheck = lucideOutlineIcon(
            name = "CalendarCheck",
    ...
    addPath(
        pathData = parseSvgPathData("M 9.000 16.000 L 11.000 18.000 L 15.000 14.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
