...
val PhosphorIcons.Duotone.AirplaneLanding: ImageVector
    get() {
        ...
        _airplaneLanding = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M232 148.32v35.68L55.37 134.54C41.554 130.671 32.002 118.078 32 103.73v-55.73c-0-2.572 1.236-4.987 3.322-6.49 2.086-1.504 4.768-1.913 7.208-1.1L48 42.24 60 75.46 104 88v-40c-0-2.572 1.236-4.987 3.322-6.49 2.086-1.504 4.768-1.913 7.208-1.1L120 42.24l24 57.2 64.56 18c13.869 3.85 23.461 16.486 23.44 30.88Z"),
