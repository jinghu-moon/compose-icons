...
val PhosphorIcons.Duotone.LinuxLogo: ImageVector
    get() {
        ...
        _linuxLogo = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M224 208h-56c-8-14.35-22.91-24-40-24-17.09 0-32 9.65-40 24h-56c0 0 32-40 32-120C64 52.654 92.654 24 128 24c35.346 0 64 28.654 64 64 0 80 32 120 32 120Z"),
