        ...
        _bag = phosphorLightIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(82.0f, 96.0f),
                    PathNode.CurveTo(82.0f, 99.313705f, 84.686295f, 102.0f, 88.0f, 102.0f),
                    PathNode.CurveTo(91.313705f, 102.0f, 94.0f, 99.313705f, 94.0f, 96.0f),
                    PathNode.LineTo(94.0f, 78.0f),
                    PathNode.LineTo(162.0f, 78.0f),
                    PathNode.LineTo(162.0f, 96.0f),
                    PathNode.CurveTo(162.0f, 99.313705f, 164.6863f, 102.0f, 168.0f, 102.0f),
                    PathNode.CurveTo(171.3137f, 102.0f, 174.0f, 99.313705f, 174.0f, 96.0f),
