...
val TablerIcons.Outline.BabyCarriage: ImageVector
    get() {
        ...
        _babyCarriage = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 2.000 5.000 L 4.500 5.000 L 6.132 9.897 C 6.949 12.348 9.242 14.000 11.825 14.000 L 14.500 14.000 C 17.538 14.000 20.000 11.538 20.000 8.500 C 20.000 5.462 17.538 3.000 14.500 3.000 L 14.000 3.000 L 14.000 9.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 6.000 9.000 L 20.000 9.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 9.000 17.000 L 10.000 14.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 16.000 14.000 L 17.000 17.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
