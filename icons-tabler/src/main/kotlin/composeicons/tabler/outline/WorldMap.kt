        ...
        _worldMap = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(12.895431f, 12.0f, 12.0f, 11.104569f, 12.0f, 10.0f),
                    PathNode.LineTo(12.0f, 9.0f),
                    PathNode.CurveTo(12.0f, 7.895431f, 11.104569f, 7.0f, 10.0f, 7.0f),
                    PathNode.LineTo(9.0f, 7.0f),
                    PathNode.CurveTo(7.895431f, 7.0f, 7.0f, 6.10457f, 7.0f, 5.0f),
                    PathNode.LineTo(7.0f, 4.5f)
                ),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(7.10457f, 12.0f, 8.0f, 12.895431f, 8.0f, 14.0f),
                    PathNode.LineTo(8.0f, 14.5f),
                    PathNode.CurveTo(8.0f, 15.328427f, 8.671573f, 16.0f, 9.5f, 16.0f),
                    PathNode.CurveTo(10.328427f, 16.0f, 11.0f, 16.671574f, 11.0f, 17.5f),
                    PathNode.LineTo(11.0f, 20.75f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
