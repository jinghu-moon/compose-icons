...
val TablerIcons.Outline.TextScan2: ImageVector
    get() {
        if (_textScan2 != null) return _textScan2!!
        _textScan2 = tablerOutlineIcon(
            name = "TextScan2",
            ...
            addPath(
                pathData = parseSvgPathData("M 8.000 9.000 L 14.000 9.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 8.000 15.000 L 12.000 15.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
