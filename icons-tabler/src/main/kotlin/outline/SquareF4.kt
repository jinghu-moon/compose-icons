...
val TablerIcons.Outline.SquareF4: ImageVector
    get() {
        if (_squareF4 != null) return _squareF4!!
        _squareF4 = tablerOutlineIcon(
            name = "SquareF4",
            ...
            addPath(
                pathData = parseSvgPathData("M 13.000 9.000 L 13.000 11.000 C 13.000 11.552 13.448 12.000 14.000 12.000 L 15.000 12.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 16.000 9.000 L 16.000 15.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
