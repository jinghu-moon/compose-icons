        ...
        _fileFunction = tablerFilledIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(13.167f, 11.0f),
                    PathNode.LineTo(13.007f, 11.006f),
                    PathNode.CurveTo(12.112f, 11.076f, 11.357f, 11.738f, 11.257f, 12.636f),
                    PathNode.LineTo(11.105f, 14.0f),
                    PathNode.LineTo(10.5f, 14.0f),
                    PathNode.CurveTo(9.947715f, 14.0f, 9.5f, 14.447715f, 9.5f, 15.0f),
                    PathNode.CurveTo(9.5f, 15.552285f, 9.947715f, 16.0f, 10.5f, 16.0f),
                    PathNode.LineTo(10.882f, 16.0f),
                    PathNode.LineTo(10.771f, 17.0f),
                    PathNode.LineTo(10.5f, 17.0f),
                    PathNode.CurveTo(9.947715f, 17.0f, 9.5f, 17.447716f, 9.5f, 18.0f),
                    PathNode.CurveTo(9.5f, 18.552284f, 9.947715f, 19.0f, 10.5f, 19.0f),
                    PathNode.LineTo(10.833f, 19.0f),
                    PathNode.LineTo(10.993f, 18.994f),
                    PathNode.CurveTo(11.889f, 18.923f, 12.645f, 18.261f, 12.743f, 17.362f),
                    PathNode.LineTo(12.894f, 16.0f),
                    PathNode.LineTo(13.5f, 16.0f),
                    PathNode.CurveTo(14.052285f, 16.0f, 14.5f, 15.552285f, 14.5f, 15.0f),
                    PathNode.CurveTo(14.5f, 14.447715f, 14.052285f, 14.0f, 13.5f, 14.0f),
                    PathNode.LineTo(13.117f, 14.0f),
                    PathNode.LineTo(13.228f, 13.0f),
                    PathNode.LineTo(13.5f, 13.0f),
                    PathNode.CurveTo(14.052285f, 13.0f, 14.5f, 12.552285f, 14.5f, 12.0f),
                    PathNode.CurveTo(14.5f, 11.447715f, 14.052285f, 11.0f, 13.5f, 11.0f)
                ),
