...
android {
    namespace = "composeicons.bootstrap"
    compileSdk = 36
...
mavenPublishing {
    ...
    pom {
        name.set("icons-bootstrap")
        description.set("Bootstrap Icons for Jetpack Compose - generated via svg2compose pipeline")
