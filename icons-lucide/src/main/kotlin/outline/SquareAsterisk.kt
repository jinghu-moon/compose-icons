...
val LucideIcons.Outline.SquareAsterisk: ImageVector
    get() {
        if (_squareAsterisk != null) return _squareAsterisk!!
        _squareAsterisk = lucideOutlineIcon(
            name = "SquareAsterisk",
    ...
    addPath(
        pathData = parseSvgPathData("M 8.500 14.000 L 15.500 10.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 8.500 10.000 L 15.500 14.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
