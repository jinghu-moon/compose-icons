...
val TablerIcons.Outline.Gradienter: ImageVector
    get() {
        ...
        _gradienter = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 3.227 14.000 C 4.144 18.000 7.724 21.000 12.000 21.000 C 16.277 21.000 19.858 18.000 20.773 14.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 20.780 10.000 C 19.846 5.903 16.202 2.998 12.000 3.000 C 7.795 2.991 4.147 5.899 3.218 10.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
