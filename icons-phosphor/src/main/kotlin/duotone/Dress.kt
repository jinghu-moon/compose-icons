        ...
        _dress = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(53.31178f, 223.99875f, 50.80391f, 222.64743f, 49.324387f, 220.40298f),
                    PathNode.CurveTo(47.844864f, 218.15854f, 47.591515f, 215.32106f, 48.65f, 212.85f),
                    PathNode.LineTo(96.0f, 112.0f),
                    PathNode.LineTo(73.14f, 76.12f),
                    PathNode.CurveTo(71.61669f, 73.58454f, 71.61669f, 70.41546f, 73.14f, 67.88f),
                    PathNode.LineTo(96.0f, 35.23f),
                    PathNode.LineTo(103.0f, 44.0f),
                    PathNode.CurveTo(109.07235f, 51.599945f, 118.27207f, 56.025017f, 128.0f, 56.025017f),
                    PathNode.CurveTo(137.72794f, 56.025017f, 146.92764f, 51.599945f, 153.0f, 44.0f),
                    PathNode.LineTo(160.0f, 35.24f),
                    PathNode.LineTo(182.86f, 67.89f),
                    PathNode.CurveTo(184.3833f, 70.42546f, 184.3833f, 73.59454f, 182.86f, 76.13f),
                    PathNode.LineTo(160.0f, 112.0f),
                    PathNode.LineTo(207.34f, 212.85f),
                    PathNode.CurveTo(208.3978f, 215.31943f, 208.14552f, 218.15492f, 206.66837f, 220.39882f),
                    PathNode.CurveTo(205.19122f, 222.64272f, 202.68645f, 223.99539f, 200.0f, 224.0f),
                    PathNode.Close
                ),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(189.72f, 80.23f),
