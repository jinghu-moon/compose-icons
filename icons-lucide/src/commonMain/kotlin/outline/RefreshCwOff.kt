        ...
        _refreshCwOff = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(18.74f, 5.74f),
                    PathNode.CurveTo(16.93103f, 3.991224f, 14.516048f, 3.009465f, 12.0f, 3.0f),
                    PathNode.CurveTo(11.0f, 3.0f, 10.03f, 3.16f, 9.13f, 3.47f)
                ),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(3.0f, 9.51f, 4.0f, 7.26f, 5.64f, 5.64f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(5.26f, 18.26f),
                    PathNode.CurveTo(7.068969f, 20.008776f, 9.483952f, 20.990536f, 12.0f, 21.0f),
                    PathNode.CurveTo(14.49f, 21.0f, 16.74f, 20.0f, 18.36f, 18.36f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(21.0f, 13.0f, 20.84f, 13.97f, 20.53f, 14.87f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
