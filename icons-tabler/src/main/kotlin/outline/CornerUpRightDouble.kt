...
val TablerIcons.Outline.CornerUpRightDouble: ImageVector
    get() {
        ...
        _cornerUpRightDouble = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 4.000 18.000 L 4.000 12.000 C 4.000 10.343 5.343 9.000 7.000 9.000 L 14.000 9.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 10.000 13.000 L 14.000 9.000 L 10.000 5.000M 15.000 13.000 L 19.000 9.000 L 15.000 5.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
