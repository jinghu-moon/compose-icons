...
val LucideIcons.Outline.FileSearch: ImageVector
    get() {
        ...
        _fileSearch = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 14.000 14.500 C 14.000 15.881 12.881 17.000 11.500 17.000 C 10.119 17.000 9.000 15.881 9.000 14.500 C 9.000 13.119 10.119 12.000 11.500 12.000 C 12.881 12.000 14.000 13.119 14.000 14.500 Z"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 13.300 16.300 L 15.000 18.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
