...
val TablerIcons.Outline.BrandDribbble: ImageVector
    get() {
        ...
        _brandDribbble = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(9.0f, 3.6f),
                    PathNode.CurveTo(14.0f, 9.6f, 16.0f, 14.1f, 16.5f, 19.8f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(6.4f, 19.0f),
                    PathNode.CurveTo(9.9f, 15.5f, 12.4f, 12.5f, 20.9f, 12.6f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(3.1f, 10.75f),
                    PathNode.CurveTo(8.100001f, 10.75f, 12.914f, 10.37f, 18.414f, 5.75f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
