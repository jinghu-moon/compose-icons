...
val TablerIcons.Outline.SquareRoundedPercentage: ImageVector
    get() {
        ...
        _squareRoundedPercentage = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(9.0f, 15.075f),
                    PathNode.LineTo(15.0f, 9.075f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(9.0f, 9.105f),
                    PathNode.LineTo(9.0f, 9.12f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(15.0f, 15.12f),
                    PathNode.LineTo(15.0f, 15.135f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
