...
val PhosphorIcons.Duotone.Swatches: ImageVector
    get() {
        ...
        _swatches = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(135.88f, 43.11f),
                    PathNode.LineTo(110.88f, 186.25f),
                    PathNode.CurveTo(109.28966f, 195.61403f, 104.03435f, 203.9587f, 96.27635f, 209.43846f),
                    PathNode.CurveTo(88.51836f, 214.91823f, 78.89694f, 217.08156f, 69.54f, 215.45f),
                    PathNode.LineTo(69.54f, 215.45f),
                    PathNode.CurveTo(50.059517f, 211.87714f, 37.123703f, 193.23973f, 40.59f, 173.74f),
                    PathNode.LineTo(65.59f, 30.61f),
                    PathNode.CurveTo(66.35789f, 26.294216f, 70.45594f, 23.400164f, 74.78f, 24.12f),
                    PathNode.LineTo(129.45f, 33.85f),
                    PathNode.CurveTo(133.77354f, 34.64567f, 136.645f, 38.78093f, 135.88f, 43.11f),
                    PathNode.Close
                ),
