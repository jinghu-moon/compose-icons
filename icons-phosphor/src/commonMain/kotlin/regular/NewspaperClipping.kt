...
val PhosphorIcons.Regular.NewspaperClipping: ImageVector
    get() {
        if (_newspaperClipping != null) return _newspaperClipping!!
        _newspaperClipping = phosphorRegularIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(59.581722f, 88.0f, 56.0f, 91.58172f, 56.0f, 96.0f),
