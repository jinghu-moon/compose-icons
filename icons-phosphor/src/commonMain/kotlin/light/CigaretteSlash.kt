        ...
        _cigaretteSlash = phosphorLightIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(176.25f, 190.0f),
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(94.0f, 178.0f),
                    PathNode.LineTo(94.0f, 142.0f),
                    PathNode.LineTo(132.62f, 142.0f),
                    PathNode.LineTo(165.35f, 178.0f),
                    PathNode.Close,
                    PathNode.MoveTo(238.0f, 144.0f),
                    PathNode.LineTo(238.0f, 176.0f),
                    PathNode.CurveTo(238.0f, 183.73198f, 231.73198f, 190.0f, 224.0f, 190.0f),
                    PathNode.LineTo(222.16f, 190.0f),
                    PathNode.CurveTo(218.8463f, 190.0f, 216.16f, 187.3137f, 216.16f, 184.0f),
                    PathNode.CurveTo(216.16f, 180.6863f, 218.8463f, 178.0f, 222.16f, 178.0f),
                    PathNode.LineTo(224.0f, 178.0f),
                    PathNode.CurveTo(225.10457f, 178.0f, 226.0f, 177.10457f, 226.0f, 176.0f),
                    PathNode.LineTo(226.0f, 144.0f),
                    PathNode.CurveTo(226.0f, 142.89543f, 225.10457f, 142.0f, 224.0f, 142.0f),
                    PathNode.LineTo(178.52f, 142.0f),
                    ...
                    PathNode.LineTo(224.0f, 130.0f),
                    PathNode.CurveTo(231.73198f, 130.0f, 238.0f, 136.26802f, 238.0f, 144.0f),
                    PathNode.Close,
