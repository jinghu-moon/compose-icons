        ...
        _brandOpera = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(9.0f, 14.761424f, 10.343145f, 17.0f, 12.0f, 17.0f),
                    PathNode.CurveTo(13.656855f, 17.0f, 15.0f, 14.761424f, 15.0f, 12.0f),
                    PathNode.CurveTo(15.0f, 9.238576f, 13.656855f, 7.0f, 12.0f, 7.0f),
                    PathNode.CurveTo(10.343145f, 7.0f, 9.0f, 9.238576f, 9.0f, 12.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
