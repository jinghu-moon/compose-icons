...
val TablerIcons.Outline.DeviceMobileStar: ImageVector
    get() {
        if (_deviceMobileStar != null) return _deviceMobileStar!!
        _deviceMobileStar = tablerOutlineIcon(
            name = "DeviceMobileStar",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24f, height = 24f),
        ) {
            addPath(
                pathData = parseSvgPathData("M 11.000 21.000 L 8.000 21.000 C 6.895 21.000 6.000 20.105 6.000 19.000 L 6.000 5.000 C 6.000 3.895 6.895 3.000 8.000 3.000 L 16.000 3.000 C 17.105 3.000 18.000 3.895 18.000 5.000 L 18.000 10.000"),
