...
val PhosphorIcons.Duotone.UserSound: ImageVector
    get() {
        if (_userSound != null) return _userSound!!
        _userSound = phosphorDuotoneIcon(
            name = "UserSound",
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(168.0f, 141.13708f, 141.13708f, 168.0f, 108.0f, 168.0f),
                    PathNode.CurveTo(74.862915f, 168.0f, 48.0f, 141.13708f, 48.0f, 108.0f),
                    PathNode.CurveTo(48.0f, 74.862915f, 74.862915f, 48.0f, 108.0f, 48.0f),
                    PathNode.CurveTo(141.13708f, 48.0f, 168.0f, 74.862915f, 168.0f, 108.0f),
                    PathNode.Close
                ),
