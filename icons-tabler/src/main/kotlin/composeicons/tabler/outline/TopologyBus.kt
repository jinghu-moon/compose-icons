        ...
        _topologyBus = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(6.0f, 8.895431f, 5.10457f, 8.0f, 4.0f, 8.0f),
                    PathNode.CurveTo(2.895431f, 8.0f, 2.0f, 8.895431f, 2.0f, 10.0f),
                    PathNode.CurveTo(2.0f, 11.104569f, 2.895431f, 12.0f, 4.0f, 12.0f),
                    PathNode.CurveTo(5.10457f, 12.0f, 6.0f, 11.104569f, 6.0f, 10.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
