...
val PhosphorIcons.Duotone.HandbagSimple: ImageVector
    get() {
        ...
        _handbagSimple = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M223.92 208h-191.84c-2.293 .016-4.483-.954-6.013-2.662-1.53-1.708-2.254-3.991-1.987-6.268L38.33 79.07c.5-4.038 3.931-7.071 8-7.07h163.34c4.069-.001 7.5 3.032 8 7.07l14.25 120c.267 2.278-.457 4.56-1.987 6.268-1.53 1.708-3.72 2.677-6.013 2.662Z"),
