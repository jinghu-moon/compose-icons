        ...
        _gitFork = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(88.0f, 77.25484f, 77.25484f, 88.0f, 64.0f, 88.0f),
                    PathNode.CurveTo(50.745167f, 88.0f, 40.0f, 77.25484f, 40.0f, 64.0f),
                    PathNode.CurveTo(40.0f, 50.745167f, 50.745167f, 40.0f, 64.0f, 40.0f),
                    PathNode.CurveTo(77.25484f, 40.0f, 88.0f, 50.745167f, 88.0f, 64.0f),
                    PathNode.Close,
                    PathNode.MoveTo(192.0f, 40.0f),
                    PathNode.CurveTo(178.74516f, 40.0f, 168.0f, 50.745167f, 168.0f, 64.0f),
                    PathNode.CurveTo(168.0f, 77.25484f, 178.74516f, 88.0f, 192.0f, 88.0f),
                    PathNode.CurveTo(205.25484f, 88.0f, 216.0f, 77.25484f, 216.0f, 64.0f),
                    PathNode.CurveTo(216.0f, 50.745167f, 205.25484f, 40.0f, 192.0f, 40.0f),
                    PathNode.Close
                ),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(72.836555f, 48.0f, 80.0f, 55.163445f, 80.0f, 64.0f),
                    PathNode.CurveTo(80.0f, 72.836555f, 72.836555f, 80.0f, 64.0f, 80.0f),
                    ...
                    PathNode.CurveTo(183.16344f, 80.0f, 176.0f, 72.836555f, 176.0f, 64.0f),
                    PathNode.CurveTo(176.0f, 55.163445f, 183.16344f, 48.0f, 192.0f, 48.0f),
                    PathNode.CurveTo(200.83656f, 48.0f, 208.0f, 55.163445f, 208.0f, 64.0f),
                    PathNode.CurveTo(208.0f, 72.836555f, 200.83656f, 80.0f, 192.0f, 80.0f),
                    PathNode.Close
                ),
                pathFillType = PathFillType.NonZero,
                fill = SolidColor(Color.Black),
