...
val TablerIcons.Outline.BrandFramerMotion: ImageVector
    get() {
        ...
        _brandFramerMotion = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 12.000 L 4.000 4.000 L 4.000 20.000 L 20.000 4.000 L 20.000 20.000 L 16.000 16.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 20.000 12.000 L 12.000 20.000 L 8.000 16.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
