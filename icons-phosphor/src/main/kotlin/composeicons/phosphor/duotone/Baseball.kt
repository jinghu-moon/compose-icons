...
val PhosphorIcons.Duotone.Baseball: ImageVector
    get() {
        ...
        _baseball = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M60.66 59.58C79.023 77.607 89.357 102.267 89.33 128c.027 25.733-10.307 50.393-28.67 68.42C42.325 178.375 32 153.725 32 128c0-25.725 10.325-50.375 28.66-68.42ZM195.34 59.58C177.005 77.625 166.68 102.275 166.68 128c0 25.725 10.325 50.375 28.66 68.42C213.675 178.375 224 153.725 224 128c0-25.725-10.325-50.375-28.66-68.42Z"),
