...
val TablerIcons.Outline.BasketShare: ImageVector
    get() {
        ...
        _basketShare = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 14.000 14.000 C 14.000 12.895 13.105 12.000 12.000 12.000 C 10.895 12.000 10.000 12.895 10.000 14.000 C 10.000 15.105 10.895 16.000 12.000 16.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
