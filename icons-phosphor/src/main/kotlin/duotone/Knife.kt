...
val PhosphorIcons.Duotone.Knife: ImageVector
    get() {
        ...
        _knife = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(226.2f, 65.8f),
                    PathNode.LineTo(174.0f, 118.0f),
                    PathNode.LineTo(146.0f, 90.0f),
                    PathNode.LineTo(198.2f, 37.8f),
                    PathNode.CurveTo(205.93222f, 30.068571f, 218.46779f, 30.068571f, 226.2f, 37.8f),
                    PathNode.LineTo(226.2f, 37.8f),
                    PathNode.CurveTo(233.93143f, 45.53222f, 233.93143f, 58.067783f, 226.2f, 65.8f),
                    PathNode.Close
                ),
