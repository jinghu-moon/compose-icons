        ...
        _treadmill = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(10.0f, 3.552285f, 10.447715f, 4.0f, 11.0f, 4.0f),
                    PathNode.CurveTo(11.552285f, 4.0f, 12.0f, 3.552285f, 12.0f, 3.0f),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(9.0f, 12.077f),
                    PathNode.LineTo(9.75f, 7.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(21.0f, 21.447716f, 20.552284f, 21.0f, 20.0f, 21.0f),
                    PathNode.LineTo(4.0f, 21.0f),
                    PathNode.CurveTo(3.447715f, 21.0f, 3.0f, 21.447716f, 3.0f, 22.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
