        ...
        _flipHorizontal = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(112.0f, 204.41827f, 108.41828f, 208.0f, 104.0f, 208.0f),
                    PathNode.LineTo(40.0f, 208.0f),
                    PathNode.CurveTo(37.31628f, 208.00117f, 34.81077f, 206.6566f, 33.328148f, 204.4196f),
                    PathNode.CurveTo(31.845528f, 202.18259f, 31.58335f, 199.35121f, 32.63f, 196.88f),
                    PathNode.LineTo(96.63f, 36.88f),
                    PathNode.CurveTo(100.0f, 28.86f, 112.0f, 31.29f, 112.0f, 40.0f),
                    PathNode.Close
                ),
