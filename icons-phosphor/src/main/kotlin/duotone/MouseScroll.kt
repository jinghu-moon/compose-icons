...
val PhosphorIcons.Duotone.MouseScroll: ImageVector
    get() {
        if (_mouseScroll != null) return _mouseScroll!!
        _mouseScroll = phosphorDuotoneIcon(
            name = "MouseScroll",
    ...
    group(
        ...
        addPath(
            pathData = parseSvgPathData("M 200.000 80.000 L 200.000 176.000 C 200.000 206.928 174.928 232.000 144.000 232.000 L 112.000 232.000 C 81.072 232.000 56.000 206.928 56.000 176.000 L 56.000 80.000 C 56.000 49.072 81.072 24.000 112.000 24.000 L 144.000 24.000 C 174.928 24.000 200.000 49.072 200.000 80.000 Z"),
