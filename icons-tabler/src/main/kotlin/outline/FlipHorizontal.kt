...
val TablerIcons.Outline.FlipHorizontal: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 7.000 16.000 L 17.000 16.000 L 7.000 21.000 L 7.000 16.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 7.000 8.000 L 17.000 8.000 L 7.000 3.000 L 7.000 8.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
