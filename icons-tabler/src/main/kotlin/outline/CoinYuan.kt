...
val TablerIcons.Outline.CoinYuan: ImageVector
    get() {
        if (_coinYuan != null) return _coinYuan!!
        _coinYuan = tablerOutlineIcon(
            name = "CoinYuan",
            ...
            addPath(
                pathData = parseSvgPathData("M 9.000 8.000 L 12.000 12.500"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 15.000 8.000 L 12.000 12.500 L 12.000 17.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
