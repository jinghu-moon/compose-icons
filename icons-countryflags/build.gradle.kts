...
android {
    namespace = "composeicons.countryflags"
    compileSdk = 36
...
mavenPublishing {
    ...
    pom {
        name.set("icons-countryflags")
        description.set("Country Flags for Jetpack Compose - generated via svg2compose pipeline")
