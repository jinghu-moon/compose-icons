...
val TablerIcons.Outline.BracketsContainEnd: ImageVector
    get() {
        ...
        _bracketsContainEnd = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 14.000 4.000 L 18.000 4.000 L 18.000 20.000 L 14.000 20.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 9.000 16.000 L 9.010 16.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 13.000 16.000 L 13.010 16.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
