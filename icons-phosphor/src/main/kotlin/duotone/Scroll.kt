...
val PhosphorIcons.Duotone.Scroll: ImageVector
    get() {
        if (_scroll != null) return _scroll!!
        _scroll = phosphorDuotoneIcon(
            name = "Scroll",
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(104.0f, 176.0f, 112.0f, 182.0f, 112.0f, 192.0f),
                    PathNode.CurveTo(112.0f, 205.25484f, 101.25484f, 216.0f, 88.0f, 216.0f),
                    PathNode.CurveTo(74.74516f, 216.0f, 64.0f, 205.25484f, 64.0f, 192.0f),
                    PathNode.LineTo(64.0f, 64.0f),
                    PathNode.CurveTo(64.0f, 50.745167f, 53.254833f, 40.0f, 40.0f, 40.0f),
