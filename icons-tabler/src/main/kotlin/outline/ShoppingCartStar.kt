...
val TablerIcons.Outline.ShoppingCartStar: ImageVector
    get() {
        if (_shoppingCartStar != null) return _shoppingCartStar!!
        _shoppingCartStar = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 9.500 17.000 L 6.000 17.000 L 6.000 3.000 L 4.000 3.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 6.000 5.000 L 20.000 6.000 L 19.385 10.302M 12.500 13.000 L 6.000 13.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
