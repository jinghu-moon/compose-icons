...
val PhosphorIcons.Duotone.HandArrowDown: ImageVector
    get() {
        if (_handArrowDown != null) return _handArrowDown!!
        _handArrowDown = phosphorDuotoneIcon(
            name = "HandArrowDown",
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(224.29787f, 136.41306f, 216.44218f, 134.84859f, 209.09f, 136.83f),
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(154.34f, 77.66f),
                    PathNode.CurveTo(151.21407f, 74.534065f, 151.21407f, 69.465935f, 154.34f, 66.34f),
                    PathNode.CurveTo(157.46593f, 63.21407f, 162.53407f, 63.21407f, 165.66f, 66.34f),
                    PathNode.LineTo(184.0f, 84.69f),
                    ...
                    PathNode.LineTo(197.66f, 109.66f),
                    PathNode.CurveTo(196.15945f, 111.16222f, 194.12328f, 112.006294f, 192.0f, 112.006294f),
                    PathNode.CurveTo(189.87672f, 112.006294f, 187.84055f, 111.16222f, 186.34f, 109.66f),
                    PathNode.Close
                ),
                pathFillType = PathFillType.NonZero,
                fill = SolidColor(Color.Black),
