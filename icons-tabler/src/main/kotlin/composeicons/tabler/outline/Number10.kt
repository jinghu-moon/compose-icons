        ...
        _number10 = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(18.209139f, 20.0f, 20.0f, 18.209139f, 20.0f, 16.0f),
                    PathNode.LineTo(20.0f, 8.0f),
                    PathNode.CurveTo(20.0f, 5.790861f, 18.209139f, 4.0f, 16.0f, 4.0f),
                    PathNode.CurveTo(13.790861f, 4.0f, 12.0f, 5.790861f, 12.0f, 8.0f),
                    PathNode.LineTo(12.0f, 16.0f),
                    PathNode.CurveTo(12.0f, 18.209139f, 13.790861f, 20.0f, 16.0f, 20.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
