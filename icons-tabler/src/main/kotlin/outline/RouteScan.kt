...
val TablerIcons.Outline.RouteScan: ImageVector
    get() {
        ...
        _routeScan = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 14.000 9.000 L 17.000 9.000 L 17.000 12.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 7.000 9.000 L 11.414 13.414 C 11.789 13.789 12.000 14.298 12.000 14.828 L 12.000 17.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 17.000 9.000 L 12.586 13.414 C 12.211 13.789 12.000 14.298 12.000 14.828 L 12.000 17.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
