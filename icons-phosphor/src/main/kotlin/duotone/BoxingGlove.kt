        ...
        _boxingGlove = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(216.0f, 118.88f),
                    PathNode.CurveTo(216.0015f, 119.62432f, 215.89711f, 120.365074f, 215.69f, 121.08f),
                    ...
                    PathNode.LineTo(33.75f, 138.19f),
                    PathNode.CurveTo(32.61577f, 136.77043f, 31.99858f, 135.00703f, 32.0f, 133.19f),
                    PathNode.LineTo(32.0f, 104.0f),
                    PathNode.CurveTo(32.0f, 90.74516f, 42.745167f, 80.0f, 56.0f, 80.0f),
                    PathNode.LineTo(72.0f, 80.0f),
                    PathNode.LineTo(72.0f, 72.0f),
                    PathNode.CurveTo(72.0f, 45.490334f, 93.49033f, 24.0f, 120.0f, 24.0f),
                    PathNode.LineTo(168.0f, 24.0f),
                    PathNode.CurveTo(194.50967f, 24.0f, 216.0f, 45.490334f, 216.0f, 72.0f),
                    PathNode.Close
                ),
