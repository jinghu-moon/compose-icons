...
val RemixIcons.Line.FolderSharedLine: ImageVector
    get() {
        ...
        _folderSharedLine = remixIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M22 13h-2v-6h-8.414L9.586 5h-5.586v14h9v2h-10C2.448 21 2 20.552 2 20v-16C2 3.448 2.448 3 3 3h7.414l2 2h8.586c.552 0 1 .448 1 1v7ZM18 17v-3.5L23 18l-5 4.5v-3.5h-3v-2h3Z"),
