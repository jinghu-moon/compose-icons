        ...
        _linkSimpleHorizontal = phosphorLightIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(104.0f, 170.0f),
                    PathNode.LineTo(64.0f, 170.0f),
                    PathNode.CurveTo(40.80404f, 170.0f, 22.0f, 151.19595f, 22.0f, 128.0f),
                    PathNode.CurveTo(22.0f, 104.80404f, 40.80404f, 86.0f, 64.0f, 86.0f),
                    PathNode.LineTo(104.0f, 86.0f),
                    PathNode.CurveTo(107.313705f, 86.0f, 110.0f, 83.313705f, 110.0f, 80.0f),
                    PathNode.CurveTo(110.0f, 76.686295f, 107.313705f, 74.0f, 104.0f, 74.0f),
                    PathNode.LineTo(64.0f, 74.0f),
                    PathNode.CurveTo(34.176624f, 74.0f, 10.0f, 98.17662f, 10.0f, 128.0f),
                    PathNode.CurveTo(10.0f, 157.82338f, 34.176624f, 182.0f, 64.0f, 182.0f),
                    PathNode.LineTo(104.0f, 182.0f),
                    PathNode.CurveTo(107.313705f, 182.0f, 110.0f, 179.3137f, 110.0f, 176.0f),
                    PathNode.CurveTo(110.0f, 172.6863f, 107.313705f, 170.0f, 104.0f, 170.0f),
                    PathNode.Close,
