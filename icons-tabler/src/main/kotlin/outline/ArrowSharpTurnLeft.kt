...
val TablerIcons.Outline.ArrowSharpTurnLeft: ImageVector
    get() {
        ...
        _arrowSharpTurnLeft = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 17.000 18.000 L 17.000 6.690 C 17.000 6.407 16.829 6.152 16.568 6.043 C 16.306 5.935 16.005 5.995 15.805 6.195 L 6.000 16.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 11.000 16.000 L 6.000 16.000 L 6.000 11.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
