...
val TablerIcons.Outline.MoodOff: ImageVector
    get() {
        ...
        _moodOff = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 5.634 5.638 C 2.120 9.154 2.122 14.852 5.638 18.366 C 9.154 21.880 14.852 21.878 18.366 18.362M 20.045 16.040 C 21.788 12.573 21.113 8.379 18.370 5.634 C 15.627 2.889 11.433 2.212 7.965 3.954"),
