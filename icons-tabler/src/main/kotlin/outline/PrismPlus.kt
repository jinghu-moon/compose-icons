...
val TablerIcons.Outline.PrismPlus: ImageVector
    get() {
        ...
        _prismPlus = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 13.020 21.655 C 12.416 22.108 11.584 22.108 10.980 21.655 L 5.000 17.170 C 4.370 16.698 4.000 15.957 4.000 15.170 L 4.000 4.000 C 4.000 3.448 4.448 3.000 5.000 3.000 L 19.000 3.000 C 19.552 3.000 20.000 3.448 20.000 4.000 L 20.000 12.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
