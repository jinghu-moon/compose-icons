        ...
        _microsoftExcelLogo = phosphorThinIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(156.0f, 73.37258f, 150.62741f, 68.0f, 144.0f, 68.0f),
                    ...
                    PathNode.CurveTo(146.20914f, 76.0f, 148.0f, 77.79086f, 148.0f, 80.0f),
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(68.93f, 149.44f),
                    PathNode.LineTo(86.79f, 128.0f),
                    PathNode.LineTo(68.93f, 106.56f),
                    PathNode.CurveTo(67.61326f, 104.85776f, 67.87935f, 102.41881f, 69.53218f, 101.04055f),
                    PathNode.CurveTo(71.18501f, 99.66229f, 73.63208f, 99.8388f, 75.07f, 101.44f),
                    PathNode.LineTo(92.0f, 121.75f),
                    PathNode.LineTo(108.93f, 101.44f),
                    PathNode.CurveTo(109.825775f, 100.28197f, 111.28264f, 99.70584f, 112.72817f, 99.93799f),
                    PathNode.CurveTo(114.1737f, 100.17014f, 115.37691f, 101.17347f, 115.86504f, 102.55375f),
                    PathNode.CurveTo(116.353165f, 103.93404f, 116.04821f, 105.47071f, 115.07f, 106.56f),
                    PathNode.LineTo(97.21f, 128.0f),
                    PathNode.LineTo(115.07f, 149.44f),
                    PathNode.CurveTo(116.04821f, 150.52928f, 116.353165f, 152.06596f, 115.86504f, 153.44624f),
                    PathNode.CurveTo(115.37691f, 154.82654f, 114.1737f, 155.82986f, 112.72817f, 156.06201f),
                    PathNode.CurveTo(111.28264f, 156.29416f, 109.825775f, 155.71803f, 108.93f, 154.56f),
                    PathNode.LineTo(92.0f, 134.25f),
                    PathNode.LineTo(75.07f, 154.56f),
                    PathNode.CurveTo(74.310814f, 155.47147f, 73.18623f, 155.99896f, 72.0f, 156.0f),
                    PathNode.CurveTo(71.06324f, 156.00418f, 70.15564f, 155.67447f, 69.44f, 155.07f),
                    PathNode.CurveTo(67.74591f, 153.65541f, 67.517685f, 151.13599f, 68.93f, 149.44f),
                    PathNode.Close
                ),
