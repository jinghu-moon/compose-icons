...
val LucideIcons.Outline.SquarePi: ImageVector
    get() {
        if (_squarePi != null) return _squarePi!!
        _squarePi = lucideOutlineIcon(
            name = "SquarePi",
            ...
            addPath(
                pathData = parseSvgPathData("M 16.000 17.000 C 14.895 17.000 14.000 16.105 14.000 15.000 L 14.000 7.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
