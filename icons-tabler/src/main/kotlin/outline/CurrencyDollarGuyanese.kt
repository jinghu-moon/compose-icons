...
val TablerIcons.Outline.CurrencyDollarGuyanese: ImageVector
    get() {
        ...
        _currencyDollarGuyanese = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 10.000 6.000 L 7.000 6.000 C 4.791 6.000 3.000 7.791 3.000 10.000 L 3.000 14.000 C 3.000 16.209 4.791 18.000 7.000 18.000 L 10.000 18.000 L 10.000 12.000 L 8.000 12.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
