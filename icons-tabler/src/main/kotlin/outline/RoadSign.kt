...
val TablerIcons.Outline.RoadSign: ImageVector
    get() {
        ...
        _roadSign = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 9.000 14.000 L 9.000 12.000 C 9.000 11.410 9.414 11.000 10.000 11.000 L 15.000 11.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 13.000 9.000 L 15.000 11.000 L 13.000 13.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
