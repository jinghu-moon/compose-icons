...
val PhosphorIcons.Duotone.Repeat: ImageVector
    get() {
        if (_repeat != null) return _repeat!!
        _repeat = phosphorDuotoneIcon(
            name = "Repeat",
    ...
    group(
        ...
        addPath(
            pathData = parseSvgPathData("M 224.000 64.000 L 224.000 128.000 C 224.000 163.346 195.346 192.000 160.000 192.000 L 32.000 192.000 L 32.000 128.000 C 32.000 92.654 60.654 64.000 96.000 64.000 Z"),
