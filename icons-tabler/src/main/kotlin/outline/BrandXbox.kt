...
val TablerIcons.Outline.BrandXbox: ImageVector
    get() {
        ...
        _brandXbox = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 6.500 5.000 C 14.220 7.266 16.537 12.597 19.000 17.500"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 17.500 5.000 C 9.780 7.266 7.463 12.597 5.000 17.500"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
