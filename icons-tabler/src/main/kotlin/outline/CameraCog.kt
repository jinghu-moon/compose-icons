...
val TablerIcons.Outline.CameraCog: ImageVector
    get() {
        ...
        _cameraCog = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 14.973 13.406 C 15.142 12.167 14.525 10.953 13.425 10.359 C 12.324 9.766 10.971 9.917 10.028 10.739 C 9.086 11.562 8.753 12.882 9.191 14.053 C 9.630 15.224 10.750 16.000 12.000 16.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
