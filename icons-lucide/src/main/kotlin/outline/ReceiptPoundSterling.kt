...
val LucideIcons.Outline.ReceiptPoundSterling: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 10.000 17.000 L 10.000 9.500 C 10.000 8.119 11.119 7.000 12.500 7.000 C 13.881 7.000 15.000 8.119 15.000 9.500"),
    ...
    addPath(
        pathData = parseSvgPathData("M 8.000 17.000 L 15.000 17.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
