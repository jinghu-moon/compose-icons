...
val TablerIcons.Outline.HeartPlus: ImageVector
    get() {
        ...
        _heartPlus = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 20.000 L 4.500 12.572 C 3.151 11.260 2.654 9.301 3.212 7.504 C 3.771 5.707 5.292 4.376 7.147 4.060 C 9.002 3.743 10.877 4.496 12.000 6.006 C 13.671 3.808 16.808 3.381 19.007 5.052 C 21.205 6.724 21.631 9.861 19.960 12.059"),
