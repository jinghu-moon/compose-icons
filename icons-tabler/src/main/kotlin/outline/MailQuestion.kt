...
val TablerIcons.Outline.MailQuestion: ImageVector
    get() {
        ...
        _mailQuestion = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 15.000 19.000 L 5.000 19.000 C 3.895 19.000 3.000 18.105 3.000 17.000 L 3.000 7.000 C 3.000 5.895 3.895 5.000 5.000 5.000 L 19.000 5.000 C 20.105 5.000 21.000 5.895 21.000 7.000 L 21.000 11.500"),
