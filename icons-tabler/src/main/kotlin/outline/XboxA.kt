...
val TablerIcons.Outline.XboxA: ImageVector
    get() {
        if (_xboxA != null) return _xboxA!!
        _xboxA = tablerOutlineIcon(
            name = "XboxA",
    ...
    addPath(
        pathData = parseSvgPathData("M 15.000 16.000 L 12.000 8.000 L 9.000 16.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 14.000 14.000 L 10.000 14.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
