...
val LucideIcons.Outline.RouteOff: ImageVector
    get() {
        ...
        _routeOff = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 9.000 19.000 L 17.500 19.000 C 17.900 19.000 18.400 18.900 18.800 18.800"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 5.200 5.200 C 3.652 5.835 2.765 7.484 3.082 9.138 C 3.398 10.793 4.829 11.991 6.500 12.000 L 12.000 12.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 21.000 15.300 C 20.901 13.520 19.480 12.099 17.700 12.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 15.000 5.000 L 10.700 5.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
