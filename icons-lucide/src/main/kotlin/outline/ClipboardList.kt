...
val LucideIcons.Outline.ClipboardList: ImageVector
    get() {
        if (_clipboardList != null) return _clipboardList!!
        _clipboardList = lucideOutlineIcon(
            name = "ClipboardList",
    ...
    addPath(
        pathData = parseSvgPathData("M 12.000 11.000 L 16.000 11.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 12.000 16.000 L 16.000 16.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
