...
val TablerIcons.Filled.Library: ImageVector
    get() {
        ...
        _library = tablerFilledIcon(
            ...
            addPathData("M18.333 2C20.358 2 22 3.642 22 5.667v8.666C22 16.358 20.358 18 18.333 18h-8.666C7.642 18 6 16.358 6 14.333v-8.666C6 3.642 7.642 2 9.667 2ZM14 12h-3c-.552 0-1 .448-1 1 0 .552 .448 1 1 1h3c.552 0 1-.448 1-1 0-.552-.448-1-1-1M17 9h-6c-.552 0-1 .448-1 1 0 .552 .448 1 1 1h6c.552 0 1-.448 1-1C18 9.448 17.552 9 17 9M16 6h-5c-.552 0-1 .448-1 1 0 .552 .448 1 1 1h5c.552 0 1-.448 1-1C17 6.448 16.552 6 16 6")
