...
val LucideIcons.Outline.Sunset: ImageVector
    get() {
        ...
        _sunset = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(4.93f, 10.93f),
                    PathNode.LineTo(6.34f, 12.34f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(19.07f, 10.93f),
                    PathNode.LineTo(17.66f, 12.34f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(16.0f, 15.790861f, 14.209139f, 14.0f, 12.0f, 14.0f),
                    PathNode.CurveTo(9.790861f, 14.0f, 8.0f, 15.790861f, 8.0f, 18.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
