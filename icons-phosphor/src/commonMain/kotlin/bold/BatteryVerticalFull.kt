        ...
        _batteryVerticalFull = phosphorBoldIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(93.37258f, 72.0f, 88.0f, 77.37258f, 88.0f, 84.0f),
                    PathNode.CurveTo(88.0f, 90.62742f, 93.37258f, 96.0f, 100.0f, 96.0f),
                    PathNode.LineTo(156.0f, 96.0f),
                    PathNode.CurveTo(162.62741f, 96.0f, 168.0f, 90.62742f, 168.0f, 84.0f),
                    PathNode.CurveTo(168.0f, 77.37258f, 162.62741f, 72.0f, 156.0f, 72.0f),
                    PathNode.Close,
                    ...
                    PathNode.CurveTo(93.37258f, 152.0f, 88.0f, 157.37259f, 88.0f, 164.0f),
                    PathNode.CurveTo(88.0f, 170.62741f, 93.37258f, 176.0f, 100.0f, 176.0f),
                    ...
                    PathNode.CurveTo(93.37258f, 192.0f, 88.0f, 197.37259f, 88.0f, 204.0f),
                    PathNode.CurveTo(88.0f, 210.62741f, 93.37258f, 216.0f, 100.0f, 216.0f),
                    PathNode.LineTo(156.0f, 216.0f),
                    PathNode.CurveTo(162.62741f, 216.0f, 168.0f, 210.62741f, 168.0f, 204.0f),
                    PathNode.CurveTo(168.0f, 197.37259f, 162.62741f, 192.0f, 156.0f, 192.0f),
                    PathNode.Close
                ),
