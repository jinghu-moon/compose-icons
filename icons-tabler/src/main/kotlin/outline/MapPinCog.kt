...
val TablerIcons.Outline.MapPinCog: ImageVector
    get() {
        ...
        _mapPinCog = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 12.005 21.485 C 11.473 21.487 10.963 21.276 10.587 20.900 L 6.343 16.657 C 3.729 14.043 3.247 9.979 5.175 6.826 C 7.104 3.673 10.942 2.252 14.459 3.388 C 17.976 4.524 20.257 7.921 19.977 11.607"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
