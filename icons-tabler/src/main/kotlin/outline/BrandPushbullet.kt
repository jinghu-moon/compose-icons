...
val TablerIcons.Outline.BrandPushbullet: ImageVector
    get() {
        ...
        _brandPushbullet = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 11.000 8.000 L 11.000 16.000 L 13.000 16.000 C 15.209 16.000 17.000 14.209 17.000 12.000 C 17.000 9.791 15.209 8.000 13.000 8.000 L 11.000 8.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
