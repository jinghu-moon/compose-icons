...
val PhosphorIcons.Duotone.Phone: ImageVector
    get() {
        ...
        _phone = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(223.94f, 174.08f),
                    PathNode.CurveTo(220.72658f, 198.0945f, 200.22853f, 216.01852f, 176.0f, 216.0f),
                    PathNode.CurveTo(100.889275f, 216.0f, 40.0f, 155.11073f, 40.0f, 80.0f),
                    PathNode.CurveTo(39.98147f, 55.77146f, 57.9055f, 35.273422f, 81.92f, 32.06f),
                    PathNode.CurveTo(85.44522f, 31.641209f, 88.82478f, 33.595657f, 90.22f, 36.86f),
                    PathNode.LineTo(111.35f, 84.06f),
                    PathNode.CurveTo(112.40444f, 86.52222f, 112.15671f, 89.348755f, 110.69f, 91.59f),
                    PathNode.LineTo(89.32f, 117.0f),
                    PathNode.CurveTo(87.77795f, 119.326836f, 87.57286f, 122.293076f, 88.78f, 124.81f),
                    PathNode.CurveTo(97.05f, 141.74f, 114.55f, 159.03f, 131.53f, 167.22f),
                    PathNode.CurveTo(134.06064f, 168.42207f, 137.03807f, 168.19772f, 139.36f, 166.63f),
                    PathNode.LineTo(164.36f, 145.33f),
                    PathNode.CurveTo(166.61087f, 143.83223f, 169.46594f, 143.57268f, 171.95f, 144.64f),
                    PathNode.LineTo(219.11f, 165.77f),
                    PathNode.CurveTo(222.39005f, 167.15631f, 224.35892f, 170.54375f, 223.94f, 174.08f),
                    PathNode.Close
                ),
