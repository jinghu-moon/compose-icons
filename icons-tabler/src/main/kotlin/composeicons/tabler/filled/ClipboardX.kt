...
val TablerIcons.Filled.ClipboardX: ImageVector
    get() {
        ...
        _clipboardX = tablerFilledIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M17.997 4.17C19.197 4.593 20 5.727 20 7v12c0 1.657-1.343 3-3 3h-10C5.343 22 4 20.657 4 19v-12C4 5.727 4.803 4.593 6.003 4.17 6.094 6.311 7.857 8 10 8h4c2.053 0 3.773-1.554 3.98-3.597ZM10.707 11.293c-.391-.39-1.023-.39-1.414 0l-.083 .094c-.309 .398-.273 .964 .083 1.32L10.585 14 9.293 15.293c-.39 .391-.39 1.023 0 1.414l.094 .083c.398 .309 .964 .273 1.32-.083L12 15.414l1.293 1.293c.391 .39 1.023 .39 1.414 0l.083-.094c.309-.398 .273-.964-.083-1.32L13.414 14l1.293-1.293c.39-.391 .39-1.023 0-1.414l-.094-.083c-.398-.309-.964-.273-1.32 .083L12 12.585ZM14 2c1.105 0 2 .895 2 2 0 1.105-.895 2-2 2h-4C8.895 6 8 5.105 8 4 8 2.895 8.895 2 10 2Z"),
