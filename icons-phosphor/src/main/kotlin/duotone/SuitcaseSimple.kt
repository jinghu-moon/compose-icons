...
val PhosphorIcons.Duotone.SuitcaseSimple: ImageVector
    get() {
        if (_suitcaseSimple != null) return _suitcaseSimple!!
        _suitcaseSimple = phosphorDuotoneIcon(
            name = "SuitcaseSimple",
    ...
    group(
        ...
        addPath(
            pathData = parseSvgPathData("M 224.000 152.000 L 224.000 200.000 C 224.000 204.418 220.418 208.000 216.000 208.000 L 40.000 208.000 C 35.582 208.000 32.000 204.418 32.000 200.000 L 32.000 152.000 Z"),
