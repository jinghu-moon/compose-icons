...
val LucideIcons.Outline.FolderOutput: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 5.000 10.000 L 2.000 13.000 L 5.000 16.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
