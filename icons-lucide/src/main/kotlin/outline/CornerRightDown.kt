...
val LucideIcons.Outline.CornerRightDown: ImageVector
    get() {
        ...
        _cornerRightDown = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 10.000 15.000 L 15.000 20.000 L 20.000 15.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 4.000 4.000 L 11.000 4.000 C 13.209 4.000 15.000 5.791 15.000 8.000 L 15.000 20.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
