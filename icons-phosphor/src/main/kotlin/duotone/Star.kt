...
val PhosphorIcons.Duotone.Star: ImageVector
    get() {
        ...
        _star = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(229.06f, 108.79f),
                    PathNode.LineTo(180.36f, 150.79f),
                    PathNode.LineTo(195.24f, 213.58f),
                    PathNode.CurveTo(196.04445f, 216.8798f, 194.78258f, 220.33934f, 192.04248f, 222.34627f),
                    PathNode.CurveTo(189.30238f, 224.35318f, 185.62334f, 224.51251f, 182.72f, 222.75f),
                    ...
                    PathNode.CurveTo(121.54379f, 26.054953f, 124.60303f, 23.99943f, 128.0f, 23.99943f),
                    PathNode.CurveTo(131.39697f, 23.99943f, 134.4562f, 26.054953f, 135.74f, 29.2f),
                    PathNode.LineTo(160.36f, 88.8f),
                    PathNode.LineTo(224.27f, 94.0f),
                    PathNode.CurveTo(227.63718f, 94.31244f, 230.49484f, 96.600044f, 231.53677f, 99.81719f),
                    PathNode.CurveTo(232.5787f, 103.034325f, 231.6047f, 106.56289f, 229.06f, 108.79f),
                    PathNode.Close
                ),
