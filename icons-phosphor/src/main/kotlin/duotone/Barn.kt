...
val PhosphorIcons.Duotone.Barn: ImageVector
    get() {
        if (_barn != null) return _barn!!
        _barn = phosphorDuotoneIcon(
            name = "Barn",
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(40.0f, 108.17f),
                    PathNode.LineTo(61.7f, 77.79f),
                    PathNode.LineTo(128.0f, 32.0f),
                    PathNode.LineTo(194.3f, 77.78f),
                    PathNode.LineTo(216.0f, 108.17f),
                    PathNode.LineTo(216.0f, 192.0f),
                    PathNode.LineTo(192.0f, 192.0f),
                    PathNode.LineTo(192.0f, 120.0f),
                    PathNode.CurveTo(192.0f, 115.58172f, 188.41827f, 112.0f, 184.0f, 112.0f),
                    PathNode.LineTo(72.0f, 112.0f),
                    PathNode.CurveTo(67.58172f, 112.0f, 64.0f, 115.58172f, 64.0f, 120.0f),
                    PathNode.LineTo(64.0f, 192.0f),
                    PathNode.LineTo(40.0f, 192.0f),
                    PathNode.Close,
                    PathNode.MoveTo(128.0f, 150.17f),
                    PathNode.LineTo(97.0f, 128.0f),
                    PathNode.LineTo(159.0f, 128.0f),
                    PathNode.Close,
                    PathNode.MoveTo(176.0f, 135.55f),
                    PathNode.LineTo(176.0f, 184.46f),
                    PathNode.LineTo(141.76f, 160.0f),
                    PathNode.Close,
                    PathNode.MoveTo(114.24f, 160.0f),
                    PathNode.LineTo(80.0f, 184.46f),
                    PathNode.LineTo(80.0f, 135.55f),
                    PathNode.Close,
                    PathNode.MoveTo(128.0f, 169.83f),
                    PathNode.LineTo(159.0f, 192.0f),
                    PathNode.LineTo(97.0f, 192.0f),
                    PathNode.Close,
