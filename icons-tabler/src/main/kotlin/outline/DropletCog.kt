...
val TablerIcons.Outline.DropletCog: ImageVector
    get() {
        if (_dropletCog != null) return _dropletCog!!
        _dropletCog = tablerOutlineIcon(
            name = "DropletCog",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24f, height = 24f),
        ) {
            addPath(
                pathData = parseSvgPathData("M 18.421 11.560 C 18.315 11.326 18.196 11.098 18.064 10.877 L 13.174 3.617 C 12.754 2.992 11.887 2.814 11.238 3.220 C 11.075 3.322 10.935 3.457 10.828 3.617 L 5.935 10.877 C 4.240 13.715 4.900 17.318 7.502 19.423 C 8.782 20.453 10.377 21.011 12.020 21.003"),
