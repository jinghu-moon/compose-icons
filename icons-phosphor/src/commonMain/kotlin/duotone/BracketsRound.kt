        ...
        _bracketsRound = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(224.0f, 192.0f, 184.0f, 216.0f, 184.0f, 216.0f),
                    PathNode.LineTo(72.0f, 216.0f),
                    PathNode.CurveTo(72.0f, 216.0f, 32.0f, 192.0f, 32.0f, 128.0f),
                    PathNode.CurveTo(32.0f, 64.0f, 72.0f, 40.0f, 72.0f, 40.0f),
                    PathNode.LineTo(184.0f, 40.0f),
                    PathNode.CurveTo(184.0f, 40.0f, 224.0f, 64.0f, 224.0f, 128.0f),
                    PathNode.Close
                ),
