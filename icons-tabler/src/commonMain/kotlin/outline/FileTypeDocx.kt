        ...
        _fileTypeDocx = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(4.10457f, 21.0f, 5.0f, 20.10457f, 5.0f, 19.0f),
                    PathNode.LineTo(5.0f, 17.0f),
                    PathNode.CurveTo(5.0f, 15.895431f, 4.10457f, 15.0f, 3.0f, 15.0f),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(14.0f, 20.328426f, 14.671573f, 21.0f, 15.5f, 21.0f),
                    PathNode.CurveTo(16.328426f, 21.0f, 17.0f, 20.328426f, 17.0f, 19.5f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(10.328427f, 15.0f, 11.0f, 15.671573f, 11.0f, 16.5f),
                    PathNode.LineTo(11.0f, 19.5f),
                    PathNode.CurveTo(11.0f, 20.328426f, 10.328427f, 21.0f, 9.5f, 21.0f),
                    PathNode.CurveTo(8.671573f, 21.0f, 8.0f, 20.328426f, 8.0f, 19.5f),
                    PathNode.LineTo(8.0f, 16.5f),
                    PathNode.CurveTo(8.0f, 15.671573f, 8.671573f, 15.0f, 9.5f, 15.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
