        ...
        _nyTimesLogo = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(116.98742f, 224.01805f, 106.09095f, 221.75023f, 96.0f, 217.34f),
                    PathNode.LineTo(96.0f, 129.07f),
                    PathNode.Close
                ),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(88.0f, 203.83f),
                    PathNode.LineTo(88.0f, 142.4f),
                    PathNode.LineTo(57.51f, 158.66f),
                    PathNode.CurveTo(61.377445f, 177.12364f, 72.3224f, 193.33827f, 88.0f, 203.83f),
                    PathNode.Close,
                    PathNode.MoveTo(120.0f, 125.33f),
                    PathNode.LineTo(104.0f, 133.87f),
                    PathNode.LineTo(104.0f, 211.87f),
                    PathNode.CurveTo(109.17351f, 213.70784f, 114.54271f, 214.9394f, 120.0f, 215.54f),
                    PathNode.Close,
