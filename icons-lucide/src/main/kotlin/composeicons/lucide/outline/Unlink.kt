...
val LucideIcons.Outline.Unlink: ImageVector
    get() {
        ...
        _unlink = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(18.84f, 12.25f),
                    PathNode.LineTo(20.56f, 10.54f),
                    PathNode.LineTo(20.54f, 10.54f),
                    PathNode.CurveTo(22.45695f, 8.553653f, 22.403254f, 5.390149f, 20.42f, 3.47f),
                    PathNode.CurveTo(18.480757f, 1.599852f, 15.409244f, 1.599852f, 13.47f, 3.47f),
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(5.17f, 11.75f),
                    PathNode.LineTo(3.46f, 13.46f),
                    PathNode.CurveTo(1.543051f, 15.446347f, 1.596746f, 18.609852f, 3.58f, 20.53f),
                    PathNode.CurveTo(5.519244f, 22.400148f, 8.590756f, 22.400148f, 10.53f, 20.53f),
