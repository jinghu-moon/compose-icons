...
val TablerIcons.Outline.UxCircle: ImageVector
    get() {
        ...
        _uxCircle = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 7.000 10.000 L 7.000 12.000 C 7.000 13.105 7.895 14.000 9.000 14.000 C 10.105 14.000 11.000 13.105 11.000 12.000 L 11.000 10.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 14.000 10.000 L 17.000 14.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 14.000 14.000 L 17.000 10.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
