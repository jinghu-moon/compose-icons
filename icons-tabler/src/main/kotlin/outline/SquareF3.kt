...
val TablerIcons.Outline.SquareF3: ImageVector
    get() {
        ...
        _squareF3 = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 13.000 9.500 C 13.000 9.224 13.224 9.000 13.500 9.000 L 14.500 9.000 C 15.328 9.000 16.000 9.672 16.000 10.500 C 16.000 11.328 15.328 12.000 14.500 12.000 L 14.000 12.000 L 14.500 12.000 C 15.328 12.000 16.000 12.672 16.000 13.500 C 16.000 14.328 15.328 15.000 14.500 15.000 L 13.500 15.000 C 13.224 15.000 13.000 14.776 13.000 14.500"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
