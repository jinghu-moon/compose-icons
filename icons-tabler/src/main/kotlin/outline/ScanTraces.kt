...
val TablerIcons.Outline.ScanTraces: ImageVector
    get() {
        if (_scanTraces != null) return _scanTraces!!
        _scanTraces = tablerOutlineIcon(
            name = "ScanTraces",
    ...
    addPath(
        pathData = parseSvgPathData("M 11.000 12.000 L 17.000 12.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 8.000 8.000 L 13.000 8.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
