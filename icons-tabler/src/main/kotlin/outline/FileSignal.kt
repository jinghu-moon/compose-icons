...
val TablerIcons.Outline.FileSignal: ImageVector
    get() {
        ...
        _fileSignal = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 9.525 11.525 C 8.869 12.181 8.500 13.072 8.500 14.000 C 8.500 14.928 8.869 15.819 9.525 16.475M 14.475 16.475 C 15.131 15.819 15.500 14.928 15.500 14.000 C 15.500 13.072 15.131 12.181 14.475 11.525"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
