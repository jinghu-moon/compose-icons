...
val TablerIcons.Outline.DropletPause: ImageVector
    get() {
        ...
        _dropletPause = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 18.952 13.456 C 18.840 12.544 18.537 11.665 18.064 10.877 L 13.174 3.617 C 12.754 2.992 11.887 2.814 11.238 3.220 C 11.075 3.322 10.935 3.457 10.828 3.617 L 5.935 10.877 C 4.240 13.715 4.900 17.318 7.502 19.423 C 9.053 20.668 11.051 21.214 13.019 20.930"),
