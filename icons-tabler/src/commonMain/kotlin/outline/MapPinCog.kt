...
val TablerIcons.Outline.MapPinCog: ImageVector
    get() {
        if (_mapPinCog != null) return _mapPinCog!!
        _mapPinCog = tablerOutlineIcon(
            name = "MapPinCog",
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(12.005f, 21.485f),
                    PathNode.CurveTo(11.473238f, 21.48688f, 10.962753f, 21.276278f, 10.587f, 20.9f),
                    PathNode.LineTo(6.343f, 16.657f),
                    PathNode.CurveTo(3.729459f, 14.043291f, 3.246766f, 9.979383f, 5.175339f, 6.826181f),
                    PathNode.CurveTo(7.103912f, 3.67298f, 10.94159f, 2.251513f, 14.458896f, 3.387575f),
                    PathNode.CurveTo(17.9762f, 4.523637f, 20.2573f, 7.92142f, 19.977f, 11.607f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
