...
val PhosphorIcons.Duotone.AirTrafficControl: ImageVector
    get() {
        ...
        _airTrafficControl = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(223.51f, 82.73f),
                    PathNode.LineTo(197.33f, 154.73f),
                    PathNode.CurveTo(196.18146f, 157.89363f, 193.17567f, 160.00009f, 189.81f, 160.0f),
                    PathNode.LineTo(66.19f, 160.0f),
                    PathNode.CurveTo(62.82433f, 160.00009f, 59.818535f, 157.89363f, 58.67f, 154.73f),
                    PathNode.LineTo(32.49f, 82.73f),
                    PathNode.CurveTo(31.60028f, 80.279274f, 31.96062f, 77.54873f, 33.455635f, 75.412704f),
                    PathNode.CurveTo(34.950653f, 73.27668f, 37.39277f, 72.00319f, 40.0f, 72.0f),
                    PathNode.LineTo(216.0f, 72.0f),
                    PathNode.CurveTo(218.60722f, 72.00319f, 221.04935f, 73.27668f, 222.54436f, 75.412704f),
                    PathNode.CurveTo(224.03938f, 77.54873f, 224.39972f, 80.279274f, 223.51f, 82.73f),
                    PathNode.Close
                ),
