...
val PhosphorIcons.Duotone.Broom: ImageVector
    get() {
        ...
        _broom = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(192.8f, 165.12f),
                    PathNode.LineTo(43.93f, 105.57f),
                    PathNode.CurveTo(48.733402f, 97.1036f, 54.63076f, 89.306564f, 61.47f, 82.38f),
                    PathNode.CurveTo(63.73193f, 80.08599f, 67.14918f, 79.37258f, 70.14f, 80.57f),
                    PathNode.LineTo(95.52f, 90.85f),
                    PathNode.CurveTo(99.47351f, 92.42814f, 103.89293f, 92.365776f, 107.80033f, 90.6767f),
                    PathNode.CurveTo(111.70773f, 88.98762f, 114.78097f, 85.81109f, 116.34f, 81.85f),
                    PathNode.LineTo(137.34f, 28.75f),
                    PathNode.CurveTo(141.49f, 18.75f, 152.81f, 13.42f, 162.97f, 17.22f),
                    PathNode.CurveTo(168.05916f, 19.112644f, 172.1601f, 22.99311f, 174.33078f, 27.97004f),
                    PathNode.CurveTo(176.50146f, 32.946968f, 176.55533f, 38.59256f, 174.48f, 43.61f),
                    PathNode.LineTo(153.13f, 96.71f),
                    PathNode.CurveTo(149.88177f, 104.905685f, 153.8751f, 114.18469f, 162.06f, 117.46f),
                    PathNode.LineTo(187.0f, 127.3f),
                    PathNode.CurveTo(190.02667f, 128.52434f, 192.00563f, 131.46509f, 192.0f, 134.73f),
                    PathNode.LineTo(192.0f, 152.0f),
                    PathNode.CurveTo(191.9913f, 156.38579f, 192.25848f, 160.76776f, 192.8f, 165.12f),
                    PathNode.Close
                ),
