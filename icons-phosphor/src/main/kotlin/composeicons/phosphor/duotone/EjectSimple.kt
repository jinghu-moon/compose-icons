...
val PhosphorIcons.Duotone.EjectSimple: ImageVector
    get() {
        ...
        _ejectSimple = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M215.92 152h-175.84c-3.117-.013-5.95-1.813-7.286-4.629-1.336-2.816-.937-6.149 1.026-8.571L115.48 38c3.057-3.766 7.649-5.953 12.5-5.953 4.851 0 9.443 2.187 12.5 5.953l81.7 100.8c1.963 2.422 2.362 5.755 1.026 8.571-1.336 2.816-4.169 4.616-7.286 4.629Z"),
