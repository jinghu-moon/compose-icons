...
val TablerIcons.Outline.ReceiptRupee: ImageVector
    get() {
        ...
        _receiptRupee = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 15.000 7.000 L 9.000 7.000 L 10.000 7.000 C 11.657 7.000 13.000 8.343 13.000 10.000 C 13.000 11.657 11.657 13.000 10.000 13.000 L 9.000 13.000 L 12.000 16.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
