...
val TablerIcons.Outline.CoinRupee: ImageVector
    get() {
        ...
        _coinRupee = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 15.000 8.000 L 9.000 8.000 L 10.000 8.000 C 11.657 8.000 13.000 9.343 13.000 11.000 C 13.000 12.657 11.657 14.000 10.000 14.000 L 9.000 14.000 L 12.000 17.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
