...
val PhosphorIcons.Duotone.CastleTurret: ImageVector
    get() {
        ...
        _castleTurret = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M208 48v44.69c-.001 2.119-.843 4.151-2.34 5.65L192 112v112h-40v-56c0-13.255-10.745-24-24-24-13.255 0-24 10.745-24 24v56h-40v-112L50.34 98.34C48.843 96.841 48.001 94.809 48 92.69v-44.69c0-4.418 3.582-8 8-8h24v32h32v-32h32v32h32v-32h24c4.418 0 8 3.582 8 8Z"),
