...
val TablerIcons.Outline.AlphabetRunes: ImageVector
    get() {
        ...
        _alphabetRunes = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 13.000 6.000 L 17.000 10.000 L 21.000 6.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 11.000 18.000 L 4.000 10.000 L 8.000 6.000 L 12.000 10.000 L 5.000 18.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
