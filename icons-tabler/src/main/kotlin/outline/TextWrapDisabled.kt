...
val TablerIcons.Outline.TextWrapDisabled: ImageVector
    get() {
        ...
        _textWrapDisabled = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 4.000 6.000 L 14.000 6.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 4.000 18.000 L 14.000 18.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 4.000 12.000 L 21.000 12.000 L 18.000 9.000M 18.000 15.000 L 21.000 12.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
