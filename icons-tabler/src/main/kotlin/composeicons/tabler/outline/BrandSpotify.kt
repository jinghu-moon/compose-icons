...
val TablerIcons.Outline.BrandSpotify: ImageVector
    get() {
        ...
        _brandSpotify = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(8.0f, 11.973f),
                    PathNode.CurveTo(10.5f, 10.5f, 13.5f, 11.0f, 15.5f, 12.5f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(10.5f, 14.0f, 13.0f, 14.0f, 14.0f, 15.5f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(9.0f, 8.0f, 13.0f, 7.0f, 17.0f, 9.5f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
