...
val TablerIcons.Outline.CornerRightDownDouble: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 5.000 4.000 L 11.000 4.000 C 12.657 4.000 14.000 5.343 14.000 7.000 L 14.000 14.000"),
    ...
    addPath(
        pathData = parseSvgPathData("M 10.000 10.000 L 14.000 14.000 L 18.000 10.000M 10.000 15.000 L 14.000 19.000 L 18.000 15.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
