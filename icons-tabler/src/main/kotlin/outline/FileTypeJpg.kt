...
val TablerIcons.Outline.FileTypeJpg: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 5.000 15.000 L 8.000 15.000 L 8.000 19.500 C 8.000 20.328 7.328 21.000 6.500 21.000 C 5.672 21.000 5.000 20.328 5.000 19.500"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
