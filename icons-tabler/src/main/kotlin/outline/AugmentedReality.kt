...
val TablerIcons.Outline.AugmentedReality: ImageVector
    get() {
        ...
        _augmentedReality = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 12.500 L 16.000 10.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 8.000 10.000 L 12.000 12.500 L 12.000 17.000 L 16.000 14.500 L 16.000 10.000 L 12.000 7.500 L 8.000 10.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
