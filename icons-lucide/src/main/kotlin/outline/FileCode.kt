...
val LucideIcons.Outline.FileCode: ImageVector
    get() {
        if (_fileCode != null) return _fileCode!!
        _fileCode = lucideOutlineIcon(
            name = "FileCode",
            ...
            addPath(
                pathData = parseSvgPathData("M 10.000 12.500 L 8.000 15.000 L 10.000 17.500"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 14.000 12.500 L 16.000 15.000 L 14.000 17.500"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
