...
val RemixIcons.Fill.FlipVertical2Fill: ImageVector
    get() {
        ...
        _flipVertical2Fill = remixIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M4 3C3.448 3 3 3.448 3 4v16c0 .552 .448 1 1 1h16c.552 0 1-.448 1-1v-16C21 3.448 20.552 3 20 3h-16ZM8 10 12 6l4 4h-3v4h3l-4 4L8 14h3v-4h-3Z"),
