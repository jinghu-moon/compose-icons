...
val TablerIcons.Outline.BrandFlightradar24: ImageVector
    get() {
        if (_brandFlightradar24 != null) return _brandFlightradar24!!
        _brandFlightradar24 = tablerOutlineIcon(
            name = "BrandFlightradar24",
    ...
    addPath(
        pathData = parseSvgPathData("M 8.500 20.000 L 12.000 12.000 L 5.500 18.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
