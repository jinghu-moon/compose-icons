        ...
        _tiktokLogo = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(203.90498f, 120.03794f, 184.30946f, 113.73939f, 168.0f, 102.0f),
                    PathNode.LineTo(168.0f, 156.0f),
                    PathNode.CurveTo(168.0f, 193.55536f, 137.55536f, 224.0f, 100.0f, 224.0f),
                    PathNode.CurveTo(62.444637f, 224.0f, 32.0f, 193.55536f, 32.0f, 156.0f),
                    PathNode.CurveTo(32.0f, 122.54f, 56.17f, 93.67f, 88.0f, 88.0f),
                    PathNode.LineTo(88.0f, 130.69f),
                    PathNode.CurveTo(75.4668f, 136.63503f, 69.1758f, 150.86058f, 73.21063f, 164.13252f),
                    PathNode.CurveTo(77.245476f, 177.40446f, 90.38969f, 185.72147f, 104.11107f, 183.68477f),
                    PathNode.CurveTo(117.83246f, 181.64807f, 127.99416f, 169.87172f, 128.0f, 156.0f),
                    PathNode.LineTo(128.0f, 24.0f),
                    PathNode.LineTo(168.0f, 24.0f),
                    PathNode.CurveTo(168.0f, 54.927944f, 193.07205f, 80.0f, 224.0f, 80.0f),
                    PathNode.Close
                ),
