...
val TablerIcons.Outline.Percentage33: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 12.000 3.000 C 15.215 3.000 18.186 4.716 19.794 7.500 C 21.402 10.285 21.402 13.715 19.794 16.500 L 12.004 12.003 L 12.004 3.003"),
