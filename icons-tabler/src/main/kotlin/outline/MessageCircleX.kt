...
val TablerIcons.Outline.MessageCircleX: ImageVector
    get() {
        ...
        _messageCircleX = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 13.593 19.855 C 11.587 20.178 9.531 19.879 7.700 19.000 L 3.000 20.000 L 4.300 16.100 C 1.976 12.663 2.874 8.228 6.400 5.726 C 9.926 3.225 14.990 3.430 18.245 6.206 C 20.373 8.022 21.298 10.569 20.938 13.019"),
