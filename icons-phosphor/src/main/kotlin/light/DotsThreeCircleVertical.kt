        ...
        _dotsThreeCircleVertical = phosphorLightIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(138.0f, 84.0f),
                    PathNode.CurveTo(138.0f, 89.52285f, 133.52284f, 94.0f, 128.0f, 94.0f),
                    PathNode.CurveTo(122.47715f, 94.0f, 118.0f, 89.52285f, 118.0f, 84.0f),
                    PathNode.CurveTo(118.0f, 78.47715f, 122.47715f, 74.0f, 128.0f, 74.0f),
                    PathNode.CurveTo(133.52284f, 74.0f, 138.0f, 78.47715f, 138.0f, 84.0f),
                    PathNode.Close,
