...
val LucideIcons.Outline.BluetoothOff: ImageVector
    get() {
        ...
        _bluetoothOff = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 17.000 17.000 L 12.000 22.000 L 12.000 12.000 L 7.000 17.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 14.500 9.500 L 17.000 7.000 L 12.000 2.000 L 12.000 6.500"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
