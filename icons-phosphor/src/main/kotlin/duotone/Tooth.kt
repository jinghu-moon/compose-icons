...
val PhosphorIcons.Duotone.Tooth: ImageVector
    get() {
        ...
        _tooth = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(216.0f, 79.76f),
                    PathNode.CurveTo(216.07f, 151.18f, 192.52f, 207.99f, 172.0f, 222.54f),
                    PathNode.CurveTo(169.63908f, 224.16801f, 166.58734f, 224.40776f, 164.00114f, 223.16838f),
                    PathNode.CurveTo(161.41498f, 221.929f, 159.69005f, 219.40012f, 159.48f, 216.54f),
                    PathNode.CurveTo(158.0f, 196.31f, 152.0f, 160.0f, 128.0f, 160.0f),
                    PathNode.CurveTo(104.0f, 160.0f, 98.0f, 196.31f, 96.49f, 216.53f),
                    PathNode.CurveTo(96.279945f, 219.39012f, 94.555016f, 221.91899f, 91.96884f, 223.15839f),
                    PathNode.CurveTo(89.38265f, 224.39777f, 86.33092f, 224.15802f, 83.97f, 222.53f),
                    PathNode.CurveTo(63.48f, 208.0f, 39.93f, 151.18f, 40.0f, 79.76f),
                    PathNode.CurveTo(40.099216f, 53.33036f, 61.570194f, 31.966736f, 88.0f, 32.0f),
                    PathNode.LineTo(168.0f, 32.0f),
                    PathNode.CurveTo(194.42981f, 31.966736f, 215.90079f, 53.33036f, 216.0f, 79.76f),
                    PathNode.Close
                ),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(224.0f, 122.47f, 216.0f, 155.15f, 209.3f, 175.03f),
                    ...
                    PathNode.CurveTo(67.34f, 220.53f, 55.42f, 200.84f, 46.7f, 175.06f),
