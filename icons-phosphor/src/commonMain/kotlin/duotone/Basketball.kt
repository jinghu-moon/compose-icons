...
val PhosphorIcons.Duotone.Basketball: ImageVector
    get() {
        ...
        _basketball = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(60.0f, 195.88f),
                    PathNode.LineTo(60.0f, 195.88f),
                    PathNode.LineTo(60.12f, 196.0f),
                    PathNode.Close,
                    PathNode.MoveTo(60.0f, 60.0f),
                    PathNode.LineTo(60.0f, 60.0f),
                    PathNode.CurveTo(22.66897f, 97.60122f, 22.66897f, 158.27878f, 60.0f, 195.88f),
                    PathNode.CurveTo(77.966095f, 177.83751f, 88.03668f, 153.40195f, 88.0f, 127.94f),
                    PathNode.CurveTo(88.03668f, 102.47805f, 77.966095f, 78.042496f, 60.0f, 60.0f),
                    PathNode.Close,
                    PathNode.MoveTo(196.0f, 60.0f),
                    PathNode.LineTo(196.0f, 60.0f),
                    PathNode.CurveTo(158.66898f, 97.60122f, 158.66898f, 158.27878f, 196.0f, 195.88f),
                    PathNode.CurveTo(233.33102f, 158.27878f, 233.33102f, 97.60122f, 196.0f, 60.0f),
                    PathNode.Close,
                    PathNode.MoveTo(196.0f, 195.88f),
                    PathNode.LineTo(196.12f, 196.0f),
                    PathNode.LineTo(196.0f, 195.88f),
                    PathNode.Close
                ),
