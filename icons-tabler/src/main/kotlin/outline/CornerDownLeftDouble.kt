...
val TablerIcons.Outline.CornerDownLeftDouble: ImageVector
    get() {
        ...
        _cornerDownLeftDouble = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 19.000 5.000 L 19.000 11.000 C 19.000 12.657 17.657 14.000 16.000 14.000 L 9.000 14.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 13.000 10.000 L 9.000 14.000 L 13.000 18.000M 8.000 10.000 L 4.000 14.000 L 8.000 18.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
