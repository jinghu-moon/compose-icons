...
val PhosphorIcons.Duotone.CurrencyEur: ImageVector
    get() {
        ...
        _currencyEur = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(184.0f, 58.33f),
                    PathNode.LineTo(184.0f, 197.67f),
                    PathNode.CurveTo(162.8363f, 216.59938f, 132.52391f, 221.3228f, 106.604126f, 209.73018f),
                    PathNode.CurveTo(80.68435f, 198.13756f, 63.998276f, 172.39407f, 64.0f, 144.0f),
                    PathNode.LineTo(64.0f, 112.0f),
                    PathNode.CurveTo(63.998276f, 83.60592f, 80.68435f, 57.86244f, 106.604126f, 46.269817f),
                    PathNode.CurveTo(132.52391f, 34.677197f, 162.8363f, 39.40061f, 184.0f, 58.33f),
                    PathNode.Close
                ),
