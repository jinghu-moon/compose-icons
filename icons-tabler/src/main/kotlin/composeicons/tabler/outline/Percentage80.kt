...
val TablerIcons.Outline.Percentage80: ImageVector
    get() {
        ...
        _percentage80 = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M12 3c3.918 .001 7.384 2.537 8.573 6.27 1.189 3.733-.174 7.806-3.37 10.072C14.007 21.608 9.713 21.546 6.583 19.189 3.454 16.833 2.208 12.722 3.503 9.025L12 12v-9"),
