...
val LucideIcons.Outline.CreativeCommons: ImageVector
    get() {
        ...
        _creativeCommons = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 10.000 9.300 C 8.746 8.726 7.261 9.150 6.500 10.300 C 5.823 11.332 5.823 12.668 6.500 13.700 C 7.233 14.888 8.750 15.321 10.000 14.700"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 17.000 9.300 C 15.746 8.726 14.261 9.150 13.500 10.300 C 12.823 11.332 12.823 12.668 13.500 13.700 C 14.233 14.888 15.750 15.321 17.000 14.700"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
