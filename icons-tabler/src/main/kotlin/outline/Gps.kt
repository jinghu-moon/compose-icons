...
val TablerIcons.Outline.Gps: ImageVector
    get() {
        if (_gps != null) return _gps!!
        _gps = tablerOutlineIcon(
            name = "Gps",
    ...
    addPath(
        pathData = parseSvgPathData("M 12.000 17.000 L 11.000 13.000 L 7.000 12.000 L 16.000 8.000 L 12.000 17.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
