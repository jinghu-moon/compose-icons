...
val TablerIcons.Outline.Moneybag: ImageVector
    get() {
        ...
        _moneybag = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 4.000 17.000 L 4.000 16.000 C 4.000 11.582 7.582 8.000 12.000 8.000 C 16.418 8.000 20.000 11.582 20.000 16.000 L 20.000 17.000 C 20.000 19.209 18.209 21.000 16.000 21.000 L 8.000 21.000 C 5.791 21.000 4.000 19.209 4.000 17.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
