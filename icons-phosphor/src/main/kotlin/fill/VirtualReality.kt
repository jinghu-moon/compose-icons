        ...
        _virtualReality = phosphorFillIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(35.81722f, 48.0f, 0f, 83.81722f, 0f, 128.0f),
                    PathNode.CurveTo(0f, 172.18279f, 35.81722f, 208.0f, 80.0f, 208.0f),
                    PathNode.LineTo(176.0f, 208.0f),
                    PathNode.CurveTo(220.18279f, 208.0f, 256.0f, 172.18279f, 256.0f, 128.0f),
                    PathNode.CurveTo(256.0f, 83.81722f, 220.18279f, 48.0f, 176.0f, 48.0f),
                    PathNode.Close,
                    ...
                    PathNode.CurveTo(176.0f, 122.62742f, 170.62741f, 128.0f, 164.0f, 128.0f),
                    PathNode.LineTo(152.0f, 128.0f),
                    PathNode.LineTo(152.0f, 104.0f),
                    PathNode.LineTo(164.0f, 104.0f),
                    PathNode.CurveTo(170.62741f, 104.0f, 176.0f, 109.37258f, 176.0f, 116.0f),
                    PathNode.Close
                ),
