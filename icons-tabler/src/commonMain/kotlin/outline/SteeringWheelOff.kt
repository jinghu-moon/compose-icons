...
val TablerIcons.Outline.SteeringWheelOff: ImageVector
    get() {
        ...
        _steeringWheelOff = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(10.595f, 10.576f),
                    PathNode.CurveTo(9.813517f, 11.356654f, 9.812845f, 12.623017f, 10.5935f, 13.4045f),
                    PathNode.CurveTo(11.374154f, 14.185983f, 12.640517f, 14.186654f, 13.422f, 13.406f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(15.542f, 11.543f),
                    PathNode.LineTo(20.75f, 10.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
