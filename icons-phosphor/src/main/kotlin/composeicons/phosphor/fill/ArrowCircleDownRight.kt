...
val PhosphorIcons.Fill.ArrowCircleDownRight: ImageVector
    get() {
        ...
        _arrowCircleDownRight = phosphorFillIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M128 24C70.562 24 24 70.562 24 128c0 57.438 46.562 104 104 104 57.438 0 104-46.562 104-104C231.939 70.588 185.412 24.061 128 24ZM168 160c0 4.418-3.582 8-8 8h-48c-4.418 0-8-3.582-8-8 0-4.418 3.582-8 8-8h28.69L90.34 101.66c-3.126-3.126-3.126-8.194 0-11.32 3.126-3.126 8.194-3.126 11.32 0L152 140.69v-28.69c0-4.418 3.582-8 8-8 4.418 0 8 3.582 8 8Z"),
