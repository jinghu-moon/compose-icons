        ...
        _diceSix = phosphorBoldIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(112.0f, 92.836555f, 104.836555f, 100.0f, 96.0f, 100.0f),
                    PathNode.CurveTo(87.163445f, 100.0f, 80.0f, 92.836555f, 80.0f, 84.0f),
                    PathNode.CurveTo(80.0f, 75.163445f, 87.163445f, 68.0f, 96.0f, 68.0f),
                    PathNode.CurveTo(104.836555f, 68.0f, 112.0f, 75.163445f, 112.0f, 84.0f),
                    PathNode.Close,
                    PathNode.MoveTo(176.0f, 84.0f),
                    PathNode.CurveTo(176.0f, 92.836555f, 168.83656f, 100.0f, 160.0f, 100.0f),
                    PathNode.CurveTo(151.16344f, 100.0f, 144.0f, 92.836555f, 144.0f, 84.0f),
                    PathNode.CurveTo(144.0f, 75.163445f, 151.16344f, 68.0f, 160.0f, 68.0f),
                    PathNode.CurveTo(168.83656f, 68.0f, 176.0f, 75.163445f, 176.0f, 84.0f),
                    PathNode.Close,
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(112.0f, 172.0f),
                    PathNode.CurveTo(112.0f, 180.83656f, 104.836555f, 188.0f, 96.0f, 188.0f),
                    PathNode.CurveTo(87.163445f, 188.0f, 80.0f, 180.83656f, 80.0f, 172.0f),
                    PathNode.CurveTo(80.0f, 163.16344f, 87.163445f, 156.0f, 96.0f, 156.0f),
                    PathNode.CurveTo(104.836555f, 156.0f, 112.0f, 163.16344f, 112.0f, 172.0f),
                    PathNode.Close,
                    PathNode.MoveTo(176.0f, 172.0f),
                    PathNode.CurveTo(176.0f, 180.83656f, 168.83656f, 188.0f, 160.0f, 188.0f),
                    PathNode.CurveTo(151.16344f, 188.0f, 144.0f, 180.83656f, 144.0f, 172.0f),
                    PathNode.CurveTo(144.0f, 163.16344f, 151.16344f, 156.0f, 160.0f, 156.0f),
                    PathNode.CurveTo(168.83656f, 156.0f, 176.0f, 163.16344f, 176.0f, 172.0f),
                    PathNode.Close
                ),
