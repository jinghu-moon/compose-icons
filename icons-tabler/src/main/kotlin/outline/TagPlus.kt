...
val TablerIcons.Outline.TagPlus: ImageVector
    get() {
        ...
        _tagPlus = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 21.002 13.000 C 21.002 12.383 20.767 11.767 20.296 11.296 L 12.586 3.586 C 12.211 3.211 11.702 3.000 11.172 3.000 L 6.000 3.000 C 4.343 3.000 3.000 4.343 3.000 6.000 L 3.000 11.172 C 3.000 11.702 3.211 12.211 3.586 12.586 L 11.296 20.296 C 11.767 20.766 12.383 21.002 13.000 21.002"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
