...
val TablerIcons.Outline.Peace: ImageVector
    get() {
        if (_peace != null) return _peace!!
        _peace = tablerOutlineIcon(
            name = "Peace",
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 12.000 L 18.300 18.300"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 12.000 L 5.700 18.300"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
