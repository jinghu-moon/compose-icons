...
val LucideIcons.Outline.CalendarOff: ImageVector
    get() {
        ...
        _calendarOff = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(4.2f, 4.2f),
                    PathNode.CurveTo(3.482015f, 4.513226f, 3.012984f, 5.216773f, 3.0f, 6.0f),
                    PathNode.LineTo(3.0f, 20.0f),
                    PathNode.CurveTo(3.0f, 21.10457f, 3.895431f, 22.0f, 5.0f, 22.0f),
                    PathNode.LineTo(19.0f, 22.0f),
                    PathNode.CurveTo(19.7858f, 21.99836f, 20.497824f, 21.536718f, 20.82f, 20.82f)
                ),
