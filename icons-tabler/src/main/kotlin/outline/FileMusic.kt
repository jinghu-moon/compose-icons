...
val TablerIcons.Outline.FileMusic: ImageVector
    get() {
        if (_fileMusic != null) return _fileMusic!!
        _fileMusic = tablerOutlineIcon(
            name = "FileMusic",
            ...
            addPath(
                pathData = parseSvgPathData("M 10.000 16.000 C 10.000 16.552 10.448 17.000 11.000 17.000 C 11.552 17.000 12.000 16.552 12.000 16.000 C 12.000 15.448 11.552 15.000 11.000 15.000 C 10.448 15.000 10.000 15.448 10.000 16.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 16.000 L 12.000 11.000 L 14.000 12.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
