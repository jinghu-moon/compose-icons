        ...
        _gitGraph = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(8.0f, 19.656855f, 6.656854f, 21.0f, 5.0f, 21.0f),
                    PathNode.CurveTo(3.343146f, 21.0f, 2.0f, 19.656855f, 2.0f, 18.0f),
                    PathNode.CurveTo(2.0f, 16.343145f, 3.343146f, 15.0f, 5.0f, 15.0f),
                    PathNode.CurveTo(6.656854f, 15.0f, 8.0f, 16.343145f, 8.0f, 18.0f),
                    PathNode.Close
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(16.0f, 15.7f),
                    PathNode.CurveTo(17.906773f, 13.994533f, 18.997667f, 11.558202f, 19.0f, 9.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
