        ...
        _squareHalfBottom = phosphorLightIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(106.0f, 202.0f),
                    PathNode.LineTo(86.0f, 202.0f),
                    PathNode.LineTo(86.0f, 134.0f),
                    PathNode.Close,
                    PathNode.MoveTo(118.0f, 134.0f),
                    PathNode.LineTo(138.0f, 134.0f),
                    PathNode.LineTo(138.0f, 202.0f),
                    PathNode.LineTo(118.0f, 202.0f),
                    PathNode.Close,
                    PathNode.MoveTo(150.0f, 134.0f),
                    PathNode.LineTo(170.0f, 134.0f),
                    PathNode.LineTo(170.0f, 202.0f),
                    PathNode.LineTo(150.0f, 202.0f),
                    PathNode.Close,
