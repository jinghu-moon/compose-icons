...
val TablerIcons.Outline.HeartSpark: ImageVector
    get() {
        ...
        _heartSpark = tablerOutlineIcon(
            ...
            addPathData("M11.537 19.542 4.5 12.572C3.151 11.26 2.654 9.301 3.212 7.504 3.771 5.707 5.292 4.376 7.147 4.06 9.002 3.743 10.877 4.496 12 6.006 13.615 3.861 16.636 3.374 18.843 4.904c2.207 1.53 2.811 4.53 1.369 6.795")
