        ...
        _fileCertificate = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(3.0f, 15.656855f, 4.343146f, 17.0f, 6.0f, 17.0f),
                    PathNode.CurveTo(7.656854f, 17.0f, 9.0f, 15.656855f, 9.0f, 14.0f),
                    PathNode.CurveTo(9.0f, 12.343145f, 7.656854f, 11.0f, 6.0f, 11.0f),
                    PathNode.CurveTo(4.343146f, 11.0f, 3.0f, 12.343145f, 3.0f, 14.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
