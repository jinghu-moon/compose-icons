...
val TablerIcons.Outline.EaseOutControlPoint: ImageVector
    get() {
        ...
        _easeOutControlPoint = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 3.000 21.000 C 3.000 21.000 13.000 5.000 21.000 5.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 7.000 5.000 L 9.000 5.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 14.000 5.000 L 12.000 5.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
