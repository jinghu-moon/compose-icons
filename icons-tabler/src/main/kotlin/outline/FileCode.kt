...
val TablerIcons.Outline.FileCode: ImageVector
    get() {
        if (_fileCode != null) return _fileCode!!
        _fileCode = tablerOutlineIcon(
            name = "FileCode",
    ...
    addPath(
        pathData = parseSvgPathData("M 10.000 13.000 L 9.000 15.000 L 10.000 17.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 14.000 13.000 L 15.000 15.000 L 14.000 17.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
