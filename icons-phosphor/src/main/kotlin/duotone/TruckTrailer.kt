        ...
        _truckTrailer = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(104.0f, 170.74516f, 93.25484f, 160.0f, 80.0f, 160.0f),
                    PathNode.CurveTo(66.74516f, 160.0f, 56.0f, 170.74516f, 56.0f, 184.0f),
                    PathNode.CurveTo(56.0f, 170.74516f, 45.254833f, 160.0f, 32.0f, 160.0f),
                    PathNode.CurveTo(18.745167f, 160.0f, 8.0f, 170.74516f, 8.0f, 184.0f),
                    ...
                    PathNode.CurveTo(216.0f, 69.49033f, 194.50967f, 48.0f, 168.0f, 48.0f),
                    PathNode.LineTo(160.0f, 48.0f),
                    PathNode.CurveTo(155.58173f, 48.0f, 152.0f, 51.581722f, 152.0f, 56.0f),
                    PathNode.LineTo(152.0f, 184.0f),
                    PathNode.LineTo(200.0f, 184.0f),
                    PathNode.CurveTo(200.0f, 170.74516f, 210.74516f, 160.0f, 224.0f, 160.0f),
                    PathNode.CurveTo(237.25484f, 160.0f, 248.0f, 170.74516f, 248.0f, 184.0f),
                    PathNode.LineTo(248.0f, 136.0f),
                    PathNode.CurveTo(248.0f, 118.32689f, 233.67311f, 104.0f, 216.0f, 104.0f),
                    PathNode.Close
                ),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(190.09138f, 56.0f, 208.0f, 73.90861f, 208.0f, 96.0f),
                    PathNode.LineTo(208.0f, 104.0f),
                    PathNode.CurveTo(208.0f, 108.41828f, 211.58173f, 112.0f, 216.0f, 112.0f),
                    PathNode.CurveTo(229.25484f, 112.0f, 240.0f, 122.74516f, 240.0f, 136.0f),
                    PathNode.LineTo(240.0f, 156.31f),
                    PathNode.CurveTo(235.14294f, 153.4806f, 229.62106f, 151.99315f, 224.0f, 152.0f),
                    PathNode.CurveTo(209.40929f, 152.0138f, 196.66814f, 161.8779f, 193.0f, 176.0f),
                    PathNode.LineTo(160.0f, 176.0f),
                    PathNode.Close,
                    PathNode.MoveTo(112.0f, 80.0f),
                    PathNode.LineTo(112.0f, 176.0f),
                    PathNode.LineTo(111.0f, 176.0f),
                    PathNode.CurveTo(108.03327f, 164.53085f, 98.97298f, 155.63914f, 87.45014f, 152.88832f),
                    PathNode.CurveTo(75.92731f, 150.13753f, 63.827545f, 153.97774f, 56.0f, 162.87f),
                    PathNode.CurveTo(45.94804f, 151.40454f, 29.18758f, 148.65582f, 16.0f, 156.31f),
