...
val TablerIcons.Outline.DeviceAirtag: ImageVector
    get() {
        ...
        _deviceAirtag = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 15.000 15.000 C 15.000 11.686 12.314 9.000 9.000 9.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 15.000 C 12.000 13.343 10.657 12.000 9.000 12.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
