        ...
        _campfire = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(180.0f, 136.71881f, 156.71881f, 160.0f, 128.0f, 160.0f),
                    PathNode.CurveTo(141.25484f, 160.0f, 152.0f, 149.25484f, 152.0f, 136.0f),
                    PathNode.CurveTo(152.0f, 112.0f, 128.0f, 96.0f, 128.0f, 96.0f),
                    PathNode.CurveTo(128.0f, 96.0f, 104.0f, 112.0f, 104.0f, 136.0f),
                    PathNode.CurveTo(104.0f, 149.25484f, 114.74516f, 160.0f, 128.0f, 160.0f),
                    PathNode.CurveTo(99.2812f, 160.0f, 76.0f, 136.71881f, 76.0f, 108.0f),
                    PathNode.CurveTo(76.0f, 64.0f, 128.0f, 32.0f, 128.0f, 32.0f),
                    PathNode.CurveTo(128.0f, 32.0f, 180.0f, 64.0f, 180.0f, 108.0f),
                    PathNode.Close
                ),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(161.1211f, 167.96143f, 187.96143f, 141.1211f, 188.0f, 108.0f),
                    ...
                    PathNode.CurveTo(68.038574f, 141.1211f, 94.87891f, 167.96143f, 128.0f, 168.0f),
                    PathNode.Close,
                    PathNode.MoveTo(112.0f, 136.0f),
                    PathNode.CurveTo(112.0f, 122.43f, 122.0f, 111.54f, 128.0f, 106.21f),
                    PathNode.CurveTo(134.0f, 111.54f, 144.0f, 122.43f, 144.0f, 136.0f),
                    PathNode.CurveTo(144.0f, 144.83656f, 136.83656f, 152.0f, 128.0f, 152.0f),
                    PathNode.CurveTo(119.163445f, 152.0f, 112.0f, 144.83656f, 112.0f, 136.0f),
                    PathNode.Close,
                    PathNode.MoveTo(128.0f, 41.66f),
                    PathNode.CurveTo(139.74f, 50.0f, 172.0f, 76.0f, 172.0f, 108.0f),
                    PathNode.CurveTo(172.00345f, 119.25867f, 167.67432f, 130.08691f, 159.91f, 138.24f),
                    PathNode.CurveTo(159.96f, 137.5f, 160.0f, 136.75f, 160.0f, 136.0f),
                    PathNode.CurveTo(160.0f, 108.0f, 133.56f, 90.09f, 132.44f, 89.34f),
                    PathNode.CurveTo(129.75171f, 87.5464f, 126.2483f, 87.5464f, 123.56f, 89.34f),
                    PathNode.CurveTo(122.44f, 90.09f, 96.0f, 108.0f, 96.0f, 136.0f),
                    PathNode.CurveTo(96.0f, 136.75f, 96.0f, 137.5f, 96.09f, 138.24f),
                    PathNode.CurveTo(88.32568f, 130.08691f, 83.99654f, 119.25867f, 84.0f, 108.0f),
                    PathNode.CurveTo(84.0f, 76.0f, 116.27f, 50.0f, 128.0f, 41.66f),
                    PathNode.Close,
