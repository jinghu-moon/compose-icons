...
val TablerIcons.Outline.CodeCircle2: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 8.500 13.500 L 7.000 12.000 L 8.500 10.500"),
    ...
    addPath(
        pathData = parseSvgPathData("M 15.500 10.500 L 17.000 12.000 L 15.500 13.500"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 13.000 9.500 L 11.000 15.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
