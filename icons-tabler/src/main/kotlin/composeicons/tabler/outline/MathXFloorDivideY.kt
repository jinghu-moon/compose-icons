...
val TablerIcons.Outline.MathXFloorDivideY: ImageVector
    get() {
        ...
        _mathXFloorDivideY = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(1.5f, 19.0f),
                    PathNode.LineTo(19.5f, 1.0f)
                ),
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(4.5f, 22.0f),
                    PathNode.LineTo(22.5f, 4.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(23.0f, 15.0f),
                    PathNode.LineTo(18.5f, 23.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(1.0f, 7.0f),
                    PathNode.LineTo(7.0f, 1.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
