...
val TablerIcons.Outline.CurrencyDogecoin: ImageVector
    get() {
        ...
        _currencyDogecoin = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 6.000 12.000 L 12.000 12.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 6.000 18.000 L 12.000 18.000 C 15.314 18.000 18.000 15.314 18.000 12.000 C 18.000 8.686 15.314 6.000 12.000 6.000 L 6.000 6.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
