...
val LucideIcons.Outline.Eclipse: ImageVector
    get() {
        if (_eclipse != null) return _eclipse!!
        _eclipse = lucideOutlineIcon(
            name = "Eclipse",
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(9.238576f, 4.761424f, 9.238576f, 9.238576f, 12.0f, 12.0f),
                    PathNode.CurveTo(14.761424f, 14.761424f, 19.238577f, 14.761424f, 22.0f, 12.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
