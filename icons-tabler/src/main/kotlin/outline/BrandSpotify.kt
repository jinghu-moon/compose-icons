...
val TablerIcons.Outline.BrandSpotify: ImageVector
    get() {
        ...
        _brandSpotify = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 8.000 11.973 C 10.500 10.500 13.500 11.000 15.500 12.500"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 9.000 15.000 C 10.500 14.000 13.000 14.000 14.000 15.500"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 7.000 9.000 C 9.000 8.000 13.000 7.000 17.000 9.500"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
