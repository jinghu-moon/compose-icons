...
val LucideIcons.Outline.ContactRound: ImageVector
    get() {
        ...
        _contactRound = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(17.915f, 22.0f),
                    PathNode.CurveTo(17.915f, 18.68629f, 15.228708f, 16.0f, 11.915f, 16.0f),
                    PathNode.CurveTo(8.601292f, 16.0f, 5.915f, 18.68629f, 5.915f, 22.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
