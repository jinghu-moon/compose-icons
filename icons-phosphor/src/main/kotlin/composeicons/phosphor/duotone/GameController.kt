...
val PhosphorIcons.Duotone.GameController: ImageVector
    get() {
        ...
        _gameController = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M216.86 207.57c-8.995 1.587-18.199-1.313-24.66-7.77L150.09 152h21.91c15.37 .017 29.958-6.775 39.84-18.548C221.721 121.679 225.881 106.135 223.2 91h0l16.36 84.17c2.663 15.212-7.493 29.708-22.7 32.4Z"),
