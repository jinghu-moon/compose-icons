...
val TablerIcons.Outline.DeviceImacQuestion: ImageVector
    get() {
        ...
        _deviceImacQuestion = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 14.000 17.000 L 4.000 17.000 C 3.448 17.000 3.000 16.552 3.000 16.000 L 3.000 4.000 C 3.000 3.448 3.448 3.000 4.000 3.000 L 20.000 3.000 C 20.552 3.000 21.000 3.448 21.000 4.000 L 21.000 11.500"),
            ...
            addPath(
                pathData = parseSvgPathData("M 3.000 13.000 L 14.500 13.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
