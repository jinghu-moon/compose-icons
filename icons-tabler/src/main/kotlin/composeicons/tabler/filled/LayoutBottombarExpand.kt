...
val TablerIcons.Filled.LayoutBottombarExpand: ImageVector
    get() {
        ...
        _layoutBottombarExpand = tablerFilledIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M18 3c1.589-0 2.902 1.238 2.995 2.824L21 6v12c0 1.589-1.238 2.902-2.824 2.995L18 21h-12C4.411 21 3.098 19.762 3.005 18.176L3 18v-12C3 4.411 4.238 3.098 5.824 3.005L6 3h12ZM18 5h-12c-.507 0-.934 .38-.993 .883L5 6v9h14v-9c-0-.507-.38-.934-.883-.993L18 5ZM12.613 8.21l.094 .083 2 2c.372 .373 .39 .972 .042 1.367-.349 .395-.945 .452-1.362 .13l-.094-.083L12 10.415l-1.293 1.292c-.356 .356-.922 .392-1.32 .083l-.094-.083c-.356-.356-.392-.922-.083-1.32l.083-.094 2-2c.356-.356 .922-.392 1.32-.083Z"),
