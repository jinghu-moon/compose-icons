...
val PhosphorIcons.Thin.BagSimple: ImageVector
    get() {
        ...
        _bagSimple = phosphorThinIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M216 68h-44v-4C172 39.699 152.301 20 128 20 103.699 20 84 39.699 84 64v4h-44C33.373 68 28 73.373 28 80v120c0 6.627 5.373 12 12 12h176c6.627 0 12-5.373 12-12v-120c0-6.627-5.373-12-12-12ZM92 64C92 44.118 108.118 28 128 28c19.882 0 36 16.118 36 36v4h-72ZM220 200c0 2.209-1.791 4-4 4h-176c-2.209 0-4-1.791-4-4v-120c0-2.209 1.791-4 4-4h176c2.209 0 4 1.791 4 4Z"),
