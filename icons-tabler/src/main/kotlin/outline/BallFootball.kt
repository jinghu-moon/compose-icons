...
val TablerIcons.Outline.BallFootball: ImageVector
    get() {
        ...
        _ballFootball = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 7.000 L 16.760 10.450 L 15.000 16.000 L 9.000 16.000 L 7.240 10.450 L 12.000 7.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 7.000 L 12.000 3.000M 15.000 16.000 L 17.500 19.000M 16.760 10.450 L 20.500 9.000M 9.060 16.050 L 6.500 19.000M 7.240 10.450 L 3.500 9.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
