...
val LucideIcons.Outline.Vault: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 7.900 7.900 L 10.600 10.600"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 13.400 10.600 L 16.100 7.900"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 7.900 16.100 L 10.600 13.400"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 17.000 16.500 C 17.000 16.776 16.776 17.000 16.500 17.000 C 16.224 17.000 16.000 16.776 16.000 16.500 C 16.000 16.224 16.224 16.000 16.500 16.000 C 16.776 16.000 17.000 16.224 17.000 16.500 Z"),
        pathFillType = PathFillType.NonZero,
        fill = SolidColor(Color(0xFF000000)),
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 13.400 13.400 L 16.100 16.100"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
