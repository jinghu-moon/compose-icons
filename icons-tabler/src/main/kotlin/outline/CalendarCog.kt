...
val TablerIcons.Outline.CalendarCog: ImageVector
    get() {
        if (_calendarCog != null) return _calendarCog!!
        _calendarCog = tablerOutlineIcon(
            name = "CalendarCog",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24f, height = 24f),
        ) {
            addPath(
                pathData = parseSvgPathData("M 12.000 21.000 L 6.000 21.000 C 4.895 21.000 4.000 20.105 4.000 19.000 L 4.000 7.000 C 4.000 5.895 4.895 5.000 6.000 5.000 L 18.000 5.000 C 19.105 5.000 20.000 5.895 20.000 7.000 L 20.000 12.000"),
