...
val TablerIcons.Outline.CalendarQuestion: ImageVector
    get() {
        if (_calendarQuestion != null) return _calendarQuestion!!
        _calendarQuestion = tablerOutlineIcon(
            name = "CalendarQuestion",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24.0f, height = 24.0f),
        ) {
    addPath(
        pathData = parseSvgPathData("M 15.000 21.000 L 6.000 21.000 C 4.895 21.000 4.000 20.105 4.000 19.000 L 4.000 7.000 C 4.000 5.895 4.895 5.000 6.000 5.000 L 18.000 5.000 C 19.105 5.000 20.000 5.895 20.000 7.000 L 20.000 11.000"),
