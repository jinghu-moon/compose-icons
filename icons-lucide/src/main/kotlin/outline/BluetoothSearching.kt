...
val LucideIcons.Outline.BluetoothSearching: ImageVector
    get() {
        ...
        _bluetoothSearching = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 7.000 7.000 L 17.000 17.000 L 12.000 22.000 L 12.000 2.000 L 17.000 7.000 L 7.000 17.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 20.830 14.830 C 21.581 14.080 22.003 13.062 22.003 12.000 C 22.003 10.938 21.581 9.920 20.830 9.170"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
