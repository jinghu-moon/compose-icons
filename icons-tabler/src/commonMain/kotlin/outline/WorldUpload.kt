...
val TablerIcons.Outline.WorldUpload: ImageVector
    get() {
        ...
        _worldUpload = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(11.578f, 3.0f),
                    PathNode.CurveTo(8.14094f, 8.507776f, 8.14094f, 15.492224f, 11.578f, 21.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(14.219f, 5.755f, 15.0f, 8.876f, 15.0f, 12.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
