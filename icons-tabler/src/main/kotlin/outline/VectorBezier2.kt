...
val TablerIcons.Outline.VectorBezier2: ImageVector
    get() {
        ...
        _vectorBezier2 = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 7.000 5.000 L 14.000 5.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 10.000 19.000 L 17.000 19.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 7.000 5.500 C 9.761 5.500 12.000 8.410 12.000 12.000 C 12.000 15.590 14.239 18.500 17.000 18.500"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
