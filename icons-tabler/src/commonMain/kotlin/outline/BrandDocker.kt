...
val TablerIcons.Outline.BrandDocker: ImageVector
    get() {
        ...
        _brandDocker = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(22.0f, 12.54f),
                    PathNode.CurveTo(20.196f, 12.195f, 19.299f, 11.46f, 18.477f, 9.6f),
                    PathNode.CurveTo(17.99f, 10.296f, 17.375f, 11.168f, 17.557f, 12.0f),
                    PathNode.CurveTo(17.585f, 12.238f, 17.237f, 13.0f, 17.0f, 13.0f),
                    PathNode.LineTo(3.0f, 13.0f),
                    PathNode.CurveTo(3.0f, 18.208f, 6.164f, 20.0f, 9.196f, 20.0f),
                    PathNode.CurveTo(13.32f, 20.022f, 17.024f, 18.624f, 19.05f, 15.0f),
                    PathNode.CurveTo(20.196f, 14.899f, 21.346f, 13.495f, 22.0f, 12.54f)
                ),
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(4.571f, 18.0f),
                    PathNode.CurveTo(6.071f, 18.0f, 6.618f, 17.926f, 7.529f, 17.22f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
