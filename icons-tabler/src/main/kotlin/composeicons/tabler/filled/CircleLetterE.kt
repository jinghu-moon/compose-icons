...
val TablerIcons.Filled.CircleLetterE: ImageVector
    get() {
        ...
        _circleLetterE = tablerFilledIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M12 2c5.523 0 10 4.477 10 10 0 5.523-4.477 10-10 10C6.477 22 2 17.523 2 12 2 6.477 6.477 2 12 2M14 7h-4C9.448 7 9 7.448 9 8v8c0 .552 .448 1 1 1h4c.552 0 1-.448 1-1l-.007-.117C14.934 15.38 14.507 15 14 15h-3v-2h1.5c.507-0 .934-.38 .993-.883L13.5 12c0-.552-.448-1-1-1h-1.5v-2h3c.552 0 1-.448 1-1C15 7.448 14.552 7 14 7"),
