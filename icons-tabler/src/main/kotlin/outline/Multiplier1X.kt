...
val TablerIcons.Outline.Multiplier1X: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 9.000 16.000 L 9.000 8.000 L 7.000 10.000"),
    ...
    addPath(
        pathData = parseSvgPathData("M 13.000 16.000 L 17.000 12.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 17.000 16.000 L 13.000 12.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
