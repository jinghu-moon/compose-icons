...
val TablerIcons.Outline.HomeCheck: ImageVector
    get() {
        ...
        _homeCheck = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 19.000 13.488 L 19.000 12.000 L 21.000 12.000 L 12.000 3.000 L 3.000 12.000 L 5.000 12.000 L 5.000 19.000 C 5.000 20.105 5.895 21.000 7.000 21.000 L 11.525 21.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
