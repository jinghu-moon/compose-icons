...
val LucideIcons.Outline.SquareChevronRight: ImageVector
    get() {
        if (_squareChevronRight != null) return _squareChevronRight!!
        _squareChevronRight = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 10.000 8.000 L 14.000 12.000 L 10.000 16.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
