...
val LucideIcons.Outline.BadgeEuro: ImageVector
    get() {
        ...
        _badgeEuro = lucideOutlineIcon(
            ...
            addPathData("M7 12h5")
            addPathData("M15 9.4C13.911 8.127 12.145 7.668 10.574 8.248 9.003 8.828 7.96 10.325 7.96 12c0 1.675 1.043 3.172 2.614 3.752 1.571 .58 3.337 .12 4.426-1.152")
        }
        return _badgeEuro!!
    }
