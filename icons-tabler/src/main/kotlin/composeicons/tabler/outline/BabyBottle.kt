        ...
        _babyBottle = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(14.761424f, 4.0f, 17.0f, 6.238577f, 17.0f, 9.0f),
                    PathNode.LineTo(17.0f, 20.0f),
                    PathNode.CurveTo(17.0f, 21.10457f, 16.10457f, 22.0f, 15.0f, 22.0f),
                    PathNode.LineTo(9.0f, 22.0f),
                    PathNode.CurveTo(7.895431f, 22.0f, 7.0f, 21.10457f, 7.0f, 20.0f),
                    PathNode.LineTo(7.0f, 9.0f),
                    PathNode.CurveTo(7.0f, 6.238577f, 9.238576f, 4.0f, 12.0f, 4.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
