...
val TablerIcons.Outline.MapPinDollar: ImageVector
    get() {
        ...
        _mapPinDollar = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 13.020 21.206 C 12.234 21.671 11.233 21.546 10.587 20.900 L 6.343 16.657 C 3.862 14.175 3.288 10.366 4.928 7.263 C 6.567 4.160 10.038 2.488 13.486 3.140 C 16.935 3.792 19.556 6.615 19.950 10.102"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
