...
val PhosphorIcons.Fill.AppWindow: ImageVector
    get() {
        ...
        _appWindow = phosphorFillIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M216 40h-176C31.163 40 24 47.163 24 56v144c0 8.837 7.163 16 16 16h176c8.837 0 16-7.163 16-16v-144c0-8.837-7.163-16-16-16ZM68 96C61.373 96 56 90.627 56 84 56 77.373 61.373 72 68 72c6.627 0 12 5.373 12 12 0 6.627-5.373 12-12 12ZM108 96C101.373 96 96 90.627 96 84c0-6.627 5.373-12 12-12 6.627 0 12 5.373 12 12 0 6.627-5.373 12-12 12Z"),
