        ...
        _replaceOff = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.MoveTo(8.697f, 8.717f),
                    PathNode.CurveTo(8.510357f, 8.898457f, 8.260312f, 8.999981f, 8.0f, 9.0f),
                    PathNode.LineTo(4.0f, 9.0f),
                    PathNode.CurveTo(3.447715f, 9.0f, 3.0f, 8.552285f, 3.0f, 8.0f),
                    PathNode.LineTo(3.0f, 4.0f),
                    PathNode.CurveTo(3.0f, 3.72f, 3.115f, 3.468f, 3.3f, 3.286f)
                ),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.MoveTo(20.697f, 20.717f),
                    PathNode.CurveTo(20.510357f, 20.898457f, 20.260311f, 20.99998f, 20.0f, 21.0f),
                    PathNode.LineTo(16.0f, 21.0f),
                    PathNode.CurveTo(15.447715f, 21.0f, 15.0f, 20.552284f, 15.0f, 20.0f),
                    PathNode.LineTo(15.0f, 16.0f),
                    PathNode.CurveTo(15.0f, 15.72f, 15.115f, 15.468f, 15.3f, 15.286f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
