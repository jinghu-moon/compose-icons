...
val TablerIcons.Outline.ClipboardTypography: ImageVector
    get() {
        if (_clipboardTypography != null) return _clipboardTypography!!
        _clipboardTypography = tablerOutlineIcon(
    ...
    addPath(
        pathData = parseSvgPathData("M 9.000 12.000 L 9.000 11.000 L 15.000 11.000 L 15.000 12.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 12.000 11.000 L 12.000 17.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
