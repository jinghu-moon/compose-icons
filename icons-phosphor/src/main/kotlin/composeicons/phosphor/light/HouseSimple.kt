...
val PhosphorIcons.Light.HouseSimple: ImageVector
    get() {
        ...
        _houseSimple = phosphorLightIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M217.9 110.1l-80-80C135.274 27.474 131.713 25.999 128 25.999c-3.713 0-7.274 1.475-9.9 4.101l-80 80C35.467 112.721 33.991 116.285 34 120v96c0 3.314 2.686 6 6 6h176c3.314 0 6-2.686 6-6v-96c.009-3.715-1.467-7.279-4.1-9.9ZM210 210h-164v-90c-.003-.532 .206-1.043 .58-1.42l80-80c.376-.379 .887-.592 1.42-.592 .533 0 1.044 .213 1.42 .592l80 80c.374 .377 .583 .888 .58 1.42Z"),
