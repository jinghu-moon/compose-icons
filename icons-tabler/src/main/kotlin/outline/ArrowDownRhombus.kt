...
val TablerIcons.Outline.ArrowDownRhombus: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 15.000 18.000 L 12.000 21.000 L 9.000 18.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 14.500 5.500 L 12.000 3.000 L 9.500 5.500 L 12.000 8.000 L 14.500 5.500"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
