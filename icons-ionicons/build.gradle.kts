...
android {
    namespace = "composeicons.ionicons"
    compileSdk = 36
...
mavenPublishing {
    ...
    pom {
        name.set("icons-ionicons")
        description.set("Ionicons for Jetpack Compose - generated via svg2compose pipeline")
