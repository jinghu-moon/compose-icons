...
val PhosphorIcons.Duotone.BezierCurve: ImageVector
    get() {
        ...
        _bezierCurve = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M152 80c0 13.255-10.745 24-24 24C114.745 104 104 93.255 104 80c0-13.255 10.745-24 24-24 13.255 0 24 10.745 24 24ZM40 152c-13.255 0-24 10.745-24 24 0 13.255 10.745 24 24 24 13.255 0 24-10.745 24-24C64 162.745 53.255 152 40 152ZM216 152c-13.255 0-24 10.745-24 24 0 13.255 10.745 24 24 24 13.255 0 24-10.745 24-24 0-13.255-10.745-24-24-24Z"),
