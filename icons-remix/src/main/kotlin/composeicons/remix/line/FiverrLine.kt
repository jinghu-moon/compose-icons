...
val RemixIcons.Line.FiverrLine: ImageVector
    get() {
        ...
        _fiverrLine = remixIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M12 2c5.523 0 10 4.477 10 10 0 5.523-4.477 10-10 10C6.477 22 2 17.523 2 12 2 6.477 6.477 2 12 2ZM12 4C7.582 4 4 7.582 4 12c0 4.418 3.582 8 8 8 4.418 0 8-3.582 8-8C20 7.582 16.418 4 12 4ZM13.679 7.927h-1.5c-.557 0-.943 .343-.943 .857v.472h4.972v7.886h-2.528v-5.743h-2.443v5.743h-2.528v-5.743h-1.457v-2.143h1.457v-.644C8.707 6.941 9.95 5.784 11.793 5.784h1.886v2.143Z"),
