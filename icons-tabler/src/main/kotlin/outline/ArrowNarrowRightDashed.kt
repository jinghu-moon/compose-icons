...
val TablerIcons.Outline.ArrowNarrowRightDashed: ImageVector
    get() {
        ...
        _arrowNarrowRightDashed = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 5.000 12.000 L 5.500 12.000M 8.500 12.000 L 10.000 12.000M 13.000 12.000 L 19.000 12.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 15.000 8.000 L 19.000 12.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
