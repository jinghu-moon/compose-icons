        ...
        _squareScissors = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(9.328427f, 7.0f, 10.0f, 7.671573f, 10.0f, 8.5f),
                    PathNode.Close
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(9.56066f, 9.56066f),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(10.0f, 16.328426f, 9.328427f, 17.0f, 8.5f, 17.0f),
                    PathNode.CurveTo(7.671573f, 17.0f, 7.0f, 16.328426f, 7.0f, 15.5f),
                    PathNode.CurveTo(7.0f, 14.671573f, 7.671573f, 14.0f, 8.5f, 14.0f),
                    PathNode.CurveTo(9.328427f, 14.0f, 10.0f, 14.671573f, 10.0f, 15.5f),
                    PathNode.Close
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(9.56066f, 14.43934f),
