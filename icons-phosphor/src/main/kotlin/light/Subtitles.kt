        ...
        _subtitles = phosphorLightIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(158.0f, 168.0f),
                    PathNode.CurveTo(158.0f, 171.3137f, 155.3137f, 174.0f, 152.0f, 174.0f),
                    PathNode.LineTo(56.0f, 174.0f),
                    PathNode.CurveTo(52.68629f, 174.0f, 50.0f, 171.3137f, 50.0f, 168.0f),
                    PathNode.CurveTo(50.0f, 164.6863f, 52.68629f, 162.0f, 56.0f, 162.0f),
                    PathNode.LineTo(152.0f, 162.0f),
                    PathNode.CurveTo(155.3137f, 162.0f, 158.0f, 164.6863f, 158.0f, 168.0f),
                    PathNode.Close,
                    ...
                    PathNode.CurveTo(180.6863f, 174.0f, 178.0f, 171.3137f, 178.0f, 168.0f),
                    PathNode.CurveTo(178.0f, 164.6863f, 180.6863f, 162.0f, 184.0f, 162.0f),
