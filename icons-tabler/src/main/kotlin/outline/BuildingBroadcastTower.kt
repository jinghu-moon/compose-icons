...
val TablerIcons.Outline.BuildingBroadcastTower: ImageVector
    get() {
        ...
        _buildingBroadcastTower = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 16.616 13.924 C 17.488 11.833 16.844 9.416 15.048 8.036 C 13.251 6.655 10.751 6.655 8.954 8.036 C 7.158 9.416 6.514 11.833 7.386 13.924"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 20.307 15.469 C 21.876 11.705 20.717 7.356 17.483 4.871 C 14.250 2.386 9.749 2.386 6.516 4.871 C 3.282 7.356 2.123 11.705 3.692 15.469"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 9.000 21.000 L 12.000 12.000 L 15.000 21.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
