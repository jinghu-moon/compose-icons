...
val TablerIcons.Outline.HeartPin: ImageVector
    get() {
        ...
        _heartPin = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 20.000 L 4.500 12.572 C 3.151 11.260 2.654 9.301 3.212 7.504 C 3.771 5.707 5.292 4.376 7.147 4.060 C 9.002 3.743 10.877 4.496 12.000 6.006 C 13.545 3.946 16.402 3.397 18.601 4.737 C 20.800 6.077 21.622 8.867 20.500 11.185"),
