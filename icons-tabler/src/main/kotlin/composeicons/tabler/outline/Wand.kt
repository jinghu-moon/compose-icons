        ...
        _wand = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(9.895431f, 5.0f, 9.0f, 5.895431f, 9.0f, 7.0f),
                    PathNode.CurveTo(9.0f, 5.895431f, 8.10457f, 5.0f, 7.0f, 5.0f),
                    PathNode.CurveTo(8.10457f, 5.0f, 9.0f, 4.10457f, 9.0f, 3.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(19.89543f, 15.0f, 19.0f, 15.895431f, 19.0f, 17.0f),
                    PathNode.CurveTo(19.0f, 15.895431f, 18.10457f, 15.0f, 17.0f, 15.0f),
                    PathNode.CurveTo(18.10457f, 15.0f, 19.0f, 14.104569f, 19.0f, 13.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
