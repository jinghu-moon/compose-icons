...
val PhosphorIcons.Duotone.PiggyBank: ImageVector
    get() {
        ...
        _piggyBank = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M240 112v32c0 8.837-7.163 16-16 16h-8l-18.1 50.69c-1.138 3.186-4.157 5.312-7.54 5.31h-12.72c-3.383 .002-6.402-2.124-7.54-5.31L166.29 200h-68.58l-3.81 10.69c-1.138 3.186-4.157 5.312-7.54 5.31h-12.72c-3.383 .002-6.402-2.124-7.54-5.31L53 174C39.473 159.272 31.978 139.997 32 120h0C32 75.817 67.817 40 112 40h32c31.905-.009 60.766 18.94 73.44 48.22 1.097 2.543 2.065 5.139 2.9 7.78h3.66c8.837 0 16 7.163 16 16Z"),
