        ...
        _wholeWord = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(10.0f, 13.656855f, 8.656855f, 15.0f, 7.0f, 15.0f),
                    PathNode.CurveTo(5.343146f, 15.0f, 4.0f, 13.656855f, 4.0f, 12.0f),
                    PathNode.CurveTo(4.0f, 10.343145f, 5.343146f, 9.0f, 7.0f, 9.0f),
                    PathNode.CurveTo(8.656855f, 9.0f, 10.0f, 10.343145f, 10.0f, 12.0f),
                    PathNode.Close
                ),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(20.0f, 13.656855f, 18.656855f, 15.0f, 17.0f, 15.0f),
                    PathNode.CurveTo(15.343145f, 15.0f, 14.0f, 13.656855f, 14.0f, 12.0f),
                    PathNode.CurveTo(14.0f, 10.343145f, 15.343145f, 9.0f, 17.0f, 9.0f),
                    PathNode.CurveTo(18.656855f, 9.0f, 20.0f, 10.343145f, 20.0f, 12.0f),
                    PathNode.Close
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
