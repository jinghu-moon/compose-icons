...
val RemixIcons.Line.CalendarEventLine: ImageVector
    get() {
        ...
        _calendarEventLine = remixIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M9 1v2h6v-2h2v2h4c.552 0 1 .448 1 1v16c0 .552-.448 1-1 1h-18C2.448 21 2 20.552 2 20v-16C2 3.448 2.448 3 3 3h4v-2h2ZM20 11h-16v8h16v-8ZM11 13v4h-5v-4h5ZM7 5h-3v4h16v-4h-3v2h-2v-2h-6v2h-2v-2Z"),
