...
val TablerIcons.Outline.CameraSearch: ImageVector
    get() {
        ...
        _cameraSearch = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(14.757f, 11.815f),
                    PathNode.CurveTo(14.197784f, 10.515708f, 12.806958f, 9.78357f, 11.419314f, 10.058025f),
                    PathNode.CurveTo(10.03167f, 10.33248f, 9.024272f, 11.538951f, 9.001773f, 12.953298f),
                    PathNode.CurveTo(8.979274f, 14.367644f, 9.947787f, 15.605546f, 11.326f, 15.924f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
