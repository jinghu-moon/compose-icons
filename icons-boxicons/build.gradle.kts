...
android {
    namespace = "composeicons.boxicons"
    compileSdk = 36
...
mavenPublishing {
    ...
    pom {
        name.set("icons-boxicons")
        description.set("Boxicons for Jetpack Compose - generated via svg2compose pipeline")
