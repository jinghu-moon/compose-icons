...
val LucideIcons.Outline.FileCog: ImageVector
    get() {
        ...
        _fileCog = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(3.305f, 19.53f),
                    PathNode.LineTo(4.228f, 19.148f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(4.228f, 16.852f),
                    PathNode.LineTo(3.304f, 16.469f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(5.852f, 15.228f),
                    PathNode.LineTo(5.469f, 14.305f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(5.852f, 20.772f),
                    PathNode.LineTo(5.469f, 21.696f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(8.148f, 15.228f),
                    PathNode.LineTo(8.531f, 14.305f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(8.53f, 21.696f),
                    PathNode.LineTo(8.148f, 20.772f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(9.773f, 16.852f),
                    PathNode.LineTo(10.695f, 16.469f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(9.773f, 19.148f),
                    PathNode.LineTo(10.695f, 19.531f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
