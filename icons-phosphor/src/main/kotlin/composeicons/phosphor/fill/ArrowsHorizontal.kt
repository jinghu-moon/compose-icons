...
val PhosphorIcons.Fill.ArrowsHorizontal: ImageVector
    get() {
        ...
        _arrowsHorizontal = phosphorFillIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M237.66 133.66l-32 32c-2.288 2.291-5.731 2.976-8.722 1.737C193.947 166.158 191.997 163.238 192 160v-24h-128v24c.003 3.238-1.947 6.158-4.938 7.397-2.991 1.239-6.434 .554-8.722-1.737l-32-32C16.838 132.159 15.994 130.123 15.994 128c0-2.123 .844-4.159 2.346-5.66l32-32c2.288-2.291 5.731-2.976 8.722-1.737C62.053 89.842 64.003 92.762 64 96v24h128v-24c-.003-3.238 1.947-6.158 4.938-7.397 2.991-1.239 6.434-.554 8.722 1.737l32 32c1.502 1.501 2.346 3.537 2.346 5.66 0 2.123-.844 4.159-2.346 5.66Z"),
