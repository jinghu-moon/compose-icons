        ...
        _subway = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(68.65378f, 32.0f, 40.0f, 60.653774f, 40.0f, 96.0f),
                    PathNode.LineTo(40.0f, 208.0f),
                    PathNode.LineTo(216.0f, 208.0f),
                    PathNode.LineTo(216.0f, 96.0f),
                    PathNode.CurveTo(216.0f, 60.653774f, 187.34622f, 32.0f, 152.0f, 32.0f),
                    PathNode.Close,
                    PathNode.MoveTo(176.0f, 168.0f),
                    PathNode.CurveTo(176.0f, 176.83656f, 168.83656f, 184.0f, 160.0f, 184.0f),
                    PathNode.LineTo(96.0f, 184.0f),
                    PathNode.CurveTo(87.163445f, 184.0f, 80.0f, 176.83656f, 80.0f, 168.0f),
