...
val PhosphorIcons.Thin.Export: ImageVector
    get() {
        ...
        _export = phosphorThinIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M212 112v96c0 6.627-5.373 12-12 12h-144c-6.627 0-12-5.373-12-12v-96c0-6.627 5.373-12 12-12h24c2.209 0 4 1.791 4 4 0 2.209-1.791 4-4 4h-24c-2.209 0-4 1.791-4 4v96c0 2.209 1.791 4 4 4h144c2.209 0 4-1.791 4-4v-96c0-2.209-1.791-4-4-4h-24c-2.209 0-4-1.791-4-4 0-2.209 1.791-4 4-4h24c6.627 0 12 5.373 12 12ZM90.83 66.83 124 33.66v102.34c0 2.209 1.791 4 4 4 2.209 0 4-1.791 4-4v-102.34l33.17 33.17c1.563 1.563 4.097 1.563 5.66 0 1.563-1.563 1.563-4.097 0-5.66l-40-40c-.75-.751-1.768-1.173-2.83-1.173-1.062 0-2.08 .422-2.83 1.173l-40 40c-1.563 1.563-1.563 4.097 0 5.66 1.563 1.563 4.097 1.563 5.66 0Z"),
