...
val LucideIcons.Outline.ListOrdered: ImageVector
    get() {
        ...
        _listOrdered = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(6.5f, 20.0f),
                    PathNode.LineTo(3.4f, 20.0f),
                    PathNode.CurveTo(3.4f, 19.0f, 6.0f, 18.075f, 6.0f, 16.5f),
                    PathNode.CurveTo(6.000081f, 15.882933f, 5.622258f, 15.328774f, 5.047814f, 15.103415f),
                    PathNode.CurveTo(4.47337f, 14.878057f, 3.819525f, 15.027484f, 3.4f, 15.48f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
