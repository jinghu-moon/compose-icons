        ...
        _fileLock = phosphorThinIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(108.0f, 158.74516f, 97.25484f, 148.0f, 84.0f, 148.0f),
                    PathNode.CurveTo(70.74516f, 148.0f, 60.0f, 158.74516f, 60.0f, 172.0f),
                    PathNode.LineTo(60.0f, 180.0f),
                    PathNode.LineTo(48.0f, 180.0f),
                    PathNode.CurveTo(45.79086f, 180.0f, 44.0f, 181.79086f, 44.0f, 184.0f),
                    ...
                    PathNode.CurveTo(124.0f, 181.79086f, 122.20914f, 180.0f, 120.0f, 180.0f),
                    PathNode.Close,
                    PathNode.MoveTo(68.0f, 172.0f),
                    PathNode.CurveTo(68.0f, 163.16344f, 75.163445f, 156.0f, 84.0f, 156.0f),
                    PathNode.CurveTo(92.836555f, 156.0f, 100.0f, 163.16344f, 100.0f, 172.0f),
                    PathNode.LineTo(100.0f, 180.0f),
                    PathNode.LineTo(68.0f, 180.0f),
                    PathNode.Close,
                    PathNode.MoveTo(116.0f, 220.0f),
                    ...
                    PathNode.CurveTo(157.79086f, 220.0f, 156.0f, 221.79086f, 156.0f, 224.0f),
                    PathNode.CurveTo(156.0f, 226.20914f, 157.79086f, 228.0f, 160.0f, 228.0f),
