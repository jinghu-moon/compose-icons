...
val TablerIcons.Outline.TextPlus: ImageVector
    get() {
        ...
        _textPlus = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 19.000 10.000 L 5.000 10.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 5.000 6.000 L 19.000 6.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 14.000 14.000 L 5.000 14.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 5.000 18.000 L 11.000 18.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
