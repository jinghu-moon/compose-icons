...
val PhosphorIcons.Duotone.Aperture: ImageVector
    get() {
        ...
        _aperture = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M195.88 60.12C168.425 32.663 127.133 24.448 91.259 39.307 55.386 54.166 31.995 89.171 31.995 128c0 38.829 23.39 73.834 59.264 88.693 35.874 14.859 77.165 6.644 104.621-20.813 37.487-37.49 37.487-98.27 0-135.76ZM140.54 163.12h0l-36.68-6.69h0L91.32 121.3 115.46 92.89h0l36.68 6.69 12.54 35.12Z"),
