...
val TablerIcons.Outline.FileTypeSql: ImageVector
    get() {
        ...
        _fileTypeSql = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(5.0f, 20.25f),
                    PathNode.CurveTo(5.0f, 20.664f, 5.336f, 21.0f, 5.75f, 21.0f),
                    PathNode.LineTo(7.0f, 21.0f),
                    PathNode.CurveTo(7.552285f, 21.0f, 8.0f, 20.552284f, 8.0f, 20.0f),
                    PathNode.LineTo(8.0f, 19.0f),
                    PathNode.CurveTo(8.0f, 18.447716f, 7.552285f, 18.0f, 7.0f, 18.0f),
                    PathNode.LineTo(6.0f, 18.0f),
                    PathNode.CurveTo(5.447716f, 18.0f, 5.0f, 17.552284f, 5.0f, 17.0f),
                    PathNode.LineTo(5.0f, 16.0f),
                    PathNode.CurveTo(5.0f, 15.447715f, 5.447716f, 15.0f, 6.0f, 15.0f),
                    PathNode.LineTo(7.25f, 15.0f),
                    PathNode.CurveTo(7.664214f, 15.0f, 8.0f, 15.335787f, 8.0f, 15.75f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(15.0f, 20.10457f, 14.104569f, 21.0f, 13.0f, 21.0f),
                    PathNode.CurveTo(11.895431f, 21.0f, 11.0f, 20.10457f, 11.0f, 19.0f),
                    PathNode.LineTo(11.0f, 17.0f),
                    PathNode.CurveTo(11.0f, 15.895431f, 11.895431f, 15.0f, 13.0f, 15.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
