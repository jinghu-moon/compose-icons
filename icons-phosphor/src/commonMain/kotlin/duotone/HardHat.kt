...
val PhosphorIcons.Duotone.HardHat: ImageVector
    get() {
        ...
        _hardHat = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(104.0f, 51.31f),
                    PathNode.LineTo(104.0f, 160.0f),
                    PathNode.LineTo(40.0f, 160.0f),
                    PathNode.LineTo(40.0f, 136.0f),
                    PathNode.CurveTo(39.988388f, 96.63246f, 66.12483f, 62.0466f, 104.0f, 51.31f),
                    PathNode.Close,
                    PathNode.MoveTo(152.0f, 51.31f),
                    PathNode.LineTo(152.0f, 160.0f),
                    PathNode.LineTo(216.0f, 160.0f),
                    PathNode.LineTo(216.0f, 136.0f),
                    PathNode.CurveTo(216.01161f, 96.63246f, 189.87517f, 62.0466f, 152.0f, 51.31f),
                    PathNode.Close
                ),
