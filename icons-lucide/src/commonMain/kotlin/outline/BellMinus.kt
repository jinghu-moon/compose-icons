...
val LucideIcons.Outline.BellMinus: ImageVector
    get() {
        ...
        _bellMinus = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(16.243f, 3.757f),
                    PathNode.CurveTo(14.526999f, 2.040709f, 11.946038f, 1.527234f, 9.703802f, 2.456045f),
                    PathNode.CurveTo(7.461566f, 3.384855f, 5.999709f, 5.573004f, 6.0f, 8.0f),
                    ...
                    PathNode.CurveTo(19.822872f, 14.376004f, 19.116514f, 13.242358f, 18.667f, 12.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
