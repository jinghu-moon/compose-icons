...
val TablerIcons.Outline.PinnedOff: ImageVector
    get() {
        ...
        _pinnedOff = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(15.0f, 4.5f),
                    PathNode.LineTo(11.751f, 7.749f),
                    PathNode.MoveTo(9.181f, 9.182f),
                    PathNode.LineTo(7.0f, 10.0f),
                    PathNode.LineTo(5.5f, 11.5f),
                    PathNode.LineTo(12.5f, 18.5f),
                    PathNode.LineTo(14.0f, 17.0f),
                    PathNode.LineTo(14.82f, 14.814f),
                    PathNode.MoveTo(16.25f, 12.251f),
