...
val TablerIcons.Outline.ReceiptBitcoin: ImageVector
    get() {
        ...
        _receiptBitcoin = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 9.000 7.000 L 13.090 7.000 C 14.145 7.000 15.000 7.895 15.000 9.000 C 15.000 10.105 14.145 11.000 13.090 11.000 C 14.145 11.000 15.000 11.895 15.000 13.000 C 15.000 14.105 14.145 15.000 13.090 15.000 L 9.000 15.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 10.000 6.000 L 10.000 16.000 L 10.000 7.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 13.000 6.000 L 13.000 7.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 13.000 15.000 L 13.000 16.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
