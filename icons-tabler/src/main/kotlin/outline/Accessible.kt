...
val TablerIcons.Outline.Accessible: ImageVector
    get() {
        if (_accessible != null) return _accessible!!
        _accessible = tablerOutlineIcon(
            name = "Accessible",
            ...
            addPath(
                pathData = parseSvgPathData("M 10.000 16.500 L 12.000 13.500 L 14.000 16.500M 12.000 13.500 L 12.000 11.500 L 15.000 10.500M 9.000 10.500 L 12.000 11.500"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
