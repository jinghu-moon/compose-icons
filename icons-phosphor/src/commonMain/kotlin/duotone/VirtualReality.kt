        ...
        _virtualReality = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(248.0f, 167.7645f, 215.7645f, 200.0f, 176.0f, 200.0f),
                    PathNode.LineTo(80.0f, 200.0f),
                    PathNode.CurveTo(40.235497f, 200.0f, 8.0f, 167.7645f, 8.0f, 128.0f),
                    PathNode.LineTo(8.0f, 128.0f),
                    PathNode.CurveTo(8.0f, 88.2355f, 40.235497f, 56.0f, 80.0f, 56.0f),
                    PathNode.LineTo(176.0f, 56.0f),
                    PathNode.CurveTo(215.7645f, 56.0f, 248.0f, 88.2355f, 248.0f, 128.0f),
                    PathNode.Close
                ),
