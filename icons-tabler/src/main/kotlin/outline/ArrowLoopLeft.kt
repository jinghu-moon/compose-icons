...
val TablerIcons.Outline.ArrowLoopLeft: ImageVector
    get() {
        ...
        _arrowLoopLeft = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 13.000 21.000 L 13.000 8.000 C 13.000 5.791 14.791 4.000 17.000 4.000 C 19.209 4.000 21.000 5.791 21.000 8.000 C 21.000 10.209 19.209 12.000 17.000 12.000 L 4.000 12.000"),
