...
val TablerIcons.Outline.PointerStar: ImageVector
    get() {
        ...
        _pointerStar = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 17.891 10.132 C 18.332 9.894 18.579 9.407 18.511 8.911 C 18.442 8.414 18.071 8.013 17.582 7.904 L 4.000 4.000 L 7.904 17.563 C 8.013 18.052 8.414 18.422 8.911 18.491 C 9.408 18.560 9.894 18.312 10.132 17.871"),
