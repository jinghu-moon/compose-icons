...
val TablerIcons.Outline.Scoreboard: ImageVector
    get() {
        ...
        _scoreboard = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(15.0f, 10.5f),
                    PathNode.LineTo(15.0f, 13.5f),
                    PathNode.CurveTo(15.0f, 14.328427f, 15.671573f, 15.0f, 16.5f, 15.0f),
                    PathNode.CurveTo(17.328426f, 15.0f, 18.0f, 14.328427f, 18.0f, 13.5f),
                    PathNode.LineTo(18.0f, 10.5f),
                    PathNode.CurveTo(18.0f, 9.671573f, 17.328426f, 9.0f, 16.5f, 9.0f),
                    PathNode.CurveTo(15.671573f, 9.0f, 15.0f, 9.671573f, 15.0f, 10.5f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(8.328428f, 9.0f, 9.0f, 9.671573f, 9.0f, 10.5f),
                    PathNode.CurveTo(9.0f, 11.328427f, 8.328428f, 12.0f, 7.5f, 12.0f),
