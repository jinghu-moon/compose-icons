...
val PhosphorIcons.Duotone.CodesandboxLogo: ImageVector
    get() {
        ...
        _codesandboxLogo = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M32 125.73 80 152v54.84l-43.84-24c-2.559-1.4-4.153-4.083-4.16-7ZM176 152v54.84l43.84-24c2.559-1.4 4.153-4.083 4.16-7v-50.1ZM124.16 25l-41 22.46h0L128 72 172.86 47.44 131.84 25c-2.393-1.309-5.287-1.309-7.68 0Z"),
