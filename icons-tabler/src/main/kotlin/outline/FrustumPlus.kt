...
val TablerIcons.Outline.FrustumPlus: ImageVector
    get() {
        ...
        _frustumPlus = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 12.841 21.309 C 12.309 21.564 11.691 21.564 11.159 21.309 L 4.124 17.944 C 3.274 17.533 2.829 16.582 3.060 15.666 L 5.598 5.508 C 5.745 4.918 6.154 4.429 6.708 4.180 L 11.204 2.170 C 11.710 1.944 12.288 1.944 12.794 2.170 L 17.290 4.180 C 17.844 4.426 18.253 4.916 18.402 5.508 L 20.072 12.191"),
