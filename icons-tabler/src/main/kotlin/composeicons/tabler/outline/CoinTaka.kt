...
val TablerIcons.Outline.CoinTaka: ImageVector
    get() {
        if (_coinTaka != null) return _coinTaka!!
        _coinTaka = tablerOutlineIcon(
            name = "CoinTaka",
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(8.553f, 7.724f),
                    PathNode.CurveTo(8.862903f, 7.569142f, 9.230879f, 7.585715f, 9.525605f, 7.767806f),
                    PathNode.CurveTo(9.820333f, 7.949897f, 9.999815f, 8.27156f, 10.0f, 8.618f),
                    PathNode.LineTo(10.0f, 15.0f),
                    PathNode.CurveTo(10.0f, 16.10457f, 10.895431f, 17.0f, 12.0f, 17.0f),
                    PathNode.LineTo(12.5f, 17.0f),
                    PathNode.CurveTo(13.880712f, 17.0f, 15.0f, 15.880712f, 15.0f, 14.5f),
