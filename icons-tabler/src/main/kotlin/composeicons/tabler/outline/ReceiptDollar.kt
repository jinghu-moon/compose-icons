...
val TablerIcons.Outline.ReceiptDollar: ImageVector
    get() {
        ...
        _receiptDollar = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(14.8f, 8.0f),
                    PathNode.CurveTo(14.430867f, 7.359678f, 13.738684f, 6.975131f, 13.0f, 7.0f),
                    PathNode.LineTo(11.0f, 7.0f),
                    PathNode.CurveTo(9.895431f, 7.0f, 9.0f, 7.895431f, 9.0f, 9.0f),
                    PathNode.CurveTo(9.0f, 10.104569f, 9.895431f, 11.0f, 11.0f, 11.0f),
                    PathNode.LineTo(13.0f, 11.0f),
                    PathNode.CurveTo(14.104569f, 11.0f, 15.0f, 11.895431f, 15.0f, 13.0f),
                    PathNode.CurveTo(15.0f, 14.104569f, 14.104569f, 15.0f, 13.0f, 15.0f),
                    PathNode.LineTo(11.0f, 15.0f),
                    PathNode.CurveTo(10.261316f, 15.024869f, 9.569133f, 14.640323f, 9.2f, 14.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
