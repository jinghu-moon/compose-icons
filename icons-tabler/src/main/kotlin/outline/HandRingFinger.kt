...
val TablerIcons.Outline.HandRingFinger: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 14.000 12.000 L 14.000 5.500 C 14.000 4.672 14.672 4.000 15.500 4.000 C 16.328 4.000 17.000 4.672 17.000 5.500 L 17.000 12.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
