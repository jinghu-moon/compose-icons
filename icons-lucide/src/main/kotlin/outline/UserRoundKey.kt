...
val LucideIcons.Outline.UserRoundKey: ImageVector
    get() {
        ...
        _userRoundKey = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 19.000 11.000 L 19.000 17.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 19.000 13.000 L 21.000 13.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 2.000 21.000 C 2.000 17.954 3.729 15.173 6.460 13.825 C 9.192 12.478 12.451 12.798 14.868 14.651"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
