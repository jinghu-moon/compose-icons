...
val TablerIcons.Outline.Brightness: ImageVector
    get() {
        ...
        _brightness = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 9.000 L 16.650 4.350"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 14.300 L 19.370 6.930"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 19.600 L 20.850 10.750"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
