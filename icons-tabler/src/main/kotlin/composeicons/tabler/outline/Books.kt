...
val TablerIcons.Outline.Books: ImageVector
    get() {
        ...
        _books = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(13.803f, 4.56f),
                    PathNode.LineTo(15.987f, 4.03f),
                    PathNode.CurveTo(16.549f, 3.895f, 17.12f, 4.22f, 17.269f, 4.762f),
                    PathNode.LineTo(20.964f, 18.18f),
                    PathNode.CurveTo(21.099092f, 18.68908f, 20.824366f, 19.2173f, 20.33f, 19.399f),
                    PathNode.LineTo(20.197f, 19.44f),
                    PathNode.LineTo(18.013f, 19.97f),
                    PathNode.CurveTo(17.451f, 20.105f, 16.88f, 19.78f, 16.731f, 19.238f),
                    PathNode.LineTo(13.036f, 5.82f),
                    PathNode.CurveTo(12.900908f, 5.310921f, 13.175635f, 4.7827f, 13.67f, 4.601f),
                    PathNode.LineTo(13.803f, 4.56f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(19.923f, 15.02f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
