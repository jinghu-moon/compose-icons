...
val TablerIcons.Outline.DeviceTabletX: ImageVector
    get() {
        if (_deviceTabletX != null) return _deviceTabletX!!
        _deviceTabletX = tablerOutlineIcon(
            name = "DeviceTabletX",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24.0f, height = 24.0f),
        ) {
    addPath(
        pathData = parseSvgPathData("M 13.000 21.000 L 6.000 21.000 C 5.448 21.000 5.000 20.552 5.000 20.000 L 5.000 4.000 C 5.000 3.448 5.448 3.000 6.000 3.000 L 18.000 3.000 C 18.552 3.000 19.000 3.448 19.000 4.000 L 19.000 13.500"),
