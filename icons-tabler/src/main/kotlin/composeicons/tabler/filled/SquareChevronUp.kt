...
val TablerIcons.Filled.SquareChevronUp: ImageVector
    get() {
        ...
        _squareChevronUp = tablerFilledIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M19 2c1.657 0 3 1.343 3 3v14c0 1.657-1.343 3-3 3h-14C3.343 22 2 20.657 2 19v-14C2 3.343 3.343 2 5 2ZM12.613 9.21c-.398-.309-.964-.273-1.32 .083l-3 3-.083 .094c-.309 .398-.273 .964 .083 1.32l.094 .083c.398 .309 .964 .273 1.32-.083L12 11.415l2.293 2.292 .094 .083c.417 .323 1.013 .266 1.362-.13 .349-.395 .33-.994-.042-1.367l-3-3Z"),
