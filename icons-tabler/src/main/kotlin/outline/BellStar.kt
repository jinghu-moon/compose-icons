...
val TablerIcons.Outline.BellStar: ImageVector
    get() {
        ...
        _bellStar = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 9.500 17.000 L 4.000 17.000 C 5.105 16.374 5.847 15.261 6.000 14.000 L 6.000 11.000 C 6.121 8.414 7.660 6.107 10.000 5.000 C 10.000 3.895 10.895 3.000 12.000 3.000 C 13.105 3.000 14.000 3.895 14.000 5.000 C 16.016 5.953 17.457 7.810 17.880 10.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 9.000 17.000 L 9.000 18.000 C 9.000 19.330 9.875 20.501 11.150 20.878"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
