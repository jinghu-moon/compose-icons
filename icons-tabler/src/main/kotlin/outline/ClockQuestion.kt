...
val TablerIcons.Outline.ClockQuestion: ImageVector
    get() {
        ...
        _clockQuestion = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 20.975 11.330 C 20.686 7.457 17.944 4.206 14.176 3.267 C 10.407 2.328 6.461 3.913 4.389 7.198 C 2.316 10.482 2.584 14.726 5.054 17.723 C 7.524 20.721 11.638 21.796 15.258 20.390"),
