...
val TablerIcons.Outline.MoodSad2: ImageVector
    get() {
        ...
        _moodSad2 = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(14.5f, 16.05f),
                    PathNode.CurveTo(13.841689f, 15.378114f, 12.94064f, 14.99949f, 12.0f, 14.99949f),
                    PathNode.CurveTo(11.05936f, 14.99949f, 10.158311f, 15.378114f, 9.5f, 16.05f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(10.0f, 9.25f),
                    PathNode.CurveTo(9.5f, 10.25f, 7.5f, 10.25f, 7.0f, 9.25f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(17.0f, 9.25f),
                    PathNode.CurveTo(16.5f, 10.25f, 14.5f, 10.25f, 14.0f, 9.25f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
