...
val LucideIcons.Outline.MessageSquareReply: ImageVector
    get() {
        if (_messageSquareReply != null) return _messageSquareReply!!
        _messageSquareReply = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 17.000 14.000 L 17.000 13.000 C 17.000 11.895 16.105 11.000 15.000 11.000 L 7.000 11.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
