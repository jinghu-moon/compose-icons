...
val LucideIcons.Outline.BadgeIndianRupee: ImageVector
    get() {
        if (_badgeIndianRupee != null) return _badgeIndianRupee!!
        _badgeIndianRupee = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 13.000 17.000 L 8.000 16.000 L 9.000 16.000 C 11.209 16.000 13.000 14.209 13.000 12.000 C 13.000 9.791 11.209 8.000 9.000 8.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
