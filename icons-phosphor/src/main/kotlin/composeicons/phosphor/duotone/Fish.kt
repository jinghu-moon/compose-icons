...
val PhosphorIcons.Duotone.Fish: ImageVector
    get() {
        ...
        _fish = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M185.81 167.62c-18 13.9-44.17 23.41-81.68 24.31L80.09 248l-16-56.07L8 175.87l56.07-24C64.97 114.38 74.48 88.26 88.38 70.22c-1.762 13.297 2.637 26.672 11.949 36.327 9.312 9.655 22.519 14.534 35.871 13.253-1.283 13.358 3.601 26.571 13.263 35.884 9.662 9.313 23.045 13.708 36.347 11.936Z"),
