...
val TablerIcons.Outline.ZoomCancel: ImageVector
    get() {
        if (_zoomCancel != null) return _zoomCancel!!
        _zoomCancel = tablerOutlineIcon(
            name = "ZoomCancel",
    ...
    addPath(
        pathData = parseSvgPathData("M 8.000 8.000 L 12.000 12.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 12.000 8.000 L 8.000 12.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
