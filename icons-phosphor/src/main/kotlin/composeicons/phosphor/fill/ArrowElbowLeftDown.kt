...
val PhosphorIcons.Fill.ArrowElbowLeftDown: ImageVector
    get() {
        ...
        _arrowElbowLeftDown = phosphorFillIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M240 72c0 4.418-3.582 8-8 8h-136v80h40c3.238-.003 6.158 1.947 7.397 4.938 1.239 2.991 .554 6.434-1.737 8.722l-48 48c-1.501 1.502-3.537 2.346-5.66 2.346-2.123 0-4.159-.844-5.66-2.346l-48-48c-2.291-2.288-2.976-5.731-1.737-8.722C33.842 161.947 36.762 159.997 40 160h40v-88c0-4.418 3.582-8 8-8h144c4.418 0 8 3.582 8 8Z"),
