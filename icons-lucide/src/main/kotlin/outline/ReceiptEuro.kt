...
val LucideIcons.Outline.ReceiptEuro: ImageVector
    get() {
        ...
        _receiptEuro = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 15.828 14.829 C 14.266 16.391 11.734 16.391 10.172 14.829 C 9.422 14.079 9.000 13.061 9.000 12.000 C 9.000 10.940 9.422 9.922 10.172 9.172 C 11.734 7.610 14.266 7.610 15.828 9.172"),
            ...
            addPath(
                pathData = parseSvgPathData("M 8.000 12.000 L 13.000 12.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
