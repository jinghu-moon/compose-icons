        ...
        _fileRss = tablerFilledIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(10.046625f, 14.999669f, 10.916503f, 15.806323f, 10.995f, 16.85f),
                    ...
                    PathNode.CurveTo(13.0f, 14.790861f, 11.209139f, 13.0f, 9.0f, 13.0f),
                    ...
                    PathNode.CurveTo(11.761424f, 12.0f, 14.0f, 14.238576f, 14.0f, 17.0f),
                    PathNode.CurveTo(14.0f, 17.552284f, 14.447715f, 18.0f, 15.0f, 18.0f),
                    PathNode.CurveTo(15.552285f, 18.0f, 16.0f, 17.552284f, 16.0f, 17.0f),
                    PathNode.CurveTo(16.0f, 13.134007f, 12.865993f, 10.0f, 9.0f, 10.0f),
                    PathNode.MoveTo(9.01f, 16.0f),
                    PathNode.LineTo(9.0f, 16.0f),
                    PathNode.CurveTo(8.470906f, 16.000587f, 8.033836f, 16.41321f, 8.002828f, 16.941395f),
                    PathNode.CurveTo(7.971821f, 17.46958f, 8.35761f, 17.93051f, 8.883f, 17.993f),
                    PathNode.LineTo(9.01f, 18.0f),
                    PathNode.CurveTo(9.562284f, 18.0f, 10.01f, 17.552284f, 10.01f, 17.0f),
                    PathNode.CurveTo(10.01f, 16.447716f, 9.562284f, 16.0f, 9.01f, 16.0f),
