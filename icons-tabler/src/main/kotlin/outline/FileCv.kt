...
val TablerIcons.Outline.FileCv: ImageVector
    get() {
        ...
        _fileCv = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 11.000 12.500 C 11.000 11.672 10.328 11.000 9.500 11.000 C 8.672 11.000 8.000 11.672 8.000 12.500 L 8.000 15.500 C 8.000 16.328 8.672 17.000 9.500 17.000 C 10.328 17.000 11.000 16.328 11.000 15.500"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 13.000 11.000 L 14.500 17.000 L 16.000 11.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
