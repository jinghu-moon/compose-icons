        ...
        _arrowWaveLeftUp = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(20.113f, 10.715f, 18.52f, 9.967f, 17.0f, 10.0f),
                    PathNode.CurveTo(15.48f, 9.967f, 13.887f, 10.715f, 13.0f, 12.0f),
                    PathNode.CurveTo(12.113f, 13.284f, 10.52f, 14.033f, 9.0f, 14.0f),
                    PathNode.CurveTo(7.48f, 14.033f, 6.0f, 13.0f, 5.0f, 12.0f),
                    PathNode.LineTo(3.0f, 10.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
