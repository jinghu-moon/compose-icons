...
val LucideIcons.Outline.FileType: ImageVector
    get() {
        if (_fileType != null) return _fileType!!
        _fileType = lucideOutlineIcon(
            name = "FileType",
    ...
    addPath(
        pathData = parseSvgPathData("M 9.000 13.000 L 9.000 12.500 C 9.000 12.224 9.224 12.000 9.500 12.000 L 14.500 12.000 C 14.776 12.000 15.000 12.224 15.000 12.500 L 15.000 13.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
