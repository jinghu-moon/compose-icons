...
val TablerIcons.Outline.DropletCancel: ImageVector
    get() {
        ...
        _dropletCancel = tablerOutlineIcon(
            ...
            addPathData("M18.606 12.014c-.144-.395-.326-.776-.542-1.137L13.174 3.617c-.42-.625-1.287-.803-1.936-.397-.163 .102-.303 .237-.41 .397L5.935 10.877c-1.695 2.838-1.035 6.441 1.567 8.546 1.362 1.096 3.079 1.655 4.826 1.572")
