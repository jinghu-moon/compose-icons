...
val PhosphorIcons.Duotone.Wine: ImageVector
    get() {
        ...
        _wine = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(182.48f, 162.5f),
                    PathNode.CurveTo(151.81189f, 191.19402f, 104.1481f, 191.19402f, 73.48f, 162.5f),
                    PathNode.CurveTo(58.14712f, 148.02065f, 52.275757f, 126.140335f, 58.3f, 105.93f),
                    PathNode.LineTo(59.87f, 100.62f),
                    PathNode.LineTo(59.87f, 100.62f),
                    PathNode.CurveTo(72.49f, 95.21f, 95.2f, 91.4f, 128.0f, 108.0f),
                    PathNode.CurveTo(163.86f, 126.16f, 187.67f, 119.89f, 199.42f, 113.84f),
                    PathNode.LineTo(199.42f, 113.84f),
                    PathNode.CurveTo(202.06212f, 131.85345f, 195.73726f, 150.02159f, 182.48f, 162.5f),
                    PathNode.Close
                ),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(177.0f, 156.65f),
                    PathNode.CurveTo(149.43263f, 182.46298f, 106.56735f, 182.46298f, 79.0f, 156.65f),
                    PathNode.CurveTo(65.803535f, 144.28334f, 60.764973f, 125.50114f, 66.0f, 108.19f),
                    PathNode.LineTo(66.45f, 106.67f),
                    PathNode.CurveTo(78.45f, 102.61f, 97.52f, 101.53f, 124.38f, 115.14f),
                    PathNode.CurveTo(135.53f, 120.79f, 153.54f, 127.99f, 172.81f, 127.99f),
                    PathNode.CurveTo(179.25053f, 128.02138f, 185.66344f, 127.14612f, 191.86f, 125.39f),
                    PathNode.CurveTo(191.04376f, 137.31575f, 185.73302f, 148.48763f, 177.0f, 156.65f),
                    PathNode.Close
                ),
                pathFillType = PathFillType.NonZero,
                fill = SolidColor(Color.Black),
