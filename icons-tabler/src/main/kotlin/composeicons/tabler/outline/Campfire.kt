        ...
        _campfire = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(14.209139f, 15.0f, 16.0f, 13.209139f, 16.0f, 11.0f),
                    PathNode.CurveTo(16.0f, 8.0f, 14.0f, 8.0f, 14.0f, 3.0f),
                    PathNode.CurveTo(10.0f, 5.0f, 8.0f, 8.0f, 8.0f, 11.0f),
                    PathNode.CurveTo(8.0f, 13.209139f, 9.790861f, 15.0f, 12.0f, 15.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
