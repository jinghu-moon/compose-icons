...
val TablerIcons.Outline.Filter2Question: ImageVector
    get() {
        ...
        _filter2Question = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 6.000 12.000 L 16.500 12.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 19.000 19.000 C 19.448 18.999 19.883 18.847 20.235 18.569 C 20.587 18.291 20.835 17.903 20.941 17.468 C 21.046 17.032 21.002 16.574 20.816 16.166 C 20.630 15.758 20.312 15.424 19.914 15.218 C 19.516 15.014 19.061 14.951 18.623 15.039 C 18.185 15.127 17.789 15.360 17.500 15.701"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
