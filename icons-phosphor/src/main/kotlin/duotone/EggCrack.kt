...
val PhosphorIcons.Duotone.EggCrack: ImageVector
    get() {
        if (_eggCrack != null) return _eggCrack!!
        _eggCrack = phosphorDuotoneIcon(
            name = "EggCrack",
    ...
    group(
        ...
        addPath(
            pathData = parseSvgPathData("M 208.000 152.000 C 208.000 196.183 172.183 232.000 128.000 232.000 C 83.817 232.000 48.000 196.183 48.000 152.000 C 48.000 88.000 96.000 24.000 128.000 24.000 C 160.000 24.000 208.000 88.000 208.000 152.000 Z"),
