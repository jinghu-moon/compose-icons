...
val LucideIcons.Outline.CircleChevronDown: ImageVector
    get() {
        if (_circleChevronDown != null) return _circleChevronDown!!
        _circleChevronDown = lucideOutlineIcon(
    ...
    addPath(
        pathData = parseSvgPathData("M 16.000 10.000 L 12.000 14.000 L 8.000 10.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
