...
val TablerIcons.Outline.Transform: ImageVector
    get() {
        ...
        _transform = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 3.000 6.000 C 3.000 7.657 4.343 9.000 6.000 9.000 C 7.657 9.000 9.000 7.657 9.000 6.000 C 9.000 4.343 7.657 3.000 6.000 3.000 C 4.343 3.000 3.000 4.343 3.000 6.000"),
