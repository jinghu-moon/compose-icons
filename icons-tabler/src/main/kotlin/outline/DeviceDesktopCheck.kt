...
val TablerIcons.Outline.DeviceDesktopCheck: ImageVector
    get() {
        ...
        _deviceDesktopCheck = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 16.000 L 4.000 16.000 C 3.448 16.000 3.000 15.552 3.000 15.000 L 3.000 5.000 C 3.000 4.448 3.448 4.000 4.000 4.000 L 20.000 4.000 C 20.552 4.000 21.000 4.448 21.000 5.000 L 21.000 13.000"),
