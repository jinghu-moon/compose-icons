...
val TablerIcons.Outline.ArrowsRandom: ImageVector
    get() {
        ...
        _arrowsRandom = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(6.5f, 9.504f),
                    PathNode.LineTo(3.0f, 7.504f),
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(3.0f, 7.504f),
                    PathNode.LineTo(9.83f, 5.634f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(20.5f, 9.0f),
                    PathNode.LineTo(16.0f, 3.5f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
