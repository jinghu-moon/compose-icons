...
val TablerIcons.Outline.ShoppingCartHeart: ImageVector
    get() {
        if (_shoppingCartHeart != null) return _shoppingCartHeart!!
        _shoppingCartHeart = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 10.000 17.000 L 6.000 17.000 L 6.000 3.000 L 4.000 3.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 6.000 5.000 L 20.000 6.000 L 19.283 11.016M 11.500 13.000 L 6.000 13.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
