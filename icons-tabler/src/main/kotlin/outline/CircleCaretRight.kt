...
val TablerIcons.Outline.CircleCaretRight: ImageVector
    get() {
        if (_circleCaretRight != null) return _circleCaretRight!!
        _circleCaretRight = tablerOutlineIcon(
            name = "CircleCaretRight",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24.0f, height = 24.0f),
        ) {
    addPath(
        pathData = parseSvgPathData("M 15.000 12.000 L 11.000 8.000 L 11.000 16.000 L 15.000 12.000"),
