...
val PhosphorIcons.Duotone.LegoSmiley: ImageVector
    get() {
        ...
        _legoSmiley = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M208 80v96c0 13.255-10.745 24-24 24h-112C58.745 200 48 189.255 48 176v-96C48 66.745 58.745 56 72 56h112c13.255 0 24 10.745 24 24Z"),
