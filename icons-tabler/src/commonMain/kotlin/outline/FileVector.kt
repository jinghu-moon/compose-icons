        ...
        _fileVector = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(8.0f, 17.328426f, 8.671573f, 18.0f, 9.5f, 18.0f),
                    PathNode.CurveTo(10.328427f, 18.0f, 11.0f, 17.328426f, 11.0f, 16.5f),
                    PathNode.CurveTo(11.0f, 15.671573f, 10.328427f, 15.0f, 9.5f, 15.0f),
                    PathNode.CurveTo(8.671573f, 15.0f, 8.0f, 15.671573f, 8.0f, 16.5f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(13.0f, 12.5f),
                    PathNode.CurveTo(13.0f, 13.328427f, 13.671573f, 14.0f, 14.5f, 14.0f),
                    PathNode.CurveTo(15.328427f, 14.0f, 16.0f, 13.328427f, 16.0f, 12.5f),
                    PathNode.CurveTo(16.0f, 11.671573f, 15.328427f, 11.0f, 14.5f, 11.0f),
                    PathNode.CurveTo(13.671573f, 11.0f, 13.0f, 11.671573f, 13.0f, 12.5f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(9.5f, 13.619288f, 10.619288f, 12.5f, 12.0f, 12.5f),
                    PathNode.LineTo(13.0f, 12.5f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
