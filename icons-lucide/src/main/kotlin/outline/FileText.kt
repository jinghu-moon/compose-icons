...
val LucideIcons.Outline.FileText: ImageVector
    get() {
        if (_fileText != null) return _fileText!!
        _fileText = lucideOutlineIcon(
            name = "FileText",
    ...
    addPath(
        pathData = parseSvgPathData("M 10.000 9.000 L 8.000 9.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 16.000 13.000 L 8.000 13.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
