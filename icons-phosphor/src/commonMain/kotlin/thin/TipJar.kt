        ...
        _tipJar = phosphorThinIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(156.0f, 171.0457f, 147.0457f, 180.0f, 136.0f, 180.0f),
                    PathNode.LineTo(132.0f, 180.0f),
                    PathNode.LineTo(132.0f, 192.0f),
                    PathNode.CurveTo(132.0f, 194.20914f, 130.20914f, 196.0f, 128.0f, 196.0f),
                    ...
                    PathNode.CurveTo(109.79086f, 180.0f, 108.0f, 178.20914f, 108.0f, 176.0f),
                    PathNode.CurveTo(108.0f, 173.79086f, 109.79086f, 172.0f, 112.0f, 172.0f),
                    PathNode.LineTo(136.0f, 172.0f),
                    PathNode.CurveTo(142.62741f, 172.0f, 148.0f, 166.62741f, 148.0f, 160.0f),
                    PathNode.CurveTo(148.0f, 153.37259f, 142.62741f, 148.0f, 136.0f, 148.0f),
                    PathNode.LineTo(120.0f, 148.0f),
                    PathNode.CurveTo(108.95431f, 148.0f, 100.0f, 139.0457f, 100.0f, 128.0f),
                    PathNode.CurveTo(100.0f, 116.95431f, 108.95431f, 108.0f, 120.0f, 108.0f),
                    ...
                    PathNode.CurveTo(113.37258f, 116.0f, 108.0f, 121.37258f, 108.0f, 128.0f),
                    PathNode.CurveTo(108.0f, 134.62741f, 113.37258f, 140.0f, 120.0f, 140.0f),
                    PathNode.LineTo(136.0f, 140.0f),
                    PathNode.CurveTo(147.0457f, 140.0f, 156.0f, 148.9543f, 156.0f, 160.0f),
                    PathNode.Close
                ),
