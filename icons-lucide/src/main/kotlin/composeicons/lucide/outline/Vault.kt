...
val LucideIcons.Outline.Vault: ImageVector
    get() {
        if (_vault != null) return _vault!!
        _vault = lucideOutlineIcon(
            name = "Vault",
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(7.9f, 7.9f),
                    PathNode.LineTo(10.6f, 10.6f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(7.9f, 16.1f),
                    PathNode.LineTo(10.6f, 13.4f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(17.0f, 16.776142f, 16.776142f, 17.0f, 16.5f, 17.0f),
                    PathNode.CurveTo(16.223858f, 17.0f, 16.0f, 16.776142f, 16.0f, 16.5f),
                    PathNode.CurveTo(16.0f, 16.223858f, 16.223858f, 16.0f, 16.5f, 16.0f),
                    PathNode.CurveTo(16.776142f, 16.0f, 17.0f, 16.223858f, 17.0f, 16.5f),
                    PathNode.Close
                ),
                pathFillType = PathFillType.NonZero,
                fill = SolidColor(Color.Black),
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(13.4f, 13.4f),
                    PathNode.LineTo(16.1f, 16.1f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
