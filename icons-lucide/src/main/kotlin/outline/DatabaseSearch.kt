...
val LucideIcons.Outline.DatabaseSearch: ImageVector
    get() {
        ...
        _databaseSearch = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 21.000 11.693 L 21.000 5.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 22.000 22.000 L 20.125 20.125"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 3.000 12.000 C 3.000 13.617 6.847 14.944 11.697 14.998"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 3.000 5.000 L 3.000 19.000 C 3.000 19.812 3.987 20.589 5.735 21.154 C 7.484 21.720 9.845 22.024 12.280 21.999"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
