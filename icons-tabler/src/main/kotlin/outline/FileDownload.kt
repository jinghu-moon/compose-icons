...
val TablerIcons.Outline.FileDownload: ImageVector
    get() {
        if (_fileDownload != null) return _fileDownload!!
        _fileDownload = tablerOutlineIcon(
            name = "FileDownload",
    ...
    addPath(
        pathData = parseSvgPathData("M 12.000 17.000 L 12.000 11.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 9.500 14.500 L 12.000 17.000 L 14.500 14.500"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
