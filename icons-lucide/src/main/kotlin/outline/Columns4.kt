...
val LucideIcons.Outline.Columns4: ImageVector
    get() {
        if (_columns4 != null) return _columns4!!
        _columns4 = lucideOutlineIcon(
            name = "Columns4",
            ...
            addPath(
                pathData = parseSvgPathData("M 7.500 3.000 L 7.500 21.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 16.500 3.000 L 16.500 21.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
