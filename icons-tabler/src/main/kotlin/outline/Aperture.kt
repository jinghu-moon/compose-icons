...
val TablerIcons.Outline.Aperture: ImageVector
    get() {
        ...
        _aperture = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 6.551 4.938 L 9.811 14.972"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 17.032 4.636 L 8.497 10.837"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 12.257 20.916 L 15.518 10.882"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
