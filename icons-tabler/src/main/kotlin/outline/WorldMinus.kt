...
val TablerIcons.Outline.WorldMinus: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 20.483 15.006 C 21.809 11.265 20.527 7.096 17.328 4.746 C 14.129 2.396 9.768 2.419 6.595 4.803 C 3.421 7.188 2.184 11.369 3.550 15.096 C 4.916 18.824 8.562 21.216 12.525 20.984"),
    ...
    addPath(
        pathData = parseSvgPathData("M 3.600 15.000 L 20.400 15.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 12.500 3.000 C 14.735 6.574 15.558 10.852 14.807 15.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
