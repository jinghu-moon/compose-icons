...
val TablerIcons.Outline.SquareChevronsDown: ImageVector
    get() {
        if (_squareChevronsDown != null) return _squareChevronsDown!!
        _squareChevronsDown = tablerOutlineIcon(
    ...
    addPath(
        pathData = parseSvgPathData("M 15.000 13.000 L 12.000 16.000 L 9.000 13.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
