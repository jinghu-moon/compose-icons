...
val TablerIcons.Outline.LockStar: ImageVector
    get() {
        if (_lockStar != null) return _lockStar!!
        _lockStar = tablerOutlineIcon(
            name = "LockStar",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24f, height = 24f),
        ) {
            addPath(
                pathData = parseSvgPathData("M 11.000 21.000 L 7.000 21.000 C 5.895 21.000 5.000 20.105 5.000 19.000 L 5.000 13.000 C 5.000 11.895 5.895 11.000 7.000 11.000 L 16.000 11.000"),
