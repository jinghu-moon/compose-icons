...
val TablerIcons.Outline.LockSearch: ImageVector
    get() {
        if (_lockSearch != null) return _lockSearch!!
        _lockSearch = tablerOutlineIcon(
            name = "LockSearch",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24f, height = 24f),
        ) {
            addPath(
                pathData = parseSvgPathData("M 11.500 21.000 L 7.000 21.000 C 5.895 21.000 5.000 20.105 5.000 19.000 L 5.000 13.000 C 5.000 11.895 5.895 11.000 7.000 11.000 L 17.000 11.000"),
