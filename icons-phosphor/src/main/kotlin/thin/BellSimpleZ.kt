        ...
        _bellSimpleZ = phosphorThinIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(147.33f, 98.22f),
                    PathNode.CurveTo(148.14912f, 96.99226f, 148.22563f, 95.41322f, 147.52902f, 94.11206f),
                    PathNode.CurveTo(146.83241f, 92.81089f, 145.4759f, 91.99904f, 144.0f, 92.0f),
                    PathNode.LineTo(112.0f, 92.0f),
                    PathNode.CurveTo(109.79086f, 92.0f, 108.0f, 93.79086f, 108.0f, 96.0f),
                    PathNode.CurveTo(108.0f, 98.20914f, 109.79086f, 100.0f, 112.0f, 100.0f),
                    PathNode.LineTo(136.53f, 100.0f),
                    PathNode.LineTo(108.67f, 141.78f),
                    PathNode.CurveTo(107.85087f, 143.00775f, 107.77437f, 144.58678f, 108.47098f, 145.88794f),
                    PathNode.CurveTo(109.16758f, 147.18912f, 110.52409f, 148.00096f, 112.0f, 148.0f),
                    PathNode.LineTo(144.0f, 148.0f),
                    PathNode.CurveTo(146.20914f, 148.0f, 148.0f, 146.20914f, 148.0f, 144.0f),
                    PathNode.CurveTo(148.0f, 141.79086f, 146.20914f, 140.0f, 144.0f, 140.0f),
                    PathNode.Close,
