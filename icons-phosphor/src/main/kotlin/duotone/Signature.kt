...
val PhosphorIcons.Duotone.Signature: ImageVector
    get() {
        ...
        _signature = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(67.41f, 142.56f),
                    PathNode.CurveTo(35.71f, 129.52f, 45.41f, 32.07f, 78.0f, 32.0f),
                    PathNode.CurveTo(111.82f, 32.05f, 92.0f, 90.26f, 67.41f, 142.56f),
                    PathNode.Close
                ),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(86.8f, 153.54f, 104.44f, 143.11f, 124.52f, 120.75f),
                    PathNode.CurveTo(129.52f, 134.21f, 138.97f, 151.68f, 155.1f, 152.0f),
                    PathNode.CurveTo(164.19f, 152.18f, 173.21f, 146.8f, 182.52f, 135.63f),
                    ...
                    PathNode.CurveTo(165.23f, 134.17f, 158.0f, 136.06f, 155.38f, 136.0f),
                    PathNode.CurveTo(147.12f, 135.84f, 138.72f, 116.48f, 135.84f, 102.58f),
                    PathNode.CurveTo(135.21265f, 99.540794f, 132.88426f, 97.13858f, 129.8661f, 96.41671f),
                    PathNode.CurveTo(126.847946f, 95.69484f, 123.68461f, 96.783554f, 121.75f, 99.21f),
