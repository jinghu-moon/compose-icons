...
val LucideIcons.Outline.ReceiptTurkishLira: ImageVector
    get() {
        if (_receiptTurkishLira != null) return _receiptTurkishLira!!
        _receiptTurkishLira = lucideOutlineIcon(
            name = "ReceiptTurkishLira",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24f, height = 24f),
        ) {
            addPath(
                pathData = parseSvgPathData("M 10.000 7.000 L 10.000 17.000 C 12.761 17.000 15.000 14.761 15.000 12.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 14.000 8.000 L 8.000 11.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
