...
val TablerIcons.Outline.InfoHexagon: ImageVector
    get() {
        if (_infoHexagon != null) return _infoHexagon!!
        _infoHexagon = tablerOutlineIcon(
            name = "InfoHexagon",
            ...
            addPath(
                pathData = parseSvgPathData("M 11.000 12.000 L 12.000 12.000 L 12.000 16.000 L 13.000 16.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
