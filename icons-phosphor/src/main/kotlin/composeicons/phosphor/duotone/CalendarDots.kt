...
val PhosphorIcons.Duotone.CalendarDots: ImageVector
    get() {
        if (_calendarDots != null) return _calendarDots!!
        _calendarDots = phosphorDuotoneIcon(
            name = "CalendarDots",
