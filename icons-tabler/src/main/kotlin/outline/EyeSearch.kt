...
val TablerIcons.Outline.EyeSearch: ImageVector
    get() {
        ...
        _eyeSearch = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 18.000 C 11.672 18.000 11.348 17.983 11.030 17.950 C 7.858 17.618 5.180 15.635 3.000 12.000 C 5.400 8.000 8.400 6.000 12.000 6.000 C 15.465 6.000 18.374 7.853 20.727 11.558"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
