...
val LucideIcons.Outline.ChartNetwork: ImageVector
    get() {
        ...
        _chartNetwork = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(13.11f, 7.664f),
                    PathNode.LineTo(14.89f, 10.336f)
                ),
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(14.162f, 12.788f),
                    PathNode.LineTo(10.838f, 14.212f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(14.0f, 7.10457f, 13.104569f, 8.0f, 12.0f, 8.0f),
                    PathNode.CurveTo(10.895431f, 8.0f, 10.0f, 7.10457f, 10.0f, 6.0f),
                    PathNode.CurveTo(10.0f, 4.895431f, 10.895431f, 4.0f, 12.0f, 4.0f),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(18.0f, 13.104569f, 17.10457f, 14.0f, 16.0f, 14.0f),
                    PathNode.CurveTo(14.895431f, 14.0f, 14.0f, 13.104569f, 14.0f, 12.0f),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(11.0f, 16.10457f, 10.104569f, 17.0f, 9.0f, 17.0f),
