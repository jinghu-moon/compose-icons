...
val PhosphorIcons.Duotone.RoadHorizon: ImageVector
    get() {
        if (_roadHorizon != null) return _roadHorizon!!
        _roadHorizon = phosphorDuotoneIcon(
            name = "RoadHorizon",
    ...
    group(
        ...
        addPath(
            pathData = parseSvgPathData("M 232.000 192.000 L 24.000 192.000 L 96.000 64.000 L 160.000 64.000 Z"),
