...
val RemixIcons.Fill.ChatFollowUpFill: ImageVector
    get() {
        ...
        _chatFollowUpFill = remixIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M21 3c.552 0 1 .448 1 1v14c0 .552-.448 1-1 1h-14.545L2 22.5v-18.5C2 3.448 2.448 3 3 3h18ZM17 7h-2v8h2v-8ZM11 8h-2v1.999L7 10v2l2-.001v2.001h2v-2.001L13 12v-2L11 9.999v-1.999Z"),
