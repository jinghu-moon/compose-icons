...
val LucideIcons.Outline.Regex: ImageVector
    get() {
        ...
        _regex = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(12.67f, 5.5f),
                    PathNode.LineTo(21.33f, 10.5f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(12.67f, 10.5f),
                    PathNode.LineTo(21.33f, 5.5f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(8.10457f, 21.0f, 9.0f, 20.10457f, 9.0f, 19.0f),
