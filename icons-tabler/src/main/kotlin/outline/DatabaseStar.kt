...
val TablerIcons.Outline.DatabaseStar: ImageVector
    get() {
        ...
        _databaseStar = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 4.000 6.000 L 4.000 12.000 C 4.000 13.430 6.670 14.627 10.243 14.927"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 20.000 10.500 L 20.000 6.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 4.000 12.000 L 4.000 18.000 C 4.000 19.546 7.120 20.820 11.128 20.982"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
