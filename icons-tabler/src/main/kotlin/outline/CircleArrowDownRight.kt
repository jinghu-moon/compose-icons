...
val TablerIcons.Outline.CircleArrowDownRight: ImageVector
    get() {
        if (_circleArrowDownRight != null) return _circleArrowDownRight!!
        _circleArrowDownRight = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 15.000 15.000 L 9.000 15.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 15.000 9.000 L 15.000 15.000 L 9.000 9.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
