...
val LucideIcons.Outline.BadgeCent: ImageVector
    get() {
        ...
        _badgeCent = lucideOutlineIcon(
            ...
            addPathData("M15.4 10C14.495 8.432 12.649 7.668 10.901 8.136 9.152 8.605 7.936 10.19 7.936 12c0 1.81 1.216 3.395 2.965 3.864 1.749 .469 3.594-.296 4.499-1.864")
        }
        return _badgeCent!!
    }
