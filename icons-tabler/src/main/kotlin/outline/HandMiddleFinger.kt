...
val TablerIcons.Outline.HandMiddleFinger: ImageVector
    get() {
        if (_handMiddleFinger != null) return _handMiddleFinger!!
        _handMiddleFinger = tablerOutlineIcon(
    ...
    addPath(
        pathData = parseSvgPathData("M 11.000 11.500 L 11.000 3.500 C 11.000 2.672 11.672 2.000 12.500 2.000 C 13.328 2.000 14.000 2.672 14.000 3.500 L 14.000 12.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
