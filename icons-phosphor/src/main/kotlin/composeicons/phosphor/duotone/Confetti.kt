...
val PhosphorIcons.Duotone.Confetti: ImageVector
    get() {
        ...
        _confetti = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M58.89 154.89l42.22 42.22L50.48 215.51c-2.85 1.048-6.05 .344-8.197-1.803-2.147-2.147-2.851-5.347-1.803-8.197ZM197.71 150.17 105.83 58.29c-1.883-1.883-4.598-2.673-7.197-2.096-2.6 .577-4.724 2.443-5.633 4.946l-14.9 41 75.82 75.82 41-14.9c2.517-.914 4.389-3.057 4.955-5.674 .567-2.617-.251-5.342-2.165-7.216Z"),
