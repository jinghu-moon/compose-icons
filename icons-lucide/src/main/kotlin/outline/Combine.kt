...
val LucideIcons.Outline.Combine: ImageVector
    get() {
        ...
        _combine = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 14.000 3.000 C 14.552 3.000 15.000 3.448 15.000 4.000 L 15.000 9.000 C 15.000 9.552 14.552 10.000 14.000 10.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 19.000 3.000 C 19.552 3.000 20.000 3.448 20.000 4.000 L 20.000 9.000 C 20.000 9.552 19.552 10.000 19.000 10.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 7.000 15.000 L 10.000 18.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 7.000 21.000 L 10.000 18.000 L 5.000 18.000 C 3.895 18.000 3.000 17.105 3.000 16.000 L 3.000 14.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
