...
val TablerIcons.Outline.BrandAlipay: ImageVector
    get() {
        ...
        _brandAlipay = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(21.0f, 17.314f),
                    PathNode.CurveTo(18.029f, 15.391f, 6.0f, 8.535f, 6.0f, 15.45f),
                    PathNode.CurveTo(6.0f, 17.166f, 7.52f, 18.0f, 8.985f, 18.0f),
                    PathNode.CurveTo(12.497f, 18.0f, 15.799f, 12.575f, 15.799f, 10.0f),
                    PathNode.LineTo(9.195f, 10.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
