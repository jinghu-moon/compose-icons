...
val PhosphorIcons.Duotone.RainbowCloud: ImageVector
    get() {
        ...
        _rainbowCloud = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M240 160c0 22.091-17.909 40-40 40h-48c-13.25 0-24-11.14-24-24.89 0-13.75 10.75-24.89 24-24.89 3.021 .001 6.013 .588 8.81 1.73 4.113-20.125 22.8-33.863 43.235-31.786 20.435 2.077 35.976 19.295 35.955 39.836Z"),
