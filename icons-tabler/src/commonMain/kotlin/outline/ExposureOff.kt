        ...
        _exposureOff = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(11.971f, 12.029f),
                    PathNode.MoveTo(14.011f, 9.989f),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.MoveTo(20.5f, 20.5f),
                    PathNode.CurveTo(20.138f, 20.86f, 19.55f, 21.0f, 19.0f, 21.0f),
                    PathNode.LineTo(5.0f, 21.0f),
                    PathNode.CurveTo(3.895431f, 21.0f, 3.0f, 20.10457f, 3.0f, 19.0f),
                    PathNode.LineTo(3.0f, 5.0f),
                    PathNode.CurveTo(3.0f, 4.459f, 3.215f, 3.967f, 3.565f, 3.607f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
