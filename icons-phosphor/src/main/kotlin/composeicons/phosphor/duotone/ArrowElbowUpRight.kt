...
val PhosphorIcons.Duotone.ArrowElbowUpRight: ImageVector
    get() {
        ...
        _arrowElbowUpRight = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M216 80l-48 48v-96Z"),
            ...
            addPath(
                pathData = parseSvgPathData("M221.66 74.34l-48-48c-2.288-2.291-5.731-2.976-8.722-1.737C161.947 25.842 159.997 28.762 160 32v40h-88c-4.418 0-8 3.582-8 8v144c0 4.418 3.582 8 8 8 4.418 0 8-3.582 8-8v-136h80v40c-.003 3.238 1.947 6.158 4.938 7.397 2.991 1.239 6.434 .554 8.722-1.737l48-48c1.502-1.501 2.346-3.537 2.346-5.66 0-2.123-.844-4.159-2.346-5.66ZM176 108.69v-57.38L204.69 80Z"),
                pathFillType = PathFillType.NonZero,
                fill = SolidColor(Color(0xFF000000)),
                fillAlpha = 1f,
                stroke = null,
