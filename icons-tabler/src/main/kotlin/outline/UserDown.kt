...
val TablerIcons.Outline.UserDown: ImageVector
    get() {
        if (_userDown != null) return _userDown!!
        _userDown = tablerOutlineIcon(
            name = "UserDown",
            ...
            addPath(
                pathData = parseSvgPathData("M 6.000 21.000 L 6.000 19.000 C 6.000 16.791 7.791 15.000 10.000 15.000 L 14.000 15.000 C 14.342 15.000 14.674 15.043 14.990 15.124"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
