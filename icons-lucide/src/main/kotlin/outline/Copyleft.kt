...
val LucideIcons.Outline.Copyleft: ImageVector
    get() {
        ...
        _copyleft = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 9.170 14.830 C 10.733 16.391 13.264 16.390 14.826 14.828 C 16.387 13.266 16.387 10.734 14.826 9.172 C 13.264 7.610 10.733 7.609 9.170 9.170"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
