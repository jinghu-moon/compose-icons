...
val TablerIcons.Outline.FileSpreadsheet: ImageVector
    get() {
        if (_fileSpreadsheet != null) return _fileSpreadsheet!!
        _fileSpreadsheet = tablerOutlineIcon(
    ...
    addPath(
        pathData = parseSvgPathData("M 8.000 11.000 L 16.000 11.000 L 16.000 18.000 L 8.000 18.000 L 8.000 11.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 11.000 11.000 L 11.000 18.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
