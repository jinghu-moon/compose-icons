...
val LucideIcons.Outline.DiamondPercent: ImageVector
    get() {
        ...
        _diamondPercent = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(9.2f, 9.2f),
                    PathNode.LineTo(9.21f, 9.2f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(14.5f, 9.5f),
                    PathNode.LineTo(9.5f, 14.5f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(14.7f, 14.8f),
                    PathNode.LineTo(14.71f, 14.8f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
