...
val PhosphorIcons.Duotone.PushPinSimpleSlash: ImageVector
    get() {
        ...
        _pushPinSimpleSlash = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M190.46 176h-134.46L78.83 46.61c.675-3.824 3.997-6.611 7.88-6.61h89.29l22.34 126.61c.411 2.329-.23 4.721-1.75 6.533-1.52 1.812-3.765 2.858-6.13 2.857Z"),
