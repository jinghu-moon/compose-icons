...
val PhosphorIcons.Duotone.Certificate: ImageVector
    get() {
        if (_certificate != null) return _certificate!!
        _certificate = phosphorDuotoneIcon(
            name = "Certificate",
            ...
            group(
                ...
                addPath(
                    pathData = parseSvgPathData("M 224.000 56.000 L 224.000 90.060 L 224.000 90.060 C 211.887 79.938 195.279 77.081 180.480 82.572 C 165.680 88.064 154.957 101.063 152.378 116.636 C 149.799 132.210 155.760 147.971 168.000 157.940 L 168.000 157.940 L 168.000 192.000 L 40.000 192.000 C 35.582 192.000 32.000 188.418 32.000 184.000 L 32.000 56.000 C 32.000 51.582 35.582 48.000 40.000 48.000 L 216.000 48.000 C 220.418 48.000 224.000 51.582 224.000 56.000 Z"),
