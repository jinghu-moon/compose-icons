...
val TablerIcons.Outline.BrandFinder: ImageVector
    get() {
        ...
        _brandFinder = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(12.5f, 4.0f),
                    PathNode.CurveTo(11.846f, 5.486f, 11.24f, 7.443f, 11.0f, 13.0f),
                    PathNode.LineTo(13.5f, 13.0f),
                    PathNode.CurveTo(13.31f, 15.867f, 13.594f, 18.024f, 14.0f, 20.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(10.667f, 17.5f, 13.333f, 17.5f, 17.0f, 15.5f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
