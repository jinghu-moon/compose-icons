...
val TablerIcons.Outline.HeartCog: ImageVector
    get() {
        if (_heartCog != null) return _heartCog!!
        _heartCog = tablerOutlineIcon(
            name = "HeartCog",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24.0f, height = 24.0f),
        ) {
    addPath(
        pathData = parseSvgPathData("M 12.000 20.000 L 4.500 12.572 C 3.151 11.260 2.654 9.301 3.212 7.504 C 3.771 5.707 5.292 4.376 7.147 4.060 C 9.002 3.743 10.877 4.496 12.000 6.006 C 13.614 3.856 16.640 3.368 18.849 4.900 C 21.058 6.433 21.659 9.438 20.210 11.703"),
