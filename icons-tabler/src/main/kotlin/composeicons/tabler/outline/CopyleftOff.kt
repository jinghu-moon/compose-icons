...
val TablerIcons.Outline.CopyleftOff: ImageVector
    get() {
        ...
        _copyleftOff = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(13.303f, 9.3f),
                    PathNode.CurveTo(13.91703f, 9.596051f, 14.412386f, 10.09176f, 14.708f, 10.706f),
                    PathNode.MoveTo(14.122f, 14.119f),
                    PathNode.CurveTo(12.997176f, 15.24201f, 11.193862f, 15.299321f, 10.0f, 14.25f)
                ),
