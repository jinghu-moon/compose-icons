        ...
        _football = phosphorFillIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(169.73f, 21.45f, 108.72f, 18.94f, 63.84f, 63.84f),
                    ...
                    PathNode.CurveTo(39.955288f, 183.96548f, 39.24594f, 168.19847f, 40.59f, 152.54f),
                    PathNode.LineTo(103.46f, 215.41f),
                    PathNode.CurveTo(87.80153f, 216.75406f, 72.03452f, 216.04471f, 56.56f, 213.3f),
                    PathNode.Close,
                    PathNode.MoveTo(165.64f, 101.67f),
                    ...
                    PathNode.CurveTo(156.34224f, 88.25251f, 159.33012f, 87.39698f, 162.14435f, 88.125374f),
                    PathNode.CurveTo(164.95859f, 88.85376f, 167.15623f, 91.051414f, 167.88463f, 93.86565f),
                    PathNode.CurveTo(168.613f, 96.679886f, 167.75749f, 99.66776f, 165.65f, 101.67f),
                    PathNode.Close,
                    PathNode.MoveTo(215.41f, 103.46f),
                    PathNode.LineTo(152.54f, 40.59f),
                    PathNode.CurveTo(157.3f, 40.15f, 162.26f, 39.9f, 167.45f, 39.9f),
                    PathNode.CurveTo(178.17615f, 39.937843f, 188.88028f, 40.874454f, 199.45f, 42.7f),
                    PathNode.CurveTo(206.54129f, 43.910515f, 212.0946f, 49.467842f, 213.3f, 56.56f),
                    PathNode.CurveTo(216.04471f, 72.03452f, 216.75406f, 87.80153f, 215.41f, 103.46f),
                    PathNode.Close
                ),
