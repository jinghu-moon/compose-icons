...
val TablerIcons.Outline.EyeBolt: ImageVector
    get() {
        ...
        _eyeBolt = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 13.100 17.936 C 12.735 17.979 12.368 18.000 12.000 18.000 C 8.400 18.000 5.400 16.000 3.000 12.000 C 5.400 8.000 8.400 6.000 12.000 6.000 C 15.600 6.000 18.600 8.000 21.000 12.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
