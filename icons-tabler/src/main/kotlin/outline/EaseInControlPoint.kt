...
val TablerIcons.Outline.EaseInControlPoint: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 3.000 19.000 C 11.000 19.000 21.000 3.000 21.000 3.000"),
    ...
    addPath(
        pathData = parseSvgPathData("M 17.000 19.000 L 15.000 19.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 12.000 19.000 L 10.000 19.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
