        ...
        _pottedPlant = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(169.39f, 217.74f),
                    PathNode.CurveTo(168.57472f, 221.39867f, 165.32841f, 224.00072f, 161.58f, 224.0f),
                    PathNode.LineTo(94.42f, 224.0f),
                    PathNode.CurveTo(90.67159f, 224.00072f, 87.42528f, 221.39867f, 86.61f, 217.74f),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(125.65f, 141.65f),
                    PathNode.LineTo(125.65f, 141.65f),
                    ...
                    PathNode.CurveTo(182.86f, 21.87f, 149.62f, 34.57f, 135.25f, 58.29f),
                    ...
                    PathNode.CurveTo(95.53f, 56.0f, 70.6f, 46.4f, 39.73f, 48.22f),
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(149.0f, 66.58f),
                    PathNode.CurveTo(159.46f, 49.32f, 184.23f, 39.58f, 216.0f, 40.01f),
                    PathNode.CurveTo(216.41f, 71.82f, 206.69f, 96.59f, 189.43f, 107.01f),
                    PathNode.CurveTo(177.92f, 114.01f, 164.03f, 113.55f, 150.15f, 105.83f),
                    PathNode.CurveTo(142.42f, 92.0f, 142.0f, 78.09f, 149.0f, 66.58f),
                    PathNode.Close,
                    PathNode.MoveTo(92.11f, 108.11f),
                    PathNode.CurveTo(82.91f, 113.03f, 73.8f, 113.26f, 66.28f, 108.71f),
                    PathNode.CurveTo(54.78f, 101.74f, 48.15f, 85.31f, 48.0f, 64.0f),
                    PathNode.CurveTo(69.31f, 64.15f, 85.75f, 70.78f, 92.71f, 82.28f),
                    PathNode.CurveTo(97.27f, 89.8f, 97.0f, 98.91f, 92.11f, 108.11f),
                    PathNode.Close,
                    PathNode.MoveTo(161.59f, 216.0f),
                    PathNode.LineTo(94.42f, 216.0f),
                    PathNode.LineTo(82.0f, 160.0f),
                    PathNode.LineTo(174.0f, 160.0f),
                    PathNode.Close
                ),
                pathFillType = PathFillType.NonZero,
                fill = SolidColor(Color.Black),
