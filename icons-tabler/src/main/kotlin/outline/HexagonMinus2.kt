...
val TablerIcons.Outline.HexagonMinus2: ImageVector
    get() {
        ...
        _hexagonMinus2 = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 13.092 21.720 C 12.412 22.093 11.588 22.093 10.908 21.720 L 4.158 17.450 C 3.445 17.061 3.002 16.314 3.000 15.502 L 3.000 8.217 C 3.000 7.408 3.443 6.663 4.158 6.270 L 10.908 2.290 C 11.608 1.904 12.458 1.904 13.158 2.290 L 19.908 6.270 L 19.875 6.270 C 20.575 6.668 21.005 7.413 21.000 8.218 L 21.000 15.000"),
