...
val TablerIcons.Outline.IrregularPolyhedron: ImageVector
    get() {
        ...
        _irregularPolyhedron = tablerOutlineIcon(
            ...
            addPathData("M6 12 4.248 18.13c-.142 .494 .114 1.015 .592 1.205l6.282 2.503c.565 .216 1.191 .216 1.756 0l6.282-2.503c.477-.19 .733-.71 .592-1.204L18 12 19.752 5.87c.142-.494-.114-1.015-.592-1.205L12.878 2.162c-.565-.216-1.191-.216-1.756 0L4.84 4.665c-.477 .19-.733 .71-.592 1.204L6 12")
