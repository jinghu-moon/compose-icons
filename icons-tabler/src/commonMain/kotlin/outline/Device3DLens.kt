...
val TablerIcons.Outline.Device3DLens: ImageVector
    get() {
        ...
        _device3DLens = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(18.005f, 14.64f),
                    PathNode.CurveTo(18.647903f, 13.911019f, 19.001823f, 12.971974f, 19.0f, 12.0f)
                ),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(22.0f, 8.134007f, 18.865993f, 5.0f, 15.0f, 5.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
