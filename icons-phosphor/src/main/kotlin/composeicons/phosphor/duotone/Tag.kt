...
val PhosphorIcons.Duotone.Tag: ImageVector
    get() {
        ...
        _tag = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M237.66 153 153 237.66c-3.124 3.122-8.186 3.122-11.31 0L42.34 138.34C40.843 136.841 40.001 134.809 40 132.69v-92.69h92.69c2.119 .001 4.151 .843 5.65 2.34l99.32 99.32c1.508 1.501 2.356 3.542 2.356 5.67 0 2.128-.848 4.169-2.356 5.67Z"),
