...
val TablerIcons.Outline.ArrowDownCircle: ImageVector
    get() {
        ...
        _arrowDownCircle = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 7.000 C 13.105 7.000 14.000 6.105 14.000 5.000 C 14.000 3.895 13.105 3.000 12.000 3.000 C 10.895 3.000 10.000 3.895 10.000 5.000 C 10.000 6.105 10.895 7.000 12.000 7.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
