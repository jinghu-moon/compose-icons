...
val PhosphorIcons.Duotone.PipeWrench: ImageVector
    get() {
        ...
        _pipeWrench = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(173.66f, 145.66f),
                    PathNode.LineTo(85.0f, 235.0f),
                    PathNode.CurveTo(78.272385f, 240.97888f, 68.05056f, 240.67798f, 61.68629f, 234.3137f),
                    PathNode.CurveTo(55.322025f, 227.94943f, 55.02112f, 217.72762f, 61.0f, 211.0f),
                    PathNode.LineTo(125.69f, 145.63f),
                    PathNode.CurveTo(127.192215f, 144.12946f, 128.0363f, 142.09328f, 128.0363f, 139.97f),
                    PathNode.CurveTo(128.0363f, 137.84673f, 127.192215f, 135.81055f, 125.69f, 134.31f),
                    PathNode.LineTo(77.0f, 85.0f),
                    PathNode.CurveTo(70.388794f, 78.365875f, 70.388794f, 67.634125f, 77.0f, 61.0f),
                    PathNode.LineTo(77.0f, 61.0f),
                    PathNode.CurveTo(83.634125f, 54.38879f, 94.365875f, 54.38879f, 101.0f, 61.0f),
                    PathNode.LineTo(173.69f, 134.37f),
                    PathNode.CurveTo(176.79015f, 137.49971f, 176.77673f, 142.5468f, 173.66f, 145.66f),
                    PathNode.Close
                ),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(79.31f, 229.37f),
                    PathNode.CurveTo(77.11571f, 231.96992f, 73.64291f, 233.11029f, 70.33448f, 232.31734f),
                    PathNode.CurveTo(67.02605f, 231.52438f, 64.447525f, 228.93364f, 63.670223f, 225.62148f),
                    PathNode.CurveTo(62.89293f, 222.30933f, 64.04973f, 218.84196f, 66.66f, 216.66f),
                    PathNode.LineTo(131.33f, 151.29f),
                    PathNode.CurveTo(137.5402f, 145.04823f, 137.5402f, 134.96176f, 131.33f, 128.72f),
                    PathNode.LineTo(82.63f, 79.31f),
                    PathNode.CurveTo(79.59354f, 75.74312f, 79.80081f, 70.44344f, 83.10659f, 67.12462f),
                    PathNode.CurveTo(86.41236f, 63.805786f, 91.711174f, 63.577618f, 95.29f, 66.6f),
