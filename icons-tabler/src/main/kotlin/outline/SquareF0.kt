...
val TablerIcons.Outline.SquareF0: ImageVector
    get() {
        ...
        _squareF0 = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 13.000 10.500 L 13.000 13.500 C 13.000 14.328 13.672 15.000 14.500 15.000 C 15.328 15.000 16.000 14.328 16.000 13.500 L 16.000 10.500 C 16.000 9.672 15.328 9.000 14.500 9.000 C 13.672 9.000 13.000 9.672 13.000 10.500"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
