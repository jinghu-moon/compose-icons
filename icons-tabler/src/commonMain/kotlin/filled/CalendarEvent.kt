        ...
        _calendarEvent = tablerFilledIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(10.552285f, 14.0f, 11.0f, 14.447715f, 11.0f, 15.0f),
                    PathNode.LineTo(11.0f, 17.0f),
                    PathNode.CurveTo(11.0f, 17.552284f, 10.552285f, 18.0f, 10.0f, 18.0f),
                    PathNode.LineTo(8.0f, 18.0f),
                    PathNode.CurveTo(7.447716f, 18.0f, 7.0f, 17.552284f, 7.0f, 17.0f),
                    PathNode.LineTo(7.0f, 15.0f),
                    PathNode.CurveTo(7.0f, 14.447715f, 7.447716f, 14.0f, 8.0f, 14.0f),
                    PathNode.Close
                ),
