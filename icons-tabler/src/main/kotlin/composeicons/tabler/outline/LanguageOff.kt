        ...
        _languageOff = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(14.463f, 14.459f),
                    PathNode.MoveTo(15.691f, 11.695f),
                    PathNode.LineTo(16.0f, 11.0f),
                    PathNode.LineTo(16.8f, 12.8f)
                ),
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(8.747f, 8.748f),
                    PathNode.CurveTo(8.087f, 11.582f, 6.211f, 13.0f, 4.0f, 13.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(4.0f, 6.371f),
                    PathNode.LineTo(6.371f, 6.371f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(5.0f, 11.144f, 7.252f, 12.908f, 11.0f, 13.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
