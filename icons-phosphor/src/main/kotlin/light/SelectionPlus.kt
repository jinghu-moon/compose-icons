        ...
        _selectionPlus = phosphorLightIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(212.6863f, 186.0f, 210.0f, 188.6863f, 210.0f, 192.0f),
                    ...
                    PathNode.LineTo(210.0f, 222.0f),
                    PathNode.LineTo(210.0f, 240.0f),
                    PathNode.CurveTo(210.0f, 243.3137f, 212.6863f, 246.0f, 216.0f, 246.0f),
                    PathNode.CurveTo(219.3137f, 246.0f, 222.0f, 243.3137f, 222.0f, 240.0f),
                    PathNode.LineTo(222.0f, 222.0f),
