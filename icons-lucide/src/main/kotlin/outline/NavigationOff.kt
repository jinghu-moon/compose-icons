...
val LucideIcons.Outline.NavigationOff: ImageVector
    get() {
        ...
        _navigationOff = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 8.430 8.430 L 3.000 11.000 L 11.000 13.000 L 13.000 21.000 L 15.570 15.570"),
            ...
            addPath(
                pathData = parseSvgPathData("M 17.390 11.730 L 22.000 2.000 L 12.270 6.610"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
