...
val TablerIcons.Outline.FileWord: ImageVector
    get() {
        if (_fileWord != null) return _fileWord!!
        _fileWord = tablerOutlineIcon(
            name = "FileWord",
    ...
    addPath(
        pathData = parseSvgPathData("M 9.000 12.000 L 10.333 17.000 L 12.000 13.000 L 13.667 17.000 L 15.000 12.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
