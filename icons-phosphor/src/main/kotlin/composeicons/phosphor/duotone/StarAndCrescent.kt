...
val PhosphorIcons.Duotone.StarAndCrescent: ImageVector
    get() {
        ...
        _starAndCrescent = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M152 206.4C114.979 225.273 69.801 215.677 43.647 183.385 17.494 151.093 17.494 104.907 43.647 72.615 69.801 40.323 114.979 30.727 152 49.6 122.525 64.626 103.968 94.915 103.968 128c0 33.085 18.557 63.374 48.032 78.4ZM217.06 114.65 214.39 80l-21.8 26.4L160 98.33 177.46 128 160 157.67l32.59-8.07L214.39 176l2.67-34.65L248 128Z"),
