...
val TablerIcons.Outline.DevicesStar: ImageVector
    get() {
        if (_devicesStar != null) return _devicesStar!!
        _devicesStar = tablerOutlineIcon(
            name = "DevicesStar",
            ...
            addPath(
                pathData = parseSvgPathData("M 18.000 8.000 L 18.000 5.000 C 18.000 4.448 17.552 4.000 17.000 4.000 L 4.000 4.000 C 3.448 4.000 3.000 4.448 3.000 5.000 L 3.000 17.000 C 3.000 17.552 3.448 18.000 4.000 18.000 L 9.500 18.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
