...
val LucideIcons.Outline.ShieldX: ImageVector
    get() {
        if (_shieldX != null) return _shieldX!!
        _shieldX = lucideOutlineIcon(
            name = "ShieldX",
            ...
            addPath(
                pathData = parseSvgPathData("M 14.500 9.500 L 9.500 14.500"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 9.500 9.500 L 14.500 14.500"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
