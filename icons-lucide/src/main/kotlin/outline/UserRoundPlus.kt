...
val LucideIcons.Outline.UserRoundPlus: ImageVector
    get() {
        if (_userRoundPlus != null) return _userRoundPlus!!
        _userRoundPlus = lucideOutlineIcon(
            name = "UserRoundPlus",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24f, height = 24f),
        ) {
            addPath(
                pathData = parseSvgPathData("M 2.000 21.000 C 2.000 17.855 3.842 15.002 6.709 13.708 C 9.575 12.414 12.934 12.920 15.292 15.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 22.000 19.000 L 16.000 19.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
