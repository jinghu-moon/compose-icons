...
val TablerIcons.Outline.CaretLeftRight: ImageVector
    get() {
        ...
        _caretLeftRight = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 14.000 18.000 L 20.000 12.000 L 14.000 6.000 L 14.000 18.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 10.000 18.000 L 4.000 12.000 L 10.000 6.000 L 10.000 18.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
