...
val TablerIcons.Outline.TransactionDollar: ImageVector
    get() {
        ...
        _transactionDollar = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 20.800 13.000 C 20.431 12.360 19.739 11.975 19.000 12.000 L 17.000 12.000 C 15.895 12.000 15.000 12.895 15.000 14.000 C 15.000 15.105 15.895 16.000 17.000 16.000 L 19.000 16.000 C 20.105 16.000 21.000 16.895 21.000 18.000 C 21.000 19.105 20.105 20.000 19.000 20.000 L 17.000 20.000 C 16.261 20.025 15.569 19.640 15.200 19.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 18.000 11.000 L 18.000 21.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
