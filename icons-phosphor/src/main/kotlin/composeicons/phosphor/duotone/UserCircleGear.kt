...
val PhosphorIcons.Duotone.UserCircleGear: ImageVector
    get() {
        if (_userCircleGear != null) return _userCircleGear!!
        _userCircleGear = phosphorDuotoneIcon(
            name = "UserCircleGear",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 256f, height = 256f),
        ) {
            addPath(
                pathData = parseSvgPathData("M224 128c.029 27.229-11.535 53.183-31.8 71.37C179.916 175.209 155.105 159.993 128 160c22.091 0 40-17.909 40-40C168 97.909 150.091 80 128 80 105.909 80 88 97.909 88 120c0 22.091 17.909 40 40 40-27.105-.007-51.916 15.209-64.2 39.37h0C25.738 165.134 21.238 107.054 53.572 67.363 85.905 27.672 143.695 20.337 184.92 50.69c-2.033 5.802-.561 12.256 3.787 16.603 4.347 4.347 10.801 5.819 16.603 3.787C217.477 87.561 224.029 107.514 224 128Z"),
