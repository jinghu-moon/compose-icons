...
val PhosphorIcons.Duotone.Binoculars: ImageVector
    get() {
        if (_binoculars != null) return _binoculars!!
        _binoculars = phosphorDuotoneIcon(
            name = "Binoculars",
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(104.0f, 190.09138f, 86.09139f, 208.0f, 64.0f, 208.0f),
                    PathNode.CurveTo(41.90861f, 208.0f, 24.0f, 190.09138f, 24.0f, 168.0f),
                    PathNode.CurveTo(24.0f, 145.90862f, 41.90861f, 128.0f, 64.0f, 128.0f),
                    PathNode.CurveTo(86.09139f, 128.0f, 104.0f, 145.90862f, 104.0f, 168.0f),
                    PathNode.Close,
