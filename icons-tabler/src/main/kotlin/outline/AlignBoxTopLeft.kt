...
val TablerIcons.Outline.AlignBoxTopLeft: ImageVector
    get() {
        if (_alignBoxTopLeft != null) return _alignBoxTopLeft!!
        _alignBoxTopLeft = tablerOutlineIcon(
    ...
    addPath(
        pathData = parseSvgPathData("M 7.000 9.000 L 7.000 7.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 10.000 13.000 L 10.000 7.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 13.000 11.000 L 13.000 7.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
