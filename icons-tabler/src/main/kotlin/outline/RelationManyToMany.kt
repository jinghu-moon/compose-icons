...
val TablerIcons.Outline.RelationManyToMany: ImageVector
    get() {
        ...
        _relationManyToMany = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 15.000 14.000 L 15.000 10.000 L 18.000 14.000 L 18.000 10.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 6.000 14.000 L 6.000 10.000 L 9.000 14.000 L 9.000 10.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 10.500 L 12.000 10.510"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 13.500 L 12.000 13.510"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
