...
val PhosphorIcons.Duotone.FilePpt: ImageVector
    get() {
        if (_filePpt != null) return _filePpt!!
        _filePpt = phosphorDuotoneIcon(
            name = "FilePpt",
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(204.0f, 212.41827f, 200.41827f, 216.0f, 196.0f, 216.0f),
                    PathNode.CurveTo(191.58173f, 216.0f, 188.0f, 212.41827f, 188.0f, 208.0f),
                    ...
                    PathNode.CurveTo(160.0f, 187.46397f, 147.46397f, 200.0f, 132.0f, 200.0f),
                    PathNode.LineTo(124.0f, 200.0f),
                    PathNode.LineTo(124.0f, 208.0f),
                    PathNode.CurveTo(124.0f, 212.41827f, 120.41828f, 216.0f, 116.0f, 216.0f),
                    PathNode.CurveTo(111.58172f, 216.0f, 108.0f, 212.41827f, 108.0f, 208.0f),
                    ...
                    PathNode.CurveTo(147.46397f, 144.0f, 160.0f, 156.53603f, 160.0f, 172.0f),
                    PathNode.Close,
                    PathNode.MoveTo(144.0f, 172.0f),
                    PathNode.CurveTo(144.0f, 165.37259f, 138.62741f, 160.0f, 132.0f, 160.0f),
                    PathNode.LineTo(124.0f, 160.0f),
                    PathNode.LineTo(124.0f, 184.0f),
                    PathNode.LineTo(132.0f, 184.0f),
                    PathNode.CurveTo(138.62741f, 184.0f, 144.0f, 178.62741f, 144.0f, 172.0f),
                    PathNode.Close,
