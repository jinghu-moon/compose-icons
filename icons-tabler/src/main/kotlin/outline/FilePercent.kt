...
val TablerIcons.Outline.FilePercent: ImageVector
    get() {
        if (_filePercent != null) return _filePercent!!
        _filePercent = tablerOutlineIcon(
            name = "FilePercent",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24f, height = 24f),
        ) {
            addPath(
                pathData = parseSvgPathData("M 10.000 17.000 L 14.000 13.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 10.000 13.000 L 10.010 13.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 14.000 17.000 L 14.010 17.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
