...
val TablerIcons.Outline.FirewallFlame: ImageVector
    get() {
        ...
        _firewallFlame = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(15.5f, 16.0f),
                    PathNode.QuadTo(18.0f, 17.5f, 18.0f, 15.0f),
                    PathNode.LineTo(18.0f, 13.0f),
                    PathNode.CurveTo(18.0f, 13.0f, 22.0f, 14.06f, 22.0f, 18.0f),
                    PathNode.CurveTo(22.0f, 19.664f, 21.351f, 21.338f, 20.0f, 22.0f),
                    PathNode.LineTo(20.0f, 21.75f),
                    PathNode.CurveTo(20.0f, 20.793f, 18.947f, 20.0f, 18.0f, 20.0f),
                    PathNode.CurveTo(17.053f, 20.0f, 16.0f, 20.793f, 16.0f, 21.75f),
                    PathNode.LineTo(16.0f, 22.0f),
                    PathNode.CurveTo(14.649f, 21.338f, 14.0f, 20.0f, 14.0f, 18.5f),
                    PathNode.CurveTo(14.0f, 17.0f, 15.5f, 16.0f, 15.5f, 16.0f)
                ),
