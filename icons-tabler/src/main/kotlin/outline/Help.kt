...
val TablerIcons.Outline.Help: ImageVector
    get() {
        ...
        _help = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 13.500 C 11.962 12.833 12.370 12.222 13.000 12.000 C 14.031 11.606 14.700 10.604 14.670 9.501 C 14.640 8.398 13.917 7.434 12.867 7.096 C 11.816 6.759 10.667 7.121 10.000 8.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
