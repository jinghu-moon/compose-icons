...
val PhosphorIcons.Duotone.Buildings: ImageVector
    get() {
        ...
        _buildings = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M136 32v184h-96v-130.65c-.002-2.676 1.334-5.175 3.56-6.66L123.56 25.36c2.452-1.636 5.606-1.791 8.207-.403 2.601 1.388 4.227 4.095 4.233 7.043Z"),
