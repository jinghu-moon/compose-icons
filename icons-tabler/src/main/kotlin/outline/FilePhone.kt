...
val TablerIcons.Outline.FilePhone: ImageVector
    get() {
        ...
        _filePhone = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 9.000 12.000 C 9.000 12.276 9.224 12.500 9.500 12.500 C 9.776 12.500 10.000 12.276 10.000 12.000 L 10.000 11.000 C 10.000 10.724 9.776 10.500 9.500 10.500 C 9.224 10.500 9.000 10.724 9.000 11.000 L 9.000 12.000 C 9.000 14.761 11.239 17.000 14.000 17.000 L 15.000 17.000 C 15.276 17.000 15.500 16.776 15.500 16.500 C 15.500 16.224 15.276 16.000 15.000 16.000 L 14.000 16.000 C 13.724 16.000 13.500 16.224 13.500 16.500 C 13.500 16.776 13.724 17.000 14.000 17.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
