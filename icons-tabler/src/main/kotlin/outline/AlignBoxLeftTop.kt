...
val TablerIcons.Outline.AlignBoxLeftTop: ImageVector
    get() {
        if (_alignBoxLeftTop != null) return _alignBoxLeftTop!!
        _alignBoxLeftTop = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 9.000 13.000 L 7.000 13.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 13.000 10.000 L 7.000 10.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
