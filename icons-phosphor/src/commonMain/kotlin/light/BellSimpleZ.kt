        ...
        _bellSimpleZ = phosphorLightIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(144.0f, 138.0f),
                    PathNode.LineTo(123.21f, 138.0f),
                    PathNode.LineTo(149.0f, 99.33f),
                    PathNode.CurveTo(150.22919f, 97.487656f, 150.3435f, 95.11799f, 149.29736f, 93.16588f),
                    PathNode.CurveTo(148.25122f, 91.21377f, 146.21475f, 89.99671f, 144.0f, 90.0f),
                    PathNode.LineTo(112.0f, 90.0f),
                    PathNode.CurveTo(108.686295f, 90.0f, 106.0f, 92.686295f, 106.0f, 96.0f),
                    PathNode.CurveTo(106.0f, 99.313705f, 108.686295f, 102.0f, 112.0f, 102.0f),
                    PathNode.LineTo(132.79f, 102.0f),
                    PathNode.LineTo(107.0f, 140.67f),
                    PathNode.CurveTo(105.770805f, 142.51236f, 105.656494f, 144.88202f, 106.70264f, 146.83412f),
                    PathNode.CurveTo(107.74879f, 148.78622f, 109.78524f, 150.00328f, 112.0f, 150.0f),
                    PathNode.LineTo(144.0f, 150.0f),
                    PathNode.CurveTo(147.3137f, 150.0f, 150.0f, 147.3137f, 150.0f, 144.0f),
                    PathNode.CurveTo(150.0f, 140.6863f, 147.3137f, 138.0f, 144.0f, 138.0f),
                    PathNode.Close,
