...
val TablerIcons.Outline.TopologyStarRing2: ImageVector
    get() {
        ...
        _topologyStarRing2 = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(5.5f, 10.5f),
                    PathNode.LineTo(10.5f, 5.5f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(13.5f, 5.5f),
                    PathNode.LineTo(18.5f, 10.5f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
