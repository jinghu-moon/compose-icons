        ...
        _sealCheck = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(204.64f, 173.01f, 210.74f, 192.34f, 201.54f, 201.54f),
                    PathNode.CurveTo(192.34f, 210.74f, 173.01f, 204.64f, 161.69f, 209.32f),
                    PathNode.CurveTo(150.0f, 214.18f, 140.5f, 232.0f, 128.0f, 232.0f),
                    PathNode.CurveTo(115.5f, 232.0f, 106.0f, 214.18f, 94.31f, 209.32f),
                    PathNode.CurveTo(82.99f, 204.64f, 63.66f, 210.74f, 54.46f, 201.54f),
                    PathNode.CurveTo(45.26f, 192.34f, 51.36f, 173.01f, 46.68f, 161.69f),
                    PathNode.CurveTo(41.82f, 150.0f, 24.0f, 140.5f, 24.0f, 128.0f),
                    PathNode.CurveTo(24.0f, 115.5f, 41.82f, 106.0f, 46.68f, 94.31f),
                    PathNode.CurveTo(51.36f, 83.0f, 45.26f, 63.66f, 54.46f, 54.46f),
                    PathNode.CurveTo(63.66f, 45.26f, 83.0f, 51.36f, 94.31f, 46.68f),
                    PathNode.CurveTo(106.05f, 41.82f, 115.5f, 24.0f, 128.0f, 24.0f),
                    PathNode.CurveTo(140.5f, 24.0f, 150.0f, 41.82f, 161.69f, 46.68f),
                    PathNode.CurveTo(173.01f, 51.36f, 192.34f, 45.26f, 201.54f, 54.46f),
                    PathNode.CurveTo(210.74f, 63.66f, 204.64f, 82.99f, 209.32f, 94.31f),
