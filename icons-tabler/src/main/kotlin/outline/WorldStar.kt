...
val TablerIcons.Outline.WorldStar: ImageVector
    get() {
        ...
        _worldStar = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 21.000 12.000 C 21.000 7.155 17.165 3.180 12.323 3.006 C 7.481 2.832 3.371 6.522 3.023 11.354 C 2.675 16.187 6.215 20.427 11.032 20.948"),
            ...
            addPath(
                pathData = parseSvgPathData("M 3.600 15.000 L 10.000 15.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 11.500 3.000 C 8.929 7.120 8.242 12.143 9.614 16.802"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 12.500 3.000 C 14.007 5.414 14.884 8.169 15.049 11.010"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
