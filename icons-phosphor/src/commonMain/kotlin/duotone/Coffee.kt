        ...
        _coffee = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(208.00706f, 170.40158f, 187.9671f, 201.65297f, 156.7f, 216.0f),
                    PathNode.LineTo(83.3f, 216.0f),
                    PathNode.CurveTo(52.03289f, 201.65297f, 31.992937f, 170.40158f, 32.0f, 136.0f),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(124.41828f, 64.0f, 128.0f, 60.418278f, 128.0f, 56.0f),
                    PathNode.LineTo(128.0f, 24.0f),
                    PathNode.CurveTo(128.0f, 19.581722f, 124.41828f, 16.0f, 120.0f, 16.0f),
                    PathNode.CurveTo(115.58172f, 16.0f, 112.0f, 19.581722f, 112.0f, 24.0f),
                    PathNode.LineTo(112.0f, 56.0f),
                    PathNode.CurveTo(112.0f, 60.418278f, 115.58172f, 64.0f, 120.0f, 64.0f),
                    PathNode.Close,
                    PathNode.MoveTo(152.0f, 64.0f),
                    PathNode.CurveTo(156.41827f, 64.0f, 160.0f, 60.418278f, 160.0f, 56.0f),
                    ...
                    PathNode.CurveTo(144.0f, 60.418278f, 147.58173f, 64.0f, 152.0f, 64.0f),
                    PathNode.Close,
                    PathNode.MoveTo(248.0f, 120.0f),
                    PathNode.LineTo(248.0f, 128.0f),
                    PathNode.CurveTo(247.99344f, 149.11972f, 231.56877f, 166.59529f, 210.49f, 167.91f),
                    PathNode.CurveTo(205.03304f, 183.3456f, 195.74214f, 197.14085f, 183.49f, 208.0f),
                    PathNode.LineTo(208.0f, 208.0f),
                    PathNode.CurveTo(212.41827f, 208.0f, 216.0f, 211.58173f, 216.0f, 216.0f),
                    ...
                    PathNode.LineTo(56.54f, 208.0f),
                    PathNode.CurveTo(35.89372f, 189.75945f, 24.04836f, 163.54968f, 24.0f, 136.0f),
                    PathNode.LineTo(24.0f, 88.0f),
                    PathNode.CurveTo(24.0f, 83.58172f, 27.581722f, 80.0f, 32.0f, 80.0f),
                    PathNode.LineTo(208.0f, 80.0f),
                    PathNode.CurveTo(230.09138f, 80.0f, 248.0f, 97.90861f, 248.0f, 120.0f),
                    PathNode.Close,
                    PathNode.MoveTo(200.0f, 96.0f),
                    PathNode.LineTo(40.0f, 96.0f),
                    PathNode.LineTo(40.0f, 136.0f),
                    PathNode.CurveTo(40.062927f, 166.64522f, 57.569088f, 194.58058f, 85.12f, 208.0f),
                    PathNode.LineTo(154.88f, 208.0f),
                    PathNode.CurveTo(182.43091f, 194.58058f, 199.93707f, 166.64522f, 200.0f, 136.0f),
                    PathNode.Close,
                    PathNode.MoveTo(232.0f, 120.0f),
                    PathNode.CurveTo(231.99686f, 109.83194f, 225.58655f, 100.769356f, 216.0f, 97.38f),
                    PathNode.LineTo(216.0f, 136.0f),
                    PathNode.CurveTo(215.994f, 141.02373f, 215.59276f, 146.03922f, 214.8f, 151.0f),
                    PathNode.CurveTo(224.9941f, 147.98827f, 231.99269f, 138.62968f, 232.0f, 128.0f),
                    PathNode.Close
                ),
                pathFillType = PathFillType.NonZero,
                fill = SolidColor(Color.Black),
