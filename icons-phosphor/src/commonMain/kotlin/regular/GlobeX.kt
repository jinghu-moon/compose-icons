...
val PhosphorIcons.Regular.GlobeX: ImageVector
    get() {
        if (_globeX != null) return _globeX!!
        _globeX = phosphorRegularIcon(
            name = "GlobeX",
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(131.38911f, 231.9921f, 134.40549f, 229.84952f, 135.52899f, 226.65204f),
                    PathNode.CurveTo(136.65248f, 223.45456f, 135.63928f, 219.8961f, 133.0f, 217.77f),
                    PathNode.LineTo(133.0f, 217.77f),
                    PathNode.CurveTo(131.88f, 216.86f, 112.12f, 200.45f, 101.94f, 168.0f),
                    PathNode.LineTo(127.94f, 168.0f),
                    PathNode.CurveTo(132.35828f, 168.0f, 135.94f, 164.41827f, 135.94f, 160.0f),
                    PathNode.CurveTo(135.94f, 155.58173f, 132.35828f, 152.0f, 127.94f, 152.0f),
                    PathNode.LineTo(98.08f, 152.0f),
                    PathNode.CurveTo(95.32009f, 136.11902f, 95.32009f, 119.88098f, 98.08f, 104.0f),
                    PathNode.LineTo(157.96f, 104.0f),
                    PathNode.CurveTo(159.3382f, 111.925255f, 160.0208f, 119.95583f, 160.0f, 128.0f),
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(107.59f, 213.6f),
                    PathNode.CurveTo(82.52798f, 207.59357f, 61.341442f, 190.93655f, 49.59f, 168.0f),
                    PathNode.LineTo(85.29f, 168.0f),
                    PathNode.CurveTo(89.77947f, 184.47092f, 97.345985f, 199.94325f, 107.59f, 213.6f),
                    PathNode.Close,
                    PathNode.MoveTo(81.84f, 152.0f),
                    PathNode.LineTo(43.33f, 152.0f),
                    PathNode.CurveTo(38.889923f, 136.30803f, 38.889923f, 119.69196f, 43.33f, 104.0f),
