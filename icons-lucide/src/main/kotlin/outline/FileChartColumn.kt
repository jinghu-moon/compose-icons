...
val LucideIcons.Outline.FileChartColumn: ImageVector
    get() {
        if (_fileChartColumn != null) return _fileChartColumn!!
        _fileChartColumn = lucideOutlineIcon(
    ...
    addPath(
        pathData = parseSvgPathData("M 8.000 18.000 L 8.000 17.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 12.000 18.000 L 12.000 12.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 16.000 18.000 L 16.000 15.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
