...
val TablerIcons.Outline.SoccerField: ImageVector
    get() {
        ...
        _soccerField = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 3.000 9.000 L 6.000 9.000 L 6.000 15.000 L 3.000 15.000 L 3.000 9.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 18.000 9.000 L 21.000 9.000 L 21.000 15.000 L 18.000 15.000 L 18.000 9.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
