...
val TablerIcons.Filled.Transform: ImageVector
    get() {
        ...
        _transform = tablerFilledIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 18.000 14.000 C 20.183 14.000 21.963 15.750 21.999 17.933 C 22.036 20.116 20.315 21.925 18.133 21.998 C 15.951 22.071 14.114 20.380 14.005 18.200 L 14.000 18.000 L 14.005 17.800 C 14.112 15.671 15.869 14.000 18.000 14.000 Z"),
            ...
            addPath(
                pathData = parseSvgPathData("M 6.000 2.000 C 8.183 2.000 9.963 3.750 9.999 5.933 C 10.036 8.116 8.315 9.925 6.133 9.998 C 3.951 10.071 2.114 8.380 2.005 6.200 L 2.000 6.000 L 2.005 5.800 C 2.112 3.671 3.869 2.000 6.000 2.000 Z"),
                pathFillType = PathFillType.NonZero,
                fill = SolidColor(Color(0xFF000000)),
                fillAlpha = 1f,
                stroke = null,
