...
val PhosphorIcons.Light.Unite: ImageVector
    get() {
        if (_unite != null) return _unite!!
        _unite = phosphorLightIcon(
            name = "Unite",
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(204.3251f, 102.13111f, 225.95837f, 128.96051f, 226.0f, 160.0f),
                    PathNode.Close,
                    PathNode.MoveTo(45.31f, 53.79f),
                    PathNode.LineTo(100.81f, 109.29f),
                    PathNode.CurveTo(95.91226f, 115.00973f, 91.87017f, 121.409706f, 88.81f, 128.29f),
                    PathNode.LineTo(34.0f, 73.48f),
                    PathNode.CurveTo(36.604164f, 66.31255f, 40.430786f, 59.650646f, 45.31f, 53.79f),
                    PathNode.Close,
                    PathNode.MoveTo(134.23f, 149.79f),
                    PathNode.LineTo(106.23f, 121.79f),
                    PathNode.CurveTo(110.50756f, 115.79238f, 115.75238f, 110.54756f, 121.75f, 106.27f),
                    PathNode.LineTo(149.75f, 134.27f),
                    PathNode.CurveTo(145.46901f, 140.25334f, 140.22438f, 145.48447f, 134.23f, 149.75f),
                    PathNode.Close,
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(109.29f, 100.81f),
                    PathNode.LineTo(53.79f, 45.31f),
                    PathNode.CurveTo(59.650646f, 40.430786f, 66.31255f, 36.604164f, 73.48f, 34.0f),
                    PathNode.LineTo(128.28f, 88.81f),
                    PathNode.CurveTo(121.40321f, 91.87102f, 115.00666f, 95.91308f, 109.29f, 100.81f),
                    PathNode.Close,
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(160.49f, 82.01f),
                    PathNode.LineTo(160.0f, 82.01f),
                    PathNode.CurveTo(153.54935f, 82.007614f, 147.12341f, 82.807076f, 140.87f, 84.39f),
                    PathNode.LineTo(87.1f, 30.62f),
                    PathNode.CurveTo(90.049065f, 30.21071f, 93.02267f, 30.00356f, 96.0f, 30.0f),
                    PathNode.CurveTo(127.03948f, 30.041628f, 153.8689f, 51.674892f, 160.49f, 82.0f),
                    PathNode.Close,
                    PathNode.MoveTo(30.0f, 96.0f),
                    PathNode.CurveTo(30.00356f, 93.02267f, 30.21071f, 90.049065f, 30.62f, 87.1f),
                    PathNode.LineTo(84.38f, 140.87f),
                    PathNode.CurveTo(82.79707f, 147.12341f, 81.997604f, 153.54935f, 82.0f, 160.0f),
                    ...
                    PathNode.CurveTo(165.95093f, 225.78929f, 162.97733f, 225.99644f, 160.0f, 226.0f),
