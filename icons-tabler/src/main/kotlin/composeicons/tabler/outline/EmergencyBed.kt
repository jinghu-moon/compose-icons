        ...
        _emergencyBed = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(14.0f, 19.10457f, 14.895431f, 20.0f, 16.0f, 20.0f),
                    PathNode.CurveTo(17.10457f, 20.0f, 18.0f, 19.10457f, 18.0f, 18.0f),
                    PathNode.CurveTo(18.0f, 16.89543f, 17.10457f, 16.0f, 16.0f, 16.0f),
                    PathNode.CurveTo(14.895431f, 16.0f, 14.0f, 16.89543f, 14.0f, 18.0f)
                ),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(9.104569f, 20.0f, 10.0f, 19.10457f, 10.0f, 18.0f),
                    PathNode.CurveTo(10.0f, 16.89543f, 9.104569f, 16.0f, 8.0f, 16.0f),
                    PathNode.CurveTo(6.895431f, 16.0f, 6.0f, 16.89543f, 6.0f, 18.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(6.1f, 10.8f),
                    PathNode.CurveTo(6.666563f, 11.555417f, 7.555728f, 12.0f, 8.5f, 12.0f),
