...
val RadixIcons.Regular.CardStackPlus: ImageVector
    get() {
        ...
        _cardStackPlus = radixIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M12.5 2C13.328 2 14 2.672 14 3.5v6c0 .653-.418 1.206-1 1.412v.588C13 12.328 12.328 13 11.5 13h-8C2.672 13 2 12.328 2 11.5v-.588C1.418 10.706 1 10.153 1 9.5v-6C1 2.672 1.672 2 2.5 2h10ZM3 11.5c0 .276 .224 .5 .5 .5h8c.276 0 .5-.224 .5-.5v-.5h-9v.5ZM2.5 3C2.224 3 2 3.224 2 3.5v6c0 .276 .224 .5 .5 .5h10c.276 0 .5-.224 .5-.5v-6C13 3.224 12.776 3 12.5 3h-10ZM7.5 4C7.776 4 8 4.224 8 4.5v1.5h1.5c.276 0 .5 .224 .5 .5C10 6.776 9.776 7 9.5 7h-1.5v1.5C8 8.776 7.776 9 7.5 9 7.224 9 7 8.776 7 8.5v-1.5h-1.5C5.224 7 5 6.776 5 6.5 5 6.224 5.224 6 5.5 6h1.5v-1.5C7 4.224 7.224 4 7.5 4Z"),
