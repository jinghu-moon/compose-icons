...
val TablerIcons.Outline.DeviceWatchDollar: ImageVector
    get() {
        ...
        _deviceWatchDollar = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 13.000 18.000 L 9.000 18.000 C 7.343 18.000 6.000 16.657 6.000 15.000 L 6.000 9.000 C 6.000 7.343 7.343 6.000 9.000 6.000 L 15.000 6.000 C 16.657 6.000 18.000 7.343 18.000 9.000 L 18.000 10.000"),
