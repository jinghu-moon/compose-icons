...
val TablerIcons.Outline.BallBasketball: ImageVector
    get() {
        ...
        _ballBasketball = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(5.65f, 18.35f),
                    PathNode.LineTo(18.35f, 5.65f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(12.0f, 7.970563f, 16.029438f, 12.0f, 21.0f, 12.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(3.0f, 12.0f),
                    PathNode.CurveTo(7.970563f, 12.0f, 12.0f, 16.029438f, 12.0f, 21.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
