...
val LucideIcons.Outline.LayoutPanelLeft: ImageVector
    get() {
        ...
        _layoutPanelLeft = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 4.000 3.000 L 9.000 3.000 C 9.552 3.000 10.000 3.448 10.000 4.000 L 10.000 20.000 C 10.000 20.552 9.552 21.000 9.000 21.000 L 4.000 21.000 C 3.448 21.000 3.000 20.552 3.000 20.000 L 3.000 4.000 C 3.000 3.448 3.448 3.000 4.000 3.000 Z"),
