...
val LucideIcons.Outline.ShieldQuestionMark: ImageVector
    get() {
        ...
        _shieldQuestionMark = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 9.100 9.000 C 9.595 7.635 10.997 6.821 12.428 7.067 C 13.859 7.312 14.909 8.548 14.920 10.000 C 14.920 12.000 11.920 13.000 11.920 13.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
