...
val PhosphorIcons.Duotone.SunHorizon: ImageVector
    get() {
        ...
        _sunHorizon = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M192 144c.007 5.396-.665 10.772-2 16h-124C59.856 136.003 68.112 110.615 87.195 94.821c19.083-15.794 45.567-19.157 67.992-8.634C177.612 96.71 191.951 119.229 192 144Z"),
