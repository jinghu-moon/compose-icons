        ...
        _hammer = phosphorFillIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(200.0f, 163.32f),
                    PathNode.CurveTo(203.00069f, 166.32137f, 207.0709f, 168.00758f, 211.315f, 168.00758f),
                    PathNode.CurveTo(215.5591f, 168.00758f, 219.62932f, 166.32137f, 222.63f, 163.32f),
                    PathNode.LineTo(251.32f, 134.63f),
                    PathNode.CurveTo(254.32402f, 131.63197f, 256.01382f, 127.56324f, 256.01758f, 123.319145f),
                    PathNode.CurveTo(256.02133f, 119.07504f, 254.33871f, 115.00334f, 251.34f, 112.0f),
                    PathNode.Close,
                    PathNode.MoveTo(162.34f, 114.33f),
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(211.34f, 151.99f),
                    PathNode.LineTo(199.34f, 139.99f),
