...
val TablerIcons.Outline.FunctionOff: ImageVector
    get() {
        ...
        _functionOff = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 9.000 15.500 L 9.000 15.750 C 9.000 16.440 9.560 17.000 10.250 17.000 C 10.960 17.000 11.554 16.462 11.624 15.756 L 12.000 12.000M 12.363 8.370 L 12.376 8.244 C 12.446 7.538 13.040 7.000 13.750 7.000 C 14.440 7.000 15.000 7.560 15.000 8.250 L 15.000 8.500"),
