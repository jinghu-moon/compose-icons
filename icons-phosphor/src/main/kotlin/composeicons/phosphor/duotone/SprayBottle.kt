...
val PhosphorIcons.Duotone.SprayBottle: ImageVector
    get() {
        ...
        _sprayBottle = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M200 211.47v12.53c0 4.418-3.582 8-8 8h-104c-4.418 0-8-3.582-8-8v-56.62c-.006-9.724 4.409-18.923 12-25l16-12.78c7.591-6.077 12.006-15.276 12-25v-32.6h40c26.14 41.823 40 90.15 40 139.47Z"),
