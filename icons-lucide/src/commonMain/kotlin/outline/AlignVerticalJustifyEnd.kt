        ...
        _alignVerticalJustifyEnd = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(18.10457f, 12.0f, 19.0f, 12.895431f, 19.0f, 14.0f),
                    PathNode.LineTo(19.0f, 16.0f),
                    PathNode.CurveTo(19.0f, 17.10457f, 18.10457f, 18.0f, 17.0f, 18.0f),
                    PathNode.LineTo(7.0f, 18.0f),
                    PathNode.CurveTo(5.895431f, 18.0f, 5.0f, 17.10457f, 5.0f, 16.0f),
                    PathNode.LineTo(5.0f, 14.0f),
                    PathNode.CurveTo(5.0f, 12.895431f, 5.895431f, 12.0f, 7.0f, 12.0f),
                    PathNode.Close
                ),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(17.0f, 7.10457f, 16.10457f, 8.0f, 15.0f, 8.0f),
                    PathNode.LineTo(9.0f, 8.0f),
                    PathNode.CurveTo(7.895431f, 8.0f, 7.0f, 7.10457f, 7.0f, 6.0f),
