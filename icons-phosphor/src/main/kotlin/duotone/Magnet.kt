...
val PhosphorIcons.Duotone.Magnet: ImageVector
    get() {
        ...
        _magnet = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(168.36f, 200.36f),
                    PathNode.LineTo(138.36f, 229.71f),
                    PathNode.CurveTo(135.22835f, 232.78476f, 130.20422f, 232.76245f, 127.1f, 229.66f),
                    PathNode.LineTo(98.46f, 201.0f),
                    PathNode.CurveTo(96.94364f, 199.48566f, 96.09825f, 197.42624f, 96.1133f, 195.28325f),
                    PathNode.CurveTo(96.128334f, 193.14027f, 97.00253f, 191.09291f, 98.54f, 189.6f),
                    PathNode.LineTo(128.54f, 160.6f),
                    PathNode.Close,
                    PathNode.MoveTo(26.36f, 117.6f),
                    PathNode.CurveTo(23.258211f, 120.7203f, 23.258211f, 125.7597f, 26.36f, 128.88f),
                    PathNode.LineTo(55.0f, 157.54f),
                    PathNode.CurveTo(56.510906f, 159.05278f, 58.56449f, 159.89781f, 60.70253f, 159.88652f),
                    PathNode.CurveTo(62.84057f, 159.87526f, 64.88513f, 159.00862f, 66.38f, 157.48f),
                    PathNode.LineTo(95.56f, 127.56f),
                    PathNode.LineTo(55.77f, 87.77f),
                    PathNode.Close
                ),
