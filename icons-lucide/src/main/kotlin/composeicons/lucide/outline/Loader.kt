...
val LucideIcons.Outline.Loader: ImageVector
    get() {
        ...
        _loader = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(16.2f, 7.8f),
                    PathNode.LineTo(19.1f, 4.9f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(4.9f, 19.1f),
                    PathNode.LineTo(7.8f, 16.2f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(4.9f, 4.9f),
                    PathNode.LineTo(7.8f, 7.8f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
