...
val TablerIcons.Outline.BallBowling: ImageVector
    get() {
        if (_ballBowling != null) return _ballBowling!!
        _ballBowling = tablerOutlineIcon(
            name = "BallBowling",
    ...
    addPath(
        pathData = parseSvgPathData("M 11.000 9.000 L 11.000 9.010"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 15.000 8.000 L 15.000 8.010"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
