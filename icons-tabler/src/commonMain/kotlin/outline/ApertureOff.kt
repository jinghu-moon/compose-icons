...
val TablerIcons.Outline.ApertureOff: ImageVector
    get() {
        ...
        _apertureOff = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(7.395f, 7.534f),
                    PathNode.LineTo(9.811f, 14.972f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(17.032f, 4.636f),
                    PathNode.LineTo(12.18f, 8.162f),
                    PathNode.MoveTo(9.846f, 9.857f),
                    PathNode.LineTo(8.497f, 10.837f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(20.559f, 14.51f),
                    PathNode.LineTo(12.024f, 8.309f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(12.257f, 20.916f),
                    PathNode.LineTo(14.38f, 14.383f),
                    PathNode.MoveTo(15.364f, 11.355f),
                    PathNode.LineTo(15.518f, 10.882f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
