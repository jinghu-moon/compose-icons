...
val TablerIcons.Outline.CodeVariableMinus: ImageVector
    get() {
        ...
        _codeVariableMinus = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 12.500 16.000 L 6.000 16.000 C 4.895 16.000 4.000 15.105 4.000 14.000 L 4.000 10.000 C 4.000 8.895 4.895 8.000 6.000 8.000 L 18.000 8.000 C 19.105 8.000 20.000 8.895 20.000 10.000 L 20.000 14.000"),
