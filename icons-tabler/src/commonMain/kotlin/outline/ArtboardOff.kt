...
val TablerIcons.Outline.ArtboardOff: ImageVector
    get() {
        ...
        _artboardOff = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(15.716f, 15.698f),
                    PathNode.CurveTo(15.527805f, 15.891074f, 15.26962f, 15.999973f, 15.0f, 16.0f),
                    PathNode.LineTo(9.0f, 16.0f),
                    PathNode.CurveTo(8.447715f, 16.0f, 8.0f, 15.552285f, 8.0f, 15.0f),
                    PathNode.LineTo(8.0f, 9.0f),
                    PathNode.CurveTo(8.0f, 8.727f, 8.11f, 8.48f, 8.287f, 8.3f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
