        ...
        _sidebar = phosphorThinIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(58.20914f, 148.0f, 60.0f, 146.20914f, 60.0f, 144.0f),
                    PathNode.CurveTo(60.0f, 141.79086f, 58.20914f, 140.0f, 56.0f, 140.0f),
                    PathNode.LineTo(36.0f, 140.0f),
                    PathNode.LineTo(36.0f, 116.0f),
                    PathNode.LineTo(56.0f, 116.0f),
                    PathNode.CurveTo(58.20914f, 116.0f, 60.0f, 114.20914f, 60.0f, 112.0f),
                    PathNode.CurveTo(60.0f, 109.79086f, 58.20914f, 108.0f, 56.0f, 108.0f),
                    PathNode.LineTo(36.0f, 108.0f),
                    PathNode.LineTo(36.0f, 84.0f),
                    PathNode.LineTo(56.0f, 84.0f),
                    PathNode.CurveTo(58.20914f, 84.0f, 60.0f, 82.20914f, 60.0f, 80.0f),
