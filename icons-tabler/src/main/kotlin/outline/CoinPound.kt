...
val TablerIcons.Outline.CoinPound: ImageVector
    get() {
        ...
        _coinPound = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 15.000 9.000 C 15.000 7.895 14.105 7.000 13.000 7.000 C 11.895 7.000 11.000 7.895 11.000 9.000 L 11.000 14.000 C 11.000 15.105 10.105 16.000 9.000 16.000 L 15.000 16.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
