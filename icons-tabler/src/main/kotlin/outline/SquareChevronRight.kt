...
val TablerIcons.Outline.SquareChevronRight: ImageVector
    get() {
        if (_squareChevronRight != null) return _squareChevronRight!!
        _squareChevronRight = tablerOutlineIcon(
            name = "SquareChevronRight",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24f, height = 24f),
        ) {
            addPath(
                pathData = parseSvgPathData("M 11.000 9.000 L 14.000 12.000 L 11.000 15.000"),
