        ...
        _arrowBigRightLines = tablerFilledIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(10.999f, 7.999f),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(6.506975f, 8.000067f, 6.933684f, 8.379507f, 6.993f, 8.883f),
                    PathNode.LineTo(7.0f, 9.0f),
                    PathNode.LineTo(7.0f, 15.0f),
                    PathNode.CurveTo(6.999413f, 15.529094f, 6.58679f, 15.966165f, 6.058605f, 15.997172f),
                    PathNode.CurveTo(5.530421f, 16.02818f, 5.069491f, 15.64239f, 5.007f, 15.117f),
                    PathNode.LineTo(5.0f, 15.0f),
                    PathNode.LineTo(5.0f, 9.0f),
                    PathNode.CurveTo(5.0f, 8.447715f, 5.447716f, 8.0f, 6.0f, 8.0f),
                    PathNode.Close
                ),
                pathFillType = PathFillType.NonZero,
                fill = SolidColor(Color.Black),
