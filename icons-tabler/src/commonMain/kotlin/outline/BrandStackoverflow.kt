...
val TablerIcons.Outline.BrandStackoverflow: ImageVector
    get() {
        ...
        _brandStackoverflow = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(8.322f, 12.582f),
                    PathNode.LineTo(16.278f, 13.418f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(8.787f, 9.168f),
                    PathNode.LineTo(16.613f, 10.832f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(10.096f, 5.764f),
                    PathNode.LineTo(17.704f, 8.236f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
