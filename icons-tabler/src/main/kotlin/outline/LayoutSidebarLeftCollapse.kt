...
val TablerIcons.Outline.LayoutSidebarLeftCollapse: ImageVector
    get() {
        if (_layoutSidebarLeftCollapse != null) return _layoutSidebarLeftCollapse!!
        _layoutSidebarLeftCollapse = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 15.000 10.000 L 13.000 12.000 L 15.000 14.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
