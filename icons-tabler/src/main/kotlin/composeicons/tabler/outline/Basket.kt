...
val TablerIcons.Outline.Basket: ImageVector
    get() {
        ...
        _basket = tablerOutlineIcon(
            ...
            addPathData("M5.001 8h13.999c.584-0 1.138 .255 1.518 .698 .38 .443 .548 1.03 .459 1.606l-1.255 7.152c-.225 1.464-1.485 2.544-2.966 2.544h-9.512C5.763 20 4.504 18.92 4.279 17.456L3.024 10.304C2.935 9.727 3.103 9.14 3.483 8.698 3.863 8.255 4.417 8 5.001 8")
