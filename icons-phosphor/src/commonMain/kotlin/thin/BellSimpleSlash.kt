...
val PhosphorIcons.Thin.BellSimpleSlash: ImageVector
    get() {
        ...
        _bellSimpleSlash = phosphorThinIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(71.75f, 60.18f),
                    PathNode.LineTo(71.75f, 60.18f),
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(212.53f, 175.52f),
                    PathNode.CurveTo(212.0655f, 175.70514f, 211.57002f, 175.80016f, 211.07f, 175.8f),
                    PathNode.CurveTo(209.42583f, 175.79834f, 207.95012f, 174.79074f, 207.35f, 173.26f),
