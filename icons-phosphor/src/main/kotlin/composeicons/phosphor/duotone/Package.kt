...
val PhosphorIcons.Duotone.Package: ImageVector
    get() {
        ...
        _package = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M128 129.09v102.91c-1.344-.006-2.664-.349-3.84-1L36.16 182.82c-2.559-1.4-4.153-4.083-4.16-7v-95.64c.003-1.12 .242-2.228 .7-3.25Z"),
