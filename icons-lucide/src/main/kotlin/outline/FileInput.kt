...
val LucideIcons.Outline.FileInput: ImageVector
    get() {
        ...
        _fileInput = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 4.000 11.000 L 4.000 4.000 C 4.000 2.895 4.895 2.000 6.000 2.000 L 14.000 2.000 C 14.640 1.998 15.254 2.253 15.706 2.706 L 19.294 6.294 C 19.747 6.746 20.002 7.360 20.000 8.000 L 20.000 20.000 C 20.000 21.105 19.105 22.000 18.000 22.000 L 6.000 22.000 C 4.895 22.000 4.000 21.105 4.000 20.000 L 4.000 19.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 2.000 15.000 L 12.000 15.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 9.000 18.000 L 12.000 15.000 L 9.000 12.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
