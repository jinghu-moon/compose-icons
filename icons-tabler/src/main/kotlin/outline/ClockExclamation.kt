...
val TablerIcons.Outline.ClockExclamation: ImageVector
    get() {
        ...
        _clockExclamation = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 20.986 12.502 C 21.207 8.540 18.807 4.901 15.078 3.544 C 11.350 2.187 7.172 3.432 4.795 6.608 C 2.417 9.785 2.400 14.144 4.753 17.339 C 7.106 20.533 11.274 21.810 15.013 20.482"),
