...
val PhosphorIcons.Duotone.Infinity: ImageVector
    get() {
        ...
        _infinity = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(225.94f, 161.94f),
                    PathNode.CurveTo(207.1951f, 180.68367f, 176.8049f, 180.68367f, 158.06f, 161.94f),
                    PathNode.LineTo(128.0f, 128.0f),
                    PathNode.LineTo(158.06f, 94.06f),
                    PathNode.CurveTo(176.84846f, 75.57508f, 207.0274f, 75.69797f, 225.66472f, 94.33528f),
                    PathNode.CurveTo(244.30203f, 112.972595f, 244.42491f, 143.15154f, 225.94f, 161.94f),
                    PathNode.Close,
                    PathNode.MoveTo(30.06f, 94.06f),
                    PathNode.CurveTo(11.575082f, 112.84847f, 11.697968f, 143.0274f, 30.33528f, 161.66472f),
                    PathNode.CurveTo(48.97259f, 180.30203f, 79.15153f, 180.42491f, 97.94f, 161.94f),
                    PathNode.LineTo(128.0f, 128.0f),
                    PathNode.LineTo(97.94f, 94.06f),
                    PathNode.CurveTo(79.19509f, 75.31634f, 48.80491f, 75.31634f, 30.06f, 94.06f),
                    PathNode.Close
                ),
