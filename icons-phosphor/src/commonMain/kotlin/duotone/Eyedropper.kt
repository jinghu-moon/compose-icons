...
val PhosphorIcons.Duotone.Eyedropper: ImageVector
    get() {
        ...
        _eyedropper = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(207.8f, 87.6f),
                    PathNode.LineTo(182.43f, 113.13f),
                    PathNode.LineTo(187.32f, 118.01f),
                    PathNode.CurveTo(190.32443f, 121.01109f, 192.01259f, 125.08345f, 192.01259f, 129.33f),
                    PathNode.CurveTo(192.01259f, 133.57655f, 190.32443f, 137.64891f, 187.32f, 140.65f),
                    PathNode.LineTo(178.32f, 149.65f),
                    PathNode.CurveTo(176.81946f, 151.15222f, 174.78328f, 151.99629f, 172.66f, 151.99629f),
                    PathNode.CurveTo(170.53671f, 151.99629f, 168.50055f, 151.15222f, 167.0f, 149.65f),
                    PathNode.LineTo(106.32f, 88.95f),
                    PathNode.CurveTo(104.81779f, 87.449455f, 103.97371f, 85.41328f, 103.97371f, 83.29f),
                    PathNode.CurveTo(103.97371f, 81.166725f, 104.81779f, 79.13055f, 106.32f, 77.63f),
                    PathNode.LineTo(115.32f, 68.63f),
                    PathNode.CurveTo(118.32069f, 65.62863f, 122.3909f, 63.942417f, 126.635f, 63.942417f),
                    PathNode.CurveTo(130.87909f, 63.942417f, 134.94931f, 65.62863f, 137.95f, 68.63f),
                    PathNode.LineTo(142.83f, 73.52f),
                    PathNode.LineTo(167.83f, 48.41f),
                    PathNode.CurveTo(178.62f, 37.62f, 196.2f, 36.96f, 207.28f, 47.41f),
                    PathNode.CurveTo(212.78333f, 52.612537f, 215.94456f, 59.822445f, 216.04254f, 67.39499f),
                    PathNode.CurveTo(216.14052f, 74.96754f, 213.16689f, 82.25682f, 207.8f, 87.6f),
                    PathNode.Close
                ),
