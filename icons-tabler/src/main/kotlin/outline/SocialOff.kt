...
val TablerIcons.Outline.SocialOff: ImageVector
    get() {
        ...
        _socialOff = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 17.570 17.602 C 16.789 18.383 16.790 19.650 17.572 20.431 C 18.353 21.211 19.619 21.210 20.400 20.429"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 11.113 11.133 C 9.745 11.557 8.868 12.888 9.017 14.312 C 9.167 15.736 10.302 16.856 11.727 16.986 C 13.153 17.117 14.473 16.221 14.878 14.848"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 6.700 17.800 L 9.500 15.800"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 17.300 17.800 L 14.500 15.800"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
