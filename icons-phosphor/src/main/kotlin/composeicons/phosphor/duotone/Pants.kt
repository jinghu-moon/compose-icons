...
val PhosphorIcons.Duotone.Pants: ImageVector
    get() {
        ...
        _pants = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M202.05 104c-.68 0-1.36 0-2.05 0C177.909 104 160 86.091 160 64h-64c0 22.091-17.909 40-40 40-.69 0-1.37 0-2 0L62.06 39c.504-4.001 3.907-7.001 7.94-7h116c4.033-.001 7.436 2.999 7.94 7Z"),
