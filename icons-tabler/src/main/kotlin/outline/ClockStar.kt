...
val TablerIcons.Outline.ClockStar: ImageVector
    get() {
        ...
        _clockStar = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 20.982 11.436 C 20.683 6.675 16.722 2.975 11.952 3.000 C 7.182 3.025 3.260 6.768 3.012 11.531 C 2.763 16.295 6.275 20.425 11.016 20.946"),
