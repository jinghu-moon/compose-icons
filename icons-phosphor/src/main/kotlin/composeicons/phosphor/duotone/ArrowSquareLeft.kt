...
val PhosphorIcons.Duotone.ArrowSquareLeft: ImageVector
    get() {
        ...
        _arrowSquareLeft = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M208 32h-160C39.163 32 32 39.163 32 48v160c0 8.837 7.163 16 16 16h160c8.837 0 16-7.163 16-16v-160c0-8.837-7.163-16-16-16ZM208 208h-160v-160h160ZM82.34 133.66C80.838 132.159 79.994 130.123 79.994 128c0-2.123 .844-4.159 2.346-5.66l32-32c3.126-3.126 8.194-3.126 11.32 0 3.126 3.126 3.126 8.194 0 11.32L107.31 120h60.69c4.418 0 8 3.582 8 8 0 4.418-3.582 8-8 8h-60.69l18.35 18.34c3.126 3.126 3.126 8.194 0 11.32-3.126 3.126-8.194 3.126-11.32 0Z"),
                pathFillType = PathFillType.NonZero,
                fill = SolidColor(Color(0xFF000000)),
                fillAlpha = 1f,
                stroke = null,
