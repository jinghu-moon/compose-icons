...
val TablerIcons.Outline.Rating12Plus: ImageVector
    get() {
        ...
        _rating12Plus = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 10.000 10.500 C 10.000 9.672 10.672 9.000 11.500 9.000 C 12.328 9.000 13.000 9.672 13.000 10.500 C 13.000 10.943 12.687 11.489 12.388 11.893 L 10.000 15.000 L 13.000 15.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
