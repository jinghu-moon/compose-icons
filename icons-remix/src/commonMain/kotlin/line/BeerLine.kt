...
val RemixIcons.Line.BeerLine: ImageVector
    get() {
        if (_beerLine != null) return _beerLine!!
        _beerLine = remixIcon(
            name = "BeerLine",
