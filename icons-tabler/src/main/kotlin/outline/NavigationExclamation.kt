...
val TablerIcons.Outline.NavigationExclamation: ImageVector
    get() {
        ...
        _navigationExclamation = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 16.535 12.832 L 12.000 3.000 L 4.030 20.275 C 3.960 20.475 4.013 20.699 4.165 20.847 C 4.315 20.995 4.539 21.040 4.735 20.963 L 12.000 18.500 C 13.380 18.968 14.416 19.320 15.107 19.553"),
