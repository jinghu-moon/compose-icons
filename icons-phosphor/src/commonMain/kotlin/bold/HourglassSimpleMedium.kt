        ...
        _hourglassSimpleMedium = phosphorBoldIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(107.75f, 92.0f),
                    PathNode.LineTo(148.25f, 92.0f),
                    PathNode.LineTo(128.0f, 111.39f),
                    PathNode.Close,
                    PathNode.MoveTo(190.0f, 52.0f),
                    PathNode.LineTo(173.31f, 68.0f),
                    PathNode.LineTo(82.69f, 68.0f),
                    PathNode.LineTo(66.0f, 52.0f),
                    PathNode.Close,
                    PathNode.MoveTo(66.0f, 204.0f),
                    PathNode.LineTo(116.0f, 156.1f),
