...
val TablerIcons.Outline.FlipVertical: ImageVector
    get() {
        ...
        _flipVertical = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 16.000 7.000 L 16.000 17.000 L 21.000 17.000 L 16.000 7.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 8.000 7.000 L 8.000 17.000 L 3.000 17.000 L 8.000 7.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
