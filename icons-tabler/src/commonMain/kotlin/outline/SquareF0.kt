...
val TablerIcons.Outline.SquareF0: ImageVector
    get() {
        ...
        _squareF0 = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(13.0f, 10.5f),
                    PathNode.LineTo(13.0f, 13.5f),
                    PathNode.CurveTo(13.0f, 14.328427f, 13.671573f, 15.0f, 14.5f, 15.0f),
                    PathNode.CurveTo(15.328427f, 15.0f, 16.0f, 14.328427f, 16.0f, 13.5f),
                    PathNode.LineTo(16.0f, 10.5f),
                    PathNode.CurveTo(16.0f, 9.671573f, 15.328427f, 9.0f, 14.5f, 9.0f),
                    PathNode.CurveTo(13.671573f, 9.0f, 13.0f, 9.671573f, 13.0f, 10.5f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
