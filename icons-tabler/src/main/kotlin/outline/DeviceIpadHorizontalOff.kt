...
val TablerIcons.Outline.DeviceIpadHorizontalOff: ImageVector
    get() {
        ...
        _deviceIpadHorizontalOff = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 8.000 4.000 L 20.000 4.000 C 21.105 4.000 22.000 4.895 22.000 6.000 L 22.000 18.000M 20.000 20.000 L 4.000 20.000 C 2.895 20.000 2.000 19.105 2.000 18.000 L 2.000 6.000 C 2.000 4.895 2.895 4.000 4.000 4.000"),
