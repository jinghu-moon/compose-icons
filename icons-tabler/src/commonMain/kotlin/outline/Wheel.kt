...
val TablerIcons.Outline.Wheel: ImageVector
    get() {
        ...
        _wheel = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(13.6f, 9.4f),
                    PathNode.LineTo(17.0f, 4.6f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(10.4f, 14.6f),
                    PathNode.LineTo(7.0f, 19.4f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(7.0f, 4.6f),
                    PathNode.LineTo(10.4f, 9.4f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(13.6f, 14.6f),
                    PathNode.LineTo(17.0f, 19.4f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
