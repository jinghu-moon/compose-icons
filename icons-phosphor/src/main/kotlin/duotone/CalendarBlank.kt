...
val PhosphorIcons.Duotone.CalendarBlank: ImageVector
    get() {
        if (_calendarBlank != null) return _calendarBlank!!
        _calendarBlank = phosphorDuotoneIcon(
            name = "CalendarBlank",
