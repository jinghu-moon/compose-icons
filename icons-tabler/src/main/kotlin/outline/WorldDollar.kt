...
val TablerIcons.Outline.WorldDollar: ImageVector
    get() {
        ...
        _worldDollar = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 20.876 10.510 C 20.063 5.667 15.517 2.369 10.661 3.100 C 5.805 3.831 2.431 8.320 3.079 13.188 C 3.727 18.056 8.159 21.506 13.037 20.940"),
            ...
            addPath(
                pathData = parseSvgPathData("M 12.500 3.000 C 14.189 5.705 15.082 8.831 15.078 12.020"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
