...
val TablerIcons.Outline.ShieldExclamation: ImageVector
    get() {
        ...
        _shieldExclamation = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 15.040 19.745 C 14.098 20.296 13.076 20.721 12.000 21.000 C 8.855 20.184 6.175 18.128 4.573 15.301 C 2.971 12.473 2.584 9.118 3.500 6.000 C 6.616 6.143 9.664 5.067 12.000 3.000 C 14.336 5.067 17.384 6.143 20.500 6.000 C 21.075 7.956 21.142 10.026 20.695 12.015"),
