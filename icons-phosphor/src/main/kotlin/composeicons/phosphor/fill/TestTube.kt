...
val PhosphorIcons.Fill.TestTube: ImageVector
    get() {
        ...
        _testTube = phosphorFillIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M237.66 86.34l-60-60C176.159 24.838 174.123 23.994 172 23.994c-2.123 0-4.159 .844-5.66 2.346L37.11 155.57c-17.485 17.485-17.485 45.835 0 63.32 17.485 17.485 45.835 17.485 63.32 0L212.32 107l22.21-7.4c2.632-.876 4.623-3.052 5.261-5.752 .638-2.7-.169-5.537-2.131-7.498ZM205.47 92.41c-1.179 .392-2.251 1.052-3.13 1.93l-39.57 39.57c-8.47 2.9-21.75 4-39.07-5-10.6-5.54-20.18-8-28.56-8.73L172 43.31l45.19 45.19Z"),
