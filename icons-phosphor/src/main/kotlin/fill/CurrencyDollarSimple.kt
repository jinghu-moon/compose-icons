        ...
        _currencyDollarSimple = phosphorFillIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(94.32689f, 184.0f, 80.0f, 169.67311f, 80.0f, 152.0f),
                    ...
                    PathNode.CurveTo(96.0f, 160.83656f, 103.163445f, 168.0f, 112.0f, 168.0f),
                    PathNode.LineTo(144.0f, 168.0f),
                    PathNode.CurveTo(152.83656f, 168.0f, 160.0f, 160.83656f, 160.0f, 152.0f),
                    PathNode.CurveTo(160.0f, 143.16344f, 152.83656f, 136.0f, 144.0f, 136.0f),
                    PathNode.LineTo(116.0f, 136.0f),
                    PathNode.CurveTo(98.32689f, 136.0f, 84.0f, 121.67311f, 84.0f, 104.0f),
                    PathNode.CurveTo(84.0f, 86.32689f, 98.32689f, 72.0f, 116.0f, 72.0f),
                    ...
                    PathNode.CurveTo(157.67311f, 72.0f, 172.0f, 86.32689f, 172.0f, 104.0f),
                    PathNode.CurveTo(172.0f, 108.41828f, 168.41827f, 112.0f, 164.0f, 112.0f),
                    PathNode.CurveTo(159.58173f, 112.0f, 156.0f, 108.41828f, 156.0f, 104.0f),
                    PathNode.CurveTo(156.0f, 95.163445f, 148.83656f, 88.0f, 140.0f, 88.0f),
                    ...
                    PathNode.CurveTo(161.67311f, 120.0f, 176.0f, 134.32689f, 176.0f, 152.0f),
                    PathNode.CurveTo(176.0f, 169.67311f, 161.67311f, 184.0f, 144.0f, 184.0f),
                    PathNode.Close
                ),
