...
val TablerIcons.Outline.Number88Small: ImageVector
    get() {
        if (_number88Small != null) return _number88Small!!
        _number88Small = tablerOutlineIcon(
            name = "Number88Small",
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(14.0f, 8.447715f, 14.447715f, 8.0f, 15.0f, 8.0f),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(6.447716f, 12.0f, 6.0f, 11.552285f, 6.0f, 11.0f),
                    PathNode.LineTo(6.0f, 9.0f),
                    PathNode.CurveTo(6.0f, 8.447715f, 6.447716f, 8.0f, 7.0f, 8.0f),
