...
val PhosphorIcons.Duotone.Certificate: ImageVector
    get() {
        ...
        _certificate = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M224 56v34.06h0C211.887 79.938 195.279 77.081 180.48 82.572c-14.8 5.492-25.523 18.49-28.102 34.064-2.579 15.573 3.383 31.335 15.622 41.304h0v34.06h-128c-4.418 0-8-3.582-8-8v-128c0-4.418 3.582-8 8-8h176c4.418 0 8 3.582 8 8Z"),
