...
val TablerIcons.Outline.Template: ImageVector
    get() {
        ...
        _template = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 4.000 5.000 C 4.000 4.448 4.448 4.000 5.000 4.000 L 19.000 4.000 C 19.552 4.000 20.000 4.448 20.000 5.000 L 20.000 7.000 C 20.000 7.552 19.552 8.000 19.000 8.000 L 5.000 8.000 C 4.448 8.000 4.000 7.552 4.000 7.000 L 4.000 5.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 14.000 16.000 L 20.000 16.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
