...
val TablerIcons.Outline.BuildingMonument: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 8.000 18.000 L 10.000 5.000 L 12.000 3.000 L 14.000 5.000 L 16.000 18.000"),
    ...
    addPath(
        pathData = parseSvgPathData("M 5.000 21.000 L 5.000 18.000 L 19.000 18.000 L 19.000 21.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
