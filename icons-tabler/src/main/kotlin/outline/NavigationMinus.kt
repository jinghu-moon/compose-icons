...
val TablerIcons.Outline.NavigationMinus: ImageVector
    get() {
        ...
        _navigationMinus = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 17.500 15.000 C 16.268 12.330 14.435 8.330 12.000 3.000 L 4.030 20.275 C 3.960 20.475 4.013 20.699 4.165 20.847 C 4.315 20.995 4.539 21.040 4.735 20.963 L 12.000 18.500"),
