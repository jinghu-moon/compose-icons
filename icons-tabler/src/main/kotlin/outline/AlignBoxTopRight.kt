...
val TablerIcons.Outline.AlignBoxTopRight: ImageVector
    get() {
        if (_alignBoxTopRight != null) return _alignBoxTopRight!!
        _alignBoxTopRight = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 11.000 9.000 L 11.000 7.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 14.000 13.000 L 14.000 7.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 17.000 11.000 L 17.000 7.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
