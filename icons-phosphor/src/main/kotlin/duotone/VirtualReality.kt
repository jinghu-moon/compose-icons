...
val PhosphorIcons.Duotone.VirtualReality: ImageVector
    get() {
        if (_virtualReality != null) return _virtualReality!!
        _virtualReality = phosphorDuotoneIcon(
            name = "VirtualReality",
            ...
            group(
                ...
                addPath(
                    pathData = parseSvgPathData("M 248.000 128.000 L 248.000 128.000 C 248.000 167.764 215.764 200.000 176.000 200.000 L 80.000 200.000 C 40.235 200.000 8.000 167.764 8.000 128.000 L 8.000 128.000 C 8.000 88.235 40.235 56.000 80.000 56.000 L 176.000 56.000 C 215.764 56.000 248.000 88.235 248.000 128.000 Z"),
