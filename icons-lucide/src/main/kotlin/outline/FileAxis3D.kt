...
val LucideIcons.Outline.FileAxis3D: ImageVector
    get() {
        if (_fileAxis3D != null) return _fileAxis3D!!
        _fileAxis3D = lucideOutlineIcon(
            name = "FileAxis3D",
            ...
            addPath(
                pathData = parseSvgPathData("M 8.000 18.000 L 12.000 14.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 8.000 10.000 L 8.000 18.000 L 16.000 18.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
