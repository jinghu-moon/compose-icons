...
val PhosphorIcons.Duotone.Gavel: ImageVector
    get() {
        ...
        _gavel = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M149.66 45.66l-64 64c-1.501 1.502-3.537 2.346-5.66 2.346-2.123 0-4.159-.844-5.66-2.346l-16-16C56.838 92.159 55.994 90.123 55.994 88c0-2.123 .844-4.159 2.346-5.66L122.34 18.34c1.501-1.502 3.537-2.346 5.66-2.346 2.123 0 4.159 .844 5.66 2.346l16 16c1.502 1.501 2.346 3.537 2.346 5.66 0 2.123-.844 4.159-2.346 5.66ZM237.66 122.34l-16-16c-1.501-1.502-3.537-2.346-5.66-2.346-2.123 0-4.159 .844-5.66 2.346l-64 64c-1.502 1.501-2.346 3.537-2.346 5.66 0 2.123 .844 4.159 2.346 5.66l16 16c1.501 1.502 3.537 2.346 5.66 2.346 2.123 0 4.159-.844 5.66-2.346l64-64c1.502-1.501 2.346-3.537 2.346-5.66 0-2.123-.844-4.159-2.346-5.66Z"),
