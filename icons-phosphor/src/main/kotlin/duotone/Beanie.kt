...
val PhosphorIcons.Duotone.Beanie: ImageVector
    get() {
        if (_beanie != null) return _beanie!!
        _beanie = phosphorDuotoneIcon(
            name = "Beanie",
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(40.0f, 95.39894f, 79.39894f, 56.0f, 128.0f, 56.0f),
                    PathNode.CurveTo(176.60106f, 56.0f, 216.0f, 95.39894f, 216.0f, 144.0f),
                    PathNode.Close
                ),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(172.16223f, 64.0496f, 207.9504f, 99.83778f, 208.0f, 144.0f),
                    PathNode.LineTo(208.0f, 160.0f),
                    PathNode.LineTo(48.0f, 160.0f),
                    PathNode.LineTo(48.0f, 144.0f),
                    PathNode.CurveTo(48.0496f, 99.83778f, 83.83778f, 64.0496f, 128.0f, 64.0f),
                    PathNode.Close,
