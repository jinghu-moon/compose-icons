...
val TablerIcons.Filled.BatteryVertical3: ImageVector
    get() {
        ...
        _batteryVertical3 = tablerFilledIcon(
            name = "BatteryVertical3",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24f, height = 24f),
        ) {
            addPath(
                pathData = parseSvgPathData("M13.5 3c.615-0 1.169 .376 1.395 .948L14.913 4h.087c1.589-0 2.902 1.238 2.995 2.824L18 7v11c0 1.657-1.343 3-3 3h-6C7.343 21 6 19.657 6 18v-11C6 5.343 7.343 4 9 4h.086l.019-.052c.207-.523 .69-.887 1.25-.941L10.5 3ZM14 16h-4c-.552 0-1 .448-1 1 0 .552 .448 1 1 1h4c.552 0 1-.448 1-1 0-.552-.448-1-1-1M14 13h-4c-.552 0-1 .448-1 1 0 .552 .448 1 1 1h4c.552 0 1-.448 1-1 0-.552-.448-1-1-1M14 10h-4c-.552 0-1 .448-1 1 0 .552 .448 1 1 1h4c.552 0 1-.448 1-1 0-.552-.448-1-1-1"),
