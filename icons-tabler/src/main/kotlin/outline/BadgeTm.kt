...
val TablerIcons.Outline.BadgeTm: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 6.000 9.000 L 10.000 9.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 8.000 9.000 L 8.000 15.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 13.000 15.000 L 13.000 9.000 L 15.000 12.000 L 17.000 9.000 L 17.000 15.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
