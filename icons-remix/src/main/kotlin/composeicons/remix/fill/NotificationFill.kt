...
val RemixIcons.Fill.NotificationFill: ImageVector
    get() {
        ...
        _notificationFill = remixIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M12 2c4.971 0 9 4.043 9 9.031v8.969h-18v-8.969C3 6.043 7.029 2 12 2ZM9.5 21h5c0 1.381-1.119 2.5-2.5 2.5C10.619 23.5 9.5 22.381 9.5 21Z"),
