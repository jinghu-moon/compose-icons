...
val PhosphorIcons.Light.BatteryWarning: ImageVector
    get() {
        if (_batteryWarning != null) return _batteryWarning!!
        _batteryWarning = phosphorLightIcon(
            name = "BatteryWarning",
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(110.0f, 124.0f),
                    PathNode.LineTo(110.0f, 96.0f),
                    PathNode.CurveTo(110.0f, 92.686295f, 112.686295f, 90.0f, 116.0f, 90.0f),
                    PathNode.CurveTo(119.313705f, 90.0f, 122.0f, 92.686295f, 122.0f, 96.0f),
                    PathNode.LineTo(122.0f, 124.0f),
                    PathNode.CurveTo(122.0f, 127.313705f, 119.313705f, 130.0f, 116.0f, 130.0f),
                    PathNode.CurveTo(112.686295f, 130.0f, 110.0f, 127.313705f, 110.0f, 124.0f),
                    PathNode.Close,
                    PathNode.MoveTo(126.0f, 156.0f),
                    PathNode.CurveTo(126.0f, 161.52284f, 121.52285f, 166.0f, 116.0f, 166.0f),
                    PathNode.CurveTo(110.47715f, 166.0f, 106.0f, 161.52284f, 106.0f, 156.0f),
                    PathNode.CurveTo(106.0f, 150.47716f, 110.47715f, 146.0f, 116.0f, 146.0f),
                    PathNode.CurveTo(121.52285f, 146.0f, 126.0f, 150.47716f, 126.0f, 156.0f),
                    PathNode.Close
                ),
