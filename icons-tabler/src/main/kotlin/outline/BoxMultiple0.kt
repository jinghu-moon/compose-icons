...
val TablerIcons.Outline.BoxMultiple0: ImageVector
    get() {
        if (_boxMultiple0 != null) return _boxMultiple0!!
        _boxMultiple0 = tablerOutlineIcon(
            name = "BoxMultiple0",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24.0f, height = 24.0f),
        ) {
    addPath(
        pathData = parseSvgPathData("M 14.000 6.000 C 15.105 6.000 16.000 6.895 16.000 8.000 L 16.000 12.000 C 16.000 13.105 15.105 14.000 14.000 14.000 C 12.895 14.000 12.000 13.105 12.000 12.000 L 12.000 8.000 C 12.000 6.895 12.895 6.000 14.000 6.000"),
