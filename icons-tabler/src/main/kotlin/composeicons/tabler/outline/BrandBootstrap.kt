        ...
        _brandBootstrap = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(3.10457f, 12.0f, 4.0f, 11.104569f, 4.0f, 10.0f),
                    ...
                    PathNode.CurveTo(20.0f, 11.104569f, 20.89543f, 12.0f, 22.0f, 12.0f)
                ),
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(2.0f, 12.0f),
                    PathNode.CurveTo(3.10457f, 12.0f, 4.0f, 12.895431f, 4.0f, 14.0f),
                    ...
                    PathNode.CurveTo(20.0f, 12.895431f, 20.89543f, 12.0f, 22.0f, 12.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(13.604569f, 8.0f, 14.5f, 8.895431f, 14.5f, 10.0f),
                    PathNode.CurveTo(14.5f, 11.104569f, 13.604569f, 12.0f, 12.5f, 12.0f),
                    PathNode.LineTo(9.0f, 12.0f),
                    PathNode.LineTo(13.0f, 12.0f),
                    PathNode.CurveTo(14.104569f, 12.0f, 15.0f, 12.895431f, 15.0f, 14.0f),
