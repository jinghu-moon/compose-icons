        ...
        _rocketLaunch = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(184.0f, 181.65f),
                    PathNode.CurveTo(183.99902f, 183.7689f, 183.15746f, 185.80087f, 181.66f, 187.3f),
                    PathNode.LineTo(147.31f, 221.65f),
                    PathNode.CurveTo(145.16634f, 223.78897f, 141.99864f, 224.5342f, 139.12617f, 223.57529f),
                    PathNode.CurveTo(136.25371f, 222.6164f, 134.1689f, 220.11777f, 133.74f, 217.12f),
                    PathNode.LineTo(128.0f, 176.0f),
                    PathNode.Close,
                    PathNode.MoveTo(136.0f, 72.0f),
                    PathNode.LineTo(74.35f, 72.0f),
                    PathNode.CurveTo(72.231094f, 72.000984f, 70.19913f, 72.842545f, 68.7f, 74.34f),
                    PathNode.LineTo(34.35f, 108.69f),
                    PathNode.CurveTo(32.211025f, 110.83367f, 31.46581f, 114.00136f, 32.42471f, 116.873825f),
                    PathNode.CurveTo(33.38361f, 119.746284f, 35.882236f, 121.8311f, 38.88f, 122.26f),
                    PathNode.LineTo(80.0f, 128.0f),
                    PathNode.Close,
                    PathNode.MoveTo(40.0f, 216.0f),
                    PathNode.CurveTo(77.65f, 216.0f, 90.69f, 196.31f, 94.56f, 187.82f),
                    PathNode.LineTo(68.18f, 161.44f),
                    PathNode.CurveTo(59.69f, 165.31f, 40.0f, 178.35f, 40.0f, 216.0f),
                    PathNode.Close
                ),
