        ...
        _helicopter = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(10.0f, 15.1f, 10.9f, 16.0f, 12.0f, 16.0f),
                    PathNode.LineTo(19.0f, 16.0f),
                    PathNode.CurveTo(20.10457f, 16.0f, 21.0f, 15.104569f, 21.0f, 14.0f),
                    PathNode.CurveTo(21.0f, 10.69f, 17.87f, 9.0f, 14.0f, 9.0f),
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(15.0f, 9.1f),
                    PathNode.LineTo(15.0f, 13.0f),
                    PathNode.LineTo(20.5f, 13.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
