...
val TablerIcons.Outline.ExchangeOff: ImageVector
    get() {
        ...
        _exchangeOff = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 19.000 8.000 L 19.000 13.000 C 19.000 13.594 18.896 14.164 18.706 14.692M 17.014 16.990 C 16.147 17.647 15.088 18.002 14.000 18.000 L 11.000 18.000 L 14.000 15.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 14.000 21.000 L 11.000 18.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 5.000 16.000 L 5.000 11.000 C 5.000 9.368 5.782 7.918 6.992 7.000M 10.000 6.000 L 13.000 6.000 L 10.000 3.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 11.501 7.499 L 13.000 6.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
