...
val TablerIcons.Outline.RewindForward60: ImageVector
    get() {
        ...
        _rewindForward60 = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 14.000 L 10.000 14.000 C 9.448 14.000 9.000 14.448 9.000 15.000 L 9.000 19.000 C 9.000 19.552 9.448 20.000 10.000 20.000 L 11.000 20.000 C 11.552 20.000 12.000 19.552 12.000 19.000 L 12.000 18.000 C 12.000 17.448 11.552 17.000 11.000 17.000 L 9.000 17.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
