...
val TablerIcons.Outline.Stretching2: ImageVector
    get() {
        ...
        _stretching2 = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 6.500 21.000 L 10.000 16.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 5.000 11.000 L 12.000 9.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 16.000 21.000 L 12.000 14.000 L 12.000 9.000 L 19.000 5.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
