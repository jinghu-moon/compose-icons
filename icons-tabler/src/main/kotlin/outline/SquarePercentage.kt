...
val TablerIcons.Outline.SquarePercentage: ImageVector
    get() {
        ...
        _squarePercentage = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 9.000 15.037 L 15.000 9.037"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 9.000 9.068 L 9.000 9.082"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 15.000 15.082 L 15.000 15.098"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
