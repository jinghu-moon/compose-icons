...
val LucideIcons.Outline.SquareSigma: ImageVector
    get() {
        if (_squareSigma != null) return _squareSigma!!
        _squareSigma = lucideOutlineIcon(
            name = "SquareSigma",
    ...
    addPath(
        pathData = parseSvgPathData("M 16.000 8.900 L 16.000 7.000 L 8.000 7.000 L 12.000 12.000 L 8.000 17.000 L 16.000 17.000 L 16.000 15.100"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
