        ...
        _creditCardOff = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(21.000298f, 16.294712f, 20.957169f, 16.587862f, 20.872f, 16.87f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(18.87f, 18.872f),
                    PathNode.CurveTo(18.587862f, 18.957169f, 18.294712f, 19.000298f, 18.0f, 19.0f),
                    PathNode.LineTo(6.0f, 19.0f),
                    PathNode.CurveTo(4.343146f, 19.0f, 3.0f, 17.656855f, 3.0f, 16.0f),
                    PathNode.LineTo(3.0f, 8.0f),
                    PathNode.CurveTo(3.0f, 6.648f, 3.894f, 5.505f, 5.124f, 5.13f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
