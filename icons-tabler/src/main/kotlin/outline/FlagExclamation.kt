...
val TablerIcons.Outline.FlagExclamation: ImageVector
    get() {
        ...
        _flagExclamation = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 15.035 15.408 C 13.891 15.303 12.819 14.805 12.000 14.000 C 10.056 12.094 6.944 12.094 5.000 14.000 L 5.000 5.000 C 6.944 3.094 10.056 3.094 12.000 5.000 C 13.944 6.906 17.056 6.906 19.000 5.000 L 19.000 12.000"),
