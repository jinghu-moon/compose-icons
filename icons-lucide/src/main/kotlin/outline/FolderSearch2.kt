...
val LucideIcons.Outline.FolderSearch2: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 14.000 12.500 C 14.000 13.881 12.881 15.000 11.500 15.000 C 10.119 15.000 9.000 13.881 9.000 12.500 C 9.000 11.119 10.119 10.000 11.500 10.000 C 12.881 10.000 14.000 11.119 14.000 12.500 Z"),
    ...
    addPath(
        pathData = parseSvgPathData("M 13.300 14.300 L 15.000 16.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
