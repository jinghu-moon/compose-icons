...
val TablerIcons.Outline.DeviceIpadHorizontalCog: ImageVector
    get() {
        if (_deviceIpadHorizontalCog != null) return _deviceIpadHorizontalCog!!
        _deviceIpadHorizontalCog = tablerOutlineIcon(
            name = "DeviceIpadHorizontalCog",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24f, height = 24f),
        ) {
            addPath(
                pathData = parseSvgPathData("M 12.000 20.000 L 5.000 20.000 C 3.895 20.000 3.000 19.105 3.000 18.000 L 3.000 6.000 C 3.000 4.895 3.895 4.000 5.000 4.000 L 19.000 4.000 C 20.105 4.000 21.000 4.895 21.000 6.000 L 21.000 12.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 9.000 17.000 L 12.000 17.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
