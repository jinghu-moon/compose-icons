...
val LucideIcons.Outline.BadgeRussianRuble: ImageVector
    get() {
        if (_badgeRussianRuble != null) return _badgeRussianRuble!!
        _badgeRussianRuble = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 9.000 16.000 L 14.000 16.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 9.000 12.000 L 14.000 12.000 C 15.105 12.000 16.000 11.105 16.000 10.000 C 16.000 8.895 15.105 8.000 14.000 8.000 L 11.000 8.000 L 11.000 17.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
