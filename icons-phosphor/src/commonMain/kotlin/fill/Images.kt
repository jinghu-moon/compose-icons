        ...
        _images = phosphorFillIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(72.0f, 120.69f),
                    PathNode.LineTo(102.34f, 90.34f),
                    PathNode.CurveTo(103.840546f, 88.83778f, 105.876724f, 87.993706f, 108.0f, 87.993706f),
                    PathNode.CurveTo(110.123276f, 87.993706f, 112.159454f, 88.83778f, 113.66f, 90.34f),
                    PathNode.LineTo(163.31f, 140.0f),
                    PathNode.LineTo(189.0f, 114.34f),
                    PathNode.CurveTo(192.12376f, 111.21828f, 197.18623f, 111.21828f, 200.31f, 114.34f),
                    PathNode.LineTo(216.0f, 130.07f),
