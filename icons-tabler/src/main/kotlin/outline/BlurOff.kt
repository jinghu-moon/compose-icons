...
val TablerIcons.Outline.BlurOff: ImageVector
    get() {
        ...
        _blurOff = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 16.000 12.000 L 21.000 12.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 13.000 9.000 L 20.000 9.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 15.000 L 15.000 15.000M 19.000 15.000 L 20.000 15.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
