...
val TablerIcons.Outline.AlignBoxTopCenter: ImageVector
    get() {
        if (_alignBoxTopCenter != null) return _alignBoxTopCenter!!
        _alignBoxTopCenter = tablerOutlineIcon(
    ...
    addPath(
        pathData = parseSvgPathData("M 9.000 9.000 L 9.000 7.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 15.000 11.000 L 15.000 7.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
