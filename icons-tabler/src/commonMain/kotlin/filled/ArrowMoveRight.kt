        ...
        _arrowMoveRight = tablerFilledIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(6.656854f, 9.0f, 8.0f, 10.343145f, 8.0f, 12.0f),
                    PathNode.CurveTo(8.0f, 13.656855f, 6.656854f, 15.0f, 5.0f, 15.0f),
                    PathNode.CurveTo(3.343146f, 15.0f, 2.0f, 13.656855f, 2.0f, 12.0f),
                    PathNode.CurveTo(2.0f, 10.343145f, 3.343146f, 9.0f, 5.0f, 9.0f)
                ),
