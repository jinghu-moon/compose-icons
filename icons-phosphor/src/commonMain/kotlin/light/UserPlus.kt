        ...
        _userPlus = phosphorLightIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(230.0f, 142.0f),
                    PathNode.LineTo(230.0f, 160.0f),
                    PathNode.CurveTo(230.0f, 163.3137f, 227.3137f, 166.0f, 224.0f, 166.0f),
                    PathNode.CurveTo(220.6863f, 166.0f, 218.0f, 163.3137f, 218.0f, 160.0f),
                    ...
                    PathNode.CurveTo(218.0f, 108.686295f, 220.6863f, 106.0f, 224.0f, 106.0f),
                    PathNode.CurveTo(227.3137f, 106.0f, 230.0f, 108.686295f, 230.0f, 112.0f),
                    PathNode.LineTo(230.0f, 130.0f),
                    ...
                    PathNode.CurveTo(35.14f, 177.41f, 55.0f, 164.48f, 77.0f, 158.25f),
                    PathNode.CurveTo(50.25236f, 144.01926f, 36.629093f, 113.405136f, 43.96252f, 84.008354f),
                    PathNode.CurveTo(51.295948f, 54.61157f, 77.70231f, 33.98337f, 108.0f, 33.98337f),
                    PathNode.CurveTo(138.29768f, 33.98337f, 164.70404f, 54.61157f, 172.03748f, 84.008354f),
                    PathNode.CurveTo(179.37091f, 113.405136f, 165.74763f, 144.01926f, 139.0f, 158.25f),
