        ...
        _handPointing = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(216.0f, 196.18279f, 180.18279f, 232.0f, 136.0f, 232.0f),
                    PathNode.CurveTo(91.82f, 232.0f, 80.19f, 208.0f, 42.68f, 142.0f),
                    PathNode.CurveTo(37.246193f, 132.4428f, 40.54517f, 120.29158f, 50.066113f, 114.79451f),
                    PathNode.CurveTo(59.58706f, 109.297424f, 71.75989f, 112.51573f, 77.32f, 122.0f),
                    PathNode.LineTo(96.0f, 152.0f),
                    PathNode.LineTo(96.0f, 44.0f),
                    PathNode.CurveTo(96.0f, 32.954304f, 104.95431f, 24.0f, 116.0f, 24.0f),
                    PathNode.CurveTo(127.04569f, 24.0f, 136.0f, 32.954304f, 136.0f, 44.0f),
                    PathNode.LineTo(136.0f, 100.0f),
                    PathNode.CurveTo(136.0f, 88.95431f, 144.9543f, 80.0f, 156.0f, 80.0f),
                    PathNode.CurveTo(167.0457f, 80.0f, 176.0f, 88.95431f, 176.0f, 100.0f),
                    PathNode.LineTo(176.0f, 116.0f),
                    PathNode.CurveTo(176.0f, 104.95431f, 184.9543f, 96.0f, 196.0f, 96.0f),
                    PathNode.CurveTo(207.0457f, 96.0f, 216.0f, 104.95431f, 216.0f, 116.0f),
                    PathNode.Close
                ),
