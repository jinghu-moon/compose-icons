...
val RemixIcons.Fill.ArrowUpBoxFill: ImageVector
    get() {
        ...
        _arrowUpBoxFill = remixIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M4 3C3.448 3 3 3.448 3 4v16c0 .552 .448 1 1 1h16c.552 0 1-.448 1-1v-16C21 3.448 20.552 3 20 3h-16ZM12 6.343l5.95 5.95h-4.95v5.364h-2v-5.364h-4.95L12 6.343Z"),
