        ...
        _boot = phosphorFillIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(112.27f, 112.0f),
                    PathNode.CurveTo(107.987f, 112.05766f, 104.386604f, 108.79768f, 104.02f, 104.53f),
                    PathNode.CurveTo(103.87337f, 102.3215f, 104.648254f, 100.15095f, 106.16036f, 98.53462f),
                    PathNode.CurveTo(107.67247f, 96.918304f, 109.78664f, 96.00067f, 112.0f, 96.0f),
                    PathNode.LineTo(156.0f, 96.0f),
                    PathNode.CurveTo(158.20914f, 96.0f, 160.0f, 94.20914f, 160.0f, 92.0f),
                    PathNode.LineTo(160.0f, 84.0f),
                    PathNode.CurveTo(160.0f, 81.79086f, 158.20914f, 80.0f, 156.0f, 80.0f),
                    PathNode.LineTo(112.27f, 80.0f),
                    PathNode.CurveTo(107.97935f, 80.06826f, 104.36713f, 76.805466f, 104.0f, 72.53f),
                    PathNode.CurveTo(103.85313f, 70.31803f, 104.63069f, 68.14429f, 106.147194f, 66.52731f),
                    PathNode.CurveTo(107.6637f, 64.91034f, 109.783165f, 63.99513f, 112.0f, 64.0f),
                    PathNode.LineTo(156.0f, 64.0f),
                    PathNode.CurveTo(158.20914f, 64.0f, 160.0f, 62.20914f, 160.0f, 60.0f),
                    PathNode.LineTo(160.0f, 56.0f),
                    PathNode.CurveTo(160.0f, 47.163445f, 152.83656f, 40.0f, 144.0f, 40.0f),
                    PathNode.LineTo(32.22f, 40.0f),
                    PathNode.CurveTo(30.391485f, 39.967064f, 28.604086f, 40.544098f, 27.14f, 41.64f),
                    PathNode.CurveTo(24.322052f, 43.794758f, 23.259607f, 47.547913f, 24.53f, 50.86f),
                    PathNode.CurveTo(35.59f, 79.7f, 33.29f, 134.57f, 24.31f, 165.79f),
                    PathNode.CurveTo(24.103922f, 166.50856f, 23.999573f, 167.25246f, 24.0f, 168.0f),
                    ...
                    PathNode.CurveTo(248.0f, 137.07205f, 222.92795f, 112.0f, 192.0f, 112.0f),
                    PathNode.Close,
                    PathNode.MoveTo(232.0f, 200.0f),
                    PathNode.LineTo(205.89f, 200.0f),
