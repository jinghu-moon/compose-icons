        ...
        _bracketsCurly = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(176.0f, 128.0f, 240.0f, 216.0f, 176.0f, 216.0f),
                    PathNode.LineTo(80.0f, 216.0f),
                    PathNode.CurveTo(16.0f, 216.0f, 80.0f, 128.0f, 16.0f, 128.0f),
                    PathNode.CurveTo(80.0f, 128.0f, 16.0f, 40.0f, 80.0f, 40.0f),
                    PathNode.LineTo(176.0f, 40.0f),
                    PathNode.CurveTo(240.0f, 40.0f, 176.0f, 128.0f, 240.0f, 128.0f),
                    PathNode.Close
                ),
