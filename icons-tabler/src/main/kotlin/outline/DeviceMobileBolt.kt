...
val TablerIcons.Outline.DeviceMobileBolt: ImageVector
    get() {
        ...
        _deviceMobileBolt = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 13.500 21.000 L 8.000 21.000 C 6.895 21.000 6.000 20.105 6.000 19.000 L 6.000 5.000 C 6.000 3.895 6.895 3.000 8.000 3.000 L 16.000 3.000 C 17.105 3.000 18.000 3.895 18.000 5.000 L 18.000 12.000"),
