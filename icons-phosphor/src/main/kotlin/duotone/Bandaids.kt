        ...
        _bandaids = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(173.25f, 128.0f),
                    PathNode.LineTo(128.0f, 82.75f),
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(49.37f, 161.37f),
                    PathNode.CurveTo(36.871796f, 173.86821f, 36.871796f, 194.13179f, 49.37f, 206.63f),
                    PathNode.CurveTo(61.868202f, 219.1282f, 82.1318f, 219.1282f, 94.63f, 206.63f),
                    PathNode.LineTo(128.0f, 173.25f),
                    PathNode.LineTo(82.75f, 128.0f),
                    PathNode.Close,
                    PathNode.MoveTo(82.75f, 128.0f),
                    PathNode.LineTo(128.0f, 82.75f),
                    PathNode.LineTo(94.63f, 49.37f),
                    PathNode.CurveTo(82.1318f, 36.871796f, 61.86821f, 36.871796f, 49.37f, 49.37f),
                    PathNode.CurveTo(36.871796f, 61.86821f, 36.871796f, 82.1318f, 49.37f, 94.63f),
                    PathNode.Close,
                    PathNode.MoveTo(173.25f, 128.0f),
                    PathNode.LineTo(128.0f, 173.25f),
                    PathNode.LineTo(161.37f, 206.63f),
                    PathNode.CurveTo(173.86821f, 219.1282f, 194.13179f, 219.1282f, 206.63f, 206.63f),
                    PathNode.CurveTo(219.1282f, 194.13179f, 219.1282f, 173.86821f, 206.63f, 161.37f),
                    PathNode.Close
                ),
