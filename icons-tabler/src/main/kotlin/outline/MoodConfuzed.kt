...
val TablerIcons.Outline.MoodConfuzed: ImageVector
    get() {
        if (_moodConfuzed != null) return _moodConfuzed!!
        _moodConfuzed = tablerOutlineIcon(
            name = "MoodConfuzed",
    ...
    addPath(
        pathData = parseSvgPathData("M 9.500 16.000 C 11.291 14.879 13.392 14.353 15.500 14.500"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
