        ...
        _hourglassSimpleLow = phosphorThinIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(168.16f, 172.0f),
                    PathNode.LineTo(87.84f, 172.0f),
                    PathNode.LineTo(128.0f, 133.54f),
                    PathNode.Close,
                    ...
                    PathNode.LineTo(79.49f, 180.0f),
                    PathNode.LineTo(176.49f, 180.0f),
                    PathNode.LineTo(202.77f, 205.17f),
                    PathNode.CurveTo(203.94362f, 206.2969f, 204.30145f, 208.03049f, 203.67f, 209.53f),
                    PathNode.Close
                ),
