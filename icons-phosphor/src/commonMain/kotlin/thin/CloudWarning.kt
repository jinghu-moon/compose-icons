        ...
        _cloudWarning = phosphorThinIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(157.79086f, 132.0f, 156.0f, 130.20914f, 156.0f, 128.0f),
                    PathNode.Close,
                    PathNode.MoveTo(168.0f, 164.0f),
                    PathNode.CurveTo(168.0f, 168.41827f, 164.41827f, 172.0f, 160.0f, 172.0f),
                    PathNode.CurveTo(155.58173f, 172.0f, 152.0f, 168.41827f, 152.0f, 164.0f),
                    PathNode.CurveTo(152.0f, 159.58173f, 155.58173f, 156.0f, 160.0f, 156.0f),
                    PathNode.CurveTo(164.41827f, 156.0f, 168.0f, 159.58173f, 168.0f, 164.0f),
                    PathNode.Close
                ),
