...
val PhosphorIcons.Duotone.Fish: ImageVector
    get() {
        ...
        _fish = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(185.81f, 167.62f),
                    PathNode.CurveTo(167.81f, 181.52f, 141.64f, 191.03f, 104.13f, 191.93f),
                    PathNode.LineTo(80.09f, 248.0f),
                    PathNode.LineTo(64.09f, 191.93f),
                    PathNode.LineTo(8.0f, 175.87f),
                    PathNode.LineTo(64.07f, 151.87f),
                    PathNode.CurveTo(64.97f, 114.38f, 74.48f, 88.26f, 88.38f, 70.22f),
                    PathNode.CurveTo(86.61764f, 83.517166f, 91.017006f, 96.89201f, 100.32884f, 106.54656f),
                    PathNode.CurveTo(109.64067f, 116.20111f, 122.84785f, 121.08081f, 136.2f, 119.8f),
                    PathNode.CurveTo(134.91737f, 133.1581f, 139.80087f, 146.37129f, 149.46263f, 155.68443f),
                    PathNode.CurveTo(159.12437f, 164.99757f, 172.50803f, 169.39243f, 185.81f, 167.62f),
                    PathNode.Close
                ),
