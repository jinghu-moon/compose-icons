...
val TablerIcons.Outline.MoodMinus: ImageVector
    get() {
        ...
        _moodMinus = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 20.480 15.014 C 21.810 11.273 20.531 7.103 17.334 4.750 C 14.136 2.397 9.774 2.418 6.598 4.801 C 3.423 7.183 2.184 11.366 3.549 15.094 C 4.914 18.822 8.561 21.215 12.524 20.984"),
