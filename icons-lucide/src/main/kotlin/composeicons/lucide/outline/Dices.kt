...
val LucideIcons.Outline.Dices: ImageVector
    get() {
        ...
        _dices = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(17.92f, 14.0f),
                    PathNode.LineTo(21.42f, 10.5f),
                    PathNode.CurveTo(22.188519f, 9.647655f, 22.188519f, 8.352345f, 21.42f, 7.5f),
                    PathNode.LineTo(16.42f, 2.58f),
                    PathNode.CurveTo(15.567656f, 1.811481f, 14.272345f, 1.811481f, 13.42f, 2.58f),
