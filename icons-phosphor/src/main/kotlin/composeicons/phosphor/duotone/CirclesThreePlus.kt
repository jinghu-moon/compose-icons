...
val PhosphorIcons.Duotone.CirclesThreePlus: ImageVector
    get() {
        ...
        _circlesThreePlus = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M112 80c0 17.673-14.327 32-32 32C62.327 112 48 97.673 48 80 48 62.327 62.327 48 80 48c17.673 0 32 14.327 32 32ZM176 48c-17.673 0-32 14.327-32 32 0 17.673 14.327 32 32 32 17.673 0 32-14.327 32-32C208 62.327 193.673 48 176 48ZM80 144c-17.673 0-32 14.327-32 32 0 17.673 14.327 32 32 32 17.673 0 32-14.327 32-32C112 158.327 97.673 144 80 144Z"),
