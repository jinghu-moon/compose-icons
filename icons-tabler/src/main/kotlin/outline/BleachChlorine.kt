...
val TablerIcons.Outline.BleachChlorine: ImageVector
    get() {
        ...
        _bleachChlorine = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 11.000 12.000 L 10.000 12.000 C 8.895 12.000 8.000 12.895 8.000 14.000 C 8.000 15.105 8.895 16.000 10.000 16.000 L 11.000 16.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 14.000 12.000 L 14.000 16.000 L 16.000 16.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
