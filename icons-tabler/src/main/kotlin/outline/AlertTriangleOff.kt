...
val TablerIcons.Outline.AlertTriangleOff: ImageVector
    get() {
        ...
        _alertTriangleOff = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 21.998 17.997 C 21.984 17.690 21.897 17.391 21.743 17.125 L 13.637 3.591 C 13.290 3.018 12.669 2.669 12.000 2.669 C 11.331 2.669 10.710 3.018 10.363 3.591 L 9.323 5.327M 7.830 7.820 L 2.257 17.124 C 1.917 17.713 1.915 18.438 2.252 19.029 C 2.588 19.620 3.213 19.987 3.893 19.995 L 20.000 19.995"),
