...
val TablerIcons.Outline.AlertCircleOff: ImageVector
    get() {
        ...
        _alertCircleOff = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 5.644 5.629 C 2.126 9.140 2.120 14.839 5.631 18.357 C 9.142 21.875 14.841 21.881 18.359 18.370M 20.052 16.021 C 21.785 12.554 21.104 8.367 18.361 5.628 C 15.618 2.889 11.429 2.214 7.965 3.953"),
