...
val TablerIcons.Outline.ArrowMergeBoth: ImageVector
    get() {
        ...
        _arrowMergeBoth = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 16.000 8.000 L 12.000 4.000 L 8.000 8.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 18.000 18.000 C 14.000 16.667 12.000 13.333 12.000 8.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 6.000 18.000 C 10.000 16.667 12.000 13.333 12.000 8.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
