        ...
        _bookmark = phosphorThinIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.LineTo(188.0f, 168.78f),
                    PathNode.LineTo(130.11f, 132.61f),
                    PathNode.CurveTo(128.81291f, 131.79932f, 127.16708f, 131.79932f, 125.87f, 132.61f),
                    PathNode.LineTo(68.0f, 168.78f),
                    PathNode.LineTo(68.0f, 48.0f),
                    PathNode.CurveTo(68.0f, 45.79086f, 69.79086f, 44.0f, 72.0f, 44.0f),
                    PathNode.Close,
                    PathNode.MoveTo(130.11f, 180.61f),
                    PathNode.CurveTo(128.81291f, 179.79932f, 127.16708f, 179.79932f, 125.87f, 180.61f),
                    PathNode.LineTo(68.0f, 216.78f),
                    PathNode.LineTo(68.0f, 178.22f),
                    PathNode.LineTo(128.0f, 140.72f),
                    PathNode.LineTo(188.0f, 178.22f),
                    PathNode.LineTo(188.0f, 216.78f),
                    PathNode.Close
                ),
