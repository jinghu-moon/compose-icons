...
val TablerIcons.Outline.RewindBackward50: ImageVector
    get() {
        ...
        _rewindBackward50 = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 6.000 20.000 L 7.500 20.000 C 8.328 20.000 9.000 19.328 9.000 18.500 C 9.000 17.672 8.328 17.000 7.500 17.000 L 6.000 17.000 L 6.000 14.000 L 9.000 14.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
