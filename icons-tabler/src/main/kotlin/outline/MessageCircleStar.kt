...
val TablerIcons.Outline.MessageCircleStar: ImageVector
    get() {
        if (_messageCircleStar != null) return _messageCircleStar!!
        _messageCircleStar = tablerOutlineIcon(
            name = "MessageCircleStar",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24.0f, height = 24.0f),
        ) {
    addPath(
        pathData = parseSvgPathData("M 10.517 19.869 C 9.539 19.724 8.590 19.431 7.700 19.000 L 3.000 20.000 L 4.300 16.100 C 1.976 12.663 2.874 8.228 6.400 5.726 C 9.926 3.225 14.990 3.430 18.245 6.206 C 19.911 7.627 20.839 9.496 20.992 11.416"),
