...
val TablerIcons.Outline.BrandDribbble: ImageVector
    get() {
        ...
        _brandDribbble = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 9.000 3.600 C 14.000 9.600 16.000 14.100 16.500 19.800"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 6.400 19.000 C 9.900 15.500 12.400 12.500 20.900 12.600"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 3.100 10.750 C 8.100 10.750 12.914 10.370 18.414 5.750"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
