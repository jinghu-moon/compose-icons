...
val LucideIcons.Outline.TowerControl: ImageVector
    get() {
        ...
        _towerControl = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(18.2f, 12.27f),
                    PathNode.LineTo(20.0f, 6.0f),
                    PathNode.LineTo(4.0f, 6.0f),
                    PathNode.LineTo(5.8f, 12.27f),
                    PathNode.CurveTo(5.919724f, 12.697094f, 6.30648f, 12.994286f, 6.75f, 13.0f),
                    PathNode.LineTo(17.25f, 13.0f),
                    PathNode.CurveTo(17.697239f, 12.99872f, 18.089247f, 12.70063f, 18.21f, 12.27f),
                    PathNode.Close
                ),
