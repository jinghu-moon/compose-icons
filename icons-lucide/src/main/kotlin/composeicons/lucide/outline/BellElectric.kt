...
val LucideIcons.Outline.BellElectric: ImageVector
    get() {
        ...
        _bellElectric = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(18.518f, 17.347f),
                    PathNode.CurveTo(17.254585f, 18.414465f, 15.653994f, 19.00007f, 14.0f, 19.0f)
                ),
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(18.8f, 4.0f),
                    PathNode.CurveTo(19.589397f, 5.548458f, 20.000631f, 7.261935f, 20.0f, 9.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(4.0f, 16.89543f, 4.895431f, 16.0f, 6.0f, 16.0f),
                    PathNode.Close
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
