...
val LucideIcons.Outline.Aperture: ImageVector
    get() {
        ...
        _aperture = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(14.31f, 8.0f),
                    PathNode.LineTo(20.05f, 17.94f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(7.38f, 12.0f),
                    PathNode.LineTo(13.12f, 2.06f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(9.69f, 16.0f),
                    PathNode.LineTo(3.95f, 6.06f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(14.31f, 16.0f),
                    PathNode.LineTo(2.83f, 16.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(16.62f, 12.0f),
                    PathNode.LineTo(10.88f, 21.94f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
