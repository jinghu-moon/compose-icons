...
val TablerIcons.Filled.FilePercent: ImageVector
    get() {
        ...
        _filePercent = tablerFilledIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M12 2l.117 .007c.459 .054 .822 .417 .876 .876L13 3v4l.005 .15c.074 .984 .854 1.767 1.838 1.844L15 9h4l.117 .007c.459 .054 .822 .417 .876 .876L20 10v9c0 1.589-1.238 2.902-2.824 2.995L17 22h-10C5.411 22 4.098 20.762 4.005 19.176L4 19v-14C4 3.411 5.238 2.098 6.824 2.005L7 2ZM14.01 16h-.01c-.529 .001-.966 .413-.997 .941-.031 .528 .355 .989 .88 1.052l.127 .007c.552 0 1-.448 1-1 0-.552-.448-1-1-1M14.707 12.293c-.391-.39-1.023-.39-1.414 0l-4 4c-.379 .392-.374 1.016 .012 1.402 .386 .386 1.009 .391 1.402 .012l4-4c.39-.391 .39-1.023 0-1.414M10.01 12h-.01c-.529 .001-.966 .413-.997 .941-.031 .528 .355 .989 .88 1.052l.127 .007c.552 0 1-.448 1-1 0-.552-.448-1-1-1M14.999 2.999 19 7h-4Z"),
