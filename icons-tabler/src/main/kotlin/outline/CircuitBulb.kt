...
val TablerIcons.Outline.CircuitBulb: ImageVector
    get() {
        ...
        _circuitBulb = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 2.000 12.000 L 7.000 12.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 17.000 12.000 L 22.000 12.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 15.500 8.500 L 8.500 15.500"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
