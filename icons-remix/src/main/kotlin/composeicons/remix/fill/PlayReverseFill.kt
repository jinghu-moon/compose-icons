...
val RemixIcons.Fill.PlayReverseFill: ImageVector
    get() {
        ...
        _playReverseFill = remixIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M4.624 12.416l10.599 7.066c.23 .153 .54 .091 .693-.139 .055-.082 .084-.179 .084-.277v-14.131c0-.276-.224-.5-.5-.5-.099 0-.195 .029-.277 .084L4.624 11.584c-.23 .153-.292 .464-.139 .693 .037 .055 .084 .102 .139 .139Z"),
