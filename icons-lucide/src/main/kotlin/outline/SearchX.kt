...
val LucideIcons.Outline.SearchX: ImageVector
    get() {
        if (_searchX != null) return _searchX!!
        _searchX = lucideOutlineIcon(
            name = "SearchX",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24.0f, height = 24.0f),
        ) {
    addPath(
        pathData = parseSvgPathData("M 13.500 8.500 L 8.500 13.500"),
    ...
    addPath(
        pathData = parseSvgPathData("M 8.500 8.500 L 13.500 13.500"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
