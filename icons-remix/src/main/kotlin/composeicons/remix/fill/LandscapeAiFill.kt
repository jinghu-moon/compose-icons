...
val RemixIcons.Fill.LandscapeAiFill: ImageVector
    get() {
        ...
        _landscapeAiFill = remixIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M6.213 8.628l-.247 .566c-.18 .414-.753 .414-.934 0L4.787 8.628C4.347 7.619 3.555 6.816 2.568 6.377L1.808 6.039c-.411-.183-.411-.78 0-.963l.717-.319C3.538 4.307 4.344 3.474 4.776 2.431l.253-.611c.176-.426 .765-.426 .941 0l.253 .611c.432 1.043 1.238 1.876 2.251 2.326l.717 .319c.411 .183 .411 .78 0 .963l-.76 .338C7.445 6.816 6.653 7.619 6.213 8.628ZM11.238 12.27 16 21h7L15 6l-3.762 6.27ZM14 21 8 10 2 21h12Z"),
