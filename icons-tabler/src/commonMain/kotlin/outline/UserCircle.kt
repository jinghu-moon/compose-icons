...
val TablerIcons.Outline.UserCircle: ImageVector
    get() {
        ...
        _userCircle = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(6.168f, 18.849f),
                    PathNode.CurveTo(6.676238f, 17.157455f, 8.233753f, 15.99948f, 10.0f, 16.0f),
                    PathNode.LineTo(14.0f, 16.0f),
                    PathNode.CurveTo(15.76864f, 15.99939f, 17.327726f, 17.16037f, 17.834f, 18.855f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
