...
val PhosphorIcons.Duotone.SmileySad: ImageVector
    get() {
        if (_smileySad != null) return _smileySad!!
        _smileySad = phosphorDuotoneIcon(
            name = "SmileySad",
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(174.92f, 172.0f),
                    PathNode.CurveTo(176.49648f, 174.47992f, 176.58647f, 177.6245f, 175.15439f, 180.1905f),
                    PathNode.CurveTo(173.7223f, 182.75652f, 170.9987f, 184.33084f, 168.0604f, 184.29108f),
                    PathNode.CurveTo(165.12209f, 184.2513f, 162.44211f, 182.60382f, 161.08f, 180.0f),
