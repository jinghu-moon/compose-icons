        ...
        _share2 = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(9.0f, 13.656855f, 7.656854f, 15.0f, 6.0f, 15.0f),
                    PathNode.CurveTo(4.343146f, 15.0f, 3.0f, 13.656855f, 3.0f, 12.0f),
                    PathNode.CurveTo(3.0f, 10.343145f, 4.343146f, 9.0f, 6.0f, 9.0f),
                    PathNode.CurveTo(7.656854f, 9.0f, 9.0f, 10.343145f, 9.0f, 12.0f),
                    PathNode.Close
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(15.0f, 17.343145f, 16.343145f, 16.0f, 18.0f, 16.0f),
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(8.59f, 13.51f),
                    PathNode.LineTo(15.42f, 17.49f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(15.41f, 6.51f),
                    PathNode.LineTo(8.59f, 10.49f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
