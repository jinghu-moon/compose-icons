...
val TablerIcons.Outline.WorldX: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 20.929 13.131 C 21.399 9.417 19.522 5.800 16.214 4.047 C 12.907 2.295 8.859 2.773 6.051 5.247 C 3.242 7.722 2.258 11.677 3.580 15.179 C 4.903 18.681 8.255 20.999 11.998 21.000"),
    ...
    addPath(
        pathData = parseSvgPathData("M 12.500 3.000 C 14.470 6.155 15.350 9.869 15.005 13.573"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
