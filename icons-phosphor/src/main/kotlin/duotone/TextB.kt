        ...
        _textB = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(200.0f, 182.09138f, 182.09138f, 200.0f, 160.0f, 200.0f),
                    PathNode.LineTo(80.0f, 200.0f),
                    PathNode.LineTo(80.0f, 48.0f),
                    PathNode.LineTo(148.0f, 48.0f),
                    PathNode.CurveTo(167.88223f, 48.0f, 184.0f, 64.11775f, 184.0f, 84.0f),
                    PathNode.CurveTo(184.0f, 103.88225f, 167.88223f, 120.0f, 148.0f, 120.0f),
                    PathNode.LineTo(160.0f, 120.0f),
                    PathNode.CurveTo(182.09138f, 120.0f, 200.0f, 137.90862f, 200.0f, 160.0f),
                    PathNode.Close
                ),
