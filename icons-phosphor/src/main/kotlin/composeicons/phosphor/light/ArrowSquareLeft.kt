...
val PhosphorIcons.Light.ArrowSquareLeft: ImageVector
    get() {
        ...
        _arrowSquareLeft = phosphorLightIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M208 34h-160C40.268 34 34 40.268 34 48v160c0 7.732 6.268 14 14 14h160c7.732 0 14-6.268 14-14v-160c0-7.732-6.268-14-14-14ZM210 208c0 1.105-.895 2-2 2h-160c-1.105 0-2-.895-2-2v-160c0-1.105 .895-2 2-2h160c1.105 0 2 .895 2 2ZM174 128c0 3.314-2.686 6-6 6h-65.51l21.75 21.76c1.605 1.496 2.266 3.748 1.723 5.874-.543 2.126-2.203 3.786-4.329 4.329-2.126 .543-4.379-.118-5.874-1.723l-32-32c-2.34-2.343-2.34-6.137 0-8.48l32-32c2.364-2.203 6.048-2.138 8.333 .147 2.285 2.285 2.35 5.969 .147 8.333L102.49 122h65.51c3.314 0 6 2.686 6 6Z"),
