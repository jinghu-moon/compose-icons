...
val TablerIcons.Outline.ParkingCircle: ImageVector
    get() {
        ...
        _parkingCircle = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 10.000 16.000 L 10.000 8.000 L 13.334 8.000 C 14.254 8.000 15.000 8.895 15.000 10.000 C 15.000 11.105 14.254 12.000 13.334 12.000 L 10.000 12.000"),
