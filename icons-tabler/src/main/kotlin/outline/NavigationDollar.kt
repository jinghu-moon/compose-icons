...
val TablerIcons.Outline.NavigationDollar: ImageVector
    get() {
        ...
        _navigationDollar = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 15.945 11.551 L 12.000 3.000 L 4.030 20.275 C 3.960 20.475 4.013 20.699 4.165 20.847 C 4.315 20.995 4.539 21.040 4.735 20.963 L 12.000 18.500 L 13.594 19.040"),
