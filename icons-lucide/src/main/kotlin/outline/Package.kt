...
val LucideIcons.Outline.Package: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 7.500 4.270 L 16.500 9.420"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
