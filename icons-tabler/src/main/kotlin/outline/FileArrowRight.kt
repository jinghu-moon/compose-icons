...
val TablerIcons.Outline.FileArrowRight: ImageVector
    get() {
        if (_fileArrowRight != null) return _fileArrowRight!!
        _fileArrowRight = tablerOutlineIcon(
            name = "FileArrowRight",
            ...
            addPath(
                pathData = parseSvgPathData("M 12.500 17.500 L 15.000 15.000 L 12.500 12.500"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
