...
val LucideIcons.Outline.CircleChevronLeft: ImageVector
    get() {
        if (_circleChevronLeft != null) return _circleChevronLeft!!
        _circleChevronLeft = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 14.000 16.000 L 10.000 12.000 L 14.000 8.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
