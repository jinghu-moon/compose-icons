...
val TablerIcons.Outline.FishHookOff: ImageVector
    get() {
        ...
        _fishHookOff = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 16.000 9.000 L 16.000 12.000M 15.915 15.924 C 15.441 18.464 13.109 20.224 10.536 19.984 C 7.963 19.745 5.997 17.584 6.000 15.000 L 6.000 11.000 L 9.000 14.000"),
