...
val LucideIcons.Outline.GitMergeConflict: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 12.000 6.000 L 16.000 6.000 C 17.105 6.000 18.000 6.895 18.000 8.000 L 18.000 15.000"),
    ...
    addPath(
        pathData = parseSvgPathData("M 6.000 12.000 L 6.000 21.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
