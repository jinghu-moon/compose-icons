...
val LucideIcons.Outline.MonitorOff: ImageVector
    get() {
        ...
        _monitorOff = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 17.000 17.000 L 4.000 17.000 C 2.895 17.000 2.000 16.105 2.000 15.000 L 2.000 5.000 C 2.000 4.211 2.464 3.496 3.184 3.174"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 8.656 3.000 L 20.000 3.000 C 21.105 3.000 22.000 3.895 22.000 5.000 L 22.000 15.000 C 22.000 15.368 21.899 15.728 21.707 16.042"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
