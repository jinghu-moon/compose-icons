...
val TablerIcons.Outline.Balloon: ImageVector
    get() {
        ...
        _balloon = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 6.000 8.000 C 6.000 4.686 8.686 2.000 12.000 2.000 C 15.314 2.000 18.000 4.686 18.000 8.000 C 18.000 12.970 15.314 17.000 12.000 17.000 C 8.686 17.000 6.000 12.970 6.000 8.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
