...
val TablerIcons.Outline.Bus: ImageVector
    get() {
        ...
        _bus = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 4.000 17.000 L 2.000 17.000 L 2.000 6.000 C 2.000 5.448 2.448 5.000 3.000 5.000 L 17.000 5.000 C 19.761 5.000 22.000 8.134 22.000 12.000 L 22.000 17.000 L 20.000 17.000M 16.000 17.000 L 8.000 17.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 2.000 10.000 L 17.000 10.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 7.000 5.000 L 7.000 10.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
