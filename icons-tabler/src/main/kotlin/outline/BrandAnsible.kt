...
val TablerIcons.Outline.BrandAnsible: ImageVector
    get() {
        if (_brandAnsible != null) return _brandAnsible!!
        _brandAnsible = tablerOutlineIcon(
            name = "BrandAnsible",
            ...
            addPath(
                pathData = parseSvgPathData("M 9.647 12.294 L 16.000 16.000 L 12.000 7.000 L 8.000 16.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
