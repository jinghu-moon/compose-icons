...
val TablerIcons.Outline.EyeBitcoin: ImageVector
    get() {
        ...
        _eyeBitcoin = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 13.193 17.924 Q 12.608 17.999 12.000 18.000 Q 6.600 18.000 3.000 12.000 Q 6.600 6.000 12.000 6.000 Q 16.508 6.000 19.761 10.181"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
