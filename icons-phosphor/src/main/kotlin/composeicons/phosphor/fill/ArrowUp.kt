...
val PhosphorIcons.Fill.ArrowUp: ImageVector
    get() {
        ...
        _arrowUp = phosphorFillIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M207.39 115.06c-1.238 2.99-4.154 4.939-7.39 4.94h-64v96c0 4.418-3.582 8-8 8-4.418 0-8-3.582-8-8v-96h-64c-3.238 .003-6.158-1.947-7.397-4.938-1.239-2.991-.554-6.434 1.737-8.722L122.34 34.34c1.501-1.502 3.537-2.346 5.66-2.346 2.123 0 4.159 .844 5.66 2.346l72 72c2.287 2.289 2.97 5.731 1.73 8.72Z"),
