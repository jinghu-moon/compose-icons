...
val PhosphorIcons.Fill.PictureInPicture: ImageVector
    get() {
        ...
        _pictureInPicture = phosphorFillIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M216 48h-176C31.163 48 24 55.163 24 64v128c0 8.837 7.163 16 16 16h176c8.837 0 16-7.163 16-16v-128c0-8.837-7.163-16-16-16ZM216 192h-80v-64h80v64Z"),
