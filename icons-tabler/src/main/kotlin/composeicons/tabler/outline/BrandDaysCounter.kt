...
val TablerIcons.Outline.BrandDaysCounter: ImageVector
    get() {
        ...
        _brandDaysCounter = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(20.779f, 10.007f),
                    PathNode.CurveTo(19.791231f, 5.663322f, 15.7745f, 2.695727f, 11.332314f, 3.027711f),
                    PathNode.CurveTo(6.89013f, 3.359694f, 3.359115f, 6.891364f, 3.027957f, 11.333611f),
                    PathNode.CurveTo(2.696798f, 15.775858f, 5.665139f, 19.792038f, 10.009f, 20.779f)
                ),
