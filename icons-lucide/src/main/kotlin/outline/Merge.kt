...
val LucideIcons.Outline.Merge: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 12.000 2.000 L 12.000 12.300 C 12.012 13.376 11.589 14.411 10.828 15.172 L 4.000 22.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 20.000 22.000 L 15.000 17.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
