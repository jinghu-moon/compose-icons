...
val LucideIcons.Outline.Anchor: ImageVector
    get() {
        ...
        _anchor = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 12.000 6.000 L 12.000 22.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 19.000 13.000 L 21.000 12.000 C 21.000 16.971 16.971 21.000 12.000 21.000 C 7.029 21.000 3.000 16.971 3.000 12.000 L 5.000 13.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
