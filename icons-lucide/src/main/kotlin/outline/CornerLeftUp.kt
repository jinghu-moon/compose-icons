...
val LucideIcons.Outline.CornerLeftUp: ImageVector
    get() {
        ...
        _cornerLeftUp = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 14.000 9.000 L 9.000 4.000 L 4.000 9.000"),
            ...
            addPath(
                pathData = parseSvgPathData("M 20.000 20.000 L 13.000 20.000 C 10.791 20.000 9.000 18.209 9.000 16.000 L 9.000 4.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
