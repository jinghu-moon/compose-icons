...
val LucideIcons.Outline.Wallpaper: ImageVector
    get() {
        ...
        _wallpaper = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 9.000 17.000 L 15.100 10.900 C 15.882 10.134 17.134 10.138 17.910 10.910 L 22.000 15.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 10.000 9.000 C 10.000 10.105 9.105 11.000 8.000 11.000 C 6.895 11.000 6.000 10.105 6.000 9.000 C 6.000 7.895 6.895 7.000 8.000 7.000 C 9.105 7.000 10.000 7.895 10.000 9.000 Z"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
