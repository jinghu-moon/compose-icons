...
val TablerIcons.Outline.SquareChevronsRight: ImageVector
    get() {
        if (_squareChevronsRight != null) return _squareChevronsRight!!
        _squareChevronsRight = tablerOutlineIcon(
            name = "SquareChevronsRight",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24f, height = 24f),
        ) {
            addPath(
                pathData = parseSvgPathData("M 8.000 9.000 L 11.000 12.000 L 8.000 15.000"),
