...
val LucideIcons.Outline.SquareRadical: ImageVector
    get() {
        if (_squareRadical != null) return _squareRadical!!
        _squareRadical = lucideOutlineIcon(
            name = "SquareRadical",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24f, height = 24f),
        ) {
            addPath(
                pathData = parseSvgPathData("M 7.000 12.000 L 9.000 12.000 L 11.000 17.000 L 13.000 7.000 L 17.000 7.000"),
