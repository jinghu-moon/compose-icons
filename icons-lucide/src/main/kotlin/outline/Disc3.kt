...
val LucideIcons.Outline.Disc3: ImageVector
    get() {
        ...
        _disc3 = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 6.000 12.000 C 6.000 10.300 6.700 8.800 7.800 7.800"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 18.000 12.000 C 18.000 13.700 17.300 15.200 16.200 16.200"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
