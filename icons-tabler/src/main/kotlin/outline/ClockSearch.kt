...
val TablerIcons.Outline.ClockSearch: ImageVector
    get() {
        ...
        _clockSearch = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 20.993 11.646 C 20.801 6.767 16.754 2.932 11.872 3.001 C 6.990 3.070 3.054 7.019 3.001 11.901 C 2.947 16.783 6.796 20.818 11.675 20.994"),
