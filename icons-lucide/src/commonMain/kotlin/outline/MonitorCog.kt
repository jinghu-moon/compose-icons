...
val LucideIcons.Outline.MonitorCog: ImageVector
    get() {
        ...
        _monitorCog = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(14.305f, 7.53f),
                    PathNode.LineTo(15.228f, 7.148f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(15.228f, 4.852f),
                    PathNode.LineTo(14.305f, 4.469f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(16.852f, 3.228f),
                    PathNode.LineTo(16.469f, 2.304f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(16.852f, 8.772f),
                    PathNode.LineTo(16.469f, 9.695f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(19.148f, 3.228f),
                    PathNode.LineTo(19.531f, 2.304f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(19.53f, 9.696f),
                    PathNode.LineTo(19.148f, 8.772f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(20.772f, 4.852f),
                    PathNode.LineTo(21.696f, 4.469f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(20.772f, 7.148f),
                    PathNode.LineTo(21.696f, 7.531f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
