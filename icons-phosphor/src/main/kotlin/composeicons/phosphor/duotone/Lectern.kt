...
val PhosphorIcons.Duotone.Lectern: ImageVector
    get() {
        ...
        _lectern = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M232 136h-208c-2.774 .002-5.351-1.433-6.81-3.793-1.459-2.359-1.591-5.306-.35-7.787l40-80C58.197 41.709 60.969 39.998 64 40h128c3.031-.002 5.803 1.709 7.16 4.42l40 80c1.241 2.481 1.109 5.428-.35 7.787-1.459 2.359-4.036 3.795-6.81 3.793Z"),
