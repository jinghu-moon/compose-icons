...
val TablerIcons.Outline.SettingsPause: ImageVector
    get() {
        if (_settingsPause != null) return _settingsPause!!
        _settingsPause = tablerOutlineIcon(
            name = "SettingsPause",
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(13.004f, 20.69f),
                    PathNode.CurveTo(12.099f, 21.322f, 10.641f, 20.986f, 10.325f, 19.683f),
                    ...
                    PathNode.CurveTo(20.997f, 10.644f, 21.328f, 12.123f, 20.675f, 13.026f)
                ),
