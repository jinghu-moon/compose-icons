...
val RemixIcons.Line.AirplayLine: ImageVector
    get() {
        ...
        _airplayLine = remixIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M12.4 13.533l5 6.667c.166 .221 .121 .534-.1 .7C17.213 20.965 17.108 21 17 21h-10c-.276 0-.5-.224-.5-.5 0-.108 .035-.213 .1-.3l5-6.667c.166-.221 .479-.266 .7-.1 .038 .028 .072 .062 .1 .1ZM12 16.33 10 19h4L12 16.33ZM18 19v-2h2v-12h-16v12h2v2h-3.008C2.444 19 2 18.555 2 17.999v-13.998C2 3.448 2.455 3 2.992 3h18.016c.548 0 .992 .445 .992 1.001v13.998c0 .553-.455 1.001-.992 1.001h-3.008Z"),
