...
val TablerIcons.Outline.ReceiptEuro: ImageVector
    get() {
        ...
        _receiptEuro = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(15.0f, 7.8f),
                    PathNode.CurveTo(14.477f, 7.298f, 13.828f, 7.0f, 13.125f, 7.0f),
                    PathNode.CurveTo(11.398f, 7.0f, 10.0f, 8.791f, 10.0f, 11.0f),
                    PathNode.CurveTo(10.0f, 13.209f, 11.398f, 15.0f, 13.125f, 15.0f),
                    PathNode.CurveTo(13.828f, 15.0f, 14.477f, 14.702f, 14.999f, 14.2f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
