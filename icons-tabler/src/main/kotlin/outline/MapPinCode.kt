...
val TablerIcons.Outline.MapPinCode: ImageVector
    get() {
        ...
        _mapPinCode = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 11.850 21.480 C 11.373 21.445 10.925 21.239 10.587 20.900 L 6.343 16.657 C 3.598 13.911 3.221 9.591 5.448 6.412 C 7.675 3.232 11.864 2.110 15.382 3.751 C 18.901 5.392 20.733 9.322 19.728 13.072"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
