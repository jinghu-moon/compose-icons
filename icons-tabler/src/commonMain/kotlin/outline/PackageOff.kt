...
val TablerIcons.Outline.PackageOff: ImageVector
    get() {
        ...
        _packageOff = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(14.543f, 10.57f),
                    PathNode.LineTo(20.0f, 7.5f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(16.0f, 5.25f),
                    PathNode.LineTo(11.65f, 7.697f),
                    PathNode.MoveTo(9.086f, 9.139f),
                    PathNode.LineTo(8.0f, 9.75f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
