...
val LucideIcons.Outline.ZodiacGemini: ImageVector
    get() {
        ...
        _zodiacGemini = lucideOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(16.0f, 4.525f),
                    PathNode.LineTo(16.0f, 19.473f)
                ),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(15.0f, 5.666667f, 9.0f, 5.666667f, 4.0f, 3.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(9.0f, 18.333334f, 15.0f, 18.333334f, 20.0f, 21.0f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(8.0f, 4.525f),
                    PathNode.LineTo(8.0f, 19.473f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1.0f,
