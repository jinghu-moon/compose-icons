...
val TablerIcons.Outline.UserCog: ImageVector
    get() {
        if (_userCog != null) return _userCog!!
        _userCog = tablerOutlineIcon(
            name = "UserCog",
    ...
    addPath(
        pathData = parseSvgPathData("M 6.000 21.000 L 6.000 19.000 C 6.000 16.791 7.791 15.000 10.000 15.000 L 12.500 15.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
