        ...
        _handHeart = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(192.54f, 40.0f),
                    PathNode.CurveTo(176.60927f, 39.813087f, 162.1566f, 49.305798f, 156.0f, 64.0f),
                    PathNode.CurveTo(149.8434f, 49.305798f, 135.39073f, 39.813087f, 119.46f, 40.0f),
                    PathNode.CurveTo(97.67f, 40.0f, 80.0f, 58.31f, 80.0f, 80.0f),
                    PathNode.CurveTo(80.0f, 94.56f, 87.0f, 107.71f, 96.73f, 120.0f),
                    PathNode.LineTo(140.0f, 120.0f),
                    PathNode.CurveTo(151.0457f, 120.0f, 160.0f, 128.9543f, 160.0f, 140.0f),
                    PathNode.CurveTo(160.0f, 151.0457f, 151.0457f, 160.0f, 140.0f, 160.0f),
                    PathNode.LineTo(144.0f, 160.0f),
                    PathNode.LineTo(181.78f, 151.32f),
                    PathNode.CurveTo(203.82f, 135.07f, 232.0f, 109.23f, 232.0f, 80.0f),
                    PathNode.CurveTo(232.0f, 58.31f, 214.33f, 40.0f, 192.54f, 40.0f),
                    PathNode.Close
                ),
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.Close,
                    PathNode.MoveTo(119.46f, 48.0f),
                    PathNode.CurveTo(132.1344f, 47.814507f, 143.6572f, 55.327663f, 148.6f, 67.0f),
                    PathNode.CurveTo(149.83272f, 70.00094f, 152.75574f, 71.960266f, 156.0f, 71.960266f),
                    PathNode.CurveTo(159.24426f, 71.960266f, 162.16728f, 70.00094f, 163.4f, 67.0f),
                    PathNode.CurveTo(168.3428f, 55.327663f, 179.8656f, 47.814507f, 192.54f, 48.0f),
                    PathNode.CurveTo(209.59f, 48.0f, 224.0f, 62.65f, 224.0f, 80.0f),
                    PathNode.CurveTo(224.0f, 99.51f, 208.21f, 121.58f, 178.34f, 143.9f),
                    ...
                    PathNode.LineTo(100.68f, 112.0f),
                    PathNode.CurveTo(92.05f, 100.36f, 88.0f, 90.12f, 88.0f, 80.0f),
                    PathNode.CurveTo(88.0f, 62.65f, 102.41f, 48.0f, 119.46f, 48.0f),
                    PathNode.Close,
