        ...
        _brandSoundcloud = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(19.38f, 11.0f, 21.0f, 12.274f, 21.0f, 14.0f),
                    PathNode.CurveTo(21.0f, 15.657f, 19.5f, 17.0f, 18.0f, 17.0f),
                    PathNode.LineTo(12.0f, 17.0f),
                    PathNode.LineTo(12.0f, 7.0f),
                    PathNode.CurveTo(15.0f, 7.0f, 16.5f, 8.5f, 17.0f, 11.0f)
                ),
