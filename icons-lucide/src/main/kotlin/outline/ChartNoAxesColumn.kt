...
val LucideIcons.Outline.ChartNoAxesColumn: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 5.000 21.000 L 5.000 15.000"),
    ...
    addPath(
        pathData = parseSvgPathData("M 12.000 21.000 L 12.000 3.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
    ...
    addPath(
        pathData = parseSvgPathData("M 19.000 21.000 L 19.000 9.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
