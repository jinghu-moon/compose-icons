...
val TablerIcons.Outline.MessageCircleUser: ImageVector
    ...
    addPath(
        pathData = parseSvgPathData("M 12.454 19.970 C 10.813 20.046 9.180 19.713 7.700 19.000 L 3.000 20.000 L 4.300 16.100 C 1.976 12.663 2.874 8.228 6.400 5.726 C 9.926 3.225 14.990 3.430 18.245 6.206 C 19.912 7.629 20.841 9.500 20.992 11.422"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
