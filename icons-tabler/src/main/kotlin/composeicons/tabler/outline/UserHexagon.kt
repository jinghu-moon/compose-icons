...
val TablerIcons.Outline.UserHexagon: ImageVector
    get() {
        ...
        _userHexagon = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(6.201f, 18.744f),
                    PathNode.CurveTo(6.742857f, 17.10562f, 8.27434f, 15.999435f, 10.0f, 16.0f),
                    PathNode.LineTo(14.0f, 16.0f),
                    PathNode.CurveTo(15.724494f, 15.999439f, 17.255215f, 17.104155f, 17.798f, 18.741f)
                ),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
