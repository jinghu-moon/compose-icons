...
val LucideIcons.Outline.GitPullRequestClosed: ImageVector
    get() {
        ...
        _gitPullRequestClosed = lucideOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 6.000 9.000 L 6.000 21.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 21.000 9.000 L 15.000 3.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
            ...
            addPath(
                pathData = parseSvgPathData("M 18.000 11.500 L 18.000 15.000"),
                pathFillType = PathFillType.NonZero,
                fill = null,
                fillAlpha = 1f,
                stroke = SolidColor(Color(0xFF000000)),
