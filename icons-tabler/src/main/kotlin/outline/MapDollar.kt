...
val TablerIcons.Outline.MapDollar: ImageVector
    get() {
        if (_mapDollar != null) return _mapDollar!!
        _mapDollar = tablerOutlineIcon(
            name = "MapDollar",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24.0f, height = 24.0f),
        ) {
    addPath(
        pathData = parseSvgPathData("M 13.000 19.000 L 9.000 17.000 L 3.000 20.000 L 3.000 7.000 L 9.000 4.000 L 15.000 7.000 L 21.000 4.000 L 21.000 10.500"),
    ...
    addPath(
        pathData = parseSvgPathData("M 15.000 7.000 L 15.000 12.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
