...
val TablerIcons.Filled.ArrowLeftRhombus: ImageVector
    get() {
        ...
        _arrowLeftRhombus = tablerFilledIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M6.707 8.293c.39 .391 .39 1.023 0 1.414L5.415 11h10.169L17.793 8.793c.391-.39 1.024-.39 1.414 0l2.5 2.5c.39 .391 .39 1.023 0 1.414l-2.5 2.5c-.391 .39-1.024 .39-1.414 0L15.585 13h-10.17l1.292 1.293c.356 .356 .392 .922 .083 1.32l-.083 .094c-.39 .39-1.023 .39-1.414 0l-3-3c-.035-.035-.067-.072-.097-.112l-.071-.11-.054-.114-.035-.105-.025-.118-.007-.058L2 12l.003-.075 .017-.126 .03-.111 .044-.111 .052-.098 .067-.096 .08-.09 3-3c.39-.39 1.023-.39 1.414 0"),
