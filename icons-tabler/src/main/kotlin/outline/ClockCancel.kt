...
val TablerIcons.Outline.ClockCancel: ImageVector
    get() {
        ...
        _clockCancel = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 20.997 12.250 C 21.100 8.563 18.942 5.187 15.554 3.730 C 12.165 2.274 8.231 3.033 5.627 5.645 C 3.023 8.257 2.276 12.194 3.743 15.578 C 5.209 18.962 8.592 21.109 12.279 20.995"),
