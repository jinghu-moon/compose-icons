...
val TablerIcons.Outline.DevicesCode: ImageVector
    get() {
        ...
        _devicesCode = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 13.000 15.500 L 13.000 9.000 C 13.000 8.448 13.448 8.000 14.000 8.000 L 20.000 8.000 C 20.552 8.000 21.000 8.448 21.000 9.000 L 21.000 13.000M 21.000 19.000 C 21.000 19.552 20.552 20.000 20.000 20.000"),
