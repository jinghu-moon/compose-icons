...
val TablerIcons.Outline.SquareF9: ImageVector
    get() {
        ...
        _squareF9 = tablerOutlineIcon(
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(13.0f, 14.25f),
                    PathNode.CurveTo(13.0f, 14.664f, 13.336f, 15.0f, 13.75f, 15.0f),
                    PathNode.LineTo(15.25f, 15.0f),
                    PathNode.CurveTo(15.664213f, 15.0f, 16.0f, 14.664213f, 16.0f, 14.25f),
                    PathNode.LineTo(16.0f, 9.75f),
                    PathNode.CurveTo(16.0f, 9.335787f, 15.664213f, 9.0f, 15.25f, 9.0f),
                    PathNode.LineTo(13.75f, 9.0f),
                    PathNode.CurveTo(13.335787f, 9.0f, 13.0f, 9.335787f, 13.0f, 9.75f),
                    PathNode.LineTo(13.0f, 11.25f),
                    PathNode.CurveTo(13.0f, 11.664f, 13.336f, 12.0f, 13.75f, 12.0f),
