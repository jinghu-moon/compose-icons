...
val TablerIcons.Outline.HeartStar: ImageVector
    get() {
        ...
        _heartStar = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 9.730 17.753 L 4.500 12.572 C 3.151 11.260 2.654 9.301 3.212 7.504 C 3.771 5.707 5.292 4.376 7.147 4.060 C 9.002 3.743 10.877 4.496 12.000 6.006 C 13.529 3.973 16.341 3.411 18.533 4.702 C 20.725 5.993 21.599 8.724 20.563 11.047"),
