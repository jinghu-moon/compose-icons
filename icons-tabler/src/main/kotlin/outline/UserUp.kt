...
val TablerIcons.Outline.UserUp: ImageVector
    get() {
        if (_userUp != null) return _userUp!!
        _userUp = tablerOutlineIcon(
            name = "UserUp",
    ...
    addPath(
        pathData = parseSvgPathData("M 6.000 21.000 L 6.000 19.000 C 6.000 16.791 7.791 15.000 10.000 15.000 L 14.000 15.000"),
        pathFillType = PathFillType.NonZero,
        fill = null,
        fillAlpha = 1.0f,
        stroke = SolidColor(Color(0xFF000000)),
