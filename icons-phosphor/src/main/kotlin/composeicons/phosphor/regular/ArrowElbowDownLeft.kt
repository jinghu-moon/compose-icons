...
val PhosphorIcons.Regular.ArrowElbowDownLeft: ImageVector
    get() {
        ...
        _arrowElbowDownLeft = phosphorRegularIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M200 32v144c0 4.418-3.582 8-8 8h-124.69l34.35 34.34c3.126 3.126 3.126 8.194 0 11.32-3.126 3.126-8.194 3.126-11.32 0l-48-48C40.838 180.159 39.994 178.123 39.994 176c0-2.123 .844-4.159 2.346-5.66l48-48c3.126-3.126 8.194-3.126 11.32 0 3.126 3.126 3.126 8.194 0 11.32L67.31 168h116.69v-136c0-4.418 3.582-8 8-8 4.418 0 8 3.582 8 8Z"),
