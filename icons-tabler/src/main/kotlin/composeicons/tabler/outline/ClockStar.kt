...
val TablerIcons.Outline.ClockStar: ImageVector
    get() {
        if (_clockStar != null) return _clockStar!!
        _clockStar = tablerOutlineIcon(
            name = "ClockStar",
            ...
            addPath(
                pathData = listOf(
                    PathNode.MoveTo(20.982f, 11.436f),
                    PathNode.CurveTo(20.683125f, 6.675395f, 16.721954f, 2.974795f, 11.952044f, 3.000045f),
                    PathNode.CurveTo(7.182132f, 3.025295f, 3.260362f, 6.767623f, 3.011902f, 11.531125f),
                    PathNode.CurveTo(2.763442f, 16.294628f, 6.274599f, 20.42465f, 11.016f, 20.946f)
                ),
