...
val PhosphorIcons.Duotone.PersonSimpleSnowboard: ImageVector
    get() {
        if (_personSimpleSnowboard != null) return _personSimpleSnowboard!!
        _personSimpleSnowboard = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = listOf(
                    ...
                    PathNode.CurveTo(144.0f, 40.954304f, 152.9543f, 32.0f, 164.0f, 32.0f),
                    PathNode.CurveTo(175.0457f, 32.0f, 184.0f, 40.954304f, 184.0f, 52.0f),
                    PathNode.CurveTo(184.0f, 63.045696f, 175.0457f, 72.0f, 164.0f, 72.0f),
                    PathNode.CurveTo(152.9543f, 72.0f, 144.0f, 63.045696f, 144.0f, 52.0f),
                    PathNode.Close,
                    PathNode.MoveTo(195.56f, 190.33f),
                    PathNode.LineTo(38.12f, 144.7f),
                    PathNode.CurveTo(32.91578f, 143.1684f, 27.294237f, 144.17421f, 22.943945f, 147.4153f),
                    PathNode.CurveTo(18.593649f, 150.65637f, 16.021461f, 155.75513f, 16.0f, 161.18f),
                    PathNode.LineTo(16.0f, 161.18f),
                    PathNode.CurveTo(16.013672f, 168.833f, 21.08496f, 175.55531f, 28.44f, 177.67f),
                    PathNode.LineTo(185.88f, 223.3f),
                    PathNode.CurveTo(194.99269f, 225.97305f, 204.54695f, 220.7527f, 207.22f, 211.64f),
                    PathNode.CurveTo(209.89305f, 202.5273f, 204.6727f, 192.97305f, 195.56f, 190.3f),
                    PathNode.Close
                ),
