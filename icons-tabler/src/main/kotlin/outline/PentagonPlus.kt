...
val TablerIcons.Outline.PentagonPlus: ImageVector
    get() {
        ...
        _pentagonPlus = tablerOutlineIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M 12.500 21.005 L 7.042 21.005 C 6.185 21.005 5.426 20.453 5.161 19.638 L 2.097 10.208 C 1.832 9.393 2.122 8.500 2.816 7.996 L 10.837 2.168 C 11.530 1.664 12.470 1.664 13.163 2.168 L 21.184 7.996 C 21.878 8.500 22.168 9.393 21.903 10.208 L 21.123 12.609"),
