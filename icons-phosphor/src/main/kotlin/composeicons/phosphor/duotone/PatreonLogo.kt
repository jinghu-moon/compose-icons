...
val PhosphorIcons.Duotone.PatreonLogo: ImageVector
    get() {
        ...
        _patreonLogo = phosphorDuotoneIcon(
            ...
            addPath(
                pathData = parseSvgPathData("M224 93.16c0 49-48.17 49-72.25 65.34C121.88 178.76 119.64 232 87.52 232 55.4 232 25.78 107 71.52 60.49 119.64 11.49 224 27.82 224 93.16Z"),
