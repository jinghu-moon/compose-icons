...
val TablerIcons.Outline.Map2: ImageVector
    get() {
        if (_map2 != null) return _map2!!
        _map2 = tablerOutlineIcon(
            name = "Map2",
            size = IconSize(width = 24f.dp, height = 24f.dp),
            viewBox = ViewBox(minX = 0f, minY = 0f, width = 24f, height = 24f),
        ) {
            addPath(
                pathData = parseSvgPathData("M 12.000 18.500 L 9.000 17.000 L 3.000 20.000 L 3.000 7.000 L 9.000 4.000 L 15.000 7.000 L 21.000 4.000 L 21.000 11.500"),
